...
vec3 l9_38=((Port_Red_N029*l9_37.x)+(Port_Green_N029*l9_37.y))+(Port_Blue_N029*l9_37.z);
float l9_39;
...
{
vec2 l9_43;
Node122_If_else(0.0,vec2(0.0),vec2(0.0),l9_43,l9_2);
float l9_44;
Node67_Bool_Parameter(l9_44,l9_2);
l9_42=mix(varPackedTex.xy,l9_43,vec2(l9_44));
}
#else
{
vec2 l9_45;
...
{
vec2 l9_46;
Node64_If_else(0.0,vec2(0.0),vec2(0.0),l9_46,l9_2);
float l9_47;
Node11_Bool_Parameter(l9_47,l9_2);
l9_45=mix(varPackedTex.xy,l9_46,vec2(l9_47));
}
#else
{
l9_45=varPackedTex.xy;
}
#endif
l9_42=l9_45;
}
...
#endif
bool l9_49=(int(SC_USE_CLAMP_TO_BORDER_opacityTex)!=0)&&(!(int(SC_USE_UV_MIN_MAX_opacityTex)!=0));
float l9_50=l9_40.x;
sc_SoftwareWrapEarly(l9_50,ivec2(SC_SOFTWARE_WRAP_MODE_U_opacityTex,SC_SOFTWARE_WRAP_MODE_V_opacityTex).x);
float l9_51=l9_50;
float l9_52=l9_40.y;
sc_SoftwareWrapEarly(l9_52,ivec2(SC_SOFTWARE_WRAP_MODE_U_opacityTex,SC_SOFTWARE_WRAP_MODE_V_opacityTex).y);
float l9_53=l9_52;
vec2 l9_54;
float l9_55;
...
{
l9_56=ivec2(SC_SOFTWARE_WRAP_MODE_U_opacityTex,SC_SOFTWARE_WRAP_MODE_V_opacityTex).x==3;
}
#else
{
l9_56=(int(SC_USE_CLAMP_TO_BORDER_opacityTex)!=0);
}
#endif
float l9_57=l9_51;
float l9_58=1.0;
sc_ClampUV(l9_57,opacityTexUvMinMax.x,opacityTexUvMinMax.z,l9_56,l9_58);
float l9_59=l9_57;
float l9_60=l9_58;
bool l9_61;
#if (SC_USE_CLAMP_TO_BORDER_opacityTex)
{
l9_61=ivec2(SC_SOFTWARE_WRAP_MODE_U_opacityTex,SC_SOFTWARE_WRAP_MODE_V_opacityTex).y==3;
}
#else
{
...
float l9_62=l9_53;
float l9_63=l9_60;
sc_ClampUV(l9_62,opacityTexUvMinMax.y,opacityTexUvMinMax.w,l9_61,l9_63);
l9_55=l9_63;
l9_54=vec2(l9_59,l9_62);
}
#else
...
#endif
vec2 l9_64=sc_TransformUV(l9_54,(int(SC_USE_UV_TRANSFORM_opacityTex)!=0),opacityTexTransform);
float l9_65=l9_64.x;
float l9_66=l9_55;
sc_SoftwareWrapLate(l9_65,ivec2(SC_SOFTWARE_WRAP_MODE_U_opacityTex,SC_SOFTWARE_WRAP_MODE_V_opacityTex).x,l9_49,l9_66);
float l9_67=l9_64.y;
float l9_68=l9_66;
sc_SoftwareWrapLate(l9_67,ivec2(SC_SOFTWARE_WRAP_MODE_U_opacityTex,SC_SOFTWARE_WRAP_MODE_V_opacityTex).y,l9_49,l9_68);
float l9_69=l9_68;
vec3 l9_70=sc_SamplingCoordsViewToGlobal(vec2(l9_65,l9_67),opacityTexLayout,l9_48);
vec4 l9_71=texture2D(opacityTex,l9_70.xy,0.0);
vec4 l9_72;
#if (SC_USE_CLAMP_TO_BORDER_opacityTex)
{
l9_72=mix(opacityTexBorderColor,l9_71,vec4(l9_69));
}
#else
{
l9_72=l9_71;
...
#else
{
l9_39=Port_Default_N204;
}
#endif
float l9_73=l9_37.w*l9_39;
vec4 l9_74=vec4(l9_38.x,l9_38.y,l9_38.z,vec4(0.0).w);
l9_74.w=l9_73;
#if (sc_BlendMode_AlphaTest)
{
if (l9_73<alphaTestThreshold)
{
discard;
}
}
...
{
if (l9_73<((mod(dot(floor(mod(gl_FragCoord.xy,vec2(4.0))),vec2(4.0,1.0))*9.0,16.0)+1.0)/17.0))
{
discard;
}
}
...
{
l9_78=clamp(dot(l9_74.xyz,vec3(l9_73)),0.0,1.0);
}
#else
{
float l9_79;
...
{
l9_80=(1.0-dot(l9_74.xyz,vec3(0.33333001)))*l9_73;
}
#else
{
float l9_81;
...
{
l9_81=(1.0-clamp(dot(l9_74.xyz,vec3(1.0)),0.0,1.0))*l9_73;
}
#else
{
float l9_82;
...
{
l9_82=clamp(dot(l9_74.xyz,vec3(1.0)),0.0,1.0)*l9_73;
}
#else
{
float l9_83;
#if (sc_BlendMode_Add)
{
l9_83=clamp(dot(l9_74.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_84;
#if (sc_BlendMode_AddWithAlphaFactor)
{
l9_84=clamp(dot(l9_74.xyz,vec3(1.0)),0.0,1.0)*l9_73;
}
#else
{
float l9_85;
...
{
l9_85=dot(l9_74.xyz,vec3(0.33333001))*l9_73;
}
#else
{
float l9_86;
#if (sc_BlendMode_Min)
{
l9_86=1.0-clamp(dot(l9_74.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_87;
#if (sc_BlendMode_Max)
{
l9_87=clamp(dot(l9_74.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
l9_87=1.0;
...
#endif
l9_75=vec4(mix(sc_ShadowColor.xyz,sc_ShadowColor.xyz*l9_74.xyz,vec3(sc_ShadowColor.w)),sc_ShadowDensity*l9_76);
}
#else
{
vec4 l9_88;
...
#if (sc_FramebufferFetch)
{
l9_90=sc_readFragData0_Platform();
}
#else
{
vec2 l9_91=sc_ScreenCoordsGlobalToView(l9_0);
int l9_92;
...
#endif
l9_90=texture2D(sc_ScreenTexture,sc_SamplingCoordsViewToGlobal(l9_91,sc_ScreenTextureLayout,l9_92).xy,0.0);
}
#endif
vec3 l9_93=mix(l9_90.xyz,definedBlend(l9_90.xyz,l9_74.xyz).xyz,vec3(l9_73));
vec4 l9_94=vec4(l9_93.x,l9_93.y,l9_93.z,vec4(0.0).w);
l9_94.w=1.0;
l9_89=l9_94;
}
#else
...
#if (sc_Voxelization)
{
l9_95=vec4(varScreenPos.xyz,1.0);
}
#else
{
vec4 l9_96;
#if (sc_OutputBounds)
{
float l9_97=clamp(abs(gl_FragCoord.z),0.0,1.0);
l9_96=vec4(l9_97,1.0-l9_97,1.0,1.0);
}
#else
{
vec4 l9_98;
#if (sc_BlendMode_MultiplyOriginal)
{
l9_98=vec4(mix(vec3(1.0),l9_74.xyz,vec3(l9_73)),l9_73);
}
#else
{
vec4 l9_99;
...
#endif
l9_99=vec4(l9_74.xyz*l9_100,l9_100);
}
#else
{
l9_99=l9_74;
...
vec4 l9_103=sc_OutputMotionVectorsIfNeeded(varPos,max(l9_101,vec4(0.0)));
vec4 l9_104=clamp(l9_103,vec4(0.0),vec4(1.0));
#if (sc_OITDepthBoundsPass)
{
#if (sc_OITDepthBoundsPass)
{
float l9_105=clamp(viewSpaceDepth()/1000.0,0.0,1.0);
sc_writeFragData0Internal(vec4(max(0.0,1.0-(l9_105-0.0039215689)),min(1.0,l9_105+0.0039215689),0.0,0.0),sc_UniformConstants.x,sc_ShaderCacheConstant);
}
#endif
}
#else
...
#if (sc_OITDepthGatherPass)
{
vec2 l9_106=sc_ScreenCoordsGlobalToView(l9_0);
...
#endif
int l9_107=encodeDepth(viewSpaceDepth(),texture2D(sc_OITFilteredDepthBoundsTexture,l9_106).xy);
float l9_108=packValue(l9_107);
int l9_115=int(l9_104.w*255.0);
float l9_116=packValue(l9_115);
sc_writeFragData0Internal(vec4(packValue(l9_107),packValue(l9_107),packValue(l9_107),packValue(l9_107)),sc_UniformConstants.x,sc_ShaderCacheConstant);
sc_writeFragData1(vec4(l9_108,packValue(l9_107),packValue(l9_107),packValue(l9_107)));
sc_writeFragData2(vec4(l9_116,packValue(l9_115),packValue(l9_115),packValue(l9_115)));
...
#if (sc_OITCompositingPass)
{
vec2 l9_119=sc_ScreenCoordsGlobalToView(l9_0);
#if (sc_OITMaxLayers4Plus1)
{
if ((gl_FragCoord.z-texture2D(sc_OITFrontDepthTexture,l9_119).x)<=getFrontLayerZTestEpsilon())
{
discard;
}
}
...
if (l9_124==0)
{
l9_127=texture2D(sc_OITAlpha0,l9_119);
l9_126=texture2D(sc_OITDepthLow0,l9_119);
l9_125=texture2D(sc_OITDepthHigh0,l9_119);
}
else
{
l9_127=vec4(0.0);
...
if (l9_124==1)
{
l9_130=texture2D(sc_OITAlpha1,l9_119);
l9_129=texture2D(sc_OITDepthLow1,l9_119);
l9_128=texture2D(sc_OITDepthHigh1,l9_119);
}
else
{
l9_130=l9_127;
...
if (any(notEqual(l9_128,vec4(0.0)))||any(notEqual(l9_129,vec4(0.0))))
{
int l9_131[8]=l9_120;
unpackValues(l9_128.w,l9_124,l9_131);
unpackValues(l9_128.z,l9_124,l9_131);
unpackValues(l9_128.y,l9_124,l9_131);
unpackValues(l9_128.x,l9_124,l9_131);
unpackValues(l9_129.w,l9_124,l9_131);
unpackValues(l9_129.z,l9_124,l9_131);
unpackValues(l9_129.y,l9_124,l9_131);
unpackValues(l9_129.x,l9_124,l9_131);
int l9_140[8]=l9_121;
unpackValues(l9_130.w,l9_124,l9_140);
unpackValues(l9_130.z,l9_124,l9_140);
unpackValues(l9_130.y,l9_124,l9_140);
unpackValues(l9_130.x,l9_124,l9_140);
}
l9_124++;
continue;
}
...
vec4 l9_145=texture2D(sc_OITFilteredDepthBoundsTexture,l9_119);
vec2 l9_146=l9_145.xy;
int l9_147;
#if (sc_SkinBonesCount>0)
{
l9_147=encodeDepth(((1.0-l9_145.x)*1000.0)+getDepthOrderingEpsilon(),l9_146);
}
#else
{
l9_147=0;
...
#endif
int l9_148=encodeDepth(viewSpaceDepth(),l9_146);
vec4 l9_149;
l9_149=l9_104*l9_104.w;
vec4 l9_150;
int l9_151=0;
for (int snapLoopIndex=0; snapLoopIndex==0; snapLoopIndex+=0)
{
if (l9_151<8)
{
int l9_152=l9_120[l9_151];
int l9_153=l9_148-l9_147;
bool l9_154=l9_152<l9_153;
bool l9_155;
if (l9_154)
{
l9_155=l9_120[l9_151]>0;
}
else
{
l9_155=l9_154;
...
if (l9_155)
{
vec3 l9_156=l9_149.xyz*(1.0-(float(l9_121[l9_151])/255.0));
l9_150=vec4(l9_156.x,l9_156.y,l9_156.z,l9_149.w);
}
else
{
l9_150=l9_149;

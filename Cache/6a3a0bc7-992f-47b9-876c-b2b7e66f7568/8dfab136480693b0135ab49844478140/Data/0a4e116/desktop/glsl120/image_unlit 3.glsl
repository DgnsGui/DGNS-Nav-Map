...
//spec_const bool uv2EnableAnimation 78 0
//spec_const bool uv3EnableAnimation 79 0
//spec_const int NODE_13_DROPLIST_ITEM 80 0
//spec_const int NODE_27_DROPLIST_ITEM 81 0
//spec_const int NODE_49_DROPLIST_ITEM 82 0
//spec_const int SC_SOFTWARE_WRAP_MODE_U_baseTex 83 -1
...
//spec_const int baseTexLayout 87 0
...
{
vec2 l9_11;
Node59_Switch(0.0,vec2(0.0),vec2(0.0),vec2(0.0),vec2(0.0),vec2(0.0),l9_11,l9_2);
l9_10=((l9_11*uv3Scale)+uv3Offset)+(uv3Offset*(sc_Time.x*Port_Speed_N063));
}
#else
{
vec2 l9_12;
Node59_Switch(0.0,vec2(0.0),vec2(0.0),vec2(0.0),vec2(0.0),vec2(0.0),l9_12,l9_2);
l9_10=(l9_12*uv3Scale)+uv3Offset;
}
#endif
float l9_13;
#if (Tweak_N11)
...
#endif
l9_9=mix(varPackedTex.xy,l9_10,vec2(l9_13-0.001));
}
#else
{
...
float l9_35=l9_34;
vec3 l9_36=sc_SamplingCoordsViewToGlobal(vec2(l9_31,l9_33),baseTexLayout,l9_14);
vec4 l9_37=texture2D(baseTex,l9_36.xy,0.0);
vec4 l9_38;
#if (SC_USE_CLAMP_TO_BORDER_baseTex)
{
...
#endif
vec4 l9_39=baseColor*l9_3;
vec3 l9_40=((Port_Red_N029*l9_39.x)+(Port_Green_N029*l9_39.y))+(Port_Blue_N029*l9_39.z);
float l9_41=l9_39.w;
vec4 l9_42=vec4(l9_40.x,l9_40.y,l9_40.z,vec4(0.0).w);
l9_42.w=l9_41;
#if (sc_BlendMode_AlphaTest)
{
if (l9_41<alphaTestThreshold)
{
discard;
}
}
...
{
if (l9_41<((mod(dot(floor(mod(gl_FragCoord.xy,vec2(4.0))),vec2(4.0,1.0))*9.0,16.0)+1.0)/17.0))
{
discard;
}
}
...
{
l9_46=clamp(dot(l9_42.xyz,vec3(l9_41)),0.0,1.0);
}
#else
{
float l9_47;
...
{
l9_48=(1.0-dot(l9_42.xyz,vec3(0.33333001)))*l9_41;
}
#else
{
float l9_49;
...
{
l9_49=(1.0-clamp(dot(l9_42.xyz,vec3(1.0)),0.0,1.0))*l9_41;
}
#else
{
float l9_50;
...
{
l9_50=clamp(dot(l9_42.xyz,vec3(1.0)),0.0,1.0)*l9_41;
}
#else
{
float l9_51;
#if (sc_BlendMode_Add)
{
l9_51=clamp(dot(l9_42.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_52;
#if (sc_BlendMode_AddWithAlphaFactor)
{
l9_52=clamp(dot(l9_42.xyz,vec3(1.0)),0.0,1.0)*l9_41;
}
#else
{
float l9_53;
...
{
l9_53=dot(l9_42.xyz,vec3(0.33333001))*l9_41;
}
#else
{
float l9_54;
#if (sc_BlendMode_Min)
{
l9_54=1.0-clamp(dot(l9_42.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_55;
#if (sc_BlendMode_Max)
{
l9_55=clamp(dot(l9_42.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
l9_55=1.0;
...
#endif
l9_43=vec4(mix(sc_ShadowColor.xyz,sc_ShadowColor.xyz*l9_42.xyz,vec3(sc_ShadowColor.w)),sc_ShadowDensity*l9_44);
}
#else
{
vec4 l9_56;
...
#if (sc_FramebufferFetch)
{
l9_58=sc_readFragData0_Platform();
}
#else
{
vec2 l9_59=sc_ScreenCoordsGlobalToView(l9_0);
int l9_60;
...
#endif
l9_58=texture2D(sc_ScreenTexture,sc_SamplingCoordsViewToGlobal(l9_59,sc_ScreenTextureLayout,l9_60).xy,0.0);
}
#endif
vec3 l9_61=mix(l9_58.xyz,definedBlend(l9_58.xyz,l9_42.xyz).xyz,vec3(l9_41));
...
#if (sc_Voxelization)
{
l9_63=vec4(varScreenPos.xyz,1.0);
}
#else
{
vec4 l9_64;
#if (sc_OutputBounds)
{
float l9_65=clamp(abs(gl_FragCoord.z),0.0,1.0);
l9_64=vec4(l9_65,1.0-l9_65,1.0,1.0);
}
#else
{
vec4 l9_66;
#if (sc_BlendMode_MultiplyOriginal)
{
l9_66=vec4(mix(vec3(1.0),l9_42.xyz,vec3(l9_41)),l9_41);
}
#else
{
vec4 l9_67;
...
#endif
l9_67=vec4(l9_42.xyz*l9_68,l9_68);
}
#else
{
l9_67=l9_42;
...
vec4 l9_71=sc_OutputMotionVectorsIfNeeded(varPos,max(l9_69,vec4(0.0)));
vec4 l9_72=clamp(l9_71,vec4(0.0),vec4(1.0));
#if (sc_OITDepthBoundsPass)
{
#if (sc_OITDepthBoundsPass)
{
float l9_73=clamp(viewSpaceDepth()/1000.0,0.0,1.0);
sc_writeFragData0Internal(vec4(max(0.0,1.0-(l9_73-0.0039215689)),min(1.0,l9_73+0.0039215689),0.0,0.0),sc_UniformConstants.x,sc_ShaderCacheConstant);
}
#endif
}
#else
...
#if (sc_OITDepthGatherPass)
{
vec2 l9_74=sc_ScreenCoordsGlobalToView(l9_0);
#if (sc_OITMaxLayers4Plus1)
{
if ((gl_FragCoord.z-texture2D(sc_OITFrontDepthTexture,l9_74).x)<=getFrontLayerZTestEpsilon())
{
discard;
}
}
#endif
int l9_75=encodeDepth(viewSpaceDepth(),texture2D(sc_OITFilteredDepthBoundsTexture,l9_74).xy);
float l9_76=packValue(l9_75);
int l9_83=int(l9_72.w*255.0);
float l9_84=packValue(l9_83);
sc_writeFragData0Internal(vec4(packValue(l9_75),packValue(l9_75),packValue(l9_75),packValue(l9_75)),sc_UniformConstants.x,sc_ShaderCacheConstant);
sc_writeFragData1(vec4(l9_76,packValue(l9_75),packValue(l9_75),packValue(l9_75)));
sc_writeFragData2(vec4(l9_84,packValue(l9_83),packValue(l9_83),packValue(l9_83)));
...
#if (sc_OITCompositingPass)
{
vec2 l9_87=sc_ScreenCoordsGlobalToView(l9_0);
#if (sc_OITMaxLayers4Plus1)
{
if ((gl_FragCoord.z-texture2D(sc_OITFrontDepthTexture,l9_87).x)<=getFrontLayerZTestEpsilon())
{
discard;
}
}
...
if (l9_92==0)
{
l9_95=texture2D(sc_OITAlpha0,l9_87);
l9_94=texture2D(sc_OITDepthLow0,l9_87);
l9_93=texture2D(sc_OITDepthHigh0,l9_87);
}
else
{
l9_95=vec4(0.0);
...
if (l9_92==1)
{
l9_98=texture2D(sc_OITAlpha1,l9_87);
l9_97=texture2D(sc_OITDepthLow1,l9_87);
l9_96=texture2D(sc_OITDepthHigh1,l9_87);
}
else
{
l9_98=l9_95;
...
if (any(notEqual(l9_96,vec4(0.0)))||any(notEqual(l9_97,vec4(0.0))))
{
int l9_99[8]=l9_88;
unpackValues(l9_96.w,l9_92,l9_99);
unpackValues(l9_96.z,l9_92,l9_99);
unpackValues(l9_96.y,l9_92,l9_99);
unpackValues(l9_96.x,l9_92,l9_99);
unpackValues(l9_97.w,l9_92,l9_99);
unpackValues(l9_97.z,l9_92,l9_99);
unpackValues(l9_97.y,l9_92,l9_99);
unpackValues(l9_97.x,l9_92,l9_99);
int l9_108[8]=l9_89;
unpackValues(l9_98.w,l9_92,l9_108);
unpackValues(l9_98.z,l9_92,l9_108);
unpackValues(l9_98.y,l9_92,l9_108);
unpackValues(l9_98.x,l9_92,l9_108);
}
l9_92++;
continue;
}
...
vec4 l9_113=texture2D(sc_OITFilteredDepthBoundsTexture,l9_87);
vec2 l9_114=l9_113.xy;
int l9_115;
#if (sc_SkinBonesCount>0)
{
l9_115=encodeDepth(((1.0-l9_113.x)*1000.0)+getDepthOrderingEpsilon(),l9_114);
}
#else
{
l9_115=0;
...
#endif
int l9_116=encodeDepth(viewSpaceDepth(),l9_114);
vec4 l9_117;
l9_117=l9_72*l9_72.w;
vec4 l9_118;
int l9_119=0;
for (int snapLoopIndex=0; snapLoopIndex==0; snapLoopIndex+=0)
{
if (l9_119<8)
{
int l9_120=l9_88[l9_119];
int l9_121=l9_116-l9_115;
bool l9_122=l9_120<l9_121;
bool l9_123;
if (l9_122)
{
l9_123=l9_88[l9_119]>0;
}
else
{
l9_123=l9_122;
...
if (l9_123)
{
vec3 l9_124=l9_117.xyz*(1.0-(float(l9_89[l9_119])/255.0));
l9_118=vec4(l9_124.x,l9_124.y,l9_124.z,l9_117.w);
}
else
{
l9_118=l9_117;
...
sc_writeFragData0Internal(l9_117,sc_UniformConstants.x,sc_ShaderCacheConstant);
#if (sc_OITMaxLayersVisualizeLayerCount)
{
discard;
}
...
#else
{
sc_writeFragData0Internal(l9_71,sc_UniformConstants.x,sc_ShaderCacheConstant);
}
#endif
}
#endif

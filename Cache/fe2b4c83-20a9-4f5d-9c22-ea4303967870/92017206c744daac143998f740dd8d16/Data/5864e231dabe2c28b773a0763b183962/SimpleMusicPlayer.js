...
let SimpleMusicPlayerManager = (() => {
    ...
    var SimpleMusicPlayerManager = _classThis = class extends _classSuper {
        constructor() {
            ...
            this.localTrackAlbumCovers = this.localTrackAlbumCovers;
            ...
            this.remoteTrackAlbumCovers = this.remoteTrackAlbumCovers;
            ...
            this.albumCoverImage = this.albumCoverImage;
        ...
        validateInputs() {
            ...
            if (!this.albumCoverImage)
                print("SimpleMusicPlayerManager Warning: Album Cover Image component not defined.");
            return isValid;
        }
        // --- Setup Callbacks ---
        setupCallbacks() {

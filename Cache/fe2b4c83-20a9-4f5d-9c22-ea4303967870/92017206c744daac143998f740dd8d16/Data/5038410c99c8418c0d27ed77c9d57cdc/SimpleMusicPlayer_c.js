...
// @input Component.Image albumCoverImage
// @input bool loopPlayback = true
// @input float volume = 1
...
awakeEvent.bind(() => {
    ...
    checkUndefined("albumCoverImage", []);

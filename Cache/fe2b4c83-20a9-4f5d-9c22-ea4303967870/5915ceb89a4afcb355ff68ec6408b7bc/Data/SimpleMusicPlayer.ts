...
export class SimpleMusicPlayerManager extends BaseScriptComponent {
    ...
    // Individual album covers for local tracks
    @input('Asset.Texture') localCover0: Texture | null = null;
    @input('Asset.Texture') localCover1: Texture | null = null;
    @input('Asset.Texture') localCover2: Texture | null = null;
    @input('Asset.Texture') localCover3: Texture | null = null;
    @input('Asset.Texture') localCover4: Texture | null = null;
    @input('Asset.Texture') localCover5: Texture | null = null;
    @input('Asset.Texture') localCover6: Texture | null = null;
    @input('Asset.Texture') localCover7: Texture | null = null;
    @input('Asset.Texture') localCover8: Texture | null = null;
    @input('Asset.Texture') localCover9: Texture | null = null;
    ...
    // Individual album covers for remote tracks
    @input('Asset.Texture') remoteCover0: Texture | null = null;
    @input('Asset.Texture') remoteCover1: Texture | null = null;
    @input('Asset.Texture') remoteCover2: Texture | null = null;
    @input('Asset.Texture') remoteCover3: Texture | null = null;
    @input('Asset.Texture') remoteCover4: Texture | null = null;
    @input('Asset.Texture') remoteCover5: Texture | null = null;
    @input('Asset.Texture') remoteCover6: Texture | null = null;
    @input('Asset.Texture') remoteCover7: Texture | null = null;
    @input('Asset.Texture') remoteCover8: Texture | null = null;
    @input('Asset.Texture') remoteCover9: Texture | null = null;
    ...
    @input('Component.Image') albumCoverImage: Image | null = null;
    
    @input loopPlayback: boolean = true;
    @input volume: number = 1.0;

    // --- Private variables ---
    private allTracksData: TrackData[] = [];
    private localCovers: (Texture | null)[] = [];
    private remoteCovers: (Texture | null)[] = [];
    ...
    onAwake(): void {
        ...
        this.localCovers = [
            this.localCover0, this.localCover1, this.localCover2, this.localCover3, this.localCover4,
            this.localCover5, this.localCover6, this.localCover7, this.localCover8, this.localCover9
        ];
        this.remoteCovers = [
            this.remoteCover0, this.remoteCover1, this.remoteCover2, this.remoteCover3, this.remoteCover4,
            this.remoteCover5, this.remoteCover6, this.remoteCover7, this.remoteCover8, this.remoteCover9
        ];
    ...
    private combineTrackData(): void {
            ...
            for (let i = 0; i < this.localTracks.length; i++) {
                if (this.localTracks[i] && 
                    ...
                    this.allTracksData.push({
                        ...
                        albumCover: this.localCovers[i] || null,
                        isRemote: false
                    });
                }
            }
        ...
        // Add remote tracks
        if (this.remoteTracks && this.remoteTracks.length > 0) {
            for (let i = 0; i < this.remoteTracks.length; i++) {
                if (this.remoteTracks[i] && 
                    ...
                    this.allTracksData.push({
                        ...
                        albumCover: this.remoteCovers[i] || null,
                        isRemote: true
                    });
                }
            }
    ...
    private validateInputs(): boolean {
        ...
        if (numLocalTracks > 0) {
            if (numLocalTracks > 10) {
                print("SimpleMusicPlayerManager Warning: Maximum 10 local tracks supported for album covers.");
            }
        ...
        if (numRemoteTracks > 0) {
            if (numRemoteTracks > 10) {
                print("SimpleMusicPlayerManager Warning: Maximum 10 remote tracks supported for album covers.");
            }
        ...
        if (!this.albumCoverImage) print("SimpleMusicPlayerManager Warning: Album Cover Image component not defined.");
    ...
    private updateTrackInfoUI(): void {
        try {
            let title = "---";
            let artist = "---";
            let albumCover: Texture | null = null;
            ...
            if (this.isLoadingRemote && this.currentTrackIndex !== -1 && this.currentTrackIndex < this.allTracksData.length) {
                ...
                albumCover = trackData?.albumCover || null;

...
vec3 l9_73=((Port_Red_N029*l9_37.x)+(Port_Green_N029*l9_37.y))+(Port_Blue_N029*l9_37.z);
...
{
l9_78=clamp(dot(l9_74.xyz,vec3(l9_72)),0.0,1.0);
}
#else
{
float l9_79;
...
{
l9_80=(1.0-dot(l9_74.xyz,vec3(0.33333001)))*l9_72;
}
#else
{
float l9_81;
...
{
l9_81=(1.0-clamp(dot(l9_74.xyz,vec3(1.0)),0.0,1.0))*l9_72;
}
#else
{
float l9_82;
...
{
l9_82=clamp(dot(l9_74.xyz,vec3(1.0)),0.0,1.0)*l9_72;
}
#else
{
float l9_83;
...
#if (sc_BlendMode_AddWithAlphaFactor)
{
l9_84=clamp(dot(l9_74.xyz,vec3(1.0)),0.0,1.0)*l9_72;
}
#else
{
float l9_85;
...
{
l9_85=dot(l9_74.xyz,vec3(0.33333001))*l9_72;
}
#else
{
float l9_86;
...
#endif
vec3 l9_93=mix(l9_90.xyz,definedBlend(l9_90.xyz,l9_74.xyz).xyz,vec3(l9_72));
...
#if (sc_BlendMode_MultiplyOriginal)
{
l9_98=vec4(mix(vec3(1.0),l9_74.xyz,vec3(l9_72)),l9_72);
}
#else
{
vec4 l9_99;

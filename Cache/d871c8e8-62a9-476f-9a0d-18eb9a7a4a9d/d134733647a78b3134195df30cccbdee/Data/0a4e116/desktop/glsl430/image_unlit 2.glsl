...
vec3 l9_125=((Port_Red_N029*l9_65.x)+(Port_Green_N029*l9_65.y))+(Port_Blue_N029*l9_65.z);
vec4 l9_126=vec4(l9_125.x,l9_125.y,l9_125.z,vec4(0.0).w);
l9_126.w=l9_124;
...
{
l9_131=clamp(l9_124*2.0,0.0,1.0);
}
#else
{
float l9_132;
...
{
l9_132=clamp(dot(l9_126.xyz,vec3(l9_124)),0.0,1.0);
}
#else
{
float l9_133;
...
{
l9_134=(1.0-dot(l9_126.xyz,vec3(0.33333001)))*l9_124;
}
#else
{
float l9_135;
...
{
l9_135=(1.0-clamp(dot(l9_126.xyz,vec3(1.0)),0.0,1.0))*l9_124;
}
#else
{
float l9_136;
...
{
l9_136=clamp(dot(l9_126.xyz,vec3(1.0)),0.0,1.0)*l9_124;
}
#else
{
float l9_137;
...
#if (sc_BlendMode_AddWithAlphaFactor)
{
l9_138=clamp(dot(l9_126.xyz,vec3(1.0)),0.0,1.0)*l9_124;
}
#else
{
float l9_139;
...
{
l9_139=dot(l9_126.xyz,vec3(0.33333001))*l9_124;
}
#else
{
float l9_140;
...
#endif
vec3 l9_147=mix(l9_144.xyz,definedBlend(l9_144.xyz,l9_126.xyz).xyz,vec3(l9_124));
...
#if (sc_BlendMode_MultiplyOriginal)
{
l9_152=vec4(mix(vec3(1.0),l9_126.xyz,vec3(l9_124)),l9_124);
}
#else
{
vec4 l9_153;

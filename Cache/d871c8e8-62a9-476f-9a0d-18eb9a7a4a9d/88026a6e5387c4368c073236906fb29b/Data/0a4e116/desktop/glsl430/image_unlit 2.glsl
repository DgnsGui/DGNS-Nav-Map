...
#endif
sc_writeFragData0Internal(max(l9_69,vec4(0.0)),sc_UniformConstants.x,sc_ShaderCacheConstant);
return;
}
vec4 l9_71;
...
{
l9_74=clamp(dot(l9_67.xyz,vec3(l9_68)),0.0,1.0);
}
#else
{
float l9_75;
...
{
l9_76=(1.0-dot(l9_67.xyz,vec3(0.33333001)))*l9_68;
}
#else
{
float l9_77;
...
{
l9_77=(1.0-clamp(dot(l9_67.xyz,vec3(1.0)),0.0,1.0))*l9_68;
}
#else
{
float l9_78;
...
{
l9_78=clamp(dot(l9_67.xyz,vec3(1.0)),0.0,1.0)*l9_68;
}
#else
{
float l9_79;
#if (sc_BlendMode_Add)
{
l9_79=clamp(dot(l9_67.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_80;
#if (sc_BlendMode_AddWithAlphaFactor)
{
l9_80=clamp(dot(l9_67.xyz,vec3(1.0)),0.0,1.0)*l9_68;
}
#else
{
float l9_81;
...
{
l9_81=dot(l9_67.xyz,vec3(0.33333001))*l9_68;
}
#else
{
float l9_82;
#if (sc_BlendMode_Min)
{
l9_82=1.0-clamp(dot(l9_67.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_83;
#if (sc_BlendMode_Max)
{
l9_83=clamp(dot(l9_67.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
l9_83=1.0;
...
#endif
l9_71=vec4(mix(sc_ShadowColor.xyz,sc_ShadowColor.xyz*l9_67.xyz,vec3(sc_ShadowColor.w)),sc_ShadowDensity*l9_72);
}
#else
{
vec4 l9_84;
...
#if (sc_FramebufferFetch)
{
l9_86=sc_readFragData0_Platform();
}
#else
{
vec2 l9_87=sc_ScreenCoordsGlobalToView(gl_FragCoord.xy*sc_CurrentRenderTargetDims.zw);
vec4 l9_88;
#if (sc_ScreenTextureLayout==2)
{
l9_88=texture(sc_ScreenTextureArrSC,sc_SamplingCoordsViewToGlobal(l9_87,sc_ScreenTextureLayout,sc_ScreenTextureGetStereoViewIndex()),0.0);
}
#else
{
l9_88=texture(sc_ScreenTexture,sc_SamplingCoordsViewToGlobal(l9_87,sc_ScreenTextureLayout,sc_ScreenTextureGetStereoViewIndex()).xy,0.0);
}
#endif
l9_86=l9_88;
}
#endif
vec3 l9_89=mix(l9_86.xyz,definedBlend(l9_86.xyz,l9_67.xyz).xyz,vec3(l9_68));
vec4 l9_90=vec4(l9_89.x,l9_89.y,l9_89.z,vec4(0.0).w);
l9_90.w=1.0;
l9_85=l9_90;
}
#else
...
#if (sc_Voxelization)
{
l9_91=vec4(varScreenPos.xyz,1.0);
}
#else
{
vec4 l9_92;
#if (sc_OutputBounds)
{
float l9_93=clamp(abs(gl_FragCoord.z),0.0,1.0);
l9_92=vec4(l9_93,1.0-l9_93,1.0,1.0);
}
#else
{
vec4 l9_94;
#if (sc_BlendMode_MultiplyOriginal)
{
l9_94=vec4(mix(vec3(1.0),l9_67.xyz,vec3(l9_68)),l9_68);
}
#else
{
vec4 l9_95;
...
#endif
l9_95=vec4(l9_67.xyz*l9_96,l9_96);
}
#else
{
l9_95=l9_67;
...
vec4 l9_99=sc_OutputMotionVectorsIfNeeded(varPos,max(l9_97,vec4(0.0)));
vec4 l9_100=clamp(l9_99,vec4(0.0),vec4(1.0));
#if (sc_OITDepthBoundsPass)
{
#if (sc_OITDepthBoundsPass)
{
float l9_101=clamp(viewSpaceDepth()/1000.0,0.0,1.0);
sc_writeFragData0Internal(vec4(max(0.0,1.0-(l9_101-0.0039215689)),min(1.0,l9_101+0.0039215689),0.0,0.0),sc_UniformConstants.x,sc_ShaderCacheConstant);
}
#endif
}
#else
...
#if (sc_OITDepthGatherPass)
{
vec2 l9_102=sc_ScreenCoordsGlobalToView(gl_FragCoord.xy*sc_CurrentRenderTargetDims.zw);
#if (sc_OITMaxLayers4Plus1)
{
if ((gl_FragCoord.z-texture(sc_OITFrontDepthTexture,l9_102).x)<=getFrontLayerZTestEpsilon())
{
discard;
}
}
#endif
int l9_103=encodeDepth(viewSpaceDepth(),texture(sc_OITFilteredDepthBoundsTexture,l9_102).xy);
float l9_104=packValue(l9_103);
int l9_111=int(l9_100.w*255.0);
float l9_112=packValue(l9_111);
sc_writeFragData0Internal(vec4(packValue(l9_103),packValue(l9_103),packValue(l9_103),packValue(l9_103)),sc_UniformConstants.x,sc_ShaderCacheConstant);
sc_writeFragData1(vec4(l9_104,packValue(l9_103),packValue(l9_103),packValue(l9_103)));
sc_writeFragData2(vec4(l9_112,packValue(l9_111),packValue(l9_111),packValue(l9_111)));
...
#if (sc_OITCompositingPass)
{
vec2 l9_115=sc_ScreenCoordsGlobalToView(gl_FragCoord.xy*sc_CurrentRenderTargetDims.zw);
#if (sc_OITMaxLayers4Plus1)
{
if ((gl_FragCoord.z-texture(sc_OITFrontDepthTexture,l9_115).x)<=getFrontLayerZTestEpsilon())
{
discard;
}
}
...
if (l9_120==0)
{
l9_123=texture(sc_OITAlpha0,l9_115);
l9_122=texture(sc_OITDepthLow0,l9_115);
l9_121=texture(sc_OITDepthHigh0,l9_115);
}
else
{
l9_123=vec4(0.0);
...
if (l9_120==1)
{
l9_126=texture(sc_OITAlpha1,l9_115);
l9_125=texture(sc_OITDepthLow1,l9_115);
l9_124=texture(sc_OITDepthHigh1,l9_115);
}
else
{
l9_126=l9_123;
...
if (any(notEqual(l9_124,vec4(0.0)))||any(notEqual(l9_125,vec4(0.0))))
{
int l9_127[8]=l9_116;
unpackValues(l9_124.w,l9_120,l9_127);
unpackValues(l9_124.z,l9_120,l9_127);
unpackValues(l9_124.y,l9_120,l9_127);
unpackValues(l9_124.x,l9_120,l9_127);
unpackValues(l9_125.w,l9_120,l9_127);
unpackValues(l9_125.z,l9_120,l9_127);
unpackValues(l9_125.y,l9_120,l9_127);
unpackValues(l9_125.x,l9_120,l9_127);
int l9_136[8]=l9_117;
unpackValues(l9_126.w,l9_120,l9_136);
unpackValues(l9_126.z,l9_120,l9_136);
unpackValues(l9_126.y,l9_120,l9_136);
unpackValues(l9_126.x,l9_120,l9_136);
}
l9_120++;
continue;
}
...
vec4 l9_141=texture(sc_OITFilteredDepthBoundsTexture,l9_115);
vec2 l9_142=l9_141.xy;
int l9_143;
#if (sc_SkinBonesCount>0)
{
l9_143=encodeDepth(((1.0-l9_141.x)*1000.0)+getDepthOrderingEpsilon(),l9_142);
}
#else
{
l9_143=0;
...
#endif
int l9_144=encodeDepth(viewSpaceDepth(),l9_142);
vec4 l9_145;
l9_145=l9_100*l9_100.w;
vec4 l9_146;
int l9_147=0;
for (int snapLoopIndex=0; snapLoopIndex==0; snapLoopIndex+=0)
{
if (l9_147<8)
{
int l9_148=l9_116[l9_147];
int l9_149=l9_144-l9_143;
bool l9_150=l9_148<l9_149;
bool l9_151;
if (l9_150)
{
l9_151=l9_116[l9_147]>0;
}
else
{
l9_151=l9_150;
...
if (l9_151)
{
vec3 l9_152=l9_145.xyz*(1.0-(float(l9_117[l9_147])/255.0));
l9_146=vec4(l9_152.x,l9_152.y,l9_152.z,l9_145.w);
}
else
{
l9_146=l9_145;
...
sc_writeFragData0Internal(l9_145,sc_UniformConstants.x,sc_ShaderCacheConstant);
#if (sc_OITMaxLayersVisualizeLayerCount)
{
discard;
}

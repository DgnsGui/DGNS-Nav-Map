...
{
if (l9_40<((mod(dot(floor(mod(gl_FragCoord.xy,vec2(4.0))),vec2(4.0,1.0))*9.0,16.0)+1.0)/17.0))
{
discard;
}
}
...
{
l9_44=clamp(dot(l9_39.xyz,vec3(l9_40)),0.0,1.0);
}
#else
{
float l9_45;
...
{
l9_46=(1.0-dot(l9_39.xyz,vec3(0.33333001)))*l9_40;
}
#else
{
float l9_47;
...
{
l9_47=(1.0-clamp(dot(l9_39.xyz,vec3(1.0)),0.0,1.0))*l9_40;
}
#else
{
float l9_48;
...
{
l9_48=clamp(dot(l9_39.xyz,vec3(1.0)),0.0,1.0)*l9_40;
}
#else
{
float l9_49;
#if (sc_BlendMode_Add)
{
l9_49=clamp(dot(l9_39.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_50;
#if (sc_BlendMode_AddWithAlphaFactor)
{
l9_50=clamp(dot(l9_39.xyz,vec3(1.0)),0.0,1.0)*l9_40;
}
#else
{
float l9_51;
...
{
l9_51=dot(l9_39.xyz,vec3(0.33333001))*l9_40;
}
#else
{
float l9_52;
#if (sc_BlendMode_Min)
{
l9_52=1.0-clamp(dot(l9_39.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_53;
#if (sc_BlendMode_Max)
{
l9_53=clamp(dot(l9_39.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
l9_53=1.0;
...
#endif
l9_41=vec4(mix(sc_ShadowColor.xyz,sc_ShadowColor.xyz*l9_39.xyz,vec3(sc_ShadowColor.w)),sc_ShadowDensity*l9_42);
}
#else
{
vec4 l9_54;
...
#if (sc_FramebufferFetch)
{
l9_56=sc_readFragData0_Platform();
}
#else
{
...
#endif
l9_56=texture2D(sc_ScreenTexture,sc_SamplingCoordsViewToGlobal(l9_57,sc_ScreenTextureLayout,l9_58).xy,0.0);
}
#endif
vec3 l9_59=mix(l9_56.xyz,definedBlend(l9_56.xyz,l9_39.xyz).xyz,vec3(l9_40));
vec4 l9_60=vec4(l9_59.x,l9_59.y,l9_59.z,vec4(0.0).w);
l9_60.w=1.0;
l9_55=l9_60;
}
#else
...
#if (sc_Voxelization)
{
l9_61=vec4(varScreenPos.xyz,1.0);
}
#else
{
vec4 l9_62;
#if (sc_OutputBounds)
{
float l9_63=clamp(abs(gl_FragCoord.z),0.0,1.0);
l9_62=vec4(l9_63,1.0-l9_63,1.0,1.0);
}
#else
{
vec4 l9_64;
#if (sc_BlendMode_MultiplyOriginal)
{
l9_64=vec4(mix(vec3(1.0),l9_39.xyz,vec3(l9_40)),l9_40);
}
#else
{
vec4 l9_65;
...
#endif
l9_65=vec4(l9_39.xyz*l9_66,l9_66);
}
#else
{
l9_65=l9_39;
...
vec4 l9_69=sc_OutputMotionVectorsIfNeeded(varPos,max(l9_67,vec4(0.0)));
vec4 l9_70=clamp(l9_69,vec4(0.0),vec4(1.0));
#if (sc_OITDepthBoundsPass)
{
#if (sc_OITDepthBoundsPass)
{
float l9_71=clamp(viewSpaceDepth()/1000.0,0.0,1.0);
sc_writeFragData0Internal(vec4(max(0.0,1.0-(l9_71-0.0039215689)),min(1.0,l9_71+0.0039215689),0.0,0.0),sc_UniformConstants.x,sc_ShaderCacheConstant);
}
#endif
}
#else
...
#if (sc_OITDepthGatherPass)
{
vec2 l9_72=sc_ScreenCoordsGlobalToView(l9_0);
#if (sc_OITMaxLayers4Plus1)
{
if ((gl_FragCoord.z-texture2D(sc_OITFrontDepthTexture,l9_72).x)<=getFrontLayerZTestEpsilon())
{
discard;
}
}
#endif
int l9_73=encodeDepth(viewSpaceDepth(),texture2D(sc_OITFilteredDepthBoundsTexture,l9_72).xy);
float l9_74=packValue(l9_73);
int l9_81=int(l9_70.w*255.0);
float l9_82=packValue(l9_81);
sc_writeFragData0Internal(vec4(packValue(l9_73),packValue(l9_73),packValue(l9_73),packValue(l9_73)),sc_UniformConstants.x,sc_ShaderCacheConstant);
sc_writeFragData1(vec4(l9_74,packValue(l9_73),packValue(l9_73),packValue(l9_73)));
sc_writeFragData2(vec4(l9_82,packValue(l9_81),packValue(l9_81),packValue(l9_81)));
...
#if (sc_OITCompositingPass)
{
vec2 l9_85=sc_ScreenCoordsGlobalToView(l9_0);
#if (sc_OITMaxLayers4Plus1)
{
...
if (l9_90==0)
{
l9_93=texture2D(sc_OITAlpha0,l9_85);
l9_92=texture2D(sc_OITDepthLow0,l9_85);
l9_91=texture2D(sc_OITDepthHigh0,l9_85);
}
else
{
l9_93=vec4(0.0);
...
if (l9_90==1)
{
l9_96=texture2D(sc_OITAlpha1,l9_85);
l9_95=texture2D(sc_OITDepthLow1,l9_85);
l9_94=texture2D(sc_OITDepthHigh1,l9_85);
}
else
{
l9_96=l9_93;
...
if (any(notEqual(l9_94,vec4(0.0)))||any(notEqual(l9_95,vec4(0.0))))
{
int l9_97[8]=l9_86;
unpackValues(l9_94.w,l9_90,l9_97);
unpackValues(l9_94.z,l9_90,l9_97);
unpackValues(l9_94.y,l9_90,l9_97);
unpackValues(l9_94.x,l9_90,l9_97);
unpackValues(l9_95.w,l9_90,l9_97);
unpackValues(l9_95.z,l9_90,l9_97);
unpackValues(l9_95.y,l9_90,l9_97);
unpackValues(l9_95.x,l9_90,l9_97);
int l9_106[8]=l9_87;
unpackValues(l9_96.w,l9_90,l9_106);
unpackValues(l9_96.z,l9_90,l9_106);
unpackValues(l9_96.y,l9_90,l9_106);
unpackValues(l9_96.x,l9_90,l9_106);
}
l9_90++;
continue;
}
...
vec4 l9_111=texture2D(sc_OITFilteredDepthBoundsTexture,l9_85);
vec2 l9_112=l9_111.xy;
int l9_113;
#if (sc_SkinBonesCount>0)
{
l9_113=encodeDepth(((1.0-l9_111.x)*1000.0)+getDepthOrderingEpsilon(),l9_112);
}
#else
{
l9_113=0;
...
#endif
int l9_114=encodeDepth(viewSpaceDepth(),l9_112);
vec4 l9_115;
l9_115=l9_70*l9_70.w;
vec4 l9_116;
int l9_117=0;
for (int snapLoopIndex=0; snapLoopIndex==0; snapLoopIndex+=0)
{
if (l9_117<8)
{
int l9_118=l9_86[l9_117];
int l9_119=l9_114-l9_113;
bool l9_120=l9_118<l9_119;
bool l9_121;
if (l9_120)
{
l9_121=l9_86[l9_117]>0;
}
else
{
l9_121=l9_120;
...
if (l9_121)
{
vec3 l9_122=l9_115.xyz*(1.0-(float(l9_87[l9_117])/255.0));
l9_116=vec4(l9_122.x,l9_122.y,l9_122.z,l9_115.w);
}
else
{
l9_116=l9_115;
...
sc_writeFragData0Internal(l9_115,sc_UniformConstants.x,sc_ShaderCacheConstant);
#if (sc_OITMaxLayersVisualizeLayerCount)
{
discard;
}
...
sc_writeFragData0Internal(l9_70,sc_UniformConstants.x,sc_ShaderCacheConstant);
}
#endif
}
#else
{
sc_writeFragData0Internal(l9_69,sc_UniformConstants.x,sc_ShaderCacheConstant);
}
#endif
}
#endif

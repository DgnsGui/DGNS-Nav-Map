...
//spec_const bool SC_USE_UV_TRANSFORM_baseTex 36 0
//spec_const bool SC_USE_UV_TRANSFORM_intensityTexture 37 0
//spec_const bool Tweak_N11 38 0
//spec_const bool Tweak_N67 39 0
//spec_const bool UseViewSpaceDepthVariant 40 1
//spec_const bool baseTexHasSwappedViews 41 0
...
//spec_const int SC_SOFTWARE_WRAP_MODE_U_baseTex 84 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_U_intensityTexture 85 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_V_baseTex 86 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_V_intensityTexture 87 -1
...
uniform vec3 Port_Red_N029;
uniform vec3 Port_Green_N029;
uniform vec3 Port_Blue_N029;
uniform int PreviewEnabled;
...
{
vec2 l9_15;
Node59_Switch(0.0,vec2(0.0),vec2(0.0),vec2(0.0),vec2(0.0),vec2(0.0),l9_15,l9_6);
l9_14=((l9_15*uv3Scale)+uv3Offset)+(uv3Offset*(sc_Time.x*Port_Speed_N063));
}
#else
{
vec2 l9_16;
Node59_Switch(0.0,vec2(0.0),vec2(0.0),vec2(0.0),vec2(0.0),vec2(0.0),l9_16,l9_6);
l9_14=(l9_16*uv3Scale)+uv3Offset;
}
#endif
float l9_17;
#if (Tweak_N11)
...
#endif
l9_13=mix(l9_3,l9_14,vec2(l9_17-0.001));
}
#else
{
l9_13=l9_3;
...
#endif
vec4 l9_67=baseColor*l9_7;
vec3 l9_68=((Port_Red_N029*l9_67.x)+(Port_Green_N029*l9_67.y))+(Port_Blue_N029*l9_67.z);
float l9_69=l9_67.w;
vec4 l9_70=vec4(l9_68.x,l9_68.y,l9_68.z,vec4(0.0).w);
l9_70.w=l9_69;
#if (sc_BlendMode_AlphaTest)
{
if (l9_69<alphaTestThreshold)
{
discard;
}
}
...
{
if (l9_69<((mod(dot(floor(mod(gl_FragCoord.xy,vec2(4.0))),vec2(4.0,1.0))*9.0,16.0)+1.0)/17.0))
{
discard;
}
}
...
#endif
sc_writeFragData0Internal(max(l9_71,vec4(0.0)),sc_UniformConstants.x,sc_ShaderCacheConstant);
return;
}
vec4 l9_73;
...
{
l9_76=clamp(dot(l9_70.xyz,vec3(l9_69)),0.0,1.0);
}
#else
{
float l9_77;
...
{
l9_78=(1.0-dot(l9_70.xyz,vec3(0.33333001)))*l9_69;
}
#else
{
float l9_79;
...
{
l9_79=(1.0-clamp(dot(l9_70.xyz,vec3(1.0)),0.0,1.0))*l9_69;
}
#else
{
float l9_80;
...
{
l9_80=clamp(dot(l9_70.xyz,vec3(1.0)),0.0,1.0)*l9_69;
}
#else
{
float l9_81;
#if (sc_BlendMode_Add)
{
l9_81=clamp(dot(l9_70.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_82;
#if (sc_BlendMode_AddWithAlphaFactor)
{
l9_82=clamp(dot(l9_70.xyz,vec3(1.0)),0.0,1.0)*l9_69;
}
#else
{
float l9_83;
...
{
l9_83=dot(l9_70.xyz,vec3(0.33333001))*l9_69;
}
#else
{
float l9_84;
#if (sc_BlendMode_Min)
{
l9_84=1.0-clamp(dot(l9_70.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_85;
#if (sc_BlendMode_Max)
{
l9_85=clamp(dot(l9_70.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
l9_85=1.0;
...
#endif
l9_73=vec4(mix(sc_ShadowColor.xyz,sc_ShadowColor.xyz*l9_70.xyz,vec3(sc_ShadowColor.w)),sc_ShadowDensity*l9_74);
}
#else
{
vec4 l9_86;
...
#if (sc_FramebufferFetch)
{
l9_88=sc_readFragData0_Platform();
}
#else
{
vec2 l9_89=sc_ScreenCoordsGlobalToView(gl_FragCoord.xy*sc_CurrentRenderTargetDims.zw);
vec4 l9_90;
#if (sc_ScreenTextureLayout==2)
{
l9_90=texture(sc_ScreenTextureArrSC,sc_SamplingCoordsViewToGlobal(l9_89,sc_ScreenTextureLayout,sc_ScreenTextureGetStereoViewIndex()),0.0);
}
#else
{
l9_90=texture(sc_ScreenTexture,sc_SamplingCoordsViewToGlobal(l9_89,sc_ScreenTextureLayout,sc_ScreenTextureGetStereoViewIndex()).xy,0.0);
}
#endif
l9_88=l9_90;
}
#endif
vec3 l9_91=mix(l9_88.xyz,definedBlend(l9_88.xyz,l9_70.xyz).xyz,vec3(l9_69));
vec4 l9_92=vec4(l9_91.x,l9_91.y,l9_91.z,vec4(0.0).w);
l9_92.w=1.0;
l9_87=l9_92;
}
#else
...
#if (sc_Voxelization)
{
l9_93=vec4(varScreenPos.xyz,1.0);
}
#else
{
vec4 l9_94;
#if (sc_OutputBounds)
{
float l9_95=clamp(abs(gl_FragCoord.z),0.0,1.0);
l9_94=vec4(l9_95,1.0-l9_95,1.0,1.0);
}
#else
{
vec4 l9_96;
#if (sc_BlendMode_MultiplyOriginal)
{
l9_96=vec4(mix(vec3(1.0),l9_70.xyz,vec3(l9_69)),l9_69);
}
#else
{
vec4 l9_97;
...
#endif
l9_97=vec4(l9_70.xyz*l9_98,l9_98);
}
#else
{
l9_97=l9_70;
...
vec4 l9_101=sc_OutputMotionVectorsIfNeeded(varPos,max(l9_99,vec4(0.0)));
vec4 l9_102=clamp(l9_101,vec4(0.0),vec4(1.0));
#if (sc_OITDepthBoundsPass)
{
#if (sc_OITDepthBoundsPass)
{
float l9_103=clamp(viewSpaceDepth()/1000.0,0.0,1.0);
sc_writeFragData0Internal(vec4(max(0.0,1.0-(l9_103-0.0039215689)),min(1.0,l9_103+0.0039215689),0.0,0.0),sc_UniformConstants.x,sc_ShaderCacheConstant);
}
#endif
}
#else
...
#if (sc_OITDepthGatherPass)
{
vec2 l9_104=sc_ScreenCoordsGlobalToView(gl_FragCoord.xy*sc_CurrentRenderTargetDims.zw);
#if (sc_OITMaxLayers4Plus1)
{
if ((gl_FragCoord.z-texture(sc_OITFrontDepthTexture,l9_104).x)<=getFrontLayerZTestEpsilon())
{
discard;
}
}
#endif
int l9_105=encodeDepth(viewSpaceDepth(),texture(sc_OITFilteredDepthBoundsTexture,l9_104).xy);
float l9_106=packValue(l9_105);
int l9_113=int(l9_102.w*255.0);
float l9_114=packValue(l9_113);
sc_writeFragData0Internal(vec4(packValue(l9_105),packValue(l9_105),packValue(l9_105),packValue(l9_105)),sc_UniformConstants.x,sc_ShaderCacheConstant);
sc_writeFragData1(vec4(l9_106,packValue(l9_105),packValue(l9_105),packValue(l9_105)));
sc_writeFragData2(vec4(l9_114,packValue(l9_113),packValue(l9_113),packValue(l9_113)));
...
#if (sc_OITCompositingPass)
{
vec2 l9_117=sc_ScreenCoordsGlobalToView(gl_FragCoord.xy*sc_CurrentRenderTargetDims.zw);
#if (sc_OITMaxLayers4Plus1)
{
if ((gl_FragCoord.z-texture(sc_OITFrontDepthTexture,l9_117).x)<=getFrontLayerZTestEpsilon())
{
discard;
}
}
...
if (l9_122==0)
{
l9_125=texture(sc_OITAlpha0,l9_117);
l9_124=texture(sc_OITDepthLow0,l9_117);
l9_123=texture(sc_OITDepthHigh0,l9_117);
}
else
{
l9_125=vec4(0.0);
...
if (l9_122==1)
{
l9_128=texture(sc_OITAlpha1,l9_117);
l9_127=texture(sc_OITDepthLow1,l9_117);
l9_126=texture(sc_OITDepthHigh1,l9_117);
}
else
{
l9_128=l9_125;
...
if (any(notEqual(l9_126,vec4(0.0)))||any(notEqual(l9_127,vec4(0.0))))
{
int l9_129[8]=l9_118;
unpackValues(l9_126.w,l9_122,l9_129);
unpackValues(l9_126.z,l9_122,l9_129);
unpackValues(l9_126.y,l9_122,l9_129);
unpackValues(l9_126.x,l9_122,l9_129);
unpackValues(l9_127.w,l9_122,l9_129);
unpackValues(l9_127.z,l9_122,l9_129);
unpackValues(l9_127.y,l9_122,l9_129);
unpackValues(l9_127.x,l9_122,l9_129);
int l9_138[8]=l9_119;
unpackValues(l9_128.w,l9_122,l9_138);
unpackValues(l9_128.z,l9_122,l9_138);
unpackValues(l9_128.y,l9_122,l9_138);
unpackValues(l9_128.x,l9_122,l9_138);
}
l9_122++;
continue;
}
...
vec4 l9_143=texture(sc_OITFilteredDepthBoundsTexture,l9_117);
vec2 l9_144=l9_143.xy;
int l9_145;
#if (sc_SkinBonesCount>0)
{
l9_145=encodeDepth(((1.0-l9_143.x)*1000.0)+getDepthOrderingEpsilon(),l9_144);
}
#else
{
l9_145=0;
...
#endif
int l9_146=encodeDepth(viewSpaceDepth(),l9_144);
vec4 l9_147;
l9_147=l9_102*l9_102.w;
vec4 l9_148;
int l9_149=0;
for (int snapLoopIndex=0; snapLoopIndex==0; snapLoopIndex+=0)
{
if (l9_149<8)
{
int l9_150=l9_118[l9_149];
int l9_151=l9_146-l9_145;
bool l9_152=l9_150<l9_151;
bool l9_153;
if (l9_152)
{
l9_153=l9_118[l9_149]>0;
}
else
{
l9_153=l9_152;
...
if (l9_153)
{
vec3 l9_154=l9_147.xyz*(1.0-(float(l9_119[l9_149])/255.0));
l9_148=vec4(l9_154.x,l9_154.y,l9_154.z,l9_147.w);
}
else
{
l9_148=l9_147;
...
#else
{
sc_writeFragData0Internal(l9_101,sc_UniformConstants.x,sc_ShaderCacheConstant);
}
#endif
}
#endif

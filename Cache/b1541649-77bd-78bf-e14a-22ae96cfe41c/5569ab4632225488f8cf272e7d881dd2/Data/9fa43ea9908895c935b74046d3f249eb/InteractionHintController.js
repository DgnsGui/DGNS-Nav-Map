    ...
    var InteractionHintController = _classThis = class extends _classSuper {
        ...
        onUpdate() {
            ...
            if (this.currentAnimationName ==
                ...
                var left_indexTipPos = this.leftIndexTip
                    .getTransform()
                    .getWorldPosition();
                var left_thumbTipPos = this.leftThumbTip
                    .getTransform()
                    .getWorldPosition();
                ...
                var right_indexTipPos = this.rightIndexTip
                    .getTransform()
                    .getWorldPosition();
                var right_thumbTipPos = this.rightThumbTip
                    .getTransform()
                    .getWorldPosition();

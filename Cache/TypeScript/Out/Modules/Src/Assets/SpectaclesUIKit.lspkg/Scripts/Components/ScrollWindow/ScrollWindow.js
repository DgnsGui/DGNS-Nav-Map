    ...
    var ScrollWindow = _classThis = class extends _classSuper {
        constructor() {
            ...
            this.setWindowSize = (size) => {
                ...
                // Configuration pour forme ovale
                ...
                // Appliquer un scale pour créer l'ovale
                ...
                // Arrondir les coins pour un effet ovale sur le masque
            ...
            this.initialize = () => {
                ...
                // MODIFICATION: Positionner au début (haut) de la liste pour scroll vertical
                if (this.vertical) {

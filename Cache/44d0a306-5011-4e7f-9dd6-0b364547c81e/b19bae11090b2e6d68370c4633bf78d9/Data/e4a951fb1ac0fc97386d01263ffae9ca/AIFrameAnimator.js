...
let AIResponseAnimator = (() => {
    ...
    var AIResponseAnimator = _classThis = class extends _classSuper {
        ...
        initialize() {
            this.mapComp = this.mapComponent;
        ...
        animateIn() {
            ...
            // Si Places est déjà visible, on lance son décalage vers le haut EN MÊME TEMPS
            if (this.mapComp.isPlacesClamVisible) {
                this.mapComp.adjustPlacesForAI(true);
            }
            // Lancement immédiat de l'animation AI (plus de callback = synchronisation parfaite)
        ...
        animateOut() {
            ...
            // Animation de descente du container AI
            this.currentAnimation = (0, animate_1.default)({
                duration: this.animationDuration,
                easing: "ease-in-quad",
                update: (t) => {
            ...
            // Synchronisation parfaite : Places redescend EN MÊME TEMPS que AI descend
            if (this.mapComp.isPlacesClamVisible) {

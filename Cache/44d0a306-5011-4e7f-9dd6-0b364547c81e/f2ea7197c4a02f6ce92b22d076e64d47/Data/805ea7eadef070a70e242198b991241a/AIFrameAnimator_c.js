...
// @input AssignableType aiAssistant {"hint":"Le script AIMapAssistant pour écouter les événements"}
// @input float hiddenPositionY {"hint":"Position Y quand l'ovale est caché (à l'intérieur)"}

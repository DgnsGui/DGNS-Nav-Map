...
// @input SceneObject responseContainer {"hint":"L'objet Container Frame de la réponse AI (AI Clam)"}
// @input float hiddenPositionY {"hint":"Position Y quand l'ovale est caché (à l'intérieur)"}
// @input float visiblePositionY = 20 {"hint":"Position Y quand l'ovale est visible (au-dessus)"}

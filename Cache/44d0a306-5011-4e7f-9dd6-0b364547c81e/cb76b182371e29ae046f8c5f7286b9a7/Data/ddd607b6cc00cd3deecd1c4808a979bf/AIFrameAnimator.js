    ...
    var AIResponseAnimator = _classThis = class extends _classSuper {
        ...
        animateIn() {
            if (this.isVisible && !this.isAnimating)
                return;
            // Si Places Clam est déjà visible, on décale Places d'abord, puis on anime AI
        ...
        animateOut() {
            ...
            // Avant de cacher AI, on remet Places à sa position normale si besoin
            if (this.mapComp.isPlacesClamVisible) {
        ...
        showImmediate() {
            ...
            this.isAnimating = false;
            this.responseContainer.enabled = true;
            // Si Places est visible, on le décale immédiatement
            if (this.mapComp.isPlacesClamVisible) {
                this.mapComp.adjustPlacesForAI(true);
            }
        }

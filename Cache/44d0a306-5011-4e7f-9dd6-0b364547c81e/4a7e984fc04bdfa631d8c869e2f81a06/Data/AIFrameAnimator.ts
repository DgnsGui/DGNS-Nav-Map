...
declare module 'SpectaclesUIKit.lspkg/Components/Frame/Frame' {
    // Remplacez ceci par les types réels si vous les connaissez
    const Frame: any;
...
export class AIResponseAnimator extends BaseScriptComponent {
  ...
  @input
  @hint("Le composant Frame pour accéder au bouton close")
  ...
  private initialize(): void {
    ...
    // Connecter le bouton close du Frame
    if (this.frameComponent) {
      ...
      log.w("Frame component not assigned - close button won't be connected");
    }

...
let AIResponseAnimator = (() => {
    ...
    var AIResponseAnimator = _classThis = class extends _classSuper {
        constructor() {
            ...
            this.frameSceneObject = this.frameSceneObject;
        ...
        initialize() {
            ...
            if (this.frameSceneObject) {
                if (this.enableDebugLogs)
                    log.i("Frame SceneObject assigned, searching for Frame component...");
                ...
                if (frameComponent) {
                    ...
                    if (closeButton) {
                        ...
                        if (this.enableDebugLogs)
                            log.i("✅ Close button event connected successfully!");
                    }
                    else {
        ...
        findFrameComponent(sceneObject) {
            ...
            for (let i = 0; i < componentCount; i++) {
                ...
                if (component && "closeButton" in component) {
                    if (this.enableDebugLogs)
                        log.i("Found Frame component on current object");
                    return component;
                }
            }
        ...
        handleCloseButton() {
            if (this.enableDebugLogs)
                log.i("handleCloseButton() called");
            // Déclencher l'animation de fermeture
            this.animateOut();
            // Appeler le callback si défini
            if (this.onCloseCallback) {
                if (this.enableDebugLogs)
                    log.i("Calling close callback...");
        ...
        setOnCloseCallback(callback) {
            ...
            if (this.enableDebugLogs)
                log.i("Close callback registered");
        }
        /**

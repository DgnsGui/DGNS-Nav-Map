...
ssGlobals l9_6=ssGlobals(sc_Time.x,sc_Time.y,0.0,vec3(0.0),l9_5,varPosAndMotion.xyz,varColor,varTex01.xy,varTex01.zw,l9_1,l9_3,l9_4,cross(l9_4,l9_3)*varTangent.w,varPosAndMotion.xyz);
...
#endif
uvec3 l9_341=uvec3(round((varPosAndMotion.xyz-sc_RayTracingOriginOffset)*sc_RayTracingOriginScale));
...
#endif
sc_writeFragData0(max(l9_381,vec4(0.0)));
return;
}
vec4 l9_383;
#if (sc_ProjectiveShadowsCaster)
...
vec4 l9_411=sc_OutputMotionVectorIfNeeded(max(l9_409,vec4(0.0)));
...
sc_writeFragData0(vec4(max(0.0,1.0-(l9_413-0.0039215689)),min(1.0,l9_413+0.0039215689),0.0,0.0));
}
#endif
}
#else
...
sc_writeFragData0(vec4(packValue(l9_415),packValue(l9_415),packValue(l9_415),packValue(l9_415)));
}
#endif
}
#else
...
sc_writeFragData0(l9_412);
}
#endif
}
#else
{
sc_writeFragData0(l9_411);
}
#endif
}
#endif

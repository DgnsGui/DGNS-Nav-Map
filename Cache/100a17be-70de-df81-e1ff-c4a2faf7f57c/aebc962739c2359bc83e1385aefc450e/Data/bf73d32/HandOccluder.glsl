...
uniform NF_PRECISION float4 Tweak_N0; // Title: Custom Color	
...
#define Node1_Surface_Position( Position, Globals ) Position = Globals.SurfacePosition_WorldSpace
...
void main() 
{
	...
	{
		float3 Position_N1 = float3(0.0); Node1_Surface_Position( Position_N1, Globals );
		
		WorldPosition = Position_N1;
	}
...
void Node0_Color_Parameter( out float4 Output, ssGlobals Globals ) { Output = Tweak_N0; }
//-----------------------------------------------------------------------------
...
void main() 
{
	...
	{
		float4 Output_N0 = float4(0.0); Node0_Color_Parameter( Output_N0, Globals );

...
uniform NF_PRECISION                  float                      masterAlpha; // Title: Master Alpha	
...
#define Node13_Remap( ValueIn, ValueOut, RangeMinA, RangeMaxA, RangeMinB, RangeMaxB, Globals ) ValueOut = ( ( ValueIn - RangeMinA ) / ( RangeMaxA - RangeMinA + SC_EPSILON ) ) * ( RangeMaxB - RangeMinB ) + RangeMinB
...
#define Node1_Remap( ValueIn, ValueOut, RangeMinA, RangeMaxA, RangeMinB, RangeMaxB, Globals ) ValueOut = ( ( ValueIn - RangeMinA ) / ( RangeMaxA - RangeMinA + SC_EPSILON ) ) * ( RangeMaxB - RangeMinB ) + RangeMinB
...
void Node165_Split_Vector( in float4 Value, out float Value1, out float Value2, out float Value3, out float Value4, ssGlobals Globals )
{ 
	Value1 = Value.x;
	Value2 = Value.y;
	Value3 = Value.z;
...
void Node163_Float_Parameter( out float Output, ssGlobals Globals ) { Output = masterAlpha; }
#define Node166_Multiply( Input0, Input1, Output, Globals ) Output = Input0 * Input1
#define Node169_Construct_Vector( Value1, Value2, Value3, Value4, Value, Globals ) Value.x = Value1; Value.y = Value2; Value.z = Value3; Value.w = Value4
//-----------------------------------------------------------------------------
...
void main() 
{
	...
	
	{
		...
		float Value1_N165 = 0.0; float Value2_N165 = 0.0; float Value3_N165 = 0.0; float Value4_N165 = 0.0; Node165_Split_Vector( Result_N33, Value1_N165, Value2_N165, Value3_N165, Value4_N165, Globals );
		float Output_N163 = 0.0; Node163_Float_Parameter( Output_N163, Globals );
		float Output_N166 = 0.0; Node166_Multiply( Value4_N165, Output_N163, Output_N166, Globals );
		float4 Value_N169 = float4(0.0); Node169_Construct_Vector( Value1_N165, Value2_N165, Value3_N165, Output_N166, Value_N169, Globals );

...
//sampler sampler Tweak_N0SmpSC 0:21
...
//texture texture2D Tweak_N0 0:3:0:21
...
//texture texture2DArray Tweak_N0ArrSC 0:32:0:21
...
//spec_const bool SC_USE_UV_MIN_MAX_Tweak_N0 33 0
//spec_const bool SC_USE_UV_MIN_MAX_intensityTexture 34 0
//spec_const bool SC_USE_UV_TRANSFORM_Tweak_N0 35 0
//spec_const bool SC_USE_UV_TRANSFORM_intensityTexture 36 0
//spec_const bool Tweak_N0HasSwappedViews 37 0
...
//spec_const int SC_SOFTWARE_WRAP_MODE_U_Tweak_N0 76 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_U_intensityTexture 77 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_V_Tweak_N0 78 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_V_intensityTexture 79 -1
//spec_const int Tweak_N0Layout 80 0
...
#if (Tweak_N0Layout==2)
{
bool l9_4=(int(SC_USE_CLAMP_TO_BORDER_Tweak_N0)!=0)&&(!(int(SC_USE_UV_MIN_MAX_Tweak_N0)!=0));
float l9_5=l9_1.x;
sc_SoftwareWrapEarly(l9_5,ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N0,SC_SOFTWARE_WRAP_MODE_V_Tweak_N0).x);
float l9_6=l9_5;
float l9_7=l9_1.y;
sc_SoftwareWrapEarly(l9_7,ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N0,SC_SOFTWARE_WRAP_MODE_V_Tweak_N0).y);
float l9_8=l9_7;
vec2 l9_9;
float l9_10;
...
{
l9_11=ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N0,SC_SOFTWARE_WRAP_MODE_V_Tweak_N0).x==3;
}
#else
{
l9_11=(int(SC_USE_CLAMP_TO_BORDER_Tweak_N0)!=0);
}
#endif
float l9_12=l9_6;
float l9_13=1.0;
sc_ClampUV(l9_12,Tweak_N0UvMinMax.x,Tweak_N0UvMinMax.z,l9_11,l9_13);
float l9_14=l9_12;
float l9_15=l9_13;
bool l9_16;
#if (SC_USE_CLAMP_TO_BORDER_Tweak_N0)
{
l9_16=ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N0,SC_SOFTWARE_WRAP_MODE_V_Tweak_N0).y==3;
}
#else
{
l9_16=(int(SC_USE_CLAMP_TO_BORDER_Tweak_N0)!=0);
}
#endif
float l9_17=l9_8;
float l9_18=l9_15;
sc_ClampUV(l9_17,Tweak_N0UvMinMax.y,Tweak_N0UvMinMax.w,l9_16,l9_18);
l9_10=l9_18;
...
#endif
vec2 l9_19=sc_TransformUV(l9_9,(int(SC_USE_UV_TRANSFORM_Tweak_N0)!=0),Tweak_N0Transform);
float l9_20=l9_19.x;
float l9_21=l9_10;
sc_SoftwareWrapLate(l9_20,ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N0,SC_SOFTWARE_WRAP_MODE_V_Tweak_N0).x,l9_4,l9_21);
float l9_22=l9_19.y;
float l9_23=l9_21;
sc_SoftwareWrapLate(l9_22,ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N0,SC_SOFTWARE_WRAP_MODE_V_Tweak_N0).y,l9_4,l9_23);
float l9_24=l9_23;
vec3 l9_25=sc_SamplingCoordsViewToGlobal(vec2(l9_20,l9_22),Tweak_N0Layout,Tweak_N0GetStereoViewIndex());
vec4 l9_26=texture(Tweak_N0ArrSC,l9_25,0.0);
vec4 l9_27;
#if (SC_USE_CLAMP_TO_BORDER_Tweak_N0)
{
l9_27=mix(Tweak_N0BorderColor,l9_26,vec4(l9_24));
}
#else
{
l9_27=l9_26;
...
#else
{
bool l9_28=(int(SC_USE_CLAMP_TO_BORDER_Tweak_N0)!=0)&&(!(int(SC_USE_UV_MIN_MAX_Tweak_N0)!=0));
float l9_29=l9_1.x;
sc_SoftwareWrapEarly(l9_29,ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N0,SC_SOFTWARE_WRAP_MODE_V_Tweak_N0).x);
float l9_30=l9_29;
float l9_31=l9_1.y;
sc_SoftwareWrapEarly(l9_31,ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N0,SC_SOFTWARE_WRAP_MODE_V_Tweak_N0).y);
float l9_32=l9_31;
vec2 l9_33;
float l9_34;
#if (SC_USE_UV_MIN_MAX_Tweak_N0)
...
#if (SC_USE_CLAMP_TO_BORDER_Tweak_N0)
{
l9_35=ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N0,SC_SOFTWARE_WRAP_MODE_V_Tweak_N0).x==3;
}
#else
{
l9_35=(int(SC_USE_CLAMP_TO_BORDER_Tweak_N0)!=0);
}
#endif
float l9_36=l9_30;
float l9_37=1.0;
sc_ClampUV(l9_36,Tweak_N0UvMinMax.x,Tweak_N0UvMinMax.z,l9_35,l9_37);
float l9_38=l9_36;
float l9_39=l9_37;
bool l9_40;
#if (SC_USE_CLAMP_TO_BORDER_Tweak_N0)
{
l9_40=ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N0,SC_SOFTWARE_WRAP_MODE_V_Tweak_N0).y==3;
}
#else
{
l9_40=(int(SC_USE_CLAMP_TO_BORDER_Tweak_N0)!=0);
}
#endif
float l9_41=l9_32;
float l9_42=l9_39;
sc_ClampUV(l9_41,Tweak_N0UvMinMax.y,Tweak_N0UvMinMax.w,l9_40,l9_42);
l9_34=l9_42;
...
#endif
vec2 l9_43=sc_TransformUV(l9_33,(int(SC_USE_UV_TRANSFORM_Tweak_N0)!=0),Tweak_N0Transform);
float l9_44=l9_43.x;
float l9_45=l9_34;
sc_SoftwareWrapLate(l9_44,ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N0,SC_SOFTWARE_WRAP_MODE_V_Tweak_N0).x,l9_28,l9_45);
float l9_46=l9_43.y;
float l9_47=l9_45;
sc_SoftwareWrapLate(l9_46,ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N0,SC_SOFTWARE_WRAP_MODE_V_Tweak_N0).y,l9_28,l9_47);
float l9_48=l9_47;
vec3 l9_49=sc_SamplingCoordsViewToGlobal(vec2(l9_44,l9_46),Tweak_N0Layout,Tweak_N0GetStereoViewIndex());
vec4 l9_50=texture(Tweak_N0,l9_49.xy,0.0);
vec4 l9_51;
#if (SC_USE_CLAMP_TO_BORDER_Tweak_N0)
{
l9_51=mix(Tweak_N0BorderColor,l9_50,vec4(l9_48));
}
#else
{
l9_51=l9_50;
...
#endif
vec4 l9_52=vec4(l9_3.xy+Port_Offset_N001,0.0,0.0);
#if (sc_BlendMode_AlphaTest)
{
if (0.0<alphaTestThreshold)
{
discard;
}
}
...
{
if (0.0<((mod(dot(floor(mod(gl_FragCoord.xy,vec2(4.0))),vec2(4.0,1.0))*9.0,16.0)+1.0)/17.0))
{
discard;
}
}
...
#endif
sc_writeFragData0Internal(max(l9_53,vec4(0.0)),sc_UniformConstants.x,sc_ShaderCacheConstant);
return;
}
vec4 l9_55;
...
{
l9_60=(1.0-dot(l9_52.xyz,vec3(0.33333001)))*0.0;
}
#else
{
float l9_61;
...
{
l9_61=(1.0-clamp(dot(l9_52.xyz,vec3(1.0)),0.0,1.0))*0.0;
}
#else
{
float l9_62;
...
{
l9_62=clamp(dot(l9_52.xyz,vec3(1.0)),0.0,1.0)*0.0;
}
#else
{
float l9_63;
#if (sc_BlendMode_Add)
{
l9_63=clamp(dot(l9_52.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_64;
#if (sc_BlendMode_AddWithAlphaFactor)
{
l9_64=clamp(dot(l9_52.xyz,vec3(1.0)),0.0,1.0)*0.0;
}
#else
{
float l9_65;
...
{
l9_65=dot(l9_52.xyz,vec3(0.33333001))*0.0;
}
#else
{
float l9_66;
#if (sc_BlendMode_Min)
{
l9_66=1.0-clamp(dot(l9_52.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_67;
#if (sc_BlendMode_Max)
{
l9_67=clamp(dot(l9_52.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
l9_67=1.0;
...
#endif
l9_55=vec4(mix(sc_ShadowColor.xyz,sc_ShadowColor.xyz*l9_52.xyz,vec3(sc_ShadowColor.w)),sc_ShadowDensity*l9_56);
}
#else
{
vec4 l9_68;
...
#endif
vec4 l9_73=vec4(l9_70.x,l9_70.y,l9_70.z,vec4(0.0).w);
l9_73.w=1.0;
l9_69=l9_73;
}
#else
...
vec4 l9_81=sc_OutputMotionVectorsIfNeeded(varPos,max(l9_79,vec4(0.0)));
vec4 l9_82=clamp(l9_81,vec4(0.0),vec4(1.0));
#if (sc_OITDepthBoundsPass)
{
#if (sc_OITDepthBoundsPass)
{
float l9_83=clamp(viewSpaceDepth()/1000.0,0.0,1.0);
sc_writeFragData0Internal(vec4(max(0.0,1.0-(l9_83-0.0039215689)),min(1.0,l9_83+0.0039215689),0.0,0.0),sc_UniformConstants.x,sc_ShaderCacheConstant);
}
#endif
}
#else
...
{
if ((gl_FragCoord.z-texture(sc_OITFrontDepthTexture,l9_84).x)<=getFrontLayerZTestEpsilon())
{
discard;
}
}
#endif
int l9_85=encodeDepth(viewSpaceDepth(),texture(sc_OITFilteredDepthBoundsTexture,l9_84).xy);
float l9_86=packValue(l9_85);
int l9_93=int(l9_82.w*255.0);
float l9_94=packValue(l9_93);
sc_writeFragData0Internal(vec4(packValue(l9_85),packValue(l9_85),packValue(l9_85),packValue(l9_85)),sc_UniformConstants.x,sc_ShaderCacheConstant);
sc_writeFragData1(vec4(l9_86,packValue(l9_85),packValue(l9_85),packValue(l9_85)));
sc_writeFragData2(vec4(l9_94,packValue(l9_93),packValue(l9_93),packValue(l9_93)));
...
#if (sc_OITCompositingPass)
{
vec2 l9_97=sc_ScreenCoordsGlobalToView(gl_FragCoord.xy*sc_CurrentRenderTargetDims.zw);
#if (sc_OITMaxLayers4Plus1)
{
if ((gl_FragCoord.z-texture(sc_OITFrontDepthTexture,l9_97).x)<=getFrontLayerZTestEpsilon())
{
discard;
}
}
...
if (l9_102==0)
{
l9_105=texture(sc_OITAlpha0,l9_97);
l9_104=texture(sc_OITDepthLow0,l9_97);
l9_103=texture(sc_OITDepthHigh0,l9_97);
}
else
{
l9_105=vec4(0.0);
...
if (l9_102==1)
{
l9_108=texture(sc_OITAlpha1,l9_97);
l9_107=texture(sc_OITDepthLow1,l9_97);
l9_106=texture(sc_OITDepthHigh1,l9_97);
}
else
{
l9_108=l9_105;
...
if (any(notEqual(l9_106,vec4(0.0)))||any(notEqual(l9_107,vec4(0.0))))
{
int l9_109[8]=l9_98;
unpackValues(l9_106.w,l9_102,l9_109);
unpackValues(l9_106.z,l9_102,l9_109);
unpackValues(l9_106.y,l9_102,l9_109);
unpackValues(l9_106.x,l9_102,l9_109);
unpackValues(l9_107.w,l9_102,l9_109);
unpackValues(l9_107.z,l9_102,l9_109);
unpackValues(l9_107.y,l9_102,l9_109);
unpackValues(l9_107.x,l9_102,l9_109);
int l9_118[8]=l9_99;
unpackValues(l9_108.w,l9_102,l9_118);
unpackValues(l9_108.z,l9_102,l9_118);
unpackValues(l9_108.y,l9_102,l9_118);
unpackValues(l9_108.x,l9_102,l9_118);
}
l9_102++;
continue;
}
...
vec4 l9_123=texture(sc_OITFilteredDepthBoundsTexture,l9_97);
vec2 l9_124=l9_123.xy;
int l9_125;
#if (sc_SkinBonesCount>0)
{
l9_125=encodeDepth(((1.0-l9_123.x)*1000.0)+getDepthOrderingEpsilon(),l9_124);
}
#else
{
l9_125=0;
...
#endif
int l9_126=encodeDepth(viewSpaceDepth(),l9_124);
vec4 l9_127;
l9_127=l9_82*l9_82.w;
vec4 l9_128;
int l9_129=0;
for (int snapLoopIndex=0; snapLoopIndex==0; snapLoopIndex+=0)
{
if (l9_129<8)
{
int l9_130=l9_98[l9_129];
int l9_131=l9_126-l9_125;
bool l9_132=l9_130<l9_131;
bool l9_133;
if (l9_132)
{
l9_133=l9_98[l9_129]>0;
}
else
{
l9_133=l9_132;
...
if (l9_133)
{
vec3 l9_134=l9_127.xyz*(1.0-(float(l9_99[l9_129])/255.0));
l9_128=vec4(l9_134.x,l9_134.y,l9_134.z,l9_127.w);
}
else
{
l9_128=l9_127;
...
sc_writeFragData0Internal(l9_127,sc_UniformConstants.x,sc_ShaderCacheConstant);
#if (sc_OITMaxLayersVisualizeLayerCount)
{
discard;
}
...
#else
{
sc_writeFragData0Internal(l9_81,sc_UniformConstants.x,sc_ShaderCacheConstant);
}
#endif
}
#endif

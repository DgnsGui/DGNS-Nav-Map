...
sc_WriteReceiverDataEx(varPos,l9_611,l9_125,0u);
vec3 l9_612;
#if (!sc_ProjectiveShadowsCaster)
{
...
sc_WriteReceiverDataEx(varPos,l9_612,l9_452,0u);
tempGlobals=l9_6;
...
#endif
sc_writeFragData0Internal(max(l9_641,vec4(0.0)),sc_UniformConstants.x,sc_ShaderCacheConstant);
return;
}
vec4 l9_643;
#if (sc_ProjectiveShadowsCaster)
...
#if (sc_BlendMode_PremultipliedAlpha)
{
l9_645=clamp(l9_19.w*2.0,0.0,1.0);
}
#else
{
float l9_646;
...
{
l9_646=clamp(dot(l9_19.xyz,vec3(l9_19.w)),0.0,1.0);
}
#else
{
float l9_647;
...
#if (sc_BlendMode_Multiply)
{
l9_648=(1.0-dot(l9_19.xyz,vec3(0.33333001)))*l9_19.w;
}
#else
{
float l9_649;
...
{
l9_649=(1.0-clamp(dot(l9_19.xyz,vec3(1.0)),0.0,1.0))*l9_19.w;
}
#else
{
float l9_650;
#if (sc_BlendMode_ColoredGlass)
{
l9_650=clamp(dot(l9_19.xyz,vec3(1.0)),0.0,1.0)*l9_19.w;
}
#else
{
float l9_651;
#if (sc_BlendMode_Add)
{
l9_651=clamp(dot(l9_19.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_652;
#if (sc_BlendMode_AddWithAlphaFactor)
{
l9_652=clamp(dot(l9_19.xyz,vec3(1.0)),0.0,1.0)*l9_19.w;
}
#else
{
float l9_653;
...
{
l9_653=dot(l9_19.xyz,vec3(0.33333001))*l9_19.w;
}
#else
{
float l9_654;
#if (sc_BlendMode_Min)
{
l9_654=1.0-clamp(dot(l9_19.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_655;
#if (sc_BlendMode_Max)
{
l9_655=clamp(dot(l9_19.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
l9_655=1.0;
...
#endif
l9_643=vec4(mix(sc_ShadowColor.xyz,sc_ShadowColor.xyz*l9_19.xyz,vec3(sc_ShadowColor.w)),sc_ShadowDensity*l9_644);
}
#else
{
vec4 l9_656;
...
{
vec3 l9_658=sc_GetFramebufferColor().xyz;
vec3 l9_659=mix(l9_658,definedBlend(l9_658,l9_19.xyz).xyz,vec3(l9_19.w));
vec4 l9_660=vec4(l9_659.x,l9_659.y,l9_659.z,vec4(0.0).w);
l9_660.w=1.0;
l9_657=l9_660;
}
#else
...
#if (sc_Voxelization)
{
l9_661=vec4(varScreenPos.xyz,1.0);
}
#else
{
vec4 l9_662;
#if (sc_OutputBounds)
{
float l9_663=clamp(abs(gl_FragCoord.z),0.0,1.0);
l9_662=vec4(l9_663,1.0-l9_663,1.0,1.0);
}
#else
{
vec4 l9_664;
#if (sc_BlendMode_MultiplyOriginal)
{
l9_664=vec4(mix(vec3(1.0),l9_19.xyz,vec3(l9_19.w)),l9_19.w);
}
#else
{
vec4 l9_665;
...
#endif
l9_665=vec4(l9_19.xyz*l9_666,l9_666);
}
#else
{
l9_665=l9_19;
...
vec4 l9_669=sc_OutputMotionVectorsIfNeeded(varPos,max(l9_667,vec4(0.0)));
vec4 l9_670=clamp(l9_669,vec4(0.0),vec4(1.0));
#if (sc_OITDepthBoundsPass)
{
#if (sc_OITDepthBoundsPass)
{
float l9_671=clamp(viewSpaceDepth()/1000.0,0.0,1.0);
sc_writeFragData0Internal(vec4(max(0.0,1.0-(l9_671-0.0039215689)),min(1.0,l9_671+0.0039215689),0.0,0.0),sc_UniformConstants.x,sc_ShaderCacheConstant);
}
#endif
}
#else
...
#if (sc_OITDepthGatherPass)
{
vec2 l9_672=sc_ScreenCoordsGlobalToView(gl_FragCoord.xy*sc_CurrentRenderTargetDims.zw);
#if (sc_OITMaxLayers4Plus1)
{
if ((gl_FragCoord.z-texture(sc_OITFrontDepthTexture,l9_672).x)<=getFrontLayerZTestEpsilon())
{
discard;
}
}
#endif
int l9_673=encodeDepth(viewSpaceDepth(),texture(sc_OITFilteredDepthBoundsTexture,l9_672).xy);
float l9_674=packValue(l9_673);
int l9_681=int(l9_670.w*255.0);
float l9_682=packValue(l9_681);
sc_writeFragData0Internal(vec4(packValue(l9_673),packValue(l9_673),packValue(l9_673),packValue(l9_673)),sc_UniformConstants.x,sc_ShaderCacheConstant);
sc_writeFragData1(vec4(l9_674,packValue(l9_673),packValue(l9_673),packValue(l9_673)));
sc_writeFragData2(vec4(l9_682,packValue(l9_681),packValue(l9_681),packValue(l9_681)));
...
#if (sc_OITCompositingPass)
{
vec2 l9_685=sc_ScreenCoordsGlobalToView(gl_FragCoord.xy*sc_CurrentRenderTargetDims.zw);
#if (sc_OITMaxLayers4Plus1)
{
if ((gl_FragCoord.z-texture(sc_OITFrontDepthTexture,l9_685).x)<=getFrontLayerZTestEpsilon())
{
discard;
}
}
...
if (l9_690==0)
{
l9_693=texture(sc_OITAlpha0,l9_685);
l9_692=texture(sc_OITDepthLow0,l9_685);
l9_691=texture(sc_OITDepthHigh0,l9_685);
}
else
{
l9_693=vec4(0.0);
...
if (l9_690==1)
{
l9_696=texture(sc_OITAlpha1,l9_685);
l9_695=texture(sc_OITDepthLow1,l9_685);
l9_694=texture(sc_OITDepthHigh1,l9_685);
}
else
{
l9_696=l9_693;
...
if (any(notEqual(l9_694,vec4(0.0)))||any(notEqual(l9_695,vec4(0.0))))
{
int l9_697[8]=l9_686;
unpackValues(l9_694.w,l9_690,l9_697);
unpackValues(l9_694.z,l9_690,l9_697);
unpackValues(l9_694.y,l9_690,l9_697);
unpackValues(l9_694.x,l9_690,l9_697);
unpackValues(l9_695.w,l9_690,l9_697);
unpackValues(l9_695.z,l9_690,l9_697);
unpackValues(l9_695.y,l9_690,l9_697);
unpackValues(l9_695.x,l9_690,l9_697);
int l9_706[8]=l9_687;
unpackValues(l9_696.w,l9_690,l9_706);
unpackValues(l9_696.z,l9_690,l9_706);
unpackValues(l9_696.y,l9_690,l9_706);
unpackValues(l9_696.x,l9_690,l9_706);
}
l9_690++;
continue;
}
...
vec4 l9_711=texture(sc_OITFilteredDepthBoundsTexture,l9_685);
vec2 l9_712=l9_711.xy;
int l9_713;
#if (sc_SkinBonesCount>0)
{
l9_713=encodeDepth(((1.0-l9_711.x)*1000.0)+getDepthOrderingEpsilon(),l9_712);
}
#else
{
l9_713=0;
...
#endif
int l9_714=encodeDepth(viewSpaceDepth(),l9_712);
vec4 l9_715;
l9_715=l9_670*l9_670.w;
vec4 l9_716;
int l9_717=0;
for (int snapLoopIndex=0; snapLoopIndex==0; snapLoopIndex+=0)
{
if (l9_717<8)
{
int l9_718=l9_686[l9_717];
int l9_719=l9_714-l9_713;
bool l9_720=l9_718<l9_719;
bool l9_721;
if (l9_720)
{
l9_721=l9_686[l9_717]>0;
}
else
{
l9_721=l9_720;
...
if (l9_721)
{
vec3 l9_722=l9_715.xyz*(1.0-(float(l9_687[l9_717])/255.0));
l9_716=vec4(l9_722.x,l9_722.y,l9_722.z,l9_715.w);
}
else
{
l9_716=l9_715;
...
sc_writeFragData0Internal(l9_715,sc_UniformConstants.x,sc_ShaderCacheConstant);
#if (sc_OITMaxLayersVisualizeLayerCount)
{
discard;
}
...
sc_writeFragData0Internal(l9_670,sc_UniformConstants.x,sc_ShaderCacheConstant);
}
#endif
}
#else
{
sc_writeFragData0Internal(l9_669,sc_UniformConstants.x,sc_ShaderCacheConstant);
}
#endif
}
#endif

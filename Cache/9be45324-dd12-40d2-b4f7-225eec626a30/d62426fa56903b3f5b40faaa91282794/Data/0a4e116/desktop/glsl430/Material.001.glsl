...
//texture texture2D sc_RayTracingReflections 0:17:0:30
//texture texture2D sc_RayTracingShadows 0:18:0:31
//texture texture2D sc_SSAOTexture 0:19:0:32
//texture texture2D sc_ScreenTexture 0:20:0:33
//texture texture2D sc_ShadowTexture 0:21:0:34
//texture texture2DArray intensityTextureArrSC 0:36:0:23
//texture texture2DArray sc_EnvmapDiffuseArrSC 0:37:0:24
//texture texture2DArray sc_EnvmapSpecularArrSC 0:38:0:25
//texture texture2DArray sc_RayTracingGlobalIlluminationArrSC 0:39:0:27
//texture texture2DArray sc_RayTracingReflectionsArrSC 0:41:0:30
//texture texture2DArray sc_RayTracingShadowsArrSC 0:42:0:31
...
//spec_const bool ENABLE_GLTF_LIGHTING 30 0
...
//spec_const bool sc_OITDepthPrepass 63 0
//spec_const bool sc_OITFrontLayerPass 64 0
//spec_const bool sc_OITMaxLayers4Plus1 65 0
//spec_const bool sc_OITMaxLayers8 66 0
//spec_const bool sc_OITMaxLayersVisualizeLayerCount 67 0
...
//spec_const bool sc_RayTracingCasterForceOpaque 71 0
//spec_const bool sc_RayTracingGlobalIlluminationHasSwappedViews 72 0
//spec_const bool sc_RayTracingReflectionsHasSwappedViews 73 0
//spec_const bool sc_RayTracingShadowsHasSwappedViews 74 0
...
//spec_const int sc_AmbientLightMode0 86 0
//spec_const int sc_AmbientLightMode1 87 0
//spec_const int sc_AmbientLightMode2 88 0
//spec_const int sc_AmbientLightMode_Constant 89 0
//spec_const int sc_AmbientLightMode_EnvironmentMap 90 0
//spec_const int sc_AmbientLightMode_FromCamera 91 0
//spec_const int sc_AmbientLightMode_SphericalHarmonics 92 0
//spec_const int sc_AmbientLightsCount 93 0
//spec_const int sc_DepthBufferMode 94 0
//spec_const int sc_DirectionalLightsCount 95 0
//spec_const int sc_EnvLightMode 96 0
//spec_const int sc_EnvmapDiffuseLayout 97 0
//spec_const int sc_EnvmapSpecularLayout 98 0
//spec_const int sc_LightEstimationSGCount 99 0
//spec_const int sc_PointLightsCount 100 0
//spec_const int sc_RayTracingGlobalIlluminationLayout 101 0
//spec_const int sc_RayTracingReflectionsLayout 102 0
//spec_const int sc_RayTracingShadowsLayout 103 0
...
uniform float Port_Opacity_N036;
uniform float Port_Roughness_N036;
uniform float Port_Opacity_N405;
uniform float Port_Roughness_N405;
uniform float Port_EnableTransmission_N031;
uniform float Port_EnableSheen_N031;
uniform float Port_EnableClearcoat_N031;
...
#endif
ngsAlphaTest(Port_Opacity_N036);
sc_WriteReceiverDataEx(varPos,l9_1,Port_Roughness_N036,0u);
vec3 l9_2;
#if (!sc_ProjectiveShadowsCaster)
{
l9_2=l9_0;
...
sc_WriteReceiverDataEx(varPos,l9_2,Port_Roughness_N405,0u);
bool l9_3=Port_EnableClearcoat_N031!=0.0;
if (((Port_EnableSheen_N031!=0.0)||(Port_EnableTransmission_N031!=0.0))||l9_3)
{
if (l9_3)
{
}
...
uniform vec3 Port_Albedo_N036;
uniform float Port_Opacity_N036;
uniform vec3 Port_Emissive_N036;
uniform float Port_Metallic_N036;
uniform float Port_Roughness_N036;
...
uniform float Port_EnableTransmission_N031;
uniform float Port_Opacity_N031;
uniform vec3 Port_Background_N031;
uniform float Port_EnableSheen_N031;
uniform vec4 Port_SheenColor_N031;
uniform float Port_EnableClearcoat_N031;
uniform float Port_ClearcoatBase_N031;
uniform sc_Camera_t sc_Camera;
...
l9_3=l9_4.viewDirWS;
l9_2=l9_4.positionWS;
l9_1=l9_4.normalWS;
}
else
{
l9_3=normalize(sc_Camera.position-varPos);
l9_2=varPos;
...
#if (sc_ProjectiveShadowsCaster)
{
l9_7=vec4(Port_Albedo_N036,Port_Opacity_N036);
}
#else
{
l9_7=ngsCalculateLighting(Port_Albedo_N036,Port_Opacity_N036,l9_6,l9_2,l9_3,Port_Emissive_N036,Port_Metallic_N036,Port_Roughness_N036,Port_AO_N036,Port_SpecularAO_N036);
}
#endif
vec4 l9_8=max(l9_7,vec4(0.0));
vec3 l9_9;
#if (!sc_ProjectiveShadowsCaster)
{
l9_9=l9_1;
...
#if (sc_ProjectiveShadowsCaster)
{
l9_10=vec4(Port_Albedo_N405,Port_Opacity_N405);
}
#else
{
l9_10=ngsCalculateLighting(Port_Albedo_N405,Port_Opacity_N405,l9_9,l9_2,l9_3,Port_Emissive_N405,Port_Metallic_N405,Port_Roughness_N405,vec3(1.0),Port_SpecularAO_N405);
}
#endif
vec4 l9_11=max(l9_10,vec4(0.0));
bool l9_12=Port_EnableTransmission_N031!=0.0;
bool l9_13=Port_EnableSheen_N031!=0.0;
bool l9_14=Port_EnableClearcoat_N031!=0.0;
vec4 l9_15;
if ((l9_13||l9_12)||l9_14)
{
vec4 l9_16=ssSRGB_to_Linear(l9_8);
vec4 l9_17;
if (l9_13)
{
vec3 l9_18=(l9_16.xyz*Port_SheenColor_N031.w)+Port_SheenColor_N031.xyz;
l9_17=vec4(l9_18.x,l9_18.y,l9_18.z,l9_16.w);
}
else
{
l9_17=l9_16;
...
#if (SC_DEVICE_CLASS>=2)
{
l9_20=pow(Port_Opacity_N031,2.2);
}
#else
{
l9_20=Port_Opacity_N031*Port_Opacity_N031;
}
#endif
vec4 l9_21=mix(vec4(Port_Background_N031,1.0),l9_17,vec4(l9_20));
l9_21.w=1.0;
l9_19=l9_21;
}
else
...
if (l9_14)
{
vec3 l9_23=l9_19.xyz+(ssSRGB_to_Linear(l9_11)*Port_ClearcoatBase_N031).xyz;
l9_22=vec4(l9_23.x,l9_23.y,l9_23.z,l9_19.w);
}
else
{
l9_22=l9_19;
...
#if (SC_DEVICE_CLASS>=2)
{
l9_24=vec4(pow(l9_22.x,0.45454544),pow(l9_22.y,0.45454544),pow(l9_22.z,0.45454544),pow(l9_22.w,0.45454544));
}
#else
{
l9_24=sqrt(l9_22);
...
#endif
sc_writeFragData0Internal(max(l9_25,vec4(0.0)),sc_UniformConstants.x,sc_ShaderCacheConstant);
return;
}
vec4 l9_27;
#if (sc_ProjectiveShadowsCaster)
...
#if (sc_BlendMode_PremultipliedAlpha)
{
l9_29=clamp(l9_5.w*2.0,0.0,1.0);
}
#else
{
float l9_30;
...
{
l9_30=clamp(dot(l9_5.xyz,vec3(l9_5.w)),0.0,1.0);
}
#else
{
float l9_31;
...
#if (sc_BlendMode_Multiply)
{
l9_32=(1.0-dot(l9_5.xyz,vec3(0.33333001)))*l9_5.w;
}
#else
{
float l9_33;
...
{
l9_33=(1.0-clamp(dot(l9_5.xyz,vec3(1.0)),0.0,1.0))*l9_5.w;
}
#else
{
float l9_34;
#if (sc_BlendMode_ColoredGlass)
{
l9_34=clamp(dot(l9_5.xyz,vec3(1.0)),0.0,1.0)*l9_5.w;
}
#else
{
float l9_35;
#if (sc_BlendMode_Add)
{
l9_35=clamp(dot(l9_5.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_36;
#if (sc_BlendMode_AddWithAlphaFactor)
{
l9_36=clamp(dot(l9_5.xyz,vec3(1.0)),0.0,1.0)*l9_5.w;
}
#else
{
float l9_37;
...
{
l9_37=dot(l9_5.xyz,vec3(0.33333001))*l9_5.w;
}
#else
{
float l9_38;
#if (sc_BlendMode_Min)
{
l9_38=1.0-clamp(dot(l9_5.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_39;
#if (sc_BlendMode_Max)
{
l9_39=clamp(dot(l9_5.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
l9_39=1.0;
...
#endif
l9_27=vec4(mix(sc_ShadowColor.xyz,sc_ShadowColor.xyz*l9_5.xyz,vec3(sc_ShadowColor.w)),sc_ShadowDensity*l9_28);
}
#else
{
vec4 l9_40;
...
{
vec3 l9_42=sc_GetFramebufferColor().xyz;
vec3 l9_43=mix(l9_42,definedBlend(l9_42,l9_5.xyz).xyz,vec3(l9_5.w));
vec4 l9_44=vec4(l9_43.x,l9_43.y,l9_43.z,vec4(0.0).w);
l9_44.w=1.0;
l9_41=l9_44;
}
#else
...
#if (sc_Voxelization)
{
l9_45=vec4(varScreenPos.xyz,1.0);
}
#else
{
vec4 l9_46;
#if (sc_OutputBounds)
{
float l9_47=clamp(abs(gl_FragCoord.z),0.0,1.0);
l9_46=vec4(l9_47,1.0-l9_47,1.0,1.0);
}
#else
{
vec4 l9_48;
#if (sc_BlendMode_MultiplyOriginal)
{
l9_48=vec4(mix(vec3(1.0),l9_5.xyz,vec3(l9_5.w)),l9_5.w);
}
#else
{
vec4 l9_49;
...
#endif
l9_49=vec4(l9_5.xyz*l9_50,l9_50);
}
#else
{
l9_49=l9_5;
...
vec4 l9_53=sc_OutputMotionVectorsIfNeeded(varPos,max(l9_51,vec4(0.0)));
vec4 l9_54=clamp(l9_53,vec4(0.0),vec4(1.0));
#if (sc_OITDepthBoundsPass)
{
#if (sc_OITDepthBoundsPass)
{
float l9_55=clamp(viewSpaceDepth()/1000.0,0.0,1.0);
sc_writeFragData0Internal(vec4(max(0.0,1.0-(l9_55-0.0039215689)),min(1.0,l9_55+0.0039215689),0.0,0.0),sc_UniformConstants.x,sc_ShaderCacheConstant);
}
#endif
}
#else
...
#if (sc_OITDepthGatherPass)
{
vec2 l9_56=sc_ScreenCoordsGlobalToView(gl_FragCoord.xy*sc_CurrentRenderTargetDims.zw);
#if (sc_OITMaxLayers4Plus1)
{
if ((gl_FragCoord.z-texture(sc_OITFrontDepthTexture,l9_56).x)<=getFrontLayerZTestEpsilon())
{
discard;
}
}
#endif
int l9_57=encodeDepth(viewSpaceDepth(),texture(sc_OITFilteredDepthBoundsTexture,l9_56).xy);
float l9_58=packValue(l9_57);
int l9_65=int(l9_54.w*255.0);
float l9_66=packValue(l9_65);
sc_writeFragData0Internal(vec4(packValue(l9_57),packValue(l9_57),packValue(l9_57),packValue(l9_57)),sc_UniformConstants.x,sc_ShaderCacheConstant);
sc_writeFragData1(vec4(l9_58,packValue(l9_57),packValue(l9_57),packValue(l9_57)));
sc_writeFragData2(vec4(l9_66,packValue(l9_65),packValue(l9_65),packValue(l9_65)));
...
#if (sc_OITMaxLayers4Plus1)
{
if ((gl_FragCoord.z-texture(sc_OITFrontDepthTexture,l9_69).x)<=getFrontLayerZTestEpsilon())
{
discard;
}
}
...
if (l9_74==0)
{
l9_77=texture(sc_OITAlpha0,l9_69);
l9_76=texture(sc_OITDepthLow0,l9_69);
l9_75=texture(sc_OITDepthHigh0,l9_69);
}
else
{
l9_77=vec4(0.0);
...
if (l9_74==1)
{
l9_80=texture(sc_OITAlpha1,l9_69);
l9_79=texture(sc_OITDepthLow1,l9_69);
l9_78=texture(sc_OITDepthHigh1,l9_69);
}
else
{
l9_80=l9_77;
...
if (any(notEqual(l9_78,vec4(0.0)))||any(notEqual(l9_79,vec4(0.0))))
{
int l9_81[8]=l9_70;
unpackValues(l9_78.w,l9_74,l9_81);
unpackValues(l9_78.z,l9_74,l9_81);
unpackValues(l9_78.y,l9_74,l9_81);
unpackValues(l9_78.x,l9_74,l9_81);
unpackValues(l9_79.w,l9_74,l9_81);
unpackValues(l9_79.z,l9_74,l9_81);
unpackValues(l9_79.y,l9_74,l9_81);
unpackValues(l9_79.x,l9_74,l9_81);
int l9_90[8]=l9_71;
unpackValues(l9_80.w,l9_74,l9_90);
unpackValues(l9_80.z,l9_74,l9_90);
unpackValues(l9_80.y,l9_74,l9_90);
unpackValues(l9_80.x,l9_74,l9_90);
}
l9_74++;
continue;
}
...
vec4 l9_95=texture(sc_OITFilteredDepthBoundsTexture,l9_69);
vec2 l9_96=l9_95.xy;
int l9_97;
#if (sc_SkinBonesCount>0)
{
l9_97=encodeDepth(((1.0-l9_95.x)*1000.0)+getDepthOrderingEpsilon(),l9_96);
}
#else
{
l9_97=0;
...
#endif
int l9_98=encodeDepth(viewSpaceDepth(),l9_96);
vec4 l9_99;
l9_99=l9_54*l9_54.w;
vec4 l9_100;
int l9_101=0;
...
if (l9_101<8)
{
int l9_102=l9_70[l9_101];
int l9_103=l9_98-l9_97;
bool l9_104=l9_102<l9_103;
bool l9_105;
if (l9_104)
{
l9_105=l9_70[l9_101]>0;
}
else
{
l9_105=l9_104;
...
if (l9_105)
{
vec3 l9_106=l9_99.xyz*(1.0-(float(l9_71[l9_101])/255.0));
l9_100=vec4(l9_106.x,l9_106.y,l9_106.z,l9_99.w);
}
else
{
l9_100=l9_99;
...
sc_writeFragData0Internal(l9_54,sc_UniformConstants.x,sc_ShaderCacheConstant);
}
#endif
}
#else
{
sc_writeFragData0Internal(l9_53,sc_UniformConstants.x,sc_ShaderCacheConstant);
}
#endif
}
#endif

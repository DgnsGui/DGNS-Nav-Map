...
//spec_const bool sc_RayTracingCasterForceOpaque 66 0
...
{
l9_1=Port_Input1_N017;
}
#else
{
l9_1=Port_Input2_N017;
}
#endif
#if (sc_BlendMode_AlphaTest)
{
if (l9_1.w<alphaTestThreshold)
{
discard;
}
}
...
{
if (l9_1.w<((mod(dot(floor(mod(gl_FragCoord.xy,vec2(4.0))),vec2(4.0,1.0))*9.0,16.0)+1.0)/17.0))
{
discard;
}
}
...
#endif
sc_writeFragData0Internal(max(l9_2,vec4(0.0)),sc_UniformConstants.x,sc_ShaderCacheConstant);
return;
}
vec4 l9_4;
...
{
l9_7=clamp(dot(l9_1.xyz,vec3(l9_1.w)),0.0,1.0);
}
#else
{
float l9_8;
...
{
l9_9=(1.0-dot(l9_1.xyz,vec3(0.33333001)))*l9_1.w;
}
#else
{
float l9_10;
...
{
l9_10=(1.0-clamp(dot(l9_1.xyz,vec3(1.0)),0.0,1.0))*l9_1.w;
}
#else
{
float l9_11;
...
{
l9_11=clamp(dot(l9_1.xyz,vec3(1.0)),0.0,1.0)*l9_1.w;
}
#else
{
float l9_12;
#if (sc_BlendMode_Add)
{
l9_12=clamp(dot(l9_1.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_13;
#if (sc_BlendMode_AddWithAlphaFactor)
{
l9_13=clamp(dot(l9_1.xyz,vec3(1.0)),0.0,1.0)*l9_1.w;
}
#else
{
float l9_14;
...
{
l9_14=dot(l9_1.xyz,vec3(0.33333001))*l9_1.w;
}
#else
{
float l9_15;
#if (sc_BlendMode_Min)
{
l9_15=1.0-clamp(dot(l9_1.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_16;
#if (sc_BlendMode_Max)
{
l9_16=clamp(dot(l9_1.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
l9_16=1.0;
...
#endif
l9_4=vec4(mix(sc_ShadowColor.xyz,sc_ShadowColor.xyz*l9_1.xyz,vec3(sc_ShadowColor.w)),sc_ShadowDensity*l9_5);
}
#else
{
vec4 l9_17;
...
#if (sc_FramebufferFetch)
{
l9_19=sc_readFragData0_Platform();
}
#else
{
vec2 l9_20=sc_ScreenCoordsGlobalToView(gl_FragCoord.xy*sc_CurrentRenderTargetDims.zw);
vec4 l9_21;
#if (sc_ScreenTextureLayout==2)
{
l9_21=texture(sc_ScreenTextureArrSC,sc_SamplingCoordsViewToGlobal(l9_20,sc_ScreenTextureLayout,sc_ScreenTextureGetStereoViewIndex()),0.0);
}
#else
{
l9_21=texture(sc_ScreenTexture,sc_SamplingCoordsViewToGlobal(l9_20,sc_ScreenTextureLayout,sc_ScreenTextureGetStereoViewIndex()).xy,0.0);
}
#endif
l9_19=l9_21;
}
#endif
vec3 l9_22=mix(l9_19.xyz,definedBlend(l9_19.xyz,l9_1.xyz).xyz,vec3(l9_1.w));
...
#if (sc_Voxelization)
{
l9_24=vec4(varScreenPos.xyz,1.0);
}
#else
{
vec4 l9_25;
#if (sc_OutputBounds)
{
float l9_26=clamp(abs(gl_FragCoord.z),0.0,1.0);
l9_25=vec4(l9_26,1.0-l9_26,1.0,1.0);
}
#else
{
vec4 l9_27;
#if (sc_BlendMode_MultiplyOriginal)
{
l9_27=vec4(mix(vec3(1.0),l9_1.xyz,vec3(l9_1.w)),l9_1.w);
}
#else
{
vec4 l9_28;
...
#endif
l9_28=vec4(l9_1.xyz*l9_29,l9_29);
}
#else
{
l9_28=l9_1;
...
vec4 l9_32=sc_OutputMotionVectorsIfNeeded(varPos,max(l9_30,vec4(0.0)));
vec4 l9_33=clamp(l9_32,vec4(0.0),vec4(1.0));
#if (sc_OITDepthBoundsPass)
{
#if (sc_OITDepthBoundsPass)
{
float l9_34=clamp(viewSpaceDepth()/1000.0,0.0,1.0);
sc_writeFragData0Internal(vec4(max(0.0,1.0-(l9_34-0.0039215689)),min(1.0,l9_34+0.0039215689),0.0,0.0),sc_UniformConstants.x,sc_ShaderCacheConstant);
}
#endif
}
#else
...
{
if ((gl_FragCoord.z-texture(sc_OITFrontDepthTexture,l9_35).x)<=getFrontLayerZTestEpsilon())
{
discard;
}
}
#endif
int l9_36=encodeDepth(viewSpaceDepth(),texture(sc_OITFilteredDepthBoundsTexture,l9_35).xy);
float l9_37=packValue(l9_36);
int l9_44=int(l9_33.w*255.0);
float l9_45=packValue(l9_44);
sc_writeFragData0Internal(vec4(packValue(l9_36),packValue(l9_36),packValue(l9_36),packValue(l9_36)),sc_UniformConstants.x,sc_ShaderCacheConstant);
sc_writeFragData1(vec4(l9_37,packValue(l9_36),packValue(l9_36),packValue(l9_36)));
sc_writeFragData2(vec4(l9_45,packValue(l9_44),packValue(l9_44),packValue(l9_44)));
...
if (l9_53==0)
{
l9_56=texture(sc_OITAlpha0,l9_48);
l9_55=texture(sc_OITDepthLow0,l9_48);
l9_54=texture(sc_OITDepthHigh0,l9_48);
}
else
{
l9_56=vec4(0.0);
...
if (l9_53==1)
{
l9_59=texture(sc_OITAlpha1,l9_48);
l9_58=texture(sc_OITDepthLow1,l9_48);
l9_57=texture(sc_OITDepthHigh1,l9_48);
}
else
{
l9_59=l9_56;
...
if (any(notEqual(l9_57,vec4(0.0)))||any(notEqual(l9_58,vec4(0.0))))
{
int l9_60[8]=l9_49;
unpackValues(l9_57.w,l9_53,l9_60);
unpackValues(l9_57.z,l9_53,l9_60);
unpackValues(l9_57.y,l9_53,l9_60);
unpackValues(l9_57.x,l9_53,l9_60);
unpackValues(l9_58.w,l9_53,l9_60);
unpackValues(l9_58.z,l9_53,l9_60);
unpackValues(l9_58.y,l9_53,l9_60);
unpackValues(l9_58.x,l9_53,l9_60);
int l9_69[8]=l9_50;
unpackValues(l9_59.w,l9_53,l9_69);
unpackValues(l9_59.z,l9_53,l9_69);
unpackValues(l9_59.y,l9_53,l9_69);
unpackValues(l9_59.x,l9_53,l9_69);
}
l9_53++;
continue;
}
...
vec4 l9_74=texture(sc_OITFilteredDepthBoundsTexture,l9_48);
vec2 l9_75=l9_74.xy;
int l9_76;
#if (sc_SkinBonesCount>0)
{
l9_76=encodeDepth(((1.0-l9_74.x)*1000.0)+getDepthOrderingEpsilon(),l9_75);
}
#else
{
l9_76=0;
...
#endif
int l9_77=encodeDepth(viewSpaceDepth(),l9_75);
vec4 l9_78;
l9_78=l9_33*l9_33.w;
vec4 l9_79;
int l9_80=0;
...
if (l9_80<8)
{
int l9_81=l9_49[l9_80];
int l9_82=l9_77-l9_76;
bool l9_83=l9_81<l9_82;
bool l9_84;
if (l9_83)
{
l9_84=l9_49[l9_80]>0;
...
if (l9_84)
{
vec3 l9_85=l9_78.xyz*(1.0-(float(l9_50[l9_80])/255.0));
l9_79=vec4(l9_85.x,l9_85.y,l9_85.z,l9_78.w);
}
else
{
l9_79=l9_78;
...
sc_writeFragData0Internal(l9_78,sc_UniformConstants.x,sc_ShaderCacheConstant);
#if (sc_OITMaxLayersVisualizeLayerCount)
{
discard;
}
...
sc_writeFragData0Internal(l9_33,sc_UniformConstants.x,sc_ShaderCacheConstant);
}
#endif
}
#else

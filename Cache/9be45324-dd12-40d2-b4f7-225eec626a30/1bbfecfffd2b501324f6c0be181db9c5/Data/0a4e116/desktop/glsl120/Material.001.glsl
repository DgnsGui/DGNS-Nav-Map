...
#if (sc_Voxelization)
{
l9_407=vec4(varScreenPos.xyz,1.0);
}
#else
{
vec4 l9_408;
#if (sc_OutputBounds)
{
float l9_409=clamp(abs(gl_FragCoord.z),0.0,1.0);
l9_408=vec4(l9_409,1.0-l9_409,1.0,1.0);
}
#else
{
vec4 l9_410;
#if (sc_BlendMode_MultiplyOriginal)
{
l9_410=vec4(mix(vec3(1.0),l9_7.xyz,vec3(l9_7.w)),l9_7.w);
}
#else
{
vec4 l9_411;
...
#endif
l9_411=vec4(l9_7.xyz*l9_412,l9_412);
}
#else
{
l9_411=l9_7;
...
vec4 l9_415=sc_OutputMotionVectorsIfNeeded(varPos,max(l9_413,vec4(0.0)));
...
sc_writeFragData0Internal(vec4(max(0.0,1.0-(l9_417-0.0039215689)),min(1.0,l9_417+0.0039215689),0.0,0.0),sc_UniformConstants.x,sc_ShaderCacheConstant);
}
#endif
}
#else
...
#if (sc_OITDepthGatherPass)
{
vec2 l9_418=sc_ScreenCoordsGlobalToView(l9_4);
...
sc_writeFragData0Internal(vec4(packValue(l9_419),packValue(l9_419),packValue(l9_419),packValue(l9_419)),sc_UniformConstants.x,sc_ShaderCacheConstant);
...
#if (sc_OITCompositingPass)
{
vec2 l9_431=sc_ScreenCoordsGlobalToView(l9_4);
#if (sc_OITMaxLayers4Plus1)
{
...
sc_writeFragData0Internal(l9_461,sc_UniformConstants.x,sc_ShaderCacheConstant);
#if (sc_OITMaxLayersVisualizeLayerCount)
{
discard;
}
...
sc_writeFragData0Internal(l9_416,sc_UniformConstants.x,sc_ShaderCacheConstant);
}
#endif
}
#else

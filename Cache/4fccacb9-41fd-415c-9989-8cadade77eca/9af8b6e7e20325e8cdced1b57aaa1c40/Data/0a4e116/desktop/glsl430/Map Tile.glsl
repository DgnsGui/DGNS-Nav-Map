...
uniform float Port_Default_N033;
...
{
vec3 l9_70=l9_2-circleBoundCentre;
vec3 l9_71=cross(l9_1,vec3(Port_Value1_N082,Port_Value2_N082,Port_Value3_N082));
float l9_72=dot(l9_71,l9_71);
float l9_73;
if (l9_72>0.0)
{
...
vec3 l9_74=l9_71*l9_73;
vec3 l9_75=cross(l9_1,l9_74);
float l9_76=dot(l9_75,l9_75);
float l9_77;
if (l9_76>0.0)
{
l9_77=1.0/sqrt(l9_76);
}
else
{
l9_77=0.0;
}
l9_69=step(length(vec2(dot(l9_70,l9_74),dot(l9_70,l9_75*l9_77))/(Port_Input1_N088+vec2(1.234e-06))),Port_Input1_N077);
}
else
{
l9_69=Port_Default_N033;
}
float l9_78;
...
{
vec2 l9_82;
Node122_If_else(0.0,vec2(0.0),vec2(0.0),l9_82,l9_9);
float l9_83;
Node67_Bool_Parameter(l9_83,l9_9);
l9_81=mix(l9_5,l9_82,vec2(l9_83));
}
#else
{
vec2 l9_84;
...
{
vec2 l9_85;
Node64_If_else(0.0,vec2(0.0),vec2(0.0),l9_85,l9_9);
float l9_86;
Node11_Bool_Parameter(l9_86,l9_9);
l9_84=mix(l9_5,l9_85,vec2(l9_86));
}
#else
{
l9_84=l9_5;
...
{
bool l9_88=(int(SC_USE_CLAMP_TO_BORDER_opacityTex)!=0)&&(!(int(SC_USE_UV_MIN_MAX_opacityTex)!=0));
float l9_89=l9_79.x;
sc_SoftwareWrapEarly(l9_89,ivec2(SC_SOFTWARE_WRAP_MODE_U_opacityTex,SC_SOFTWARE_WRAP_MODE_V_opacityTex).x);
float l9_90=l9_89;
float l9_91=l9_79.y;
sc_SoftwareWrapEarly(l9_91,ivec2(SC_SOFTWARE_WRAP_MODE_U_opacityTex,SC_SOFTWARE_WRAP_MODE_V_opacityTex).y);
float l9_92=l9_91;
vec2 l9_93;
float l9_94;
...
{
l9_95=ivec2(SC_SOFTWARE_WRAP_MODE_U_opacityTex,SC_SOFTWARE_WRAP_MODE_V_opacityTex).x==3;
}
#else
{
...
float l9_96=l9_90;
float l9_97=1.0;
sc_ClampUV(l9_96,opacityTexUvMinMax.x,opacityTexUvMinMax.z,l9_95,l9_97);
float l9_98=l9_96;
float l9_99=l9_97;
bool l9_100;
#if (SC_USE_CLAMP_TO_BORDER_opacityTex)
{
l9_100=ivec2(SC_SOFTWARE_WRAP_MODE_U_opacityTex,SC_SOFTWARE_WRAP_MODE_V_opacityTex).y==3;
}
#else
{
l9_100=(int(SC_USE_CLAMP_TO_BORDER_opacityTex)!=0);
}
#endif
float l9_101=l9_92;
float l9_102=l9_99;
sc_ClampUV(l9_101,opacityTexUvMinMax.y,opacityTexUvMinMax.w,l9_100,l9_102);
l9_94=l9_102;
...
#endif
vec2 l9_103=sc_TransformUV(l9_93,(int(SC_USE_UV_TRANSFORM_opacityTex)!=0),opacityTexTransform);
float l9_104=l9_103.x;
float l9_105=l9_94;
sc_SoftwareWrapLate(l9_104,ivec2(SC_SOFTWARE_WRAP_MODE_U_opacityTex,SC_SOFTWARE_WRAP_MODE_V_opacityTex).x,l9_88,l9_105);
float l9_106=l9_103.y;
float l9_107=l9_105;
sc_SoftwareWrapLate(l9_106,ivec2(SC_SOFTWARE_WRAP_MODE_U_opacityTex,SC_SOFTWARE_WRAP_MODE_V_opacityTex).y,l9_88,l9_107);
float l9_108=l9_107;
vec3 l9_109=sc_SamplingCoordsViewToGlobal(vec2(l9_104,l9_106),opacityTexLayout,opacityTexGetStereoViewIndex());
vec4 l9_110=texture(opacityTexArrSC,l9_109,0.0);
vec4 l9_111;
#if (SC_USE_CLAMP_TO_BORDER_opacityTex)
{
l9_111=mix(opacityTexBorderColor,l9_110,vec4(l9_108));
}
#else
{
l9_111=l9_110;
...
#else
{
bool l9_112=(int(SC_USE_CLAMP_TO_BORDER_opacityTex)!=0)&&(!(int(SC_USE_UV_MIN_MAX_opacityTex)!=0));
float l9_113=l9_79.x;
sc_SoftwareWrapEarly(l9_113,ivec2(SC_SOFTWARE_WRAP_MODE_U_opacityTex,SC_SOFTWARE_WRAP_MODE_V_opacityTex).x);
float l9_114=l9_113;
float l9_115=l9_79.y;
sc_SoftwareWrapEarly(l9_115,ivec2(SC_SOFTWARE_WRAP_MODE_U_opacityTex,SC_SOFTWARE_WRAP_MODE_V_opacityTex).y);
float l9_116=l9_115;
vec2 l9_117;
float l9_118;
#if (SC_USE_UV_MIN_MAX_opacityTex)
...
#if (SC_USE_CLAMP_TO_BORDER_opacityTex)
{
l9_119=ivec2(SC_SOFTWARE_WRAP_MODE_U_opacityTex,SC_SOFTWARE_WRAP_MODE_V_opacityTex).x==3;
}
#else
{
...
float l9_120=l9_114;
float l9_121=1.0;
sc_ClampUV(l9_120,opacityTexUvMinMax.x,opacityTexUvMinMax.z,l9_119,l9_121);
float l9_122=l9_120;
float l9_123=l9_121;
bool l9_124;
#if (SC_USE_CLAMP_TO_BORDER_opacityTex)
{
l9_124=ivec2(SC_SOFTWARE_WRAP_MODE_U_opacityTex,SC_SOFTWARE_WRAP_MODE_V_opacityTex).y==3;
}
#else
{
l9_124=(int(SC_USE_CLAMP_TO_BORDER_opacityTex)!=0);
}
#endif
float l9_125=l9_116;
float l9_126=l9_123;
sc_ClampUV(l9_125,opacityTexUvMinMax.y,opacityTexUvMinMax.w,l9_124,l9_126);
l9_118=l9_126;
...
#endif
vec2 l9_127=sc_TransformUV(l9_117,(int(SC_USE_UV_TRANSFORM_opacityTex)!=0),opacityTexTransform);
float l9_128=l9_127.x;
float l9_129=l9_118;
sc_SoftwareWrapLate(l9_128,ivec2(SC_SOFTWARE_WRAP_MODE_U_opacityTex,SC_SOFTWARE_WRAP_MODE_V_opacityTex).x,l9_112,l9_129);
float l9_130=l9_127.y;
float l9_131=l9_129;
sc_SoftwareWrapLate(l9_130,ivec2(SC_SOFTWARE_WRAP_MODE_U_opacityTex,SC_SOFTWARE_WRAP_MODE_V_opacityTex).y,l9_112,l9_131);
float l9_132=l9_131;
vec3 l9_133=sc_SamplingCoordsViewToGlobal(vec2(l9_128,l9_130),opacityTexLayout,opacityTexGetStereoViewIndex());
vec4 l9_134=texture(opacityTex,l9_133.xy,0.0);
vec4 l9_135;
#if (SC_USE_CLAMP_TO_BORDER_opacityTex)
{
l9_135=mix(opacityTexBorderColor,l9_134,vec4(l9_132));
}
#else
{
l9_135=l9_134;
...
#else
{
l9_78=Port_Default_N204;
}
#endif
float l9_136=l9_68.w*l9_78;
float l9_137=min(l9_69,l9_136);
vec4 l9_138=vec4(l9_68.x,l9_68.y,l9_68.z,vec4(0.0).w);
l9_138.w=l9_137;
...
#endif
sc_writeFragData0Internal(max(l9_139,vec4(0.0)),sc_UniformConstants.x,sc_ShaderCacheConstant);
return;
}
vec4 l9_141;
...
{
l9_143=clamp(l9_137*2.0,0.0,1.0);
}
#else
{
float l9_144;
...
{
l9_144=clamp(dot(l9_138.xyz,vec3(l9_137)),0.0,1.0);
}
#else
{
float l9_145;
...
{
l9_146=(1.0-dot(l9_138.xyz,vec3(0.33333001)))*l9_137;
}
#else
{
float l9_147;
...
{
l9_147=(1.0-clamp(dot(l9_138.xyz,vec3(1.0)),0.0,1.0))*l9_137;
}
#else
{
float l9_148;
...
{
l9_148=clamp(dot(l9_138.xyz,vec3(1.0)),0.0,1.0)*l9_137;
}
#else
{
float l9_149;
#if (sc_BlendMode_Add)
{
l9_149=clamp(dot(l9_138.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_150;
#if (sc_BlendMode_AddWithAlphaFactor)
{
l9_150=clamp(dot(l9_138.xyz,vec3(1.0)),0.0,1.0)*l9_137;
}
#else
{
float l9_151;
...
{
l9_151=dot(l9_138.xyz,vec3(0.33333001))*l9_137;
}
#else
{
float l9_152;
#if (sc_BlendMode_Min)
{
l9_152=1.0-clamp(dot(l9_138.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_153;
#if (sc_BlendMode_Max)
{
l9_153=clamp(dot(l9_138.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
l9_153=1.0;
...
#endif
l9_141=vec4(mix(sc_ShadowColor.xyz,sc_ShadowColor.xyz*l9_138.xyz,vec3(sc_ShadowColor.w)),sc_ShadowDensity*l9_142);
}
#else
{
vec4 l9_154;
...
#if (sc_FramebufferFetch)
{
l9_156=sc_readFragData0_Platform();
}
#else
{
vec2 l9_157=sc_ScreenCoordsGlobalToView(gl_FragCoord.xy*sc_CurrentRenderTargetDims.zw);
vec4 l9_158;
#if (sc_ScreenTextureLayout==2)
{
l9_158=texture(sc_ScreenTextureArrSC,sc_SamplingCoordsViewToGlobal(l9_157,sc_ScreenTextureLayout,sc_ScreenTextureGetStereoViewIndex()),0.0);
}
#else
{
l9_158=texture(sc_ScreenTexture,sc_SamplingCoordsViewToGlobal(l9_157,sc_ScreenTextureLayout,sc_ScreenTextureGetStereoViewIndex()).xy,0.0);
}
#endif
l9_156=l9_158;
}
#endif
vec3 l9_159=mix(l9_156.xyz,definedBlend(l9_156.xyz,l9_138.xyz).xyz,vec3(l9_137));
vec4 l9_160=vec4(l9_159.x,l9_159.y,l9_159.z,vec4(0.0).w);
l9_160.w=1.0;
l9_155=l9_160;
}
#else
...
#if (sc_Voxelization)
{
l9_161=vec4(varScreenPos.xyz,1.0);
}
#else
{
vec4 l9_162;
#if (sc_OutputBounds)
{
float l9_163=clamp(abs(gl_FragCoord.z),0.0,1.0);
l9_162=vec4(l9_163,1.0-l9_163,1.0,1.0);
}
#else
{
vec4 l9_164;
#if (sc_BlendMode_MultiplyOriginal)
{
l9_164=vec4(mix(vec3(1.0),l9_138.xyz,vec3(l9_137)),l9_137);
}
#else
{
vec4 l9_165;
...
#endif
l9_165=vec4(l9_138.xyz*l9_166,l9_166);
}
#else
{
l9_165=l9_138;
...
vec4 l9_169=sc_OutputMotionVectorsIfNeeded(varPos,max(l9_167,vec4(0.0)));
vec4 l9_170=clamp(l9_169,vec4(0.0),vec4(1.0));
#if (sc_OITDepthBoundsPass)
{
#if (sc_OITDepthBoundsPass)
{
float l9_171=clamp(viewSpaceDepth()/1000.0,0.0,1.0);
sc_writeFragData0Internal(vec4(max(0.0,1.0-(l9_171-0.0039215689)),min(1.0,l9_171+0.0039215689),0.0,0.0),sc_UniformConstants.x,sc_ShaderCacheConstant);
}
#endif
}
#else
...
#endif
int l9_173=encodeDepth(viewSpaceDepth(),texture(sc_OITFilteredDepthBoundsTexture,l9_172).xy);
float l9_174=packValue(l9_173);
int l9_181=int(l9_170.w*255.0);
float l9_182=packValue(l9_181);
sc_writeFragData0Internal(vec4(packValue(l9_173),packValue(l9_173),packValue(l9_173),packValue(l9_173)),sc_UniformConstants.x,sc_ShaderCacheConstant);
sc_writeFragData1(vec4(l9_174,packValue(l9_173),packValue(l9_173),packValue(l9_173)));
sc_writeFragData2(vec4(l9_182,packValue(l9_181),packValue(l9_181),packValue(l9_181)));
...
#if (sc_OITCompositingPass)
{
vec2 l9_185=sc_ScreenCoordsGlobalToView(gl_FragCoord.xy*sc_CurrentRenderTargetDims.zw);
#if (sc_OITMaxLayers4Plus1)
{
...
if (l9_190==0)
{
l9_193=texture(sc_OITAlpha0,l9_185);
l9_192=texture(sc_OITDepthLow0,l9_185);
l9_191=texture(sc_OITDepthHigh0,l9_185);
}
else
{
l9_193=vec4(0.0);
...
if (l9_190==1)
{
l9_196=texture(sc_OITAlpha1,l9_185);
l9_195=texture(sc_OITDepthLow1,l9_185);
l9_194=texture(sc_OITDepthHigh1,l9_185);
}
else
{
l9_196=l9_193;
...
if (any(notEqual(l9_194,vec4(0.0)))||any(notEqual(l9_195,vec4(0.0))))
{
int l9_197[8]=l9_186;
unpackValues(l9_194.w,l9_190,l9_197);
unpackValues(l9_194.z,l9_190,l9_197);
unpackValues(l9_194.y,l9_190,l9_197);
unpackValues(l9_194.x,l9_190,l9_197);
unpackValues(l9_195.w,l9_190,l9_197);
unpackValues(l9_195.z,l9_190,l9_197);
unpackValues(l9_195.y,l9_190,l9_197);
unpackValues(l9_195.x,l9_190,l9_197);
int l9_206[8]=l9_187;
unpackValues(l9_196.w,l9_190,l9_206);
unpackValues(l9_196.z,l9_190,l9_206);
unpackValues(l9_196.y,l9_190,l9_206);
unpackValues(l9_196.x,l9_190,l9_206);
}
l9_190++;
continue;
}
...
vec4 l9_211=texture(sc_OITFilteredDepthBoundsTexture,l9_185);
vec2 l9_212=l9_211.xy;
int l9_213;
#if (sc_SkinBonesCount>0)
{
l9_213=encodeDepth(((1.0-l9_211.x)*1000.0)+getDepthOrderingEpsilon(),l9_212);
}
#else
{
l9_213=0;
...
#endif
int l9_214=encodeDepth(viewSpaceDepth(),l9_212);
vec4 l9_215;
l9_215=l9_170*l9_170.w;
vec4 l9_216;
int l9_217=0;
for (int snapLoopIndex=0; snapLoopIndex==0; snapLoopIndex+=0)
{
if (l9_217<8)
{
int l9_218=l9_186[l9_217];
int l9_219=l9_214-l9_213;
bool l9_220=l9_218<l9_219;
bool l9_221;
if (l9_220)
{
l9_221=l9_186[l9_217]>0;
}
else
{
l9_221=l9_220;
...
if (l9_221)
{
vec3 l9_222=l9_215.xyz*(1.0-(float(l9_187[l9_217])/255.0));
l9_216=vec4(l9_222.x,l9_222.y,l9_222.z,l9_215.w);
}
else
{
l9_216=l9_215;
...
sc_writeFragData0Internal(l9_170,sc_UniformConstants.x,sc_ShaderCacheConstant);
}
#endif
}
#else
{
sc_writeFragData0Internal(l9_169,sc_UniformConstants.x,sc_ShaderCacheConstant);
}
#endif
}
#endif

...
uniform float Port_Value1_N038;
uniform float Port_Value2_N038;
uniform float Port_Value3_N038;
uniform vec2 Port_Input1_N070;
...
{
vec3 l9_78=l9_2-Tweak_N32;
vec3 l9_79=cross(l9_1,vec3(Port_Value1_N038,Port_Value2_N038,Port_Value3_N038));
float l9_80=dot(l9_79,l9_79);
float l9_81;
if (l9_80>0.0)
{
l9_81=1.0/sqrt(l9_80);
}
else
{
l9_81=0.0;
}
vec3 l9_82=l9_79*l9_81;
vec3 l9_83=cross(l9_1,l9_82);
float l9_84=dot(l9_83,l9_83);
float l9_85;
if (l9_84>0.0)
{
l9_85=1.0/sqrt(l9_84);
}
else
{
l9_85=0.0;
}
l9_69=step(length(vec2(dot(l9_78,l9_82),dot(l9_78,l9_83*l9_85))/(Port_Input1_N070+vec2(1.234e-06))),Port_Input1_N090);
}
float l9_86;
...
{
vec2 l9_90;
Node122_If_else(0.0,vec2(0.0),vec2(0.0),l9_90,l9_9);
float l9_91;
Node67_Bool_Parameter(l9_91,l9_9);
l9_89=mix(l9_5,l9_90,vec2(l9_91));
}
#else
{
vec2 l9_92;
...
{
vec2 l9_93;
Node64_If_else(0.0,vec2(0.0),vec2(0.0),l9_93,l9_9);
float l9_94;
Node11_Bool_Parameter(l9_94,l9_9);
l9_92=mix(l9_5,l9_93,vec2(l9_94));
}
#else
{
l9_92=l9_5;
...
{
bool l9_96=(int(SC_USE_CLAMP_TO_BORDER_opacityTex)!=0)&&(!(int(SC_USE_UV_MIN_MAX_opacityTex)!=0));
float l9_97=l9_87.x;
...
float l9_113=l9_102;
sc_SoftwareWrapLate(l9_112,ivec2(SC_SOFTWARE_WRAP_MODE_U_opacityTex,SC_SOFTWARE_WRAP_MODE_V_opacityTex).x,l9_96,l9_113);
float l9_114=l9_111.y;
float l9_115=l9_113;
sc_SoftwareWrapLate(l9_114,ivec2(SC_SOFTWARE_WRAP_MODE_U_opacityTex,SC_SOFTWARE_WRAP_MODE_V_opacityTex).y,l9_96,l9_115);
float l9_116=l9_115;
vec3 l9_117=sc_SamplingCoordsViewToGlobal(vec2(l9_112,l9_114),opacityTexLayout,opacityTexGetStereoViewIndex());
vec4 l9_118=texture(opacityTexArrSC,l9_117,0.0);
vec4 l9_119;
#if (SC_USE_CLAMP_TO_BORDER_opacityTex)
{
...
#else
{
bool l9_120=(int(SC_USE_CLAMP_TO_BORDER_opacityTex)!=0)&&(!(int(SC_USE_UV_MIN_MAX_opacityTex)!=0));
float l9_121=l9_87.x;
sc_SoftwareWrapEarly(l9_121,ivec2(SC_SOFTWARE_WRAP_MODE_U_opacityTex,SC_SOFTWARE_WRAP_MODE_V_opacityTex).x);
float l9_122=l9_121;
float l9_123=l9_87.y;
sc_SoftwareWrapEarly(l9_123,ivec2(SC_SOFTWARE_WRAP_MODE_U_opacityTex,SC_SOFTWARE_WRAP_MODE_V_opacityTex).y);
float l9_124=l9_123;
vec2 l9_125;
float l9_126;
#if (SC_USE_UV_MIN_MAX_opacityTex)
...
#if (SC_USE_CLAMP_TO_BORDER_opacityTex)
{
l9_127=ivec2(SC_SOFTWARE_WRAP_MODE_U_opacityTex,SC_SOFTWARE_WRAP_MODE_V_opacityTex).x==3;
}
#else
{
l9_127=(int(SC_USE_CLAMP_TO_BORDER_opacityTex)!=0);
}
#endif
float l9_128=l9_122;
float l9_129=1.0;
sc_ClampUV(l9_128,opacityTexUvMinMax.x,opacityTexUvMinMax.z,l9_127,l9_129);
float l9_130=l9_128;
float l9_131=l9_129;
bool l9_132;
#if (SC_USE_CLAMP_TO_BORDER_opacityTex)
{
l9_132=ivec2(SC_SOFTWARE_WRAP_MODE_U_opacityTex,SC_SOFTWARE_WRAP_MODE_V_opacityTex).y==3;
}
#else
{
l9_132=(int(SC_USE_CLAMP_TO_BORDER_opacityTex)!=0);
}
#endif
float l9_133=l9_124;
float l9_134=l9_131;
sc_ClampUV(l9_133,opacityTexUvMinMax.y,opacityTexUvMinMax.w,l9_132,l9_134);
l9_126=l9_134;
...
#endif
vec2 l9_135=sc_TransformUV(l9_125,(int(SC_USE_UV_TRANSFORM_opacityTex)!=0),opacityTexTransform);
float l9_136=l9_135.x;
float l9_137=l9_126;
sc_SoftwareWrapLate(l9_136,ivec2(SC_SOFTWARE_WRAP_MODE_U_opacityTex,SC_SOFTWARE_WRAP_MODE_V_opacityTex).x,l9_120,l9_137);
float l9_138=l9_135.y;
float l9_139=l9_137;
sc_SoftwareWrapLate(l9_138,ivec2(SC_SOFTWARE_WRAP_MODE_U_opacityTex,SC_SOFTWARE_WRAP_MODE_V_opacityTex).y,l9_120,l9_139);
float l9_140=l9_139;
vec3 l9_141=sc_SamplingCoordsViewToGlobal(vec2(l9_136,l9_138),opacityTexLayout,opacityTexGetStereoViewIndex());
vec4 l9_142=texture(opacityTex,l9_141.xy,0.0);
vec4 l9_143;
#if (SC_USE_CLAMP_TO_BORDER_opacityTex)
{
l9_143=mix(opacityTexBorderColor,l9_142,vec4(l9_140));
}
#else
{
l9_143=l9_142;
...
#else
{
l9_86=Port_Default_N204;
}
#endif
float l9_144=l9_68.w*l9_86;
float l9_145=min(l9_69,l9_144);
vec4 l9_146=vec4(l9_68.x,l9_68.y,l9_68.z,vec4(0.0).w);
l9_146.w=l9_145;
#if (sc_BlendMode_AlphaTest)
{
if (l9_145<alphaTestThreshold)
{
discard;
}
}
...
{
if (l9_145<((mod(dot(floor(mod(gl_FragCoord.xy,vec2(4.0))),vec2(4.0,1.0))*9.0,16.0)+1.0)/17.0))
{
discard;
}
}
...
#endif
sc_writeFragData0Internal(max(l9_147,vec4(0.0)),sc_UniformConstants.x,sc_ShaderCacheConstant);
return;
}
vec4 l9_149;
...
{
l9_151=clamp(l9_145*2.0,0.0,1.0);
}
#else
{
float l9_152;
...
{
l9_152=clamp(dot(l9_146.xyz,vec3(l9_145)),0.0,1.0);
}
#else
{
float l9_153;
...
{
l9_154=(1.0-dot(l9_146.xyz,vec3(0.33333001)))*l9_145;
}
#else
{
float l9_155;
...
{
l9_155=(1.0-clamp(dot(l9_146.xyz,vec3(1.0)),0.0,1.0))*l9_145;
}
#else
{
float l9_156;
...
{
l9_156=clamp(dot(l9_146.xyz,vec3(1.0)),0.0,1.0)*l9_145;
}
#else
{
float l9_157;
#if (sc_BlendMode_Add)
{
l9_157=clamp(dot(l9_146.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_158;
#if (sc_BlendMode_AddWithAlphaFactor)
{
l9_158=clamp(dot(l9_146.xyz,vec3(1.0)),0.0,1.0)*l9_145;
}
#else
{
float l9_159;
...
{
l9_159=dot(l9_146.xyz,vec3(0.33333001))*l9_145;
}
#else
{
float l9_160;
#if (sc_BlendMode_Min)
{
l9_160=1.0-clamp(dot(l9_146.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_161;
#if (sc_BlendMode_Max)
{
l9_161=clamp(dot(l9_146.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
l9_161=1.0;
...
#endif
l9_149=vec4(mix(sc_ShadowColor.xyz,sc_ShadowColor.xyz*l9_146.xyz,vec3(sc_ShadowColor.w)),sc_ShadowDensity*l9_150);
}
#else
{
vec4 l9_162;
...
#if (sc_FramebufferFetch)
{
l9_164=sc_readFragData0_Platform();
}
#else
{
...
{
l9_166=texture(sc_ScreenTextureArrSC,sc_SamplingCoordsViewToGlobal(l9_165,sc_ScreenTextureLayout,sc_ScreenTextureGetStereoViewIndex()),0.0);
}
#else
{
l9_166=texture(sc_ScreenTexture,sc_SamplingCoordsViewToGlobal(l9_165,sc_ScreenTextureLayout,sc_ScreenTextureGetStereoViewIndex()).xy,0.0);
}
#endif
l9_164=l9_166;
}
#endif
vec3 l9_167=mix(l9_164.xyz,definedBlend(l9_164.xyz,l9_146.xyz).xyz,vec3(l9_145));
vec4 l9_168=vec4(l9_167.x,l9_167.y,l9_167.z,vec4(0.0).w);
l9_168.w=1.0;
l9_163=l9_168;
}
#else
...
#if (sc_Voxelization)
{
l9_169=vec4(varScreenPos.xyz,1.0);
}
#else
{
vec4 l9_170;
#if (sc_OutputBounds)
{
float l9_171=clamp(abs(gl_FragCoord.z),0.0,1.0);
l9_170=vec4(l9_171,1.0-l9_171,1.0,1.0);
}
#else
{
vec4 l9_172;
#if (sc_BlendMode_MultiplyOriginal)
{
l9_172=vec4(mix(vec3(1.0),l9_146.xyz,vec3(l9_145)),l9_145);
}
#else
{
vec4 l9_173;
...
#endif
l9_173=vec4(l9_146.xyz*l9_174,l9_174);
}
#else
{
l9_173=l9_146;
...
vec4 l9_177=sc_OutputMotionVectorsIfNeeded(varPos,max(l9_175,vec4(0.0)));
vec4 l9_178=clamp(l9_177,vec4(0.0),vec4(1.0));
#if (sc_OITDepthBoundsPass)
{
#if (sc_OITDepthBoundsPass)
{
float l9_179=clamp(viewSpaceDepth()/1000.0,0.0,1.0);
sc_writeFragData0Internal(vec4(max(0.0,1.0-(l9_179-0.0039215689)),min(1.0,l9_179+0.0039215689),0.0,0.0),sc_UniformConstants.x,sc_ShaderCacheConstant);
}
#endif
}
#else
...
#endif
int l9_181=encodeDepth(viewSpaceDepth(),texture(sc_OITFilteredDepthBoundsTexture,l9_180).xy);
float l9_182=packValue(l9_181);
int l9_189=int(l9_178.w*255.0);
float l9_190=packValue(l9_189);
sc_writeFragData0Internal(vec4(packValue(l9_181),packValue(l9_181),packValue(l9_181),packValue(l9_181)),sc_UniformConstants.x,sc_ShaderCacheConstant);
sc_writeFragData1(vec4(l9_182,packValue(l9_181),packValue(l9_181),packValue(l9_181)));
sc_writeFragData2(vec4(l9_190,packValue(l9_189),packValue(l9_189),packValue(l9_189)));
...
#if (sc_OITMaxLayers4Plus1)
{
if ((gl_FragCoord.z-texture(sc_OITFrontDepthTexture,l9_193).x)<=getFrontLayerZTestEpsilon())
{
discard;
}
}
...
if (l9_198==0)
{
l9_201=texture(sc_OITAlpha0,l9_193);
l9_200=texture(sc_OITDepthLow0,l9_193);
l9_199=texture(sc_OITDepthHigh0,l9_193);
}
else
{
l9_201=vec4(0.0);
...
if (l9_198==1)
{
l9_204=texture(sc_OITAlpha1,l9_193);
l9_203=texture(sc_OITDepthLow1,l9_193);
l9_202=texture(sc_OITDepthHigh1,l9_193);
}
else
{
l9_204=l9_201;
...
if (any(notEqual(l9_202,vec4(0.0)))||any(notEqual(l9_203,vec4(0.0))))
{
int l9_205[8]=l9_194;
unpackValues(l9_202.w,l9_198,l9_205);
unpackValues(l9_202.z,l9_198,l9_205);
unpackValues(l9_202.y,l9_198,l9_205);
unpackValues(l9_202.x,l9_198,l9_205);
unpackValues(l9_203.w,l9_198,l9_205);
unpackValues(l9_203.z,l9_198,l9_205);
unpackValues(l9_203.y,l9_198,l9_205);
unpackValues(l9_203.x,l9_198,l9_205);
int l9_214[8]=l9_195;
unpackValues(l9_204.w,l9_198,l9_214);
unpackValues(l9_204.z,l9_198,l9_214);
unpackValues(l9_204.y,l9_198,l9_214);
unpackValues(l9_204.x,l9_198,l9_214);
}
l9_198++;
continue;
}
...
vec4 l9_219=texture(sc_OITFilteredDepthBoundsTexture,l9_193);
vec2 l9_220=l9_219.xy;
int l9_221;
#if (sc_SkinBonesCount>0)
{
l9_221=encodeDepth(((1.0-l9_219.x)*1000.0)+getDepthOrderingEpsilon(),l9_220);
}
#else
{
l9_221=0;
...
#endif
int l9_222=encodeDepth(viewSpaceDepth(),l9_220);
vec4 l9_223;
l9_223=l9_178*l9_178.w;
vec4 l9_224;
int l9_225=0;
for (int snapLoopIndex=0; snapLoopIndex==0; snapLoopIndex+=0)
{
if (l9_225<8)
{
int l9_226=l9_194[l9_225];
int l9_227=l9_222-l9_221;
bool l9_228=l9_226<l9_227;
bool l9_229;
if (l9_228)
{
l9_229=l9_194[l9_225]>0;
}
else
{
l9_229=l9_228;
...
if (l9_229)
{
vec3 l9_230=l9_223.xyz*(1.0-(float(l9_195[l9_225])/255.0));
l9_224=vec4(l9_230.x,l9_230.y,l9_230.z,l9_223.w);
}
else
{
l9_224=l9_223;
...
sc_writeFragData0Internal(l9_223,sc_UniformConstants.x,sc_ShaderCacheConstant);
#if (sc_OITMaxLayersVisualizeLayerCount)
{
discard;
}
...
sc_writeFragData0Internal(l9_178,sc_UniformConstants.x,sc_ShaderCacheConstant);
}
#endif
}
#else
{
sc_writeFragData0Internal(l9_177,sc_UniformConstants.x,sc_ShaderCacheConstant);
}
#endif
}
#endif

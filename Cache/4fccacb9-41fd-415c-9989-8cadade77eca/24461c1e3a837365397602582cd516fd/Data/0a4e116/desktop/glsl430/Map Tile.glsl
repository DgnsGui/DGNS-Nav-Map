...
float l9_80=step(length(vec2(dot(l9_71,l9_75),dot(l9_71,l9_79))/(Port_Input1_N088+vec2(1.234e-06))),Port_Input1_N077);
float l9_81=min(l9_80,l9_80);
vec4 l9_82=vec4(l9_70.x,l9_70.y,l9_70.z,vec4(0.0).w);
l9_82.w=l9_81;
#if (sc_BlendMode_AlphaTest)
{
if (l9_81<alphaTestThreshold)
{
discard;
}
}
...
{
if (l9_81<((mod(dot(floor(mod(gl_FragCoord.xy,vec2(4.0))),vec2(4.0,1.0))*9.0,16.0)+1.0)/17.0))
{
discard;
}
}
...
{
l9_88=clamp(dot(l9_82.xyz,vec3(l9_81)),0.0,1.0);
}
#else
{
float l9_89;
...
{
l9_90=(1.0-dot(l9_82.xyz,vec3(0.33333001)))*l9_81;
}
#else
{
float l9_91;
...
{
l9_91=(1.0-clamp(dot(l9_82.xyz,vec3(1.0)),0.0,1.0))*l9_81;
}
#else
{
float l9_92;
...
{
l9_92=clamp(dot(l9_82.xyz,vec3(1.0)),0.0,1.0)*l9_81;
}
#else
{
float l9_93;
...
#if (sc_BlendMode_AddWithAlphaFactor)
{
l9_94=clamp(dot(l9_82.xyz,vec3(1.0)),0.0,1.0)*l9_81;
}
#else
{
float l9_95;
...
{
l9_95=dot(l9_82.xyz,vec3(0.33333001))*l9_81;
}
#else
{
float l9_96;
...
#endif
vec3 l9_103=mix(l9_100.xyz,definedBlend(l9_100.xyz,l9_82.xyz).xyz,vec3(l9_81));
...
#if (sc_BlendMode_MultiplyOriginal)
{
l9_108=vec4(mix(vec3(1.0),l9_82.xyz,vec3(l9_81)),l9_81);
}
#else
{
vec4 l9_109;

...
vec3 l9_68=circleBoundCentre-l9_1;
float l9_69;
...
{
vec2 l9_73;
Node122_If_else(0.0,vec2(0.0),vec2(0.0),l9_73,l9_8);
float l9_74;
Node67_Bool_Parameter(l9_74,l9_8);
l9_72=mix(l9_4,l9_73,vec2(l9_74));
}
#else
{
vec2 l9_75;
...
{
vec2 l9_76;
Node64_If_else(0.0,vec2(0.0),vec2(0.0),l9_76,l9_8);
float l9_77;
Node11_Bool_Parameter(l9_77,l9_8);
...
vec4 l9_101=texture(opacityTexArrSC,l9_100,0.0);
vec4 l9_102;
#if (SC_USE_CLAMP_TO_BORDER_opacityTex)
{
...
#else
{
bool l9_103=(int(SC_USE_CLAMP_TO_BORDER_opacityTex)!=0)&&(!(int(SC_USE_UV_MIN_MAX_opacityTex)!=0));
float l9_104=l9_70.x;
sc_SoftwareWrapEarly(l9_104,ivec2(SC_SOFTWARE_WRAP_MODE_U_opacityTex,SC_SOFTWARE_WRAP_MODE_V_opacityTex).x);
float l9_105=l9_104;
float l9_106=l9_70.y;
sc_SoftwareWrapEarly(l9_106,ivec2(SC_SOFTWARE_WRAP_MODE_U_opacityTex,SC_SOFTWARE_WRAP_MODE_V_opacityTex).y);
float l9_107=l9_106;
vec2 l9_108;
float l9_109;
#if (SC_USE_UV_MIN_MAX_opacityTex)
...
#if (SC_USE_CLAMP_TO_BORDER_opacityTex)
{
l9_110=ivec2(SC_SOFTWARE_WRAP_MODE_U_opacityTex,SC_SOFTWARE_WRAP_MODE_V_opacityTex).x==3;
}
#else
{
...
float l9_111=l9_105;
float l9_112=1.0;
sc_ClampUV(l9_111,opacityTexUvMinMax.x,opacityTexUvMinMax.z,l9_110,l9_112);
float l9_113=l9_111;
float l9_114=l9_112;
bool l9_115;
#if (SC_USE_CLAMP_TO_BORDER_opacityTex)
{
l9_115=ivec2(SC_SOFTWARE_WRAP_MODE_U_opacityTex,SC_SOFTWARE_WRAP_MODE_V_opacityTex).y==3;
}
#else
{
l9_115=(int(SC_USE_CLAMP_TO_BORDER_opacityTex)!=0);
}
#endif
float l9_116=l9_107;
float l9_117=l9_114;
sc_ClampUV(l9_116,opacityTexUvMinMax.y,opacityTexUvMinMax.w,l9_115,l9_117);
l9_109=l9_117;
...
#endif
vec2 l9_118=sc_TransformUV(l9_108,(int(SC_USE_UV_TRANSFORM_opacityTex)!=0),opacityTexTransform);
float l9_119=l9_118.x;
float l9_120=l9_109;
sc_SoftwareWrapLate(l9_119,ivec2(SC_SOFTWARE_WRAP_MODE_U_opacityTex,SC_SOFTWARE_WRAP_MODE_V_opacityTex).x,l9_103,l9_120);
float l9_121=l9_118.y;
float l9_122=l9_120;
sc_SoftwareWrapLate(l9_121,ivec2(SC_SOFTWARE_WRAP_MODE_U_opacityTex,SC_SOFTWARE_WRAP_MODE_V_opacityTex).y,l9_103,l9_122);
float l9_123=l9_122;
vec3 l9_124=sc_SamplingCoordsViewToGlobal(vec2(l9_119,l9_121),opacityTexLayout,opacityTexGetStereoViewIndex());
vec4 l9_125=texture(opacityTex,l9_124.xy,0.0);
vec4 l9_126;
#if (SC_USE_CLAMP_TO_BORDER_opacityTex)
{
l9_126=mix(opacityTexBorderColor,l9_125,vec4(l9_123));
}
#else
{
l9_126=l9_125;
...
#else
{
l9_69=Port_Default_N204;
}
#endif
float l9_127=l9_67.w*l9_69;
float l9_128=min(step(length(l9_68/(Port_Input1_N079+vec3(1.234e-06))),circleBoundRadius),l9_127);
vec4 l9_129=vec4(l9_67.x,l9_67.y,l9_67.z,vec4(0.0).w);
l9_129.w=l9_128;
#if (sc_BlendMode_AlphaTest)
{
if (l9_128<alphaTestThreshold)
{
discard;
}
}
...
{
if (l9_128<((mod(dot(floor(mod(gl_FragCoord.xy,vec2(4.0))),vec2(4.0,1.0))*9.0,16.0)+1.0)/17.0))
{
discard;
}
}
...
#endif
sc_writeFragData0Internal(max(l9_130,vec4(0.0)),sc_UniformConstants.x,sc_ShaderCacheConstant);
return;
}
vec4 l9_132;
...
{
l9_134=clamp(l9_128*2.0,0.0,1.0);
}
#else
{
float l9_135;
...
{
l9_135=clamp(dot(l9_129.xyz,vec3(l9_128)),0.0,1.0);
}
#else
{
float l9_136;
...
{
l9_137=(1.0-dot(l9_129.xyz,vec3(0.33333001)))*l9_128;
}
#else
{
float l9_138;
...
{
l9_138=(1.0-clamp(dot(l9_129.xyz,vec3(1.0)),0.0,1.0))*l9_128;
}
#else
{
float l9_139;
...
{
l9_139=clamp(dot(l9_129.xyz,vec3(1.0)),0.0,1.0)*l9_128;
}
#else
{
float l9_140;
#if (sc_BlendMode_Add)
{
l9_140=clamp(dot(l9_129.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_141;
#if (sc_BlendMode_AddWithAlphaFactor)
{
l9_141=clamp(dot(l9_129.xyz,vec3(1.0)),0.0,1.0)*l9_128;
}
#else
{
float l9_142;
...
{
l9_142=dot(l9_129.xyz,vec3(0.33333001))*l9_128;
}
#else
{
float l9_143;
#if (sc_BlendMode_Min)
{
l9_143=1.0-clamp(dot(l9_129.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_144;
#if (sc_BlendMode_Max)
{
l9_144=clamp(dot(l9_129.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
l9_144=1.0;
...
#endif
l9_132=vec4(mix(sc_ShadowColor.xyz,sc_ShadowColor.xyz*l9_129.xyz,vec3(sc_ShadowColor.w)),sc_ShadowDensity*l9_133);
}
#else
{
vec4 l9_145;
...
#if (sc_FramebufferFetch)
{
l9_147=sc_readFragData0_Platform();
}
#else
{
vec2 l9_148=sc_ScreenCoordsGlobalToView(gl_FragCoord.xy*sc_CurrentRenderTargetDims.zw);
vec4 l9_149;
#if (sc_ScreenTextureLayout==2)
{
l9_149=texture(sc_ScreenTextureArrSC,sc_SamplingCoordsViewToGlobal(l9_148,sc_ScreenTextureLayout,sc_ScreenTextureGetStereoViewIndex()),0.0);
}
#else
{
l9_149=texture(sc_ScreenTexture,sc_SamplingCoordsViewToGlobal(l9_148,sc_ScreenTextureLayout,sc_ScreenTextureGetStereoViewIndex()).xy,0.0);
}
#endif
l9_147=l9_149;
}
#endif
vec3 l9_150=mix(l9_147.xyz,definedBlend(l9_147.xyz,l9_129.xyz).xyz,vec3(l9_128));
vec4 l9_151=vec4(l9_150.x,l9_150.y,l9_150.z,vec4(0.0).w);
l9_151.w=1.0;
l9_146=l9_151;
}
#else
...
#if (sc_Voxelization)
{
l9_152=vec4(varScreenPos.xyz,1.0);
}
#else
{
vec4 l9_153;
#if (sc_OutputBounds)
{
float l9_154=clamp(abs(gl_FragCoord.z),0.0,1.0);
l9_153=vec4(l9_154,1.0-l9_154,1.0,1.0);
}
#else
{
vec4 l9_155;
#if (sc_BlendMode_MultiplyOriginal)
{
l9_155=vec4(mix(vec3(1.0),l9_129.xyz,vec3(l9_128)),l9_128);
}
#else
{
vec4 l9_156;
...
#endif
l9_156=vec4(l9_129.xyz*l9_157,l9_157);
}
#else
{
l9_156=l9_129;
...
vec4 l9_160=sc_OutputMotionVectorsIfNeeded(varPos,max(l9_158,vec4(0.0)));

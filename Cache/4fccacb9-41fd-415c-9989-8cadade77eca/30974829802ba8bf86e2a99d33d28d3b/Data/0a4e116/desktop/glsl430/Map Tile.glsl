...
{
l9_69=step(length((circleBoundCentre-l9_2)/(Port_Input1_N079+vec3(1.234e-06))),circleBoundRadius);
}
else
{
vec3 l9_70=l9_1-cornerPosition;
float l9_71=dot(verticalVector,l9_70);
float l9_72=dot(l9_70,horizontalVector);
l9_69=min(min(min(step(Port_Input0_N047,l9_71),step(l9_71,dot(verticalVector,verticalVector))),step(Port_Input0_N057,l9_72)),step(l9_72,dot(horizontalVector,horizontalVector)));
}
float l9_73;
...
{
vec2 l9_77;
Node122_If_else(0.0,vec2(0.0),vec2(0.0),l9_77,l9_9);
float l9_78;
Node67_Bool_Parameter(l9_78,l9_9);
l9_76=mix(l9_5,l9_77,vec2(l9_78));
}
#else
{
vec2 l9_79;
...
{
vec2 l9_80;
Node64_If_else(0.0,vec2(0.0),vec2(0.0),l9_80,l9_9);
float l9_81;
Node11_Bool_Parameter(l9_81,l9_9);
l9_79=mix(l9_5,l9_80,vec2(l9_81));
}
#else
{
l9_79=l9_5;
...
{
bool l9_83=(int(SC_USE_CLAMP_TO_BORDER_opacityTex)!=0)&&(!(int(SC_USE_UV_MIN_MAX_opacityTex)!=0));
float l9_84=l9_74.x;
sc_SoftwareWrapEarly(l9_84,ivec2(SC_SOFTWARE_WRAP_MODE_U_opacityTex,SC_SOFTWARE_WRAP_MODE_V_opacityTex).x);
float l9_85=l9_84;
float l9_86=l9_74.y;
sc_SoftwareWrapEarly(l9_86,ivec2(SC_SOFTWARE_WRAP_MODE_U_opacityTex,SC_SOFTWARE_WRAP_MODE_V_opacityTex).y);
float l9_87=l9_86;
vec2 l9_88;
float l9_89;
...
{
l9_90=ivec2(SC_SOFTWARE_WRAP_MODE_U_opacityTex,SC_SOFTWARE_WRAP_MODE_V_opacityTex).x==3;
}
#else
{
l9_90=(int(SC_USE_CLAMP_TO_BORDER_opacityTex)!=0);
}
#endif
float l9_91=l9_85;
float l9_92=1.0;
sc_ClampUV(l9_91,opacityTexUvMinMax.x,opacityTexUvMinMax.z,l9_90,l9_92);
float l9_93=l9_91;
float l9_94=l9_92;
bool l9_95;
#if (SC_USE_CLAMP_TO_BORDER_opacityTex)
{
l9_95=ivec2(SC_SOFTWARE_WRAP_MODE_U_opacityTex,SC_SOFTWARE_WRAP_MODE_V_opacityTex).y==3;
}
#else
{
l9_95=(int(SC_USE_CLAMP_TO_BORDER_opacityTex)!=0);
}
#endif
float l9_96=l9_87;
float l9_97=l9_94;
sc_ClampUV(l9_96,opacityTexUvMinMax.y,opacityTexUvMinMax.w,l9_95,l9_97);
l9_89=l9_97;
...
#endif
vec2 l9_98=sc_TransformUV(l9_88,(int(SC_USE_UV_TRANSFORM_opacityTex)!=0),opacityTexTransform);
float l9_99=l9_98.x;
float l9_100=l9_89;
sc_SoftwareWrapLate(l9_99,ivec2(SC_SOFTWARE_WRAP_MODE_U_opacityTex,SC_SOFTWARE_WRAP_MODE_V_opacityTex).x,l9_83,l9_100);
float l9_101=l9_98.y;
float l9_102=l9_100;
sc_SoftwareWrapLate(l9_101,ivec2(SC_SOFTWARE_WRAP_MODE_U_opacityTex,SC_SOFTWARE_WRAP_MODE_V_opacityTex).y,l9_83,l9_102);
float l9_103=l9_102;
vec3 l9_104=sc_SamplingCoordsViewToGlobal(vec2(l9_99,l9_101),opacityTexLayout,opacityTexGetStereoViewIndex());
vec4 l9_105=texture(opacityTexArrSC,l9_104,0.0);
vec4 l9_106;
#if (SC_USE_CLAMP_TO_BORDER_opacityTex)
{
l9_106=mix(opacityTexBorderColor,l9_105,vec4(l9_103));
}
#else
{
l9_106=l9_105;
...
#else
{
bool l9_107=(int(SC_USE_CLAMP_TO_BORDER_opacityTex)!=0)&&(!(int(SC_USE_UV_MIN_MAX_opacityTex)!=0));
float l9_108=l9_74.x;
sc_SoftwareWrapEarly(l9_108,ivec2(SC_SOFTWARE_WRAP_MODE_U_opacityTex,SC_SOFTWARE_WRAP_MODE_V_opacityTex).x);
float l9_109=l9_108;
float l9_110=l9_74.y;
sc_SoftwareWrapEarly(l9_110,ivec2(SC_SOFTWARE_WRAP_MODE_U_opacityTex,SC_SOFTWARE_WRAP_MODE_V_opacityTex).y);
float l9_111=l9_110;
vec2 l9_112;
float l9_113;
#if (SC_USE_UV_MIN_MAX_opacityTex)
...
#if (SC_USE_CLAMP_TO_BORDER_opacityTex)
{
l9_114=ivec2(SC_SOFTWARE_WRAP_MODE_U_opacityTex,SC_SOFTWARE_WRAP_MODE_V_opacityTex).x==3;
}
#else
{
l9_114=(int(SC_USE_CLAMP_TO_BORDER_opacityTex)!=0);
}
#endif
float l9_115=l9_109;
float l9_116=1.0;
sc_ClampUV(l9_115,opacityTexUvMinMax.x,opacityTexUvMinMax.z,l9_114,l9_116);
float l9_117=l9_115;
float l9_118=l9_116;
bool l9_119;
#if (SC_USE_CLAMP_TO_BORDER_opacityTex)
{
l9_119=ivec2(SC_SOFTWARE_WRAP_MODE_U_opacityTex,SC_SOFTWARE_WRAP_MODE_V_opacityTex).y==3;
}
#else
{
l9_119=(int(SC_USE_CLAMP_TO_BORDER_opacityTex)!=0);
}
#endif
float l9_120=l9_111;
float l9_121=l9_118;
sc_ClampUV(l9_120,opacityTexUvMinMax.y,opacityTexUvMinMax.w,l9_119,l9_121);
l9_113=l9_121;
...
#endif
vec2 l9_122=sc_TransformUV(l9_112,(int(SC_USE_UV_TRANSFORM_opacityTex)!=0),opacityTexTransform);
float l9_123=l9_122.x;
float l9_124=l9_113;
sc_SoftwareWrapLate(l9_123,ivec2(SC_SOFTWARE_WRAP_MODE_U_opacityTex,SC_SOFTWARE_WRAP_MODE_V_opacityTex).x,l9_107,l9_124);
float l9_125=l9_122.y;
float l9_126=l9_124;
sc_SoftwareWrapLate(l9_125,ivec2(SC_SOFTWARE_WRAP_MODE_U_opacityTex,SC_SOFTWARE_WRAP_MODE_V_opacityTex).y,l9_107,l9_126);
float l9_127=l9_126;
vec3 l9_128=sc_SamplingCoordsViewToGlobal(vec2(l9_123,l9_125),opacityTexLayout,opacityTexGetStereoViewIndex());
vec4 l9_129=texture(opacityTex,l9_128.xy,0.0);
vec4 l9_130;
#if (SC_USE_CLAMP_TO_BORDER_opacityTex)
{
l9_130=mix(opacityTexBorderColor,l9_129,vec4(l9_127));
}
#else
{
l9_130=l9_129;
...
#else
{
l9_73=Port_Default_N204;
}
#endif
float l9_131=l9_68.w*l9_73;
float l9_132=min(l9_69,l9_131);
vec4 l9_133=vec4(l9_68.x,l9_68.y,l9_68.z,vec4(0.0).w);
l9_133.w=l9_132;
#if (sc_BlendMode_AlphaTest)
{
if (l9_132<alphaTestThreshold)
{
discard;
}
}
...
{
if (l9_132<((mod(dot(floor(mod(gl_FragCoord.xy,vec2(4.0))),vec2(4.0,1.0))*9.0,16.0)+1.0)/17.0))
{
discard;
}
}
...
#endif
sc_writeFragData0Internal(max(l9_134,vec4(0.0)),sc_UniformConstants.x,sc_ShaderCacheConstant);
return;
}
vec4 l9_136;
...
{
l9_138=clamp(l9_132*2.0,0.0,1.0);
}
#else
{
float l9_139;
...
{
l9_139=clamp(dot(l9_133.xyz,vec3(l9_132)),0.0,1.0);
}
#else
{
float l9_140;
...
{
l9_141=(1.0-dot(l9_133.xyz,vec3(0.33333001)))*l9_132;
}
#else
{
float l9_142;
...
{
l9_142=(1.0-clamp(dot(l9_133.xyz,vec3(1.0)),0.0,1.0))*l9_132;
}
#else
{
float l9_143;
...
{
l9_143=clamp(dot(l9_133.xyz,vec3(1.0)),0.0,1.0)*l9_132;
}
#else
{
float l9_144;
#if (sc_BlendMode_Add)
{
l9_144=clamp(dot(l9_133.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_145;
#if (sc_BlendMode_AddWithAlphaFactor)
{
l9_145=clamp(dot(l9_133.xyz,vec3(1.0)),0.0,1.0)*l9_132;
}
#else
{
float l9_146;
...
{
l9_146=dot(l9_133.xyz,vec3(0.33333001))*l9_132;
}
#else
{
float l9_147;
#if (sc_BlendMode_Min)
{
l9_147=1.0-clamp(dot(l9_133.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_148;
#if (sc_BlendMode_Max)
{
l9_148=clamp(dot(l9_133.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
l9_148=1.0;
...
#endif
l9_136=vec4(mix(sc_ShadowColor.xyz,sc_ShadowColor.xyz*l9_133.xyz,vec3(sc_ShadowColor.w)),sc_ShadowDensity*l9_137);
}
#else
{
vec4 l9_149;
...
#if (sc_FramebufferFetch)
{
l9_151=sc_readFragData0_Platform();
}
#else
{
...
{
l9_153=texture(sc_ScreenTextureArrSC,sc_SamplingCoordsViewToGlobal(l9_152,sc_ScreenTextureLayout,sc_ScreenTextureGetStereoViewIndex()),0.0);
}
#else
{
l9_153=texture(sc_ScreenTexture,sc_SamplingCoordsViewToGlobal(l9_152,sc_ScreenTextureLayout,sc_ScreenTextureGetStereoViewIndex()).xy,0.0);
}
#endif
l9_151=l9_153;
}
#endif
vec3 l9_154=mix(l9_151.xyz,definedBlend(l9_151.xyz,l9_133.xyz).xyz,vec3(l9_132));
vec4 l9_155=vec4(l9_154.x,l9_154.y,l9_154.z,vec4(0.0).w);
l9_155.w=1.0;
l9_150=l9_155;
}
#else
...
#if (sc_Voxelization)
{
l9_156=vec4(varScreenPos.xyz,1.0);
}
#else
{
vec4 l9_157;
#if (sc_OutputBounds)
{
float l9_158=clamp(abs(gl_FragCoord.z),0.0,1.0);
l9_157=vec4(l9_158,1.0-l9_158,1.0,1.0);
}
#else
{
vec4 l9_159;
#if (sc_BlendMode_MultiplyOriginal)
{
l9_159=vec4(mix(vec3(1.0),l9_133.xyz,vec3(l9_132)),l9_132);
}
#else
{
vec4 l9_160;
...
#endif
l9_160=vec4(l9_133.xyz*l9_161,l9_161);
}
#else
{
l9_160=l9_133;
...
vec4 l9_164=sc_OutputMotionVectorsIfNeeded(varPos,max(l9_162,vec4(0.0)));
vec4 l9_165=clamp(l9_164,vec4(0.0),vec4(1.0));
#if (sc_OITDepthBoundsPass)
{
#if (sc_OITDepthBoundsPass)
{
float l9_166=clamp(viewSpaceDepth()/1000.0,0.0,1.0);
sc_writeFragData0Internal(vec4(max(0.0,1.0-(l9_166-0.0039215689)),min(1.0,l9_166+0.0039215689),0.0,0.0),sc_UniformConstants.x,sc_ShaderCacheConstant);
}
#endif
}
#else
...
#if (sc_OITDepthGatherPass)
{
vec2 l9_167=sc_ScreenCoordsGlobalToView(gl_FragCoord.xy*sc_CurrentRenderTargetDims.zw);
#if (sc_OITMaxLayers4Plus1)
{
if ((gl_FragCoord.z-texture(sc_OITFrontDepthTexture,l9_167).x)<=getFrontLayerZTestEpsilon())
{
discard;
}
}
#endif
int l9_168=encodeDepth(viewSpaceDepth(),texture(sc_OITFilteredDepthBoundsTexture,l9_167).xy);
float l9_169=packValue(l9_168);
int l9_176=int(l9_165.w*255.0);
float l9_177=packValue(l9_176);
sc_writeFragData0Internal(vec4(packValue(l9_168),packValue(l9_168),packValue(l9_168),packValue(l9_168)),sc_UniformConstants.x,sc_ShaderCacheConstant);
sc_writeFragData1(vec4(l9_169,packValue(l9_168),packValue(l9_168),packValue(l9_168)));
sc_writeFragData2(vec4(l9_177,packValue(l9_176),packValue(l9_176),packValue(l9_176)));
...
#if (sc_OITCompositingPass)
{
vec2 l9_180=sc_ScreenCoordsGlobalToView(gl_FragCoord.xy*sc_CurrentRenderTargetDims.zw);
#if (sc_OITMaxLayers4Plus1)
{
if ((gl_FragCoord.z-texture(sc_OITFrontDepthTexture,l9_180).x)<=getFrontLayerZTestEpsilon())
{
discard;
}
}
...
if (l9_185==0)
{
l9_188=texture(sc_OITAlpha0,l9_180);
l9_187=texture(sc_OITDepthLow0,l9_180);
l9_186=texture(sc_OITDepthHigh0,l9_180);
}
else
{
l9_188=vec4(0.0);
...
if (l9_185==1)
{
l9_191=texture(sc_OITAlpha1,l9_180);
l9_190=texture(sc_OITDepthLow1,l9_180);
l9_189=texture(sc_OITDepthHigh1,l9_180);
}
else
{
l9_191=l9_188;
...
if (any(notEqual(l9_189,vec4(0.0)))||any(notEqual(l9_190,vec4(0.0))))
{
int l9_192[8]=l9_181;
unpackValues(l9_189.w,l9_185,l9_192);
unpackValues(l9_189.z,l9_185,l9_192);
unpackValues(l9_189.y,l9_185,l9_192);
unpackValues(l9_189.x,l9_185,l9_192);
unpackValues(l9_190.w,l9_185,l9_192);
unpackValues(l9_190.z,l9_185,l9_192);
unpackValues(l9_190.y,l9_185,l9_192);
unpackValues(l9_190.x,l9_185,l9_192);
int l9_201[8]=l9_182;
unpackValues(l9_191.w,l9_185,l9_201);
unpackValues(l9_191.z,l9_185,l9_201);
unpackValues(l9_191.y,l9_185,l9_201);
unpackValues(l9_191.x,l9_185,l9_201);
}
l9_185++;
continue;
}
...
vec4 l9_206=texture(sc_OITFilteredDepthBoundsTexture,l9_180);
vec2 l9_207=l9_206.xy;
int l9_208;
#if (sc_SkinBonesCount>0)
{
l9_208=encodeDepth(((1.0-l9_206.x)*1000.0)+getDepthOrderingEpsilon(),l9_207);
}
#else
{
l9_208=0;
...
#endif
int l9_209=encodeDepth(viewSpaceDepth(),l9_207);
vec4 l9_210;
l9_210=l9_165*l9_165.w;
vec4 l9_211;
int l9_212=0;
for (int snapLoopIndex=0; snapLoopIndex==0; snapLoopIndex+=0)
{
if (l9_212<8)
{
int l9_213=l9_181[l9_212];
int l9_214=l9_209-l9_208;
bool l9_215=l9_213<l9_214;
bool l9_216;
if (l9_215)
{
l9_216=l9_181[l9_212]>0;
}
else
{
l9_216=l9_215;
...
if (l9_216)
{
vec3 l9_217=l9_210.xyz*(1.0-(float(l9_182[l9_212])/255.0));
l9_211=vec4(l9_217.x,l9_217.y,l9_217.z,l9_210.w);
}
else
{
l9_211=l9_210;

...
uniform bool isMini;
uniform vec3 circleBoundCentre;
uniform float circleBoundRadius;
uniform vec3 verticalVector;
uniform vec3 cornerPosition;
uniform vec3 horizontalVector;
uniform vec3 Port_Input1_N079;
uniform float Port_Input0_N047;
...
l9_4=l9_5.uv0;
l9_3=l9_5.uv1;
l9_2=((l9_7.xy/vec2(l9_7.w))*0.5)+vec2(0.5);
l9_1=l9_6;
}
else
{
...
ssGlobals l9_8=ssGlobals(sc_Time.x,sc_Time.y,0.0,l9_4,l9_3,l9_2,l9_1);
vec4 l9_9;
#if (ENABLE_BASE_TEX)
{
vec2 l9_10;
...
{
vec2 l9_13;
Node122_If_else(0.0,vec2(0.0),vec2(0.0),l9_13,l9_8);
float l9_14;
Node67_Bool_Parameter(l9_14,l9_8);
l9_12=mix(l9_4,l9_13,vec2(l9_14));
}
#else
{
vec2 l9_15;
...
{
vec2 l9_16;
Node64_If_else(0.0,vec2(0.0),vec2(0.0),l9_16,l9_8);
float l9_17;
Node11_Bool_Parameter(l9_17,l9_8);
l9_15=mix(l9_4,l9_16,vec2(l9_17));
}
#else
{
l9_15=l9_4;
...
#if (baseTexLayout==2)
{
bool l9_19=(int(SC_USE_CLAMP_TO_BORDER_baseTex)!=0)&&(!(int(SC_USE_UV_MIN_MAX_baseTex)!=0));
float l9_20=l9_10.x;
sc_SoftwareWrapEarly(l9_20,ivec2(SC_SOFTWARE_WRAP_MODE_U_baseTex,SC_SOFTWARE_WRAP_MODE_V_baseTex).x);
float l9_21=l9_20;
float l9_22=l9_10.y;
sc_SoftwareWrapEarly(l9_22,ivec2(SC_SOFTWARE_WRAP_MODE_U_baseTex,SC_SOFTWARE_WRAP_MODE_V_baseTex).y);
float l9_23=l9_22;
vec2 l9_24;
float l9_25;
...
{
l9_26=ivec2(SC_SOFTWARE_WRAP_MODE_U_baseTex,SC_SOFTWARE_WRAP_MODE_V_baseTex).x==3;
}
#else
{
...
float l9_27=l9_21;
float l9_28=1.0;
sc_ClampUV(l9_27,baseTexUvMinMax.x,baseTexUvMinMax.z,l9_26,l9_28);
float l9_29=l9_27;
float l9_30=l9_28;
bool l9_31;
#if (SC_USE_CLAMP_TO_BORDER_baseTex)
{
l9_31=ivec2(SC_SOFTWARE_WRAP_MODE_U_baseTex,SC_SOFTWARE_WRAP_MODE_V_baseTex).y==3;
}
#else
{
...
float l9_32=l9_23;
float l9_33=l9_30;
sc_ClampUV(l9_32,baseTexUvMinMax.y,baseTexUvMinMax.w,l9_31,l9_33);
l9_25=l9_33;
...
#endif
vec2 l9_34=sc_TransformUV(l9_24,(int(SC_USE_UV_TRANSFORM_baseTex)!=0),baseTexTransform);
float l9_35=l9_34.x;
float l9_36=l9_25;
sc_SoftwareWrapLate(l9_35,ivec2(SC_SOFTWARE_WRAP_MODE_U_baseTex,SC_SOFTWARE_WRAP_MODE_V_baseTex).x,l9_19,l9_36);
float l9_37=l9_34.y;
float l9_38=l9_36;
sc_SoftwareWrapLate(l9_37,ivec2(SC_SOFTWARE_WRAP_MODE_U_baseTex,SC_SOFTWARE_WRAP_MODE_V_baseTex).y,l9_19,l9_38);
float l9_39=l9_38;
vec3 l9_40=sc_SamplingCoordsViewToGlobal(vec2(l9_35,l9_37),baseTexLayout,baseTexGetStereoViewIndex());
vec4 l9_41=texture(baseTexArrSC,l9_40,0.0);
vec4 l9_42;
#if (SC_USE_CLAMP_TO_BORDER_baseTex)
{
l9_42=mix(baseTexBorderColor,l9_41,vec4(l9_39));
}
#else
{
l9_42=l9_41;
...
#else
{
bool l9_43=(int(SC_USE_CLAMP_TO_BORDER_baseTex)!=0)&&(!(int(SC_USE_UV_MIN_MAX_baseTex)!=0));
float l9_44=l9_10.x;
sc_SoftwareWrapEarly(l9_44,ivec2(SC_SOFTWARE_WRAP_MODE_U_baseTex,SC_SOFTWARE_WRAP_MODE_V_baseTex).x);
float l9_45=l9_44;
float l9_46=l9_10.y;
sc_SoftwareWrapEarly(l9_46,ivec2(SC_SOFTWARE_WRAP_MODE_U_baseTex,SC_SOFTWARE_WRAP_MODE_V_baseTex).y);
float l9_47=l9_46;
vec2 l9_48;
float l9_49;
#if (SC_USE_UV_MIN_MAX_baseTex)
...
#if (SC_USE_CLAMP_TO_BORDER_baseTex)
{
l9_50=ivec2(SC_SOFTWARE_WRAP_MODE_U_baseTex,SC_SOFTWARE_WRAP_MODE_V_baseTex).x==3;
}
#else
{
...
float l9_51=l9_45;
float l9_52=1.0;
sc_ClampUV(l9_51,baseTexUvMinMax.x,baseTexUvMinMax.z,l9_50,l9_52);
float l9_53=l9_51;
float l9_54=l9_52;
bool l9_55;
#if (SC_USE_CLAMP_TO_BORDER_baseTex)
{
l9_55=ivec2(SC_SOFTWARE_WRAP_MODE_U_baseTex,SC_SOFTWARE_WRAP_MODE_V_baseTex).y==3;
}
#else
{
l9_55=(int(SC_USE_CLAMP_TO_BORDER_baseTex)!=0);
}
#endif
float l9_56=l9_47;
float l9_57=l9_54;
sc_ClampUV(l9_56,baseTexUvMinMax.y,baseTexUvMinMax.w,l9_55,l9_57);
l9_49=l9_57;
...
#endif
vec2 l9_58=sc_TransformUV(l9_48,(int(SC_USE_UV_TRANSFORM_baseTex)!=0),baseTexTransform);
float l9_59=l9_58.x;
float l9_60=l9_49;
sc_SoftwareWrapLate(l9_59,ivec2(SC_SOFTWARE_WRAP_MODE_U_baseTex,SC_SOFTWARE_WRAP_MODE_V_baseTex).x,l9_43,l9_60);
float l9_61=l9_58.y;
float l9_62=l9_60;
sc_SoftwareWrapLate(l9_61,ivec2(SC_SOFTWARE_WRAP_MODE_U_baseTex,SC_SOFTWARE_WRAP_MODE_V_baseTex).y,l9_43,l9_62);
float l9_63=l9_62;
vec3 l9_64=sc_SamplingCoordsViewToGlobal(vec2(l9_59,l9_61),baseTexLayout,baseTexGetStereoViewIndex());
vec4 l9_65=texture(baseTex,l9_64.xy,0.0);
vec4 l9_66;
#if (SC_USE_CLAMP_TO_BORDER_baseTex)
{
l9_66=mix(baseTexBorderColor,l9_65,vec4(l9_63));
}
#else
{
l9_66=l9_65;
...
#else
{
l9_9=Port_Default_N369;
}
#endif
vec4 l9_67=baseColor*l9_9;
float l9_68;
if ((float(isMini)*1.0)!=0.0)
{
l9_68=step(length((circleBoundCentre-l9_1)/(Port_Input1_N079+vec3(1.234e-06))),circleBoundRadius);
}
else
{
vec3 l9_69=l9_1-cornerPosition;
float l9_70=dot(verticalVector,l9_69);
float l9_71=dot(l9_69,horizontalVector);
l9_68=min(min(min(step(Port_Input0_N047,l9_70),step(l9_70,dot(verticalVector,verticalVector))),step(Port_Input0_N057,l9_71)),step(l9_71,dot(horizontalVector,horizontalVector)));
}
float l9_72;
...
{
vec2 l9_76;
Node122_If_else(0.0,vec2(0.0),vec2(0.0),l9_76,l9_8);
float l9_77;
Node67_Bool_Parameter(l9_77,l9_8);
l9_75=mix(l9_4,l9_76,vec2(l9_77));
}
#else
{
vec2 l9_78;
...
{
vec2 l9_79;
Node64_If_else(0.0,vec2(0.0),vec2(0.0),l9_79,l9_8);
float l9_80;
Node11_Bool_Parameter(l9_80,l9_8);
l9_78=mix(l9_4,l9_79,vec2(l9_80));
}
#else
{
l9_78=l9_4;
...
{
bool l9_82=(int(SC_USE_CLAMP_TO_BORDER_opacityTex)!=0)&&(!(int(SC_USE_UV_MIN_MAX_opacityTex)!=0));
float l9_83=l9_73.x;
sc_SoftwareWrapEarly(l9_83,ivec2(SC_SOFTWARE_WRAP_MODE_U_opacityTex,SC_SOFTWARE_WRAP_MODE_V_opacityTex).x);
float l9_84=l9_83;
float l9_85=l9_73.y;
sc_SoftwareWrapEarly(l9_85,ivec2(SC_SOFTWARE_WRAP_MODE_U_opacityTex,SC_SOFTWARE_WRAP_MODE_V_opacityTex).y);
float l9_86=l9_85;
vec2 l9_87;
float l9_88;
...
{
l9_89=ivec2(SC_SOFTWARE_WRAP_MODE_U_opacityTex,SC_SOFTWARE_WRAP_MODE_V_opacityTex).x==3;
}
#else
{
l9_89=(int(SC_USE_CLAMP_TO_BORDER_opacityTex)!=0);
}
#endif
float l9_90=l9_84;
float l9_91=1.0;
sc_ClampUV(l9_90,opacityTexUvMinMax.x,opacityTexUvMinMax.z,l9_89,l9_91);
float l9_92=l9_90;
float l9_93=l9_91;
bool l9_94;
#if (SC_USE_CLAMP_TO_BORDER_opacityTex)
{
l9_94=ivec2(SC_SOFTWARE_WRAP_MODE_U_opacityTex,SC_SOFTWARE_WRAP_MODE_V_opacityTex).y==3;
}
#else
{
...
float l9_95=l9_86;
float l9_96=l9_93;
sc_ClampUV(l9_95,opacityTexUvMinMax.y,opacityTexUvMinMax.w,l9_94,l9_96);
l9_88=l9_96;
...
#endif
vec2 l9_97=sc_TransformUV(l9_87,(int(SC_USE_UV_TRANSFORM_opacityTex)!=0),opacityTexTransform);
float l9_98=l9_97.x;
float l9_99=l9_88;
sc_SoftwareWrapLate(l9_98,ivec2(SC_SOFTWARE_WRAP_MODE_U_opacityTex,SC_SOFTWARE_WRAP_MODE_V_opacityTex).x,l9_82,l9_99);
float l9_100=l9_97.y;
float l9_101=l9_99;
sc_SoftwareWrapLate(l9_100,ivec2(SC_SOFTWARE_WRAP_MODE_U_opacityTex,SC_SOFTWARE_WRAP_MODE_V_opacityTex).y,l9_82,l9_101);
float l9_102=l9_101;
vec3 l9_103=sc_SamplingCoordsViewToGlobal(vec2(l9_98,l9_100),opacityTexLayout,opacityTexGetStereoViewIndex());
vec4 l9_104=texture(opacityTexArrSC,l9_103,0.0);
vec4 l9_105;
#if (SC_USE_CLAMP_TO_BORDER_opacityTex)
{
l9_105=mix(opacityTexBorderColor,l9_104,vec4(l9_102));
}
#else
{
l9_105=l9_104;
...
#else
{
bool l9_106=(int(SC_USE_CLAMP_TO_BORDER_opacityTex)!=0)&&(!(int(SC_USE_UV_MIN_MAX_opacityTex)!=0));
float l9_107=l9_73.x;
sc_SoftwareWrapEarly(l9_107,ivec2(SC_SOFTWARE_WRAP_MODE_U_opacityTex,SC_SOFTWARE_WRAP_MODE_V_opacityTex).x);
float l9_108=l9_107;
float l9_109=l9_73.y;
sc_SoftwareWrapEarly(l9_109,ivec2(SC_SOFTWARE_WRAP_MODE_U_opacityTex,SC_SOFTWARE_WRAP_MODE_V_opacityTex).y);
float l9_110=l9_109;
vec2 l9_111;
float l9_112;
#if (SC_USE_UV_MIN_MAX_opacityTex)
...
#if (SC_USE_CLAMP_TO_BORDER_opacityTex)
{
l9_113=ivec2(SC_SOFTWARE_WRAP_MODE_U_opacityTex,SC_SOFTWARE_WRAP_MODE_V_opacityTex).x==3;
}
#else
{
l9_113=(int(SC_USE_CLAMP_TO_BORDER_opacityTex)!=0);
}
#endif
float l9_114=l9_108;
float l9_115=1.0;
sc_ClampUV(l9_114,opacityTexUvMinMax.x,opacityTexUvMinMax.z,l9_113,l9_115);
float l9_116=l9_114;
float l9_117=l9_115;
bool l9_118;
#if (SC_USE_CLAMP_TO_BORDER_opacityTex)
{
l9_118=ivec2(SC_SOFTWARE_WRAP_MODE_U_opacityTex,SC_SOFTWARE_WRAP_MODE_V_opacityTex).y==3;
}
#else
{
l9_118=(int(SC_USE_CLAMP_TO_BORDER_opacityTex)!=0);
}
#endif
float l9_119=l9_110;
float l9_120=l9_117;
sc_ClampUV(l9_119,opacityTexUvMinMax.y,opacityTexUvMinMax.w,l9_118,l9_120);
l9_112=l9_120;
...
#endif
vec2 l9_121=sc_TransformUV(l9_111,(int(SC_USE_UV_TRANSFORM_opacityTex)!=0),opacityTexTransform);
float l9_122=l9_121.x;
float l9_123=l9_112;
sc_SoftwareWrapLate(l9_122,ivec2(SC_SOFTWARE_WRAP_MODE_U_opacityTex,SC_SOFTWARE_WRAP_MODE_V_opacityTex).x,l9_106,l9_123);
float l9_124=l9_121.y;
float l9_125=l9_123;
sc_SoftwareWrapLate(l9_124,ivec2(SC_SOFTWARE_WRAP_MODE_U_opacityTex,SC_SOFTWARE_WRAP_MODE_V_opacityTex).y,l9_106,l9_125);
float l9_126=l9_125;
vec3 l9_127=sc_SamplingCoordsViewToGlobal(vec2(l9_122,l9_124),opacityTexLayout,opacityTexGetStereoViewIndex());
vec4 l9_128=texture(opacityTex,l9_127.xy,0.0);
vec4 l9_129;
#if (SC_USE_CLAMP_TO_BORDER_opacityTex)
{
l9_129=mix(opacityTexBorderColor,l9_128,vec4(l9_126));
}
#else
{
l9_129=l9_128;
...
#else
{
l9_72=Port_Default_N204;
}
#endif
float l9_130=l9_67.w*l9_72;
float l9_131=min(l9_68,l9_130);
vec4 l9_132=vec4(l9_67.x,l9_67.y,l9_67.z,vec4(0.0).w);
l9_132.w=l9_131;
...
#endif
sc_writeFragData0Internal(max(l9_133,vec4(0.0)),sc_UniformConstants.x,sc_ShaderCacheConstant);
return;
}
vec4 l9_135;
...
{
l9_137=clamp(l9_131*2.0,0.0,1.0);
}
#else
{
float l9_138;
...
{
l9_138=clamp(dot(l9_132.xyz,vec3(l9_131)),0.0,1.0);
}
#else
{
float l9_139;
...
{
l9_140=(1.0-dot(l9_132.xyz,vec3(0.33333001)))*l9_131;
}
#else
{
float l9_141;
...
{
l9_141=(1.0-clamp(dot(l9_132.xyz,vec3(1.0)),0.0,1.0))*l9_131;
}
#else
{
float l9_142;
...
{
l9_142=clamp(dot(l9_132.xyz,vec3(1.0)),0.0,1.0)*l9_131;
}
#else
{
float l9_143;
#if (sc_BlendMode_Add)
{
l9_143=clamp(dot(l9_132.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_144;
#if (sc_BlendMode_AddWithAlphaFactor)
{
l9_144=clamp(dot(l9_132.xyz,vec3(1.0)),0.0,1.0)*l9_131;
}
#else
{
float l9_145;
...
{
l9_145=dot(l9_132.xyz,vec3(0.33333001))*l9_131;
}
#else
{
float l9_146;
#if (sc_BlendMode_Min)
{
l9_146=1.0-clamp(dot(l9_132.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_147;
#if (sc_BlendMode_Max)
{
l9_147=clamp(dot(l9_132.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
l9_147=1.0;
...
#endif
l9_135=vec4(mix(sc_ShadowColor.xyz,sc_ShadowColor.xyz*l9_132.xyz,vec3(sc_ShadowColor.w)),sc_ShadowDensity*l9_136);
}
#else
{
vec4 l9_148;
...
#if (sc_FramebufferFetch)
{
l9_150=sc_readFragData0_Platform();
}
#else
{
vec2 l9_151=sc_ScreenCoordsGlobalToView(gl_FragCoord.xy*sc_CurrentRenderTargetDims.zw);
vec4 l9_152;
#if (sc_ScreenTextureLayout==2)
{
l9_152=texture(sc_ScreenTextureArrSC,sc_SamplingCoordsViewToGlobal(l9_151,sc_ScreenTextureLayout,sc_ScreenTextureGetStereoViewIndex()),0.0);
}
#else
{
l9_152=texture(sc_ScreenTexture,sc_SamplingCoordsViewToGlobal(l9_151,sc_ScreenTextureLayout,sc_ScreenTextureGetStereoViewIndex()).xy,0.0);
}
#endif
l9_150=l9_152;
}
#endif
vec3 l9_153=mix(l9_150.xyz,definedBlend(l9_150.xyz,l9_132.xyz).xyz,vec3(l9_131));
vec4 l9_154=vec4(l9_153.x,l9_153.y,l9_153.z,vec4(0.0).w);
l9_154.w=1.0;
l9_149=l9_154;
}
#else
...
#if (sc_Voxelization)
{
l9_155=vec4(varScreenPos.xyz,1.0);
}
#else
{
vec4 l9_156;
#if (sc_OutputBounds)
{
float l9_157=clamp(abs(gl_FragCoord.z),0.0,1.0);
l9_156=vec4(l9_157,1.0-l9_157,1.0,1.0);
}
#else
{
vec4 l9_158;
#if (sc_BlendMode_MultiplyOriginal)
{
l9_158=vec4(mix(vec3(1.0),l9_132.xyz,vec3(l9_131)),l9_131);
}
#else
{
vec4 l9_159;
...
#endif
l9_159=vec4(l9_132.xyz*l9_160,l9_160);
}
#else
{
l9_159=l9_132;
...
vec4 l9_163=sc_OutputMotionVectorsIfNeeded(varPos,max(l9_161,vec4(0.0)));
vec4 l9_164=clamp(l9_163,vec4(0.0),vec4(1.0));
#if (sc_OITDepthBoundsPass)
{
#if (sc_OITDepthBoundsPass)
{
float l9_165=clamp(viewSpaceDepth()/1000.0,0.0,1.0);
sc_writeFragData0Internal(vec4(max(0.0,1.0-(l9_165-0.0039215689)),min(1.0,l9_165+0.0039215689),0.0,0.0),sc_UniformConstants.x,sc_ShaderCacheConstant);
}
#endif
}
#else
...
#endif
int l9_167=encodeDepth(viewSpaceDepth(),texture(sc_OITFilteredDepthBoundsTexture,l9_166).xy);
float l9_168=packValue(l9_167);
int l9_175=int(l9_164.w*255.0);
float l9_176=packValue(l9_175);
sc_writeFragData0Internal(vec4(packValue(l9_167),packValue(l9_167),packValue(l9_167),packValue(l9_167)),sc_UniformConstants.x,sc_ShaderCacheConstant);
sc_writeFragData1(vec4(l9_168,packValue(l9_167),packValue(l9_167),packValue(l9_167)));
sc_writeFragData2(vec4(l9_176,packValue(l9_175),packValue(l9_175),packValue(l9_175)));
...
#if (sc_OITCompositingPass)
{
vec2 l9_179=sc_ScreenCoordsGlobalToView(gl_FragCoord.xy*sc_CurrentRenderTargetDims.zw);
#if (sc_OITMaxLayers4Plus1)
{
if ((gl_FragCoord.z-texture(sc_OITFrontDepthTexture,l9_179).x)<=getFrontLayerZTestEpsilon())
{
discard;
}
}
...
if (l9_184==0)
{
l9_187=texture(sc_OITAlpha0,l9_179);
l9_186=texture(sc_OITDepthLow0,l9_179);
l9_185=texture(sc_OITDepthHigh0,l9_179);
}
else
{
l9_187=vec4(0.0);
...
if (l9_184==1)
{
l9_190=texture(sc_OITAlpha1,l9_179);
l9_189=texture(sc_OITDepthLow1,l9_179);
l9_188=texture(sc_OITDepthHigh1,l9_179);
}
else
{
l9_190=l9_187;
...
if (any(notEqual(l9_188,vec4(0.0)))||any(notEqual(l9_189,vec4(0.0))))
{
int l9_191[8]=l9_180;
unpackValues(l9_188.w,l9_184,l9_191);
unpackValues(l9_188.z,l9_184,l9_191);
unpackValues(l9_188.y,l9_184,l9_191);
unpackValues(l9_188.x,l9_184,l9_191);
unpackValues(l9_189.w,l9_184,l9_191);
unpackValues(l9_189.z,l9_184,l9_191);
unpackValues(l9_189.y,l9_184,l9_191);
unpackValues(l9_189.x,l9_184,l9_191);
int l9_200[8]=l9_181;
unpackValues(l9_190.w,l9_184,l9_200);
unpackValues(l9_190.z,l9_184,l9_200);
unpackValues(l9_190.y,l9_184,l9_200);
unpackValues(l9_190.x,l9_184,l9_200);
}
l9_184++;
continue;
}
...
vec4 l9_205=texture(sc_OITFilteredDepthBoundsTexture,l9_179);
vec2 l9_206=l9_205.xy;
int l9_207;
#if (sc_SkinBonesCount>0)
{
l9_207=encodeDepth(((1.0-l9_205.x)*1000.0)+getDepthOrderingEpsilon(),l9_206);
}
#else
{
l9_207=0;
...
#endif
int l9_208=encodeDepth(viewSpaceDepth(),l9_206);
vec4 l9_209;
l9_209=l9_164*l9_164.w;
vec4 l9_210;
int l9_211=0;
for (int snapLoopIndex=0; snapLoopIndex==0; snapLoopIndex+=0)
{
if (l9_211<8)
{
int l9_212=l9_180[l9_211];
int l9_213=l9_208-l9_207;
bool l9_214=l9_212<l9_213;
bool l9_215;
if (l9_214)
{
l9_215=l9_180[l9_211]>0;
}
else
{
l9_215=l9_214;
...
if (l9_215)
{
vec3 l9_216=l9_209.xyz*(1.0-(float(l9_181[l9_211])/255.0));
l9_210=vec4(l9_216.x,l9_216.y,l9_216.z,l9_209.w);
}
else
{
l9_210=l9_209;
...
sc_writeFragData0Internal(l9_164,sc_UniformConstants.x,sc_ShaderCacheConstant);
}
#endif
}
#else
{
sc_writeFragData0Internal(l9_163,sc_UniformConstants.x,sc_ShaderCacheConstant);
}
#endif
}
#endif

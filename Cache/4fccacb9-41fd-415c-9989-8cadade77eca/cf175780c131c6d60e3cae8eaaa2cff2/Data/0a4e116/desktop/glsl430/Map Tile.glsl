...
uniform vec3 Port_Red_N030;
uniform vec3 Port_Green_N030;
uniform vec3 Port_Blue_N030;
uniform int PreviewEnabled;
...
{
vec2 l9_18;
Node59_Switch(0.0,vec2(0.0),vec2(0.0),vec2(0.0),vec2(0.0),vec2(0.0),l9_18,l9_9);
l9_17=((l9_18*uv3Scale)+uv3Offset)+(uv3Offset*(sc_Time.x*Port_Speed_N063));
}
#else
{
vec2 l9_19;
Node59_Switch(0.0,vec2(0.0),vec2(0.0),vec2(0.0),vec2(0.0),vec2(0.0),l9_19,l9_9);
l9_17=(l9_19*uv3Scale)+uv3Offset;
}
#endif
float l9_20;
#if (Tweak_N11)
...
#endif
vec4 l9_70=baseColor*l9_10;
vec3 l9_71=l9_2-circleBoundCentre;
vec3 l9_72=cross(l9_1,vec3(Port_Value1_N082,Port_Value2_N082,Port_Value3_N082));
...
float l9_80=step(length(vec2(dot(l9_71,l9_75)*Mask_Radius,dot(l9_71,l9_79)*Mask_Radius)/(Port_Input1_N088+vec2(1.234e-06))),Port_Input1_N077);
vec3 l9_81=((Port_Red_N030*l9_70.x)+(Port_Green_N030*l9_70.y))+(Port_Blue_N030*l9_70.z);

...
uniform float Port_Value1_N087;
uniform float Port_Value2_N087;
...
float l9_68=step(length(vec2(Port_Value1_N087,Port_Value2_N087)/(Port_Input1_N088+vec2(1.234e-06))),Port_Input1_N077);
vec4 l9_69=vec4(l9_67.x,l9_67.y,l9_67.z,vec4(0.0).w);
l9_69.w=l9_68;
#if (sc_BlendMode_AlphaTest)
{
if (l9_68<alphaTestThreshold)
{
discard;
}
}
...
{
if (l9_68<((mod(dot(floor(mod(gl_FragCoord.xy,vec2(4.0))),vec2(4.0,1.0))*9.0,16.0)+1.0)/17.0))
{
discard;
}
}
...
#endif
sc_writeFragData0Internal(max(l9_70,vec4(0.0)),sc_UniformConstants.x,sc_ShaderCacheConstant);
return;
}
vec4 l9_72;
...
{
l9_75=clamp(dot(l9_69.xyz,vec3(l9_68)),0.0,1.0);
}
#else
{
float l9_76;
...
{
l9_77=(1.0-dot(l9_69.xyz,vec3(0.33333001)))*l9_68;
}
#else
{
float l9_78;
...
{
l9_78=(1.0-clamp(dot(l9_69.xyz,vec3(1.0)),0.0,1.0))*l9_68;
}
#else
{
float l9_79;
...
{
l9_79=clamp(dot(l9_69.xyz,vec3(1.0)),0.0,1.0)*l9_68;
}
#else
{
float l9_80;
#if (sc_BlendMode_Add)
{
l9_80=clamp(dot(l9_69.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_81;
#if (sc_BlendMode_AddWithAlphaFactor)
{
l9_81=clamp(dot(l9_69.xyz,vec3(1.0)),0.0,1.0)*l9_68;
}
#else
{
float l9_82;
...
{
l9_82=dot(l9_69.xyz,vec3(0.33333001))*l9_68;
}
#else
{
float l9_83;
#if (sc_BlendMode_Min)
{
l9_83=1.0-clamp(dot(l9_69.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_84;
#if (sc_BlendMode_Max)
{
l9_84=clamp(dot(l9_69.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
l9_84=1.0;
...
#endif
l9_72=vec4(mix(sc_ShadowColor.xyz,sc_ShadowColor.xyz*l9_69.xyz,vec3(sc_ShadowColor.w)),sc_ShadowDensity*l9_73);
}
#else
{
vec4 l9_85;
...
#if (sc_FramebufferFetch)
{
l9_87=sc_readFragData0_Platform();
}
#else
{
vec2 l9_88=sc_ScreenCoordsGlobalToView(gl_FragCoord.xy*sc_CurrentRenderTargetDims.zw);
vec4 l9_89;
#if (sc_ScreenTextureLayout==2)
{
l9_89=texture(sc_ScreenTextureArrSC,sc_SamplingCoordsViewToGlobal(l9_88,sc_ScreenTextureLayout,sc_ScreenTextureGetStereoViewIndex()),0.0);
}
#else
{
l9_89=texture(sc_ScreenTexture,sc_SamplingCoordsViewToGlobal(l9_88,sc_ScreenTextureLayout,sc_ScreenTextureGetStereoViewIndex()).xy,0.0);
}
#endif
l9_87=l9_89;
}
#endif
vec3 l9_90=mix(l9_87.xyz,definedBlend(l9_87.xyz,l9_69.xyz).xyz,vec3(l9_68));
...
#if (sc_Voxelization)
{
l9_92=vec4(varScreenPos.xyz,1.0);
}
#else
{
vec4 l9_93;
#if (sc_OutputBounds)
{
float l9_94=clamp(abs(gl_FragCoord.z),0.0,1.0);
l9_93=vec4(l9_94,1.0-l9_94,1.0,1.0);
}
#else
{
vec4 l9_95;
#if (sc_BlendMode_MultiplyOriginal)
{
l9_95=vec4(mix(vec3(1.0),l9_69.xyz,vec3(l9_68)),l9_68);
}
#else
{
vec4 l9_96;
...
#endif
l9_96=vec4(l9_69.xyz*l9_97,l9_97);
}
#else
{
l9_96=l9_69;
...
vec4 l9_100=sc_OutputMotionVectorsIfNeeded(varPos,max(l9_98,vec4(0.0)));
vec4 l9_101=clamp(l9_100,vec4(0.0),vec4(1.0));
#if (sc_OITDepthBoundsPass)
{
#if (sc_OITDepthBoundsPass)
{
float l9_102=clamp(viewSpaceDepth()/1000.0,0.0,1.0);
sc_writeFragData0Internal(vec4(max(0.0,1.0-(l9_102-0.0039215689)),min(1.0,l9_102+0.0039215689),0.0,0.0),sc_UniformConstants.x,sc_ShaderCacheConstant);
}
#endif
}
#else
...
#endif
int l9_104=encodeDepth(viewSpaceDepth(),texture(sc_OITFilteredDepthBoundsTexture,l9_103).xy);
float l9_105=packValue(l9_104);
int l9_112=int(l9_101.w*255.0);
float l9_113=packValue(l9_112);
sc_writeFragData0Internal(vec4(packValue(l9_104),packValue(l9_104),packValue(l9_104),packValue(l9_104)),sc_UniformConstants.x,sc_ShaderCacheConstant);
sc_writeFragData1(vec4(l9_105,packValue(l9_104),packValue(l9_104),packValue(l9_104)));
sc_writeFragData2(vec4(l9_113,packValue(l9_112),packValue(l9_112),packValue(l9_112)));
...
if (l9_121==0)
{
l9_124=texture(sc_OITAlpha0,l9_116);
l9_123=texture(sc_OITDepthLow0,l9_116);
l9_122=texture(sc_OITDepthHigh0,l9_116);
}
else
{
l9_124=vec4(0.0);
...
if (l9_121==1)
{
l9_127=texture(sc_OITAlpha1,l9_116);
l9_126=texture(sc_OITDepthLow1,l9_116);
l9_125=texture(sc_OITDepthHigh1,l9_116);
}
else
{
l9_127=l9_124;
...
if (any(notEqual(l9_125,vec4(0.0)))||any(notEqual(l9_126,vec4(0.0))))
{
int l9_128[8]=l9_117;
unpackValues(l9_125.w,l9_121,l9_128);
unpackValues(l9_125.z,l9_121,l9_128);
unpackValues(l9_125.y,l9_121,l9_128);
unpackValues(l9_125.x,l9_121,l9_128);
unpackValues(l9_126.w,l9_121,l9_128);
unpackValues(l9_126.z,l9_121,l9_128);
unpackValues(l9_126.y,l9_121,l9_128);
unpackValues(l9_126.x,l9_121,l9_128);
int l9_137[8]=l9_118;
unpackValues(l9_127.w,l9_121,l9_137);
unpackValues(l9_127.z,l9_121,l9_137);
unpackValues(l9_127.y,l9_121,l9_137);
unpackValues(l9_127.x,l9_121,l9_137);
}
l9_121++;
continue;
}
...
vec4 l9_142=texture(sc_OITFilteredDepthBoundsTexture,l9_116);
vec2 l9_143=l9_142.xy;
int l9_144;
#if (sc_SkinBonesCount>0)
{
l9_144=encodeDepth(((1.0-l9_142.x)*1000.0)+getDepthOrderingEpsilon(),l9_143);
}
#else
{
l9_144=0;
...
#endif
int l9_145=encodeDepth(viewSpaceDepth(),l9_143);
vec4 l9_146;
l9_146=l9_101*l9_101.w;
vec4 l9_147;
int l9_148=0;
for (int snapLoopIndex=0; snapLoopIndex==0; snapLoopIndex+=0)
{
if (l9_148<8)
{
int l9_149=l9_117[l9_148];
int l9_150=l9_145-l9_144;
bool l9_151=l9_149<l9_150;
bool l9_152;
if (l9_151)
{
l9_152=l9_117[l9_148]>0;
}
else
{
l9_152=l9_151;
...
if (l9_152)
{
vec3 l9_153=l9_146.xyz*(1.0-(float(l9_118[l9_148])/255.0));
l9_147=vec4(l9_153.x,l9_153.y,l9_153.z,l9_146.w);
}
else
{
l9_147=l9_146;
...
#else
{
sc_writeFragData0Internal(l9_100,sc_UniformConstants.x,sc_ShaderCacheConstant);
}
#endif
}
#endif

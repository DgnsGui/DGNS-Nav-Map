...
l9_69=min(min(min(step(Port_Input0_N047,l9_79),step(l9_79,dot(verticalVector,verticalVector))),step(Port_Input0_N057,l9_80)),step(l9_80,dot(horizontalVector,horizontalVector)));
}
float l9_81;

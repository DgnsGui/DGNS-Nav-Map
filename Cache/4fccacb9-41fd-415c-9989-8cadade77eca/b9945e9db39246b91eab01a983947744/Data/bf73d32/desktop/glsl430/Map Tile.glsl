...
#endif
sc_writeFragData0(max(l9_82,vec4(0.0)));
return;
}
vec4 l9_84;
...
vec4 l9_112=sc_OutputMotionVectorIfNeeded(max(l9_110,vec4(0.0)));
...
sc_writeFragData0(vec4(max(0.0,1.0-(l9_114-0.0039215689)),min(1.0,l9_114+0.0039215689),0.0,0.0));
}
#endif
}
#else
...
sc_writeFragData0(vec4(packValue(l9_116),packValue(l9_116),packValue(l9_116),packValue(l9_116)));
}
#endif
}
#else

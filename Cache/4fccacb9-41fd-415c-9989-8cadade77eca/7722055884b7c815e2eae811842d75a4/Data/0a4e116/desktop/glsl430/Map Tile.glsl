...
vec3 l9_4=l9_1-circleBoundCentre;
vec3 l9_5=cross(l9_2,vec3(Port_Value1_N082,Port_Value2_N082,Port_Value3_N082));
...
vec3 l9_8=l9_5*l9_7;
vec3 l9_9=cross(l9_2,l9_8);
float l9_10=dot(l9_9,l9_9);
float l9_11;
if (l9_10>0.0)
{
l9_11=1.0/sqrt(l9_10);
}
else
{
l9_11=0.0;
}
vec3 l9_12=l9_9*l9_11;
float l9_13=step(length(vec2(dot(l9_4,l9_8),dot(l9_4,l9_12))/(Port_Input1_N088+vec2(1.234e-06))),Port_Input1_N077);
vec4 l9_14=vec4(Port_Value1_N001.x,Port_Value1_N001.y,Port_Value1_N001.z,vec4(0.0).w);
l9_14.w=l9_13;
#if (sc_BlendMode_AlphaTest)
{
if (l9_13<alphaTestThreshold)
{
discard;
}
}
...
{
if (l9_13<((mod(dot(floor(mod(gl_FragCoord.xy,vec2(4.0))),vec2(4.0,1.0))*9.0,16.0)+1.0)/17.0))
{
discard;
}
}
...
#endif
sc_writeFragData0Internal(max(l9_15,vec4(0.0)),sc_UniformConstants.x,sc_ShaderCacheConstant);
return;
}
vec4 l9_17;
...
{
l9_20=clamp(dot(l9_14.xyz,vec3(l9_13)),0.0,1.0);
}
#else
{
float l9_21;
...
{
l9_22=(1.0-dot(l9_14.xyz,vec3(0.33333001)))*l9_13;
}
#else
{
float l9_23;
...
{
l9_23=(1.0-clamp(dot(l9_14.xyz,vec3(1.0)),0.0,1.0))*l9_13;
}
#else
{
float l9_24;
...
{
l9_24=clamp(dot(l9_14.xyz,vec3(1.0)),0.0,1.0)*l9_13;
}
#else
{
float l9_25;
#if (sc_BlendMode_Add)
{
l9_25=clamp(dot(l9_14.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_26;
#if (sc_BlendMode_AddWithAlphaFactor)
{
l9_26=clamp(dot(l9_14.xyz,vec3(1.0)),0.0,1.0)*l9_13;
}
#else
{
float l9_27;
...
{
l9_27=dot(l9_14.xyz,vec3(0.33333001))*l9_13;
}
#else
{
float l9_28;
#if (sc_BlendMode_Min)
{
l9_28=1.0-clamp(dot(l9_14.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_29;
#if (sc_BlendMode_Max)
{
l9_29=clamp(dot(l9_14.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
l9_29=1.0;
...
#endif
l9_17=vec4(mix(sc_ShadowColor.xyz,sc_ShadowColor.xyz*l9_14.xyz,vec3(sc_ShadowColor.w)),sc_ShadowDensity*l9_18);
}
#else
{
vec4 l9_30;
...
#if (sc_FramebufferFetch)
{
l9_32=sc_readFragData0_Platform();
}
#else
{
vec2 l9_33=sc_ScreenCoordsGlobalToView(gl_FragCoord.xy*sc_CurrentRenderTargetDims.zw);
vec4 l9_34;
#if (sc_ScreenTextureLayout==2)
{
l9_34=texture(sc_ScreenTextureArrSC,sc_SamplingCoordsViewToGlobal(l9_33,sc_ScreenTextureLayout,sc_ScreenTextureGetStereoViewIndex()),0.0);
}
#else
{
l9_34=texture(sc_ScreenTexture,sc_SamplingCoordsViewToGlobal(l9_33,sc_ScreenTextureLayout,sc_ScreenTextureGetStereoViewIndex()).xy,0.0);
}
#endif
l9_32=l9_34;
}
#endif
vec3 l9_35=mix(l9_32.xyz,definedBlend(l9_32.xyz,l9_14.xyz).xyz,vec3(l9_13));
...
#if (sc_Voxelization)
{
l9_37=vec4(varScreenPos.xyz,1.0);
}
#else
{
vec4 l9_38;
#if (sc_OutputBounds)
{
float l9_39=clamp(abs(gl_FragCoord.z),0.0,1.0);
l9_38=vec4(l9_39,1.0-l9_39,1.0,1.0);
}
#else
{
vec4 l9_40;
#if (sc_BlendMode_MultiplyOriginal)
{
l9_40=vec4(mix(vec3(1.0),l9_14.xyz,vec3(l9_13)),l9_13);
}
#else
{
vec4 l9_41;
...
#endif
l9_41=vec4(l9_14.xyz*l9_42,l9_42);
}
#else
{
l9_41=l9_14;
...
vec4 l9_45=sc_OutputMotionVectorsIfNeeded(varPos,max(l9_43,vec4(0.0)));

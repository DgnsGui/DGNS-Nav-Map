...
float l9_76=step(length(vec2(dot(l9_71,l9_75),Port_Value2_N087)/(Mask_Radius+vec2(1.234e-06))),Port_Input1_N077);
vec4 l9_77=vec4(l9_70.x,l9_70.y,l9_70.z,vec4(0.0).w);
l9_77.w=l9_76;
#if (sc_BlendMode_AlphaTest)
{
if (l9_76<alphaTestThreshold)
{
discard;
}
}
...
{
if (l9_76<((mod(dot(floor(mod(gl_FragCoord.xy,vec2(4.0))),vec2(4.0,1.0))*9.0,16.0)+1.0)/17.0))
{
discard;
}
}
...
#endif
sc_writeFragData0Internal(max(l9_78,vec4(0.0)),sc_UniformConstants.x,sc_ShaderCacheConstant);
return;
}
vec4 l9_80;
...
{
l9_83=clamp(dot(l9_77.xyz,vec3(l9_76)),0.0,1.0);
}
#else
{
float l9_84;
...
{
l9_85=(1.0-dot(l9_77.xyz,vec3(0.33333001)))*l9_76;
}
#else
{
float l9_86;
...
{
l9_86=(1.0-clamp(dot(l9_77.xyz,vec3(1.0)),0.0,1.0))*l9_76;
}
#else
{
float l9_87;
...
{
l9_87=clamp(dot(l9_77.xyz,vec3(1.0)),0.0,1.0)*l9_76;
}
#else
{
float l9_88;
#if (sc_BlendMode_Add)
{
l9_88=clamp(dot(l9_77.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_89;
#if (sc_BlendMode_AddWithAlphaFactor)
{
l9_89=clamp(dot(l9_77.xyz,vec3(1.0)),0.0,1.0)*l9_76;
}
#else
{
float l9_90;
...
{
l9_90=dot(l9_77.xyz,vec3(0.33333001))*l9_76;
}
#else
{
float l9_91;
#if (sc_BlendMode_Min)
{
l9_91=1.0-clamp(dot(l9_77.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_92;
#if (sc_BlendMode_Max)
{
l9_92=clamp(dot(l9_77.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
l9_92=1.0;
...
#endif
l9_80=vec4(mix(sc_ShadowColor.xyz,sc_ShadowColor.xyz*l9_77.xyz,vec3(sc_ShadowColor.w)),sc_ShadowDensity*l9_81);
}
#else
{
vec4 l9_93;
...
#if (sc_FramebufferFetch)
{
l9_95=sc_readFragData0_Platform();
}
#else
{
...
{
l9_97=texture(sc_ScreenTextureArrSC,sc_SamplingCoordsViewToGlobal(l9_96,sc_ScreenTextureLayout,sc_ScreenTextureGetStereoViewIndex()),0.0);
}
#else
{
l9_97=texture(sc_ScreenTexture,sc_SamplingCoordsViewToGlobal(l9_96,sc_ScreenTextureLayout,sc_ScreenTextureGetStereoViewIndex()).xy,0.0);
}
#endif
l9_95=l9_97;
}
#endif
vec3 l9_98=mix(l9_95.xyz,definedBlend(l9_95.xyz,l9_77.xyz).xyz,vec3(l9_76));
vec4 l9_99=vec4(l9_98.x,l9_98.y,l9_98.z,vec4(0.0).w);
l9_99.w=1.0;
l9_94=l9_99;
}
#else
...
#if (sc_Voxelization)
{
l9_100=vec4(varScreenPos.xyz,1.0);
}
#else
{
vec4 l9_101;
#if (sc_OutputBounds)
{
float l9_102=clamp(abs(gl_FragCoord.z),0.0,1.0);
l9_101=vec4(l9_102,1.0-l9_102,1.0,1.0);
}
#else
{
vec4 l9_103;
#if (sc_BlendMode_MultiplyOriginal)
{
l9_103=vec4(mix(vec3(1.0),l9_77.xyz,vec3(l9_76)),l9_76);
}
#else
{
vec4 l9_104;
...
#endif
l9_104=vec4(l9_77.xyz*l9_105,l9_105);
}
#else
{
l9_104=l9_77;
...
vec4 l9_108=sc_OutputMotionVectorsIfNeeded(varPos,max(l9_106,vec4(0.0)));
vec4 l9_109=clamp(l9_108,vec4(0.0),vec4(1.0));
#if (sc_OITDepthBoundsPass)
{
#if (sc_OITDepthBoundsPass)
{
float l9_110=clamp(viewSpaceDepth()/1000.0,0.0,1.0);
sc_writeFragData0Internal(vec4(max(0.0,1.0-(l9_110-0.0039215689)),min(1.0,l9_110+0.0039215689),0.0,0.0),sc_UniformConstants.x,sc_ShaderCacheConstant);
}
#endif
}
#else
...
#if (sc_OITDepthGatherPass)
{
vec2 l9_111=sc_ScreenCoordsGlobalToView(gl_FragCoord.xy*sc_CurrentRenderTargetDims.zw);
...
#endif
int l9_112=encodeDepth(viewSpaceDepth(),texture(sc_OITFilteredDepthBoundsTexture,l9_111).xy);
float l9_113=packValue(l9_112);
int l9_120=int(l9_109.w*255.0);
float l9_121=packValue(l9_120);
sc_writeFragData0Internal(vec4(packValue(l9_112),packValue(l9_112),packValue(l9_112),packValue(l9_112)),sc_UniformConstants.x,sc_ShaderCacheConstant);
sc_writeFragData1(vec4(l9_113,packValue(l9_112),packValue(l9_112),packValue(l9_112)));
sc_writeFragData2(vec4(l9_121,packValue(l9_120),packValue(l9_120),packValue(l9_120)));
...
#if (sc_OITMaxLayers4Plus1)
{
if ((gl_FragCoord.z-texture(sc_OITFrontDepthTexture,l9_124).x)<=getFrontLayerZTestEpsilon())
{
discard;
}
}
...
if (l9_129==0)
{
l9_132=texture(sc_OITAlpha0,l9_124);
l9_131=texture(sc_OITDepthLow0,l9_124);
l9_130=texture(sc_OITDepthHigh0,l9_124);
}
else
{
l9_132=vec4(0.0);
...
if (l9_129==1)
{
l9_135=texture(sc_OITAlpha1,l9_124);
l9_134=texture(sc_OITDepthLow1,l9_124);
l9_133=texture(sc_OITDepthHigh1,l9_124);
}
else
{
l9_135=l9_132;
...
if (any(notEqual(l9_133,vec4(0.0)))||any(notEqual(l9_134,vec4(0.0))))
{
int l9_136[8]=l9_125;
unpackValues(l9_133.w,l9_129,l9_136);
unpackValues(l9_133.z,l9_129,l9_136);
unpackValues(l9_133.y,l9_129,l9_136);
unpackValues(l9_133.x,l9_129,l9_136);
unpackValues(l9_134.w,l9_129,l9_136);
unpackValues(l9_134.z,l9_129,l9_136);
unpackValues(l9_134.y,l9_129,l9_136);
unpackValues(l9_134.x,l9_129,l9_136);
int l9_145[8]=l9_126;
unpackValues(l9_135.w,l9_129,l9_145);
unpackValues(l9_135.z,l9_129,l9_145);
unpackValues(l9_135.y,l9_129,l9_145);
unpackValues(l9_135.x,l9_129,l9_145);
}
l9_129++;
continue;
}
...
vec4 l9_150=texture(sc_OITFilteredDepthBoundsTexture,l9_124);
vec2 l9_151=l9_150.xy;
int l9_152;
#if (sc_SkinBonesCount>0)
{
l9_152=encodeDepth(((1.0-l9_150.x)*1000.0)+getDepthOrderingEpsilon(),l9_151);
}
#else
{
l9_152=0;
...
#endif
int l9_153=encodeDepth(viewSpaceDepth(),l9_151);
vec4 l9_154;
l9_154=l9_109*l9_109.w;
vec4 l9_155;
int l9_156=0;
for (int snapLoopIndex=0; snapLoopIndex==0; snapLoopIndex+=0)
{
if (l9_156<8)
{
int l9_157=l9_125[l9_156];
int l9_158=l9_153-l9_152;
bool l9_159=l9_157<l9_158;
bool l9_160;
if (l9_159)
{
l9_160=l9_125[l9_156]>0;
}
else
{
l9_160=l9_159;
...
if (l9_160)
{
vec3 l9_161=l9_154.xyz*(1.0-(float(l9_126[l9_156])/255.0));
l9_155=vec4(l9_161.x,l9_161.y,l9_161.z,l9_154.w);
}
else
{
l9_155=l9_154;
...
sc_writeFragData0Internal(l9_154,sc_UniformConstants.x,sc_ShaderCacheConstant);
#if (sc_OITMaxLayersVisualizeLayerCount)
{
discard;
}
...
sc_writeFragData0Internal(l9_109,sc_UniformConstants.x,sc_ShaderCacheConstant);
}
#endif
}
#else
{
sc_writeFragData0Internal(l9_108,sc_UniformConstants.x,sc_ShaderCacheConstant);
}
#endif
}
#endif

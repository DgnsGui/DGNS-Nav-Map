...
{
vec2 l9_17;
Node59_Switch(0.0,vec2(0.0),vec2(0.0),vec2(0.0),vec2(0.0),vec2(0.0),l9_17,l9_8);
l9_16=((l9_17*uv3Scale)+uv3Offset)+(uv3Offset*(sc_Time.x*Port_Speed_N063));
}
#else
{
vec2 l9_18;
Node59_Switch(0.0,vec2(0.0),vec2(0.0),vec2(0.0),vec2(0.0),vec2(0.0),l9_18,l9_8);
l9_16=(l9_18*uv3Scale)+uv3Offset;
}
#endif
float l9_19;
#if (Tweak_N11)
...
#endif
l9_15=mix(l9_4,l9_16,vec2(l9_19-0.001));
}
#else
{
l9_15=l9_4;
...
#endif
vec4 l9_69=baseColor*l9_9;
vec3 l9_70=circleBoundCentre-l9_1;
float l9_71=step(length(l9_70/(Port_Input1_N079+vec3(1.234e-06))),circleBoundRadius);
vec4 l9_72=vec4(l9_69.x,l9_69.y,l9_69.z,vec4(0.0).w);
l9_72.w=l9_71;
#if (sc_BlendMode_AlphaTest)
{
if (l9_71<alphaTestThreshold)
{
discard;
}
}
...
{
if (l9_71<((mod(dot(floor(mod(gl_FragCoord.xy,vec2(4.0))),vec2(4.0,1.0))*9.0,16.0)+1.0)/17.0))
{
discard;
}
}
...
#endif
sc_writeFragData0Internal(max(l9_73,vec4(0.0)),sc_UniformConstants.x,sc_ShaderCacheConstant);
return;
}
vec4 l9_75;
...
{
l9_78=clamp(dot(l9_72.xyz,vec3(l9_71)),0.0,1.0);
}
#else
{
float l9_79;
...
{
l9_80=(1.0-dot(l9_72.xyz,vec3(0.33333001)))*l9_71;
}
#else
{
float l9_81;
...
{
l9_81=(1.0-clamp(dot(l9_72.xyz,vec3(1.0)),0.0,1.0))*l9_71;
}
#else
{
float l9_82;
...
{
l9_82=clamp(dot(l9_72.xyz,vec3(1.0)),0.0,1.0)*l9_71;
}
#else
{
float l9_83;
#if (sc_BlendMode_Add)
{
l9_83=clamp(dot(l9_72.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_84;
#if (sc_BlendMode_AddWithAlphaFactor)
{
l9_84=clamp(dot(l9_72.xyz,vec3(1.0)),0.0,1.0)*l9_71;
}
#else
{
float l9_85;
...
{
l9_85=dot(l9_72.xyz,vec3(0.33333001))*l9_71;
}
#else
{
float l9_86;
#if (sc_BlendMode_Min)
{
l9_86=1.0-clamp(dot(l9_72.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_87;
#if (sc_BlendMode_Max)
{
l9_87=clamp(dot(l9_72.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
l9_87=1.0;
...
#endif
l9_75=vec4(mix(sc_ShadowColor.xyz,sc_ShadowColor.xyz*l9_72.xyz,vec3(sc_ShadowColor.w)),sc_ShadowDensity*l9_76);
}
#else
{
vec4 l9_88;
...
#else
{
vec2 l9_91=sc_ScreenCoordsGlobalToView(gl_FragCoord.xy*sc_CurrentRenderTargetDims.zw);
vec4 l9_92;
#if (sc_ScreenTextureLayout==2)
{
l9_92=texture(sc_ScreenTextureArrSC,sc_SamplingCoordsViewToGlobal(l9_91,sc_ScreenTextureLayout,sc_ScreenTextureGetStereoViewIndex()),0.0);
}
#else
{
l9_92=texture(sc_ScreenTexture,sc_SamplingCoordsViewToGlobal(l9_91,sc_ScreenTextureLayout,sc_ScreenTextureGetStereoViewIndex()).xy,0.0);
}
#endif
l9_90=l9_92;
}
#endif
vec3 l9_93=mix(l9_90.xyz,definedBlend(l9_90.xyz,l9_72.xyz).xyz,vec3(l9_71));
...
#if (sc_BlendMode_MultiplyOriginal)
{
l9_98=vec4(mix(vec3(1.0),l9_72.xyz,vec3(l9_71)),l9_71);
}
#else
{
vec4 l9_99;
...
#endif
l9_99=vec4(l9_72.xyz*l9_100,l9_100);
}
#else
{
l9_99=l9_72;
...
#if (sc_OITDepthGatherPass)
{
vec2 l9_106=sc_ScreenCoordsGlobalToView(gl_FragCoord.xy*sc_CurrentRenderTargetDims.zw);
#if (sc_OITMaxLayers4Plus1)
{
if ((gl_FragCoord.z-texture(sc_OITFrontDepthTexture,l9_106).x)<=getFrontLayerZTestEpsilon())
{
discard;
}
}
#endif
int l9_107=encodeDepth(viewSpaceDepth(),texture(sc_OITFilteredDepthBoundsTexture,l9_106).xy);
...
#if (sc_OITCompositingPass)
{
vec2 l9_119=sc_ScreenCoordsGlobalToView(gl_FragCoord.xy*sc_CurrentRenderTargetDims.zw);
#if (sc_OITMaxLayers4Plus1)
{
if ((gl_FragCoord.z-texture(sc_OITFrontDepthTexture,l9_119).x)<=getFrontLayerZTestEpsilon())
{
discard;
}
}
...
if (l9_124==0)
{
l9_127=texture(sc_OITAlpha0,l9_119);
l9_126=texture(sc_OITDepthLow0,l9_119);
l9_125=texture(sc_OITDepthHigh0,l9_119);
}
else
{
l9_127=vec4(0.0);
...
if (l9_124==1)
{
l9_130=texture(sc_OITAlpha1,l9_119);
l9_129=texture(sc_OITDepthLow1,l9_119);
l9_128=texture(sc_OITDepthHigh1,l9_119);
}
else
{
l9_130=l9_127;
...
vec4 l9_145=texture(sc_OITFilteredDepthBoundsTexture,l9_119);

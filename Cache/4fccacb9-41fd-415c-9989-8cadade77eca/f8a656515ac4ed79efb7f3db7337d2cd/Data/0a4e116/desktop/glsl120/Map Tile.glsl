...
{
vec2 l9_12;
Node59_Switch(0.0,vec2(0.0),vec2(0.0),vec2(0.0),vec2(0.0),vec2(0.0),l9_12,l9_3);
l9_11=((l9_12*uv3Scale)+uv3Offset)+(uv3Offset*(sc_Time.x*Port_Speed_N063));
}
#else
{
vec2 l9_13;
Node59_Switch(0.0,vec2(0.0),vec2(0.0),vec2(0.0),vec2(0.0),vec2(0.0),l9_13,l9_3);
l9_11=(l9_13*uv3Scale)+uv3Offset;
}
#endif
float l9_14;
#if (Tweak_N11)
...
#endif
l9_10=mix(varPackedTex.xy,l9_11,vec2(l9_14-0.001));
}
#else
{
...
float l9_36=l9_35;
vec3 l9_37=sc_SamplingCoordsViewToGlobal(vec2(l9_32,l9_34),baseTexLayout,l9_15);
vec4 l9_38=texture2D(baseTex,l9_37.xy,0.0);
vec4 l9_39;
#if (SC_USE_CLAMP_TO_BORDER_baseTex)
{
...
#endif
vec4 l9_40=baseColor*l9_4;
vec3 l9_41=varPos-circleBoundCentre;
vec3 l9_42=cross(l9_2,vec3(Port_Value1_N082,Port_Value2_N082,Port_Value3_N082));
float l9_43=dot(l9_42,l9_42);
float l9_44;
if (l9_43>0.0)
{
...
vec3 l9_45=l9_42*l9_44;
vec3 l9_46=cross(l9_2,l9_45);
float l9_47=dot(l9_46,l9_46);
float l9_48;
if (l9_47>0.0)
{
l9_48=1.0/sqrt(l9_47);
}
else
{
l9_48=0.0;
}
vec3 l9_49=l9_46*l9_48;
float l9_50=step(length(vec2(dot(l9_41,l9_45),dot(l9_41,l9_49))/(Port_Input1_N088+vec2(1.234e-06))),Port_Input1_N077);
vec4 l9_51=vec4(l9_40.x,l9_40.y,l9_40.z,vec4(0.0).w);
l9_51.w=l9_50;
#if (sc_BlendMode_AlphaTest)
{
if (l9_50<alphaTestThreshold)
{
discard;
}
}
...
{
if (l9_50<((mod(dot(floor(mod(gl_FragCoord.xy,vec2(4.0))),vec2(4.0,1.0))*9.0,16.0)+1.0)/17.0))
{
discard;
}
}
...
{
l9_55=clamp(dot(l9_51.xyz,vec3(l9_50)),0.0,1.0);
}
#else
{
float l9_56;
...
{
l9_57=(1.0-dot(l9_51.xyz,vec3(0.33333001)))*l9_50;
}
#else
{
float l9_58;
...
{
l9_58=(1.0-clamp(dot(l9_51.xyz,vec3(1.0)),0.0,1.0))*l9_50;
}
#else
{
float l9_59;
...
{
l9_59=clamp(dot(l9_51.xyz,vec3(1.0)),0.0,1.0)*l9_50;
}
#else
{
float l9_60;
#if (sc_BlendMode_Add)
{
l9_60=clamp(dot(l9_51.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_61;
#if (sc_BlendMode_AddWithAlphaFactor)
{
l9_61=clamp(dot(l9_51.xyz,vec3(1.0)),0.0,1.0)*l9_50;
}
#else
{
float l9_62;
...
{
l9_62=dot(l9_51.xyz,vec3(0.33333001))*l9_50;
}
#else
{
float l9_63;
#if (sc_BlendMode_Min)
{
l9_63=1.0-clamp(dot(l9_51.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_64;
#if (sc_BlendMode_Max)
{
l9_64=clamp(dot(l9_51.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
l9_64=1.0;
...
#endif
l9_52=vec4(mix(sc_ShadowColor.xyz,sc_ShadowColor.xyz*l9_51.xyz,vec3(sc_ShadowColor.w)),sc_ShadowDensity*l9_53);
}
#else
{
vec4 l9_65;
...
#if (sc_FramebufferFetch)
{
l9_67=sc_readFragData0_Platform();
}
#else
{
vec2 l9_68=sc_ScreenCoordsGlobalToView(l9_0);
int l9_69;
...
#endif
l9_67=texture2D(sc_ScreenTexture,sc_SamplingCoordsViewToGlobal(l9_68,sc_ScreenTextureLayout,l9_69).xy,0.0);
}
#endif
vec3 l9_70=mix(l9_67.xyz,definedBlend(l9_67.xyz,l9_51.xyz).xyz,vec3(l9_50));
vec4 l9_71=vec4(l9_70.x,l9_70.y,l9_70.z,vec4(0.0).w);
l9_71.w=1.0;
l9_66=l9_71;
}
#else
...
#if (sc_Voxelization)
{
l9_72=vec4(varScreenPos.xyz,1.0);
}
#else
{
vec4 l9_73;
#if (sc_OutputBounds)
{
float l9_74=clamp(abs(gl_FragCoord.z),0.0,1.0);
l9_73=vec4(l9_74,1.0-l9_74,1.0,1.0);
}
#else
{
vec4 l9_75;
#if (sc_BlendMode_MultiplyOriginal)
{
l9_75=vec4(mix(vec3(1.0),l9_51.xyz,vec3(l9_50)),l9_50);
}
#else
{
vec4 l9_76;
...
#endif
l9_76=vec4(l9_51.xyz*l9_77,l9_77);
}
#else
{
l9_76=l9_51;
...
vec4 l9_80=sc_OutputMotionVectorsIfNeeded(varPos,max(l9_78,vec4(0.0)));
...
sc_writeFragData0Internal(vec4(max(0.0,1.0-(l9_82-0.0039215689)),min(1.0,l9_82+0.0039215689),0.0,0.0),sc_UniformConstants.x,sc_ShaderCacheConstant);
}
#endif
}
#else
...
#if (sc_OITDepthGatherPass)
{
vec2 l9_83=sc_ScreenCoordsGlobalToView(l9_0);
...
sc_writeFragData0Internal(vec4(packValue(l9_84),packValue(l9_84),packValue(l9_84),packValue(l9_84)),sc_UniformConstants.x,sc_ShaderCacheConstant);
...
#if (sc_OITCompositingPass)
{
vec2 l9_96=sc_ScreenCoordsGlobalToView(l9_0);
#if (sc_OITMaxLayers4Plus1)
{
...
sc_writeFragData0Internal(l9_126,sc_UniformConstants.x,sc_ShaderCacheConstant);
#if (sc_OITMaxLayersVisualizeLayerCount)
{
discard;
}

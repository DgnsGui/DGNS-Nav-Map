...
float l9_80=step(length(vec2((vec2(dot(l9_71,l9_75))*Mask_Radius).x,(vec2(dot(l9_71,l9_79))*Mask_Radius).x)/(Port_Input1_N088+vec2(1.234e-06))),Port_Input1_N077);
vec4 l9_81=vec4(l9_70.x,l9_70.y,l9_70.z,vec4(0.0).w);
l9_81.w=l9_80;
...
#endif
sc_writeFragData0Internal(max(l9_82,vec4(0.0)),sc_UniformConstants.x,sc_ShaderCacheConstant);
return;
}
vec4 l9_84;
...
{
l9_87=clamp(dot(l9_81.xyz,vec3(l9_80)),0.0,1.0);
}
#else
{
float l9_88;
...
{
l9_89=(1.0-dot(l9_81.xyz,vec3(0.33333001)))*l9_80;
}
#else
{
float l9_90;
...
{
l9_90=(1.0-clamp(dot(l9_81.xyz,vec3(1.0)),0.0,1.0))*l9_80;
}
#else
{
float l9_91;
...
{
l9_91=clamp(dot(l9_81.xyz,vec3(1.0)),0.0,1.0)*l9_80;
}
#else
{
float l9_92;
#if (sc_BlendMode_Add)
{
l9_92=clamp(dot(l9_81.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_93;
#if (sc_BlendMode_AddWithAlphaFactor)
{
l9_93=clamp(dot(l9_81.xyz,vec3(1.0)),0.0,1.0)*l9_80;
}
#else
{
float l9_94;
...
{
l9_94=dot(l9_81.xyz,vec3(0.33333001))*l9_80;
}
#else
{
float l9_95;
#if (sc_BlendMode_Min)
{
l9_95=1.0-clamp(dot(l9_81.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_96;
#if (sc_BlendMode_Max)
{
l9_96=clamp(dot(l9_81.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
l9_96=1.0;
...
#endif
l9_84=vec4(mix(sc_ShadowColor.xyz,sc_ShadowColor.xyz*l9_81.xyz,vec3(sc_ShadowColor.w)),sc_ShadowDensity*l9_85);
}
#else
{
vec4 l9_97;
...
#if (sc_FramebufferFetch)
{
l9_99=sc_readFragData0_Platform();
}
#else
{
vec2 l9_100=sc_ScreenCoordsGlobalToView(gl_FragCoord.xy*sc_CurrentRenderTargetDims.zw);
vec4 l9_101;
#if (sc_ScreenTextureLayout==2)
{
l9_101=texture(sc_ScreenTextureArrSC,sc_SamplingCoordsViewToGlobal(l9_100,sc_ScreenTextureLayout,sc_ScreenTextureGetStereoViewIndex()),0.0);
}
#else
{
l9_101=texture(sc_ScreenTexture,sc_SamplingCoordsViewToGlobal(l9_100,sc_ScreenTextureLayout,sc_ScreenTextureGetStereoViewIndex()).xy,0.0);
}
#endif
l9_99=l9_101;
}
#endif
vec3 l9_102=mix(l9_99.xyz,definedBlend(l9_99.xyz,l9_81.xyz).xyz,vec3(l9_80));
vec4 l9_103=vec4(l9_102.x,l9_102.y,l9_102.z,vec4(0.0).w);
l9_103.w=1.0;
l9_98=l9_103;
}
#else
...
#if (sc_Voxelization)
{
l9_104=vec4(varScreenPos.xyz,1.0);
}
#else
{
vec4 l9_105;
#if (sc_OutputBounds)
{
float l9_106=clamp(abs(gl_FragCoord.z),0.0,1.0);
l9_105=vec4(l9_106,1.0-l9_106,1.0,1.0);
}
#else
{
vec4 l9_107;
#if (sc_BlendMode_MultiplyOriginal)
{
l9_107=vec4(mix(vec3(1.0),l9_81.xyz,vec3(l9_80)),l9_80);
}
#else
{
vec4 l9_108;
...
#endif
l9_108=vec4(l9_81.xyz*l9_109,l9_109);
}
#else
{
l9_108=l9_81;
...
vec4 l9_112=sc_OutputMotionVectorsIfNeeded(varPos,max(l9_110,vec4(0.0)));
vec4 l9_113=clamp(l9_112,vec4(0.0),vec4(1.0));
#if (sc_OITDepthBoundsPass)
{
#if (sc_OITDepthBoundsPass)
{
float l9_114=clamp(viewSpaceDepth()/1000.0,0.0,1.0);
sc_writeFragData0Internal(vec4(max(0.0,1.0-(l9_114-0.0039215689)),min(1.0,l9_114+0.0039215689),0.0,0.0),sc_UniformConstants.x,sc_ShaderCacheConstant);
}
#endif
}
#else
...
#endif
int l9_116=encodeDepth(viewSpaceDepth(),texture(sc_OITFilteredDepthBoundsTexture,l9_115).xy);
float l9_117=packValue(l9_116);
int l9_124=int(l9_113.w*255.0);
float l9_125=packValue(l9_124);
sc_writeFragData0Internal(vec4(packValue(l9_116),packValue(l9_116),packValue(l9_116),packValue(l9_116)),sc_UniformConstants.x,sc_ShaderCacheConstant);
sc_writeFragData1(vec4(l9_117,packValue(l9_116),packValue(l9_116),packValue(l9_116)));
sc_writeFragData2(vec4(l9_125,packValue(l9_124),packValue(l9_124),packValue(l9_124)));
...
#if (sc_OITCompositingPass)
{
vec2 l9_128=sc_ScreenCoordsGlobalToView(gl_FragCoord.xy*sc_CurrentRenderTargetDims.zw);
#if (sc_OITMaxLayers4Plus1)
{
if ((gl_FragCoord.z-texture(sc_OITFrontDepthTexture,l9_128).x)<=getFrontLayerZTestEpsilon())
{
discard;
}
}
...
if (l9_133==0)
{
l9_136=texture(sc_OITAlpha0,l9_128);
l9_135=texture(sc_OITDepthLow0,l9_128);
l9_134=texture(sc_OITDepthHigh0,l9_128);
}
else
{
l9_136=vec4(0.0);
...
if (l9_133==1)
{
l9_139=texture(sc_OITAlpha1,l9_128);
l9_138=texture(sc_OITDepthLow1,l9_128);
l9_137=texture(sc_OITDepthHigh1,l9_128);
}
else
{
l9_139=l9_136;
...
if (any(notEqual(l9_137,vec4(0.0)))||any(notEqual(l9_138,vec4(0.0))))
{
int l9_140[8]=l9_129;
unpackValues(l9_137.w,l9_133,l9_140);
unpackValues(l9_137.z,l9_133,l9_140);
unpackValues(l9_137.y,l9_133,l9_140);
unpackValues(l9_137.x,l9_133,l9_140);
unpackValues(l9_138.w,l9_133,l9_140);
unpackValues(l9_138.z,l9_133,l9_140);
unpackValues(l9_138.y,l9_133,l9_140);
unpackValues(l9_138.x,l9_133,l9_140);
int l9_149[8]=l9_130;
unpackValues(l9_139.w,l9_133,l9_149);
unpackValues(l9_139.z,l9_133,l9_149);
unpackValues(l9_139.y,l9_133,l9_149);
unpackValues(l9_139.x,l9_133,l9_149);
}
l9_133++;
continue;
}
...
vec4 l9_154=texture(sc_OITFilteredDepthBoundsTexture,l9_128);
vec2 l9_155=l9_154.xy;
int l9_156;
#if (sc_SkinBonesCount>0)
{
l9_156=encodeDepth(((1.0-l9_154.x)*1000.0)+getDepthOrderingEpsilon(),l9_155);
}
#else
{
l9_156=0;
...
#endif
int l9_157=encodeDepth(viewSpaceDepth(),l9_155);
vec4 l9_158;
l9_158=l9_113*l9_113.w;
vec4 l9_159;
int l9_160=0;
for (int snapLoopIndex=0; snapLoopIndex==0; snapLoopIndex+=0)
{
if (l9_160<8)
{
int l9_161=l9_129[l9_160];
int l9_162=l9_157-l9_156;
bool l9_163=l9_161<l9_162;
bool l9_164;
if (l9_163)
{
l9_164=l9_129[l9_160]>0;
}
else
{
l9_164=l9_163;
...
if (l9_164)
{
vec3 l9_165=l9_158.xyz*(1.0-(float(l9_130[l9_160])/255.0));
l9_159=vec4(l9_165.x,l9_165.y,l9_165.z,l9_158.w);
}
else
{
l9_159=l9_158;
...
#else
{
sc_writeFragData0Internal(l9_112,sc_UniformConstants.x,sc_ShaderCacheConstant);
}
#endif
}
#endif

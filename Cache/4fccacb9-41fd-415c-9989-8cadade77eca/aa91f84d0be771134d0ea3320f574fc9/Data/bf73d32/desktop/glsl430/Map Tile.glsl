...
#endif
sc_writeFragData0(max(l9_83,vec4(0.0)));
return;
}
vec4 l9_85;
...
vec4 l9_113=sc_OutputMotionVectorIfNeeded(max(l9_111,vec4(0.0)));
...
sc_writeFragData0(vec4(max(0.0,1.0-(l9_115-0.0039215689)),min(1.0,l9_115+0.0039215689),0.0,0.0));
}
#endif
}
#else
...
sc_writeFragData0(vec4(packValue(l9_117),packValue(l9_117),packValue(l9_117),packValue(l9_117)));
}
#endif
}
#else
...
sc_writeFragData0(l9_114);
}
#endif
}
#else
{
sc_writeFragData0(l9_113);
}
#endif
}
#endif

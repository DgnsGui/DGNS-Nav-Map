...
let TutorialAnimator = (() => {
    ...
    var TutorialAnimator = _classThis = class extends _classSuper {
        constructor() {
            ...
            this.isVisible = false; // false = caché, true = visible
            this.animating = false;
            this.animationProgress = 0;
            this.animatingToVisible = false; // direction de l'animation en cours
        ...
        initialize() {
            ...
            this.targetPosition = new vec3(this.initialPosition.x, this.initialPosition.y + this.moveDistanceY, this.initialPosition.z + this.moveDistanceZ);
            // État initial : caché
        ...
        updateAnimation() {
            ...
            if (this.animationProgress >= 1.0) {
                ...
                if (this.animatingToVisible) {
                    ...
                    this.isVisible = true;
                    if (this.enableDebugLogs)
                        log.i("Apparition terminée → container visible");
                }
                else {
                    ...
                    if (this.enableDebugLogs)
                        log.i("Disparition terminée → container caché");
                }
            }
        }

// TutorialAnimator.ts
// VERSION DÉFINITIVE – Fonctionne parfaitement dès le PREMIER pinch
// Container toujours activé, caché très loin en Z au départ
...
export class TutorialAnimator extends BaseScriptComponent {
  ...
  private initialize(): void {
    ...
    // === ÉTAT INITIAL ===
    this.targetObject.enabled = true                    // Toujours activé
    this.targetTransform.setLocalPosition(this.farHiddenPosition)  // Très loin = invisible
  ...
  public show(): void {
    ...
    this.animationStartPos = this.farHiddenPosition  // On part de très loin
  ...
  public hide(): void {
    ...
    this.animationEndPos = this.farHiddenPosition  // On renvoie très loin

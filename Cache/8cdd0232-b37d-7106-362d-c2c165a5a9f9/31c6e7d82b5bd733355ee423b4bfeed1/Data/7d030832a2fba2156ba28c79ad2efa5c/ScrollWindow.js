...
let ScrollWindow = (() => {
    ...
    var ScrollWindow = _classThis = class extends _classSuper {
        constructor() {
            super();
            // inputs
            this.vertical = this.vertical; // ← Réactivé : scroll vertical par défaut
            this.horizontal = this.horizontal; // ← Désactivé par défaut
            this.windowSize = this.windowSize; // Format carré par défaut (adapté vertical)
            this.scrollDimensions = this.scrollDimensions; // Hauteur > largeur = scroll vertical
            ...
            this.initialize = () => {
                ...
                if (this.vertical) {
                    const topPosition = new vec2(0, this.scrollDimensions.y * -0.5 + this.windowSize.y * 0.5);

...
let ScrollWindow = (() => {
    ...
    var ScrollWindow = _classThis = class extends _classSuper {
        constructor() {
            super();
            // inputs
            this.vertical = this.vertical; // ← Désactivé par défaut (scroll horizontal activé)
            this.horizontal = this.horizontal; // ← Activé par défaut
            this.windowSize = this.windowSize; // Largeur > hauteur pour horizontal
            this.scrollDimensions = this.scrollDimensions; // Contenu plus large
            ...
            this.colliderShape = Shape.createSphereShape();
            ...
            this.initialize = () => {
                ...
                this._interactable = this.sceneObject.getComponent(Interactable_1.Interactable.getTypeName()) || this.sceneObject.createComponent(Interactable_1.Interactable.getTypeName());
                ...
                if (this.horizontal) {
                    const leftPosition = new vec2(this.scrollDimensions.x * -0.5 + this.windowSize.x * 0.5, 0);
        ...
        getVisibleWindow() {
            const visibleWindow = { bottomLeft: vec2.zero(), topRight: vec2.zero() };
            const scrollerLocalPosition = this.scrollerTransform.getLocalPosition();

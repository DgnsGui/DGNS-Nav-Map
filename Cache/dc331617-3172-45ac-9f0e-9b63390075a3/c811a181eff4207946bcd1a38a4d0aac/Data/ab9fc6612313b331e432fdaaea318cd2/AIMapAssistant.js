...
Start your response with the exact location name (e.g., "You're in Hossegor..." or "You're in the village of...")`;
        ...
        callOpenAI(prompt) {
            this.displayLoading("📡Calculating your precise location...🛰️", true);
            const request = {
        ...
        handleChatResponse(response) {
            ...
            // Cacher le loading et afficher la réponse
            if (this.loadingText) {
        ...
        displayLoading(text, show) {
            if (this.loadingText) {
                ...
                this.loadingText.enabled = show;
            }
            else if (this.responseText) {
                // Fallback sur responseText si loadingText n'est pas assigné
                this.responseText.text = text;
            }
            if (this.aiResponseAnimator) {
                show ? this.aiResponseAnimator.animateIn() : this.aiResponseAnimator.animateOut();

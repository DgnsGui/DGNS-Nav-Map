...
import { AIResponseAnimator } from "./MapComponent/AIFrameAnimator"; // Assurez-vous que le chemin d'importation est correct, il pourrait varier selon votre structure de projet.

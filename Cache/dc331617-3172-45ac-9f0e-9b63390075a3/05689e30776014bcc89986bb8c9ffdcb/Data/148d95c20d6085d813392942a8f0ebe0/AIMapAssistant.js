...
// Essayez différents chemins selon votre structure
// Option 1: Si RemoteServiceGateway est au même niveau que MapComponent
const OpenAI = require("../RemoteServiceGateway/OpenAI");
const OpenAITypes = require("../RemoteServiceGateway/OpenAITypes");
// Option 2: Si dans Scripts root
// const OpenAI = require("../../RemoteServiceGateway/OpenAI");
// const OpenAITypes = require("../../RemoteServiceGateway/OpenAITypes");
...
Provide 2-3 brief, interesting insights about this geographical area. Keep your response under 100 words and conversational.`;
        ...
        callOpenAI(prompt) {
            ...
            OpenAI.OpenAI.chatCompletions(request)
                .then((response) => {
        ...
        generateAndPlayTTS(text) {
            ...
            OpenAI.OpenAI.speech(speechRequest)
                .then((audioTrack) => {

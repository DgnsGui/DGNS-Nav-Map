...
// @input AssignableType_1 aiResponseAnimator {"hint":"L'animateur de réponse AI pour contrôler les animations du container"}
// @input float estimatedAudioDuration = 5 {"hint":"Durée estimée de l'audio TTS (secondes) – à ajuster selon la longueur moyenne"}
...
awakeEvent.bind(() => {
    ...
    checkUndefined("estimatedAudioDuration", []);

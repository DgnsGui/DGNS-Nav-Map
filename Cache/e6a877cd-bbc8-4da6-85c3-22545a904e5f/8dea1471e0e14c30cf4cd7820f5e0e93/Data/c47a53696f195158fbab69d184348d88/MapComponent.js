...
let MapComponent = class MapComponent extends BaseScriptComponent {
    ...
    createMapPin(longitude, latitude) { const loc = GeoPosition.create(); loc.longitude = longitude; loc.latitude = latitude; return this.mapController.createMapPin(loc); }
    ...
    centerMap() { if (this.mapController)
        this.mapController.centerMap(); }
    showNeaybyPlaces(categoryName) { this.mapController.showNearbyPlaces(categoryName); }

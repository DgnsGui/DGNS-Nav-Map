...
let MapComponent = class MapComponent extends BaseScriptComponent {
    ...
    onStart() {
        ...
        // Setup auto-rotate toggle button if provided
    ...
    handleAutoRotateToggle(event) {
        ...
        if (this.mapController) {
            ...
            // Si l'auto-rotation est activée, centrer la carte sur l'utilisateur
            if (this.isMinimapAutoRotate) {
                this.mapController.centerMap();
            }
        }
        // Log for debugging
        print(`Minimap auto-rotate toggled: ${this.isMinimapAutoRotate}`);
        if (this.isMinimapAutoRotate) {
            print("Map centered on user for auto-rotation");
        }
    }

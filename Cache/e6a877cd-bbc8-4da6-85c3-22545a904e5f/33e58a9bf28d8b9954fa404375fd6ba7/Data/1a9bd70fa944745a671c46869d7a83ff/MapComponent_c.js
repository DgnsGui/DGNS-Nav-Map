...
// @input float placesClamVisibleY {"hint":"Position Y visible du container (position actuelle)"}
// @input float placesClamHiddenOffset = 30 {"hint":"Offset Y pour cacher le container (ex: 30 pour descendre)"}

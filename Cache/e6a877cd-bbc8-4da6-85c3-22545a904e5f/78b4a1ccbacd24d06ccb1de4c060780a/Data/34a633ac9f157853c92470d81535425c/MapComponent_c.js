...
// @input float placeItemSpacing = -5 {"hint":"Espacement vertical entre les items (-5 par défaut)"}
// @input float placesClamVisibleY = 15 {"hint":"Position Y visible du container (position actuelle)"}
// @input float placesClamHiddenOffset = -30 {"hint":"Offset Y pour cacher le container (ex: -30 pour monter)"}

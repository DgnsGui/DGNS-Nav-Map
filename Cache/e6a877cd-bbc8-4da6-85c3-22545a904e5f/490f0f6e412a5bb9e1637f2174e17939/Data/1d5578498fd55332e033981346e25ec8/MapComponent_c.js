...
// @input float scrollingFriction = 4 {"hint":"Contr̫le l'inertie de la carte"}
// @ui {"widget":"separator"}
...
// @input float fallbackPlacesCount = 10 {"hint":"Nombre de places placeholder si l'API ̩choue"}
// @input Component.ScriptComponent aiResponseAnimator {"hint":"Script qui anime le container de r̩ponse AI"}
// @input Component.ScriptComponent placesResponseAnimator {"hint":"Script qui anime le Places Clam"}

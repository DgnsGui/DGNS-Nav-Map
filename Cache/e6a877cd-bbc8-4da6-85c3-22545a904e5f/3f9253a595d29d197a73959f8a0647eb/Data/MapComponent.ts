...
export class MapComponent extends BaseScriptComponent {
  ...
  @input
  @hint("Contr̫le l'inertie de la carte")
  ...
  @input
  @hint("Nombre de places placeholder si l'API ̩choue")
  fallbackPlacesCount: number = 10;

  @input
  @hint("Script qui anime le container de r̩ponse AI")
  ...
  showNearybyPlaces(categoryName: string[]): void {

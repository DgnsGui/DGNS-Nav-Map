// --- START OF FILE MapMaskScaler_FinalDebug.ts (The Real Final Fix) ---
        ...
        for (const cell of cells) {
            if (cell && cell.imageComponent && cell.imageComponent.mainMaterial) {
                try {
                    ...
                    (cell.imageComponent.mainMaterial.mainPass as any)[this.parameterScriptName] = new vec2(value, value);
                } catch (e) {
                    if (this.debugMode) {

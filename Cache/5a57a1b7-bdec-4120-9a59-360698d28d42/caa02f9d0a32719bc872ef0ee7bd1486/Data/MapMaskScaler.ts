...
export class MapMaskScaler extends BaseScriptComponent {
    ...
    onStart() {
        // Créer l'event d'update dans onStart plutôt que onAwake
        const updateEvent = this.sceneObject.createComponent("Component.ScriptComponent");
        updateEvent.api.script = this.script;
        
        // Alternative plus directe
        this.script.createEvent("UpdateEvent").bind(this.onUpdate.bind(this));
    }

...
// @input AssignableType mapComponent {"hint":"Le MapComponent principal qui gère la carte"}
// @input string parameterScriptName = "Mask_Radius" {"hint":"Script Name du paramètre dans le Material Graph"}
// @input float baseMaskRadius = 1 {"hint":"Valeur de base du mask radius (doit correspondre au défaut dans le shader)"}
// @input float baseScale = 1 {"hint":"Scale de base du ContainerFrame"}
// @input bool debugMode {"hint":"Activer le mode debug pour voir les logs"}

...
float l9_29=l9_28;
vec3 l9_30=sc_SamplingCoordsViewToGlobal(vec2(l9_25,l9_27),opacityTextureLayout,l9_8);
vec4 l9_31=texture2D(opacityTexture,l9_30.xy,0.0);
vec4 l9_32;
#if (SC_USE_CLAMP_TO_BORDER_opacityTexture)
{
...
#endif
float l9_33=clamp((l9_6.w*l9_7.x)+0.001,Port_Input1_N058+0.001,Port_Input2_N058+0.001)-0.001;
vec4 l9_34=vec4(l9_6.x,l9_6.y,l9_6.z,vec4(0.0).w);
l9_34.w=l9_33;
#if (sc_BlendMode_AlphaTest)
{
if (l9_33<alphaTestThreshold)
{
discard;
}
}
...
{
if (l9_33<((mod(dot(floor(mod(gl_FragCoord.xy,vec2(4.0))),vec2(4.0,1.0))*9.0,16.0)+1.0)/17.0))
{
discard;
}
}
...
{
l9_38=clamp(dot(l9_34.xyz,vec3(l9_33)),0.0,1.0);
}
#else
{
float l9_39;
...
{
l9_40=(1.0-dot(l9_34.xyz,vec3(0.33333001)))*l9_33;
}
#else
{
float l9_41;
...
{
l9_41=(1.0-clamp(dot(l9_34.xyz,vec3(1.0)),0.0,1.0))*l9_33;
}
#else
{
float l9_42;
...
{
l9_42=clamp(dot(l9_34.xyz,vec3(1.0)),0.0,1.0)*l9_33;
}
#else
{
float l9_43;
#if (sc_BlendMode_Add)
{
l9_43=clamp(dot(l9_34.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_44;
#if (sc_BlendMode_AddWithAlphaFactor)
{
l9_44=clamp(dot(l9_34.xyz,vec3(1.0)),0.0,1.0)*l9_33;
}
#else
{
float l9_45;
...
{
l9_45=dot(l9_34.xyz,vec3(0.33333001))*l9_33;
}
#else
{
float l9_46;
#if (sc_BlendMode_Min)
{
l9_46=1.0-clamp(dot(l9_34.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_47;
#if (sc_BlendMode_Max)
{
l9_47=clamp(dot(l9_34.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
l9_47=1.0;
...
#endif
l9_35=vec4(mix(sc_ShadowColor.xyz,sc_ShadowColor.xyz*l9_34.xyz,vec3(sc_ShadowColor.w)),sc_ShadowDensity*l9_36);
}
#else
{
vec4 l9_48;
...
#if (sc_FramebufferFetch)
{
l9_50=sc_readFragData0_Platform();
}
#else
{
vec2 l9_51=sc_ScreenCoordsGlobalToView(l9_0);
int l9_52;
#if (sc_ScreenTextureHasSwappedViews)
{
l9_52=1-sc_GetStereoViewIndex();
}
#else
{
l9_52=sc_GetStereoViewIndex();
}
#endif
l9_50=texture2D(sc_ScreenTexture,sc_SamplingCoordsViewToGlobal(l9_51,sc_ScreenTextureLayout,l9_52).xy,0.0);
}
#endif
vec3 l9_53=mix(l9_50.xyz,definedBlend(l9_50.xyz,l9_34.xyz).xyz,vec3(l9_33));
...
#if (sc_Voxelization)
{
l9_55=vec4(varScreenPos.xyz,1.0);
}
#else
{
vec4 l9_56;
#if (sc_OutputBounds)
{
float l9_57=clamp(abs(gl_FragCoord.z),0.0,1.0);
l9_56=vec4(l9_57,1.0-l9_57,1.0,1.0);
}
#else
{
vec4 l9_58;
#if (sc_BlendMode_MultiplyOriginal)
{
l9_58=vec4(mix(vec3(1.0),l9_34.xyz,vec3(l9_33)),l9_33);
}
#else
{
vec4 l9_59;
...
#endif
l9_59=vec4(l9_34.xyz*l9_60,l9_60);
}
#else
{
l9_59=l9_34;
...
vec4 l9_63=sc_OutputMotionVectorsIfNeeded(varPos,max(l9_61,vec4(0.0)));
vec4 l9_64=clamp(l9_63,vec4(0.0),vec4(1.0));
#if (sc_OITDepthBoundsPass)
{
#if (sc_OITDepthBoundsPass)
{
float l9_65=clamp(viewSpaceDepth()/1000.0,0.0,1.0);
sc_writeFragData0Internal(vec4(max(0.0,1.0-(l9_65-0.0039215689)),min(1.0,l9_65+0.0039215689),0.0,0.0),sc_UniformConstants.x,sc_ShaderCacheConstant);
}
#endif
}
#else
...
#if (sc_OITDepthGatherPass)
{
vec2 l9_66=sc_ScreenCoordsGlobalToView(l9_0);
#if (sc_OITMaxLayers4Plus1)
{
if ((gl_FragCoord.z-texture2D(sc_OITFrontDepthTexture,l9_66).x)<=getFrontLayerZTestEpsilon())
{
discard;
}
}
#endif
int l9_67=encodeDepth(viewSpaceDepth(),texture2D(sc_OITFilteredDepthBoundsTexture,l9_66).xy);
float l9_68=packValue(l9_67);
int l9_75=int(l9_64.w*255.0);
float l9_76=packValue(l9_75);
sc_writeFragData0Internal(vec4(packValue(l9_67),packValue(l9_67),packValue(l9_67),packValue(l9_67)),sc_UniformConstants.x,sc_ShaderCacheConstant);
sc_writeFragData1(vec4(l9_68,packValue(l9_67),packValue(l9_67),packValue(l9_67)));
sc_writeFragData2(vec4(l9_76,packValue(l9_75),packValue(l9_75),packValue(l9_75)));
...
#if (sc_OITCompositingPass)
{
vec2 l9_79=sc_ScreenCoordsGlobalToView(l9_0);
#if (sc_OITMaxLayers4Plus1)
{
if ((gl_FragCoord.z-texture2D(sc_OITFrontDepthTexture,l9_79).x)<=getFrontLayerZTestEpsilon())
{
discard;
}
}
...
if (l9_84==0)
{
l9_87=texture2D(sc_OITAlpha0,l9_79);
l9_86=texture2D(sc_OITDepthLow0,l9_79);
l9_85=texture2D(sc_OITDepthHigh0,l9_79);
}
else
{
l9_87=vec4(0.0);
...
if (l9_84==1)
{
l9_90=texture2D(sc_OITAlpha1,l9_79);
l9_89=texture2D(sc_OITDepthLow1,l9_79);
l9_88=texture2D(sc_OITDepthHigh1,l9_79);
}
else
{
l9_90=l9_87;
...
if (any(notEqual(l9_88,vec4(0.0)))||any(notEqual(l9_89,vec4(0.0))))
{
int l9_91[8]=l9_80;
unpackValues(l9_88.w,l9_84,l9_91);
unpackValues(l9_88.z,l9_84,l9_91);
unpackValues(l9_88.y,l9_84,l9_91);
unpackValues(l9_88.x,l9_84,l9_91);
unpackValues(l9_89.w,l9_84,l9_91);
unpackValues(l9_89.z,l9_84,l9_91);
unpackValues(l9_89.y,l9_84,l9_91);
unpackValues(l9_89.x,l9_84,l9_91);
int l9_100[8]=l9_81;
unpackValues(l9_90.w,l9_84,l9_100);
unpackValues(l9_90.z,l9_84,l9_100);
unpackValues(l9_90.y,l9_84,l9_100);
unpackValues(l9_90.x,l9_84,l9_100);
}
l9_84++;
continue;
}
...
vec4 l9_105=texture2D(sc_OITFilteredDepthBoundsTexture,l9_79);
vec2 l9_106=l9_105.xy;
int l9_107;
#if (sc_SkinBonesCount>0)
{
l9_107=encodeDepth(((1.0-l9_105.x)*1000.0)+getDepthOrderingEpsilon(),l9_106);
}
#else
{
l9_107=0;
...
#endif
int l9_108=encodeDepth(viewSpaceDepth(),l9_106);
vec4 l9_109;
l9_109=l9_64*l9_64.w;
vec4 l9_110;
int l9_111=0;
for (int snapLoopIndex=0; snapLoopIndex==0; snapLoopIndex+=0)
{
if (l9_111<8)
{
int l9_112=l9_80[l9_111];
int l9_113=l9_108-l9_107;
bool l9_114=l9_112<l9_113;
bool l9_115;
if (l9_114)
{
l9_115=l9_80[l9_111]>0;
}
else
{
l9_115=l9_114;
...
if (l9_115)
{
vec3 l9_116=l9_109.xyz*(1.0-(float(l9_81[l9_111])/255.0));
l9_110=vec4(l9_116.x,l9_116.y,l9_116.z,l9_109.w);
}
else
{
l9_110=l9_109;
...
sc_writeFragData0Internal(l9_64,sc_UniformConstants.x,sc_ShaderCacheConstant);
}
#endif
}
#else
{
sc_writeFragData0Internal(l9_63,sc_UniformConstants.x,sc_ShaderCacheConstant);
}
#endif
}
#endif

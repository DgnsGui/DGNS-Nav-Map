...
export class MapUIController extends BaseScriptComponent {
  ...
  private onStart() {
    ...
    if (this.askAIButton) {
      this.askAIButton.onButtonPinched.add(
        this.handleAskAIButtonPinched.bind(this)
      );
  ...
  private handleAskAIButtonPinched(event: InteractorEvent) {
    log.i("====================================");
...
Maintenant compilez et testez. Quand vous cliquez sur "Ask AI", vous devriez voir dans la console Logger (en bas à gauche) :
```
====================================
ASK AI BUTTON PRESSED!
====================================
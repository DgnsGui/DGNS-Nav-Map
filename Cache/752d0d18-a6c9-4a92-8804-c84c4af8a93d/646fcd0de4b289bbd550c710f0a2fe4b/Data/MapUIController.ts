// --- START OF FILE MapUIController.ts (FINAL CORRECTED VERSION) ---
...
export class MapUIController extends BaseScriptComponent {
  ...
  // --- CORRECTIONS DES FAUTES DE FRAPPE CI-DESSOUS ---
  private handleShowCafeButtonPinched(event: InteractorEvent) {
    this.mapComponent.showNearbyPlaces(["Cafe"]);
  }

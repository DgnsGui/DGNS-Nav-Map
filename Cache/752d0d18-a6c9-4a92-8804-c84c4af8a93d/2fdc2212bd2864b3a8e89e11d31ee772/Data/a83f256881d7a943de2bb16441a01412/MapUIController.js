...
let MapUIController = class MapUIController extends BaseScriptComponent {
    ...
    // Left side button handlers - MODIFIED: Using null for testing
    ...
    handleShowSnacksButtonPinched(event) {
        ...
        this.searchNearbyPlaces(null, "Snacks (All Places)");
    }
    handleShowShopsButtonPinched(event) {
        log.i("=== SHOW SHOPS BUTTON PRESSED ===");
        log.i("Testing with null categories - will filter results programmatically later");
        this.searchNearbyPlaces(null, "Shops (All Places)");
    }
    // Original category button handlers - MODIFIED: Using null for testing

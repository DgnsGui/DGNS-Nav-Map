    ...
    handleScrollUpdate(localPosition) {
        if (this.config.horizontalScrollingEnabled ||
            ...
            if (this.isScrolling) {
                ...
                const touchOffsetFromInitialTouch = this.getPositionWithMapRotationOffset(localPosition.sub(this.initialLocalTouchPosition));
                ...
                const touchOffsetFromLastTouch = this.getPositionWithMapRotationOffset(localPosition.sub(this.lastTouchPosition));

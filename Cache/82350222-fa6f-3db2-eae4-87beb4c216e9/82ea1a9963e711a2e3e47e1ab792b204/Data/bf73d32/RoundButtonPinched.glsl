...
uniform NF_PRECISION float4 Port_Value0_N030;
uniform NF_PRECISION float Port_Position1_N030;
uniform NF_PRECISION float4 Port_Value1_N030;
uniform NF_PRECISION float4 Port_Value2_N030;
...
void Node30_Gradient( in float Ratio, in float4 Value0, in float Position1, in float4 Value1, in float4 Value2, out float4 Value, ssGlobals Globals )
{ 
...
void main() 
{
	...
	
	{
		...
		float4 Value_N30 = float4(0.0); Node30_Gradient( Output_N14, NF_PORT_CONSTANT( float4( 1.0, 0.879988, 0.4, 1.0 ), Port_Value0_N030 ), NF_PORT_CONSTANT( float( 0.0 ), Port_Position1_N030 ), NF_PORT_CONSTANT( float4( 0.500008, 0.437507, 0.250004, 1.0 ), Port_Value1_N030 ), NF_PORT_CONSTANT( float4( 0.500008, 0.450004, 0.2, 1.0 ), Port_Value2_N030 ), Value_N30, Globals );
		float Rim_N31 = 0.0; Node31_Rim( NF_PORT_CONSTANT( float3( 0.0, 0.0, 1.0 ), Port_Normal_N031 ), NF_PORT_CONSTANT( float( 0.6 ), Port_Exponent_N031 ), NF_PORT_CONSTANT( float( 1.0 ), Port_Intensity_N031 ), Rim_N31, Globals );
		float4 Output_N34 = float4(0.0); Node34_Mix( Value_N30, NF_PORT_CONSTANT( float4( 1.0, 0.890852, 0.345098, 1.0 ), Port_Input1_N034 ), Rim_N31, Output_N34, Globals );
		float3 Value1_N23 = float3(0.0); float Value2_N23 = 0.0; Node23_Split_Vector( Output_N34, Value1_N23, Value2_N23, Globals );

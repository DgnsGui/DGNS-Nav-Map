...
varColor=color;
vec4 l9_7=sc_ViewProjectionMatrixArray[sc_GetStereoViewIndex()]*vec4(varPosAndMotion.xyz,1.0);
ssGlobals l9_8=ssGlobals(sc_Time.x,sc_Time.y,0.0,(sc_ModelMatrixInverse*vec4(varPosAndMotion.xyz,1.0)).xyz,varNormalAndMotion.xyz,normalize((sc_ModelMatrixInverse*vec4(varNormalAndMotion.xyz,0.0)).xyz),vec2(0.0),varPosAndMotion.xyz,((l9_7.xyz/vec3(l9_7.w)).xy*0.5)+vec2(0.5));
vec3 l9_9;
#if (Tweak_N75&&Tweak_N76)
{
vec3 l9_10;
Node121_Conditional(0.0,vec3(1.0),vec3(0.0),l9_10,l9_8);
float l9_11;
#if (Tweak_N130)
{
float l9_12;
Node10_If_else(0.0,0.0,0.0,l9_12,l9_8);
float l9_13=l9_12;
vec2 l9_14;
Node86_Conditional(1.0,vec2(1.0),vec2(0.0),l9_14,l9_8);
float l9_15;
Node77_Loop_Triplanar_UV(0.0,vec3(0.0),vec3(0.0,1.0,0.0),vec3(1.0),vec3(0.0),1.0,l9_15,l9_8);
float l9_16=l9_15;
float l9_17=l9_16*Port_Input1_N122;
float l9_18;
if (l9_17<=0.0)
{
l9_18=0.0;
...
{
l9_18=pow(l9_17,Port_Input1_N125);
}
l9_11=clamp((float(fract(thickLines*(l9_13-l9_14.y))<(1.0-(Port_Input0_N129-randScale)))*l9_18)+0.001,Port_Input1_N126+0.001,Port_Input2_N126+0.001)-0.001;
}
#else
{
float l9_19;
Node10_If_else(0.0,0.0,0.0,l9_19,l9_8);
float l9_20=l9_19;
vec2 l9_21;
Node86_Conditional(1.0,vec2(1.0),vec2(0.0),l9_21,l9_8);
float l9_22;
Node77_Loop_Triplanar_UV(0.0,vec3(0.0),vec3(0.0,1.0,0.0),vec3(1.0),vec3(0.0),1.0,l9_22,l9_8);
float l9_23=l9_22;
float l9_24=l9_23*Port_Input1_N122;
float l9_25;
if (l9_24<=0.0)
{
l9_25=0.0;
...
{
l9_25=pow(l9_24,Port_Input1_N125);
}
l9_11=1.0-(clamp((float(fract(thickLines*(l9_20-l9_21.y))<(1.0-(Port_Input0_N129-randScale)))*l9_25)+0.001,Port_Input1_N126+0.001,Port_Input2_N126+0.001)-0.001);
}
#endif
l9_9=mix((sc_ModelMatrix*vec4(l9_10,1.0)).xyz,varPosAndMotion.xyz,vec3(l9_11));
}
#else
{
vec3 l9_26;
...
{
vec3 l9_27;
Node121_Conditional(0.0,vec3(1.0),vec3(0.0),l9_27,l9_8);
l9_26=(sc_ModelMatrix*vec4(l9_27,1.0)).xyz;
}
#else
{
l9_26=varPosAndMotion.xyz;
}
#endif
l9_9=l9_26;
}
...
l9_29=varNormalAndMotion.xyz;
l9_28=varPosAndMotion.xyz;
}
else
{
l9_30=varTangent.xyz;
...
vec3 l9_31=normalize(l9_29);
varNormalAndMotion=vec4(l9_31.x,l9_31.y,l9_31.z,varNormalAndMotion.w);
vec3 l9_32=normalize(l9_30);
...
#if (sc_RenderingSpace==2)
{
l9_38=sc_ViewProjectionMatrixArray[sc_GetStereoViewIndex()]*vec4(varPosAndMotion.xyz,1.0);
}
#else
{
vec4 l9_39;
#if (sc_RenderingSpace==1)
{
l9_39=sc_ViewProjectionMatrixArray[sc_GetStereoViewIndex()]*vec4(varPosAndMotion.xyz,1.0);
}
#else
{
l9_39=vec4(0.0);
...
#if (sc_Voxelization)
{
sc_Vertex_t l9_47=sc_Vertex_t(l9_0.position,l9_0.normal,l9_0.tangent,l9_5,l9_0.texture1);
...
#if (sc_OutputBounds)
{
sc_Vertex_t l9_51=sc_Vertex_t(l9_0.position,l9_0.normal,l9_0.tangent,l9_5,l9_0.texture1);
sc_BlendVertex(l9_51);
sc_SkinVertex(l9_51);
vec2 l9_52=((l9_51.position.xy/vec2(l9_51.position.w))*0.5)+vec2(0.5);
varTex01=vec4(l9_52.x,l9_52.y,varTex01.z,varTex01.w);
...
vec3 l9_55=normalize(l9_51.normal);
varNormalAndMotion=vec4(l9_55.x,l9_55.y,l9_55.z,varNormalAndMotion.w);
vec4 l9_56=createVoxelOrthoMatrix(voxelization_params_frustum_lrbt.x,voxelization_params_frustum_lrbt.y,voxelization_params_frustum_lrbt.z,voxelization_params_frustum_lrbt.w,voxelization_params_frustum_nf.x,voxelization_params_frustum_nf.y)*vec4(l9_54.x,l9_54.y,l9_54.z,l9_53.w);
vec4 l9_57=vec4(l9_56.x,l9_56.y,l9_56.z,vec4(0.0).w);
l9_57.w=1.0;
varScreenPos=l9_57;
sc_SetClipPosition(l9_57*1.0);
}
#endif
}
#endif
vec4 l9_58=varPosAndMotion;
#if (sc_MotionVectorsPass)
{
vec4 l9_59=vec4(l9_58.xyz,1.0);
#if (sc_MotionVectorsPass)
{
vec4 l9_60=sc_ViewProjectionMatrixArray[sc_GetStereoViewIndex()]*l9_59;
vec4 l9_61=sc_PrevFrameViewProjectionMatrixArray[sc_GetStereoViewIndex()]*vec4(((sc_PrevFrameModelMatrix*sc_ModelMatrixInverse)*l9_59).xyz,1.0);
vec2 l9_62=((l9_60.xy/vec2(l9_60.w)).xy-(l9_61.xy/vec2(l9_61.w)).xy)*0.5;
varPosAndMotion.w=l9_62.x;
varNormalAndMotion.w=l9_62.y;
}
#endif
}
#endif
...
#else
{
l9_4=(sc_ModelMatrixInverse*vec4(varPosAndMotion.xyz,1.0)).xy;
}
#endif
float l9_5=l9_2-l9_4.y;
vec4 l9_6=(((thicklinesColor*vec4(Port_Input1_N020))*vec4(fract(thickLines*l9_5)))+((vec4(fract(l9_4.y*thinLines))*vec4(Port_Input1_N049))*thinlinesColor))+(vec4(1.0-clamp(dot(normalize(sc_Camera.position-varPosAndMotion.xyz),normalize(varNormalAndMotion.xyz)),0.0,1.0))*rimTint);
vec4 l9_7;
#if (Tweak_N12)
{
vec4 l9_8;
...
vec4 l9_87=sc_OutputMotionVectorIfNeeded(max(l9_85,vec4(0.0)));
...
sc_writeFragData0(vec4(max(0.0,1.0-(l9_89-0.0039215689)),min(1.0,l9_89+0.0039215689),0.0,0.0));
}
#endif
}
#else
...
sc_writeFragData0(vec4(packValue(l9_91),packValue(l9_91),packValue(l9_91),packValue(l9_91)));
}
#endif
}
#else

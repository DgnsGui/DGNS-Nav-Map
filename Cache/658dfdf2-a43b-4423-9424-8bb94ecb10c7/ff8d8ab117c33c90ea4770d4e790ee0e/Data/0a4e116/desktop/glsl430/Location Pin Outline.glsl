...
{
vec3 l9_2=varPos-Tweak_N10;
vec3 l9_3=cross(l9_0,vec3(Port_Value1_N082,Port_Value2_N082,Port_Value3_N082));
...
vec3 l9_6=l9_3*l9_5;
vec3 l9_7=cross(l9_0,l9_6);
float l9_8=dot(l9_7,l9_7);
float l9_9;
if (l9_8>0.0)
{
l9_9=1.0/sqrt(l9_8);
...
l9_1=step(length(vec2(dot(l9_2,l9_6)*Mask_Radius,dot(l9_2,l9_7*l9_9)*Mask_Radius)/(Port_Input1_N088+vec2(1.234e-06))),Port_Input1_N021);
}
else
{
vec3 l9_10=varPos-cornerPosition;
float l9_11=dot(verticalVector,l9_10);
float l9_12=dot(l9_10,horizontalVector);
l9_1=min(min(min(step(Port_Input0_N047,l9_11),step(l9_11,dot(verticalVector,verticalVector))),step(Port_Input0_N072,l9_12)),step(l9_12,dot(horizontalVector,horizontalVector)));
}
vec4 l9_13;
#if (baseTexLayout==2)
{
bool l9_14=(int(SC_USE_CLAMP_TO_BORDER_baseTex)!=0)&&(!(int(SC_USE_UV_MIN_MAX_baseTex)!=0));
float l9_15=varPackedTex.x;
sc_SoftwareWrapEarly(l9_15,ivec2(SC_SOFTWARE_WRAP_MODE_U_baseTex,SC_SOFTWARE_WRAP_MODE_V_baseTex).x);
float l9_16=l9_15;
float l9_17=varPackedTex.y;
...
#endif
float l9_62=min(l9_1,l9_13.w);
vec4 l9_63=vec4(lineColor.x,lineColor.y,lineColor.z,vec4(0.0).w);
l9_63.w=l9_62;
...
{
l9_67=clamp(dot(l9_63.xyz,vec3(l9_62)),0.0,1.0);
}
#else
{
float l9_68;
...
{
l9_69=(1.0-dot(l9_63.xyz,vec3(0.33333001)))*l9_62;
}
#else
{
float l9_70;
...
{
l9_70=(1.0-clamp(dot(l9_63.xyz,vec3(1.0)),0.0,1.0))*l9_62;
}
#else
{
float l9_71;
...
{
l9_71=clamp(dot(l9_63.xyz,vec3(1.0)),0.0,1.0)*l9_62;
}
#else
{
float l9_72;
#if (sc_BlendMode_Add)
{
l9_72=clamp(dot(l9_63.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_73;
#if (sc_BlendMode_AddWithAlphaFactor)
{
l9_73=clamp(dot(l9_63.xyz,vec3(1.0)),0.0,1.0)*l9_62;
}
#else
{
float l9_74;
...
{
l9_74=dot(l9_63.xyz,vec3(0.33333001))*l9_62;
}
#else
{
float l9_75;
#if (sc_BlendMode_Min)
{
l9_75=1.0-clamp(dot(l9_63.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_76;
#if (sc_BlendMode_Max)
{
l9_76=clamp(dot(l9_63.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
l9_76=1.0;
...
#endif
l9_64=vec4(mix(sc_ShadowColor.xyz,sc_ShadowColor.xyz*l9_63.xyz,vec3(sc_ShadowColor.w)),sc_ShadowDensity*l9_65);
}
#else
{
vec4 l9_77;
...
#if (sc_FramebufferFetch)
{
l9_79=sc_readFragData0_Platform();
}
#else
{
...
{
l9_81=texture(sc_ScreenTextureArrSC,sc_SamplingCoordsViewToGlobal(l9_80,sc_ScreenTextureLayout,sc_ScreenTextureGetStereoViewIndex()),0.0);
}
#else
{
l9_81=texture(sc_ScreenTexture,sc_SamplingCoordsViewToGlobal(l9_80,sc_ScreenTextureLayout,sc_ScreenTextureGetStereoViewIndex()).xy,0.0);
}
#endif
l9_79=l9_81;
}
#endif
vec3 l9_82=mix(l9_79.xyz,definedBlend(l9_79.xyz,l9_63.xyz).xyz,vec3(l9_62));
...
#if (sc_Voxelization)
{
l9_84=vec4(varScreenPos.xyz,1.0);
}
#else
{
vec4 l9_85;
#if (sc_OutputBounds)
{
float l9_86=clamp(abs(gl_FragCoord.z),0.0,1.0);
l9_85=vec4(l9_86,1.0-l9_86,1.0,1.0);
}
#else
{
vec4 l9_87;
#if (sc_BlendMode_MultiplyOriginal)
{
l9_87=vec4(mix(vec3(1.0),l9_63.xyz,vec3(l9_62)),l9_62);
}
#else
{
vec4 l9_88;
...
#endif
l9_88=vec4(l9_63.xyz*l9_89,l9_89);
}
#else
{
l9_88=l9_63;
...
vec4 l9_92=sc_OutputMotionVectorsIfNeeded(varPos,max(l9_90,vec4(0.0)));

...
#endif
float l9_49=min(Port_Input0_N009,l9_0.w);
vec4 l9_50=vec4(lineColor.x,lineColor.y,lineColor.z,vec4(0.0).w);
l9_50.w=l9_49;
...
{
l9_54=clamp(dot(l9_50.xyz,vec3(l9_49)),0.0,1.0);
}
#else
{
float l9_55;
...
{
l9_56=(1.0-dot(l9_50.xyz,vec3(0.33333001)))*l9_49;
}
#else
{
float l9_57;
...
{
l9_57=(1.0-clamp(dot(l9_50.xyz,vec3(1.0)),0.0,1.0))*l9_49;
}
#else
{
float l9_58;
...
{
l9_58=clamp(dot(l9_50.xyz,vec3(1.0)),0.0,1.0)*l9_49;
}
#else
{
float l9_59;
#if (sc_BlendMode_Add)
{
l9_59=clamp(dot(l9_50.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_60;
#if (sc_BlendMode_AddWithAlphaFactor)
{
l9_60=clamp(dot(l9_50.xyz,vec3(1.0)),0.0,1.0)*l9_49;
}
#else
{
float l9_61;
...
{
l9_61=dot(l9_50.xyz,vec3(0.33333001))*l9_49;
}
#else
{
float l9_62;
#if (sc_BlendMode_Min)
{
l9_62=1.0-clamp(dot(l9_50.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_63;
#if (sc_BlendMode_Max)
{
l9_63=clamp(dot(l9_50.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
l9_63=1.0;
...
#endif
l9_51=vec4(mix(sc_ShadowColor.xyz,sc_ShadowColor.xyz*l9_50.xyz,vec3(sc_ShadowColor.w)),sc_ShadowDensity*l9_52);
}
#else
{
vec4 l9_64;
...
#if (sc_FramebufferFetch)
{
l9_66=sc_readFragData0_Platform();
}
#else
{
...
{
l9_68=texture(sc_ScreenTextureArrSC,sc_SamplingCoordsViewToGlobal(l9_67,sc_ScreenTextureLayout,sc_ScreenTextureGetStereoViewIndex()),0.0);
}
#else
{
l9_68=texture(sc_ScreenTexture,sc_SamplingCoordsViewToGlobal(l9_67,sc_ScreenTextureLayout,sc_ScreenTextureGetStereoViewIndex()).xy,0.0);
}
#endif
l9_66=l9_68;
}
#endif
vec3 l9_69=mix(l9_66.xyz,definedBlend(l9_66.xyz,l9_50.xyz).xyz,vec3(l9_49));
vec4 l9_70=vec4(l9_69.x,l9_69.y,l9_69.z,vec4(0.0).w);
l9_70.w=1.0;
l9_65=l9_70;
}
#else
...
#if (sc_Voxelization)
{
l9_71=vec4(varScreenPos.xyz,1.0);
}
#else
{
vec4 l9_72;
#if (sc_OutputBounds)
{
float l9_73=clamp(abs(gl_FragCoord.z),0.0,1.0);
l9_72=vec4(l9_73,1.0-l9_73,1.0,1.0);
}
#else
{
vec4 l9_74;
#if (sc_BlendMode_MultiplyOriginal)
{
l9_74=vec4(mix(vec3(1.0),l9_50.xyz,vec3(l9_49)),l9_49);
}
#else
{
vec4 l9_75;
...
#endif
l9_75=vec4(l9_50.xyz*l9_76,l9_76);
}
#else
{
l9_75=l9_50;
...
vec4 l9_79=sc_OutputMotionVectorsIfNeeded(varPos,max(l9_77,vec4(0.0)));
vec4 l9_80=clamp(l9_79,vec4(0.0),vec4(1.0));
#if (sc_OITDepthBoundsPass)
{
#if (sc_OITDepthBoundsPass)
{
float l9_81=clamp(viewSpaceDepth()/1000.0,0.0,1.0);
sc_writeFragData0Internal(vec4(max(0.0,1.0-(l9_81-0.0039215689)),min(1.0,l9_81+0.0039215689),0.0,0.0),sc_UniformConstants.x,sc_ShaderCacheConstant);
}
#endif
}
#else
...
#if (sc_OITDepthGatherPass)
{
vec2 l9_82=sc_ScreenCoordsGlobalToView(gl_FragCoord.xy*sc_CurrentRenderTargetDims.zw);
#if (sc_OITMaxLayers4Plus1)
{
if ((gl_FragCoord.z-texture(sc_OITFrontDepthTexture,l9_82).x)<=getFrontLayerZTestEpsilon())
{
discard;
}
}
#endif
int l9_83=encodeDepth(viewSpaceDepth(),texture(sc_OITFilteredDepthBoundsTexture,l9_82).xy);
float l9_84=packValue(l9_83);
int l9_91=int(l9_80.w*255.0);
float l9_92=packValue(l9_91);
sc_writeFragData0Internal(vec4(packValue(l9_83),packValue(l9_83),packValue(l9_83),packValue(l9_83)),sc_UniformConstants.x,sc_ShaderCacheConstant);
sc_writeFragData1(vec4(l9_84,packValue(l9_83),packValue(l9_83),packValue(l9_83)));
sc_writeFragData2(vec4(l9_92,packValue(l9_91),packValue(l9_91),packValue(l9_91)));
...
#if (sc_OITCompositingPass)
{
vec2 l9_95=sc_ScreenCoordsGlobalToView(gl_FragCoord.xy*sc_CurrentRenderTargetDims.zw);
#if (sc_OITMaxLayers4Plus1)
{
...
if (l9_100==0)
{
l9_103=texture(sc_OITAlpha0,l9_95);
l9_102=texture(sc_OITDepthLow0,l9_95);
l9_101=texture(sc_OITDepthHigh0,l9_95);
}
else
{
l9_103=vec4(0.0);
...
if (l9_100==1)
{
l9_106=texture(sc_OITAlpha1,l9_95);
l9_105=texture(sc_OITDepthLow1,l9_95);
l9_104=texture(sc_OITDepthHigh1,l9_95);
}
else
{
l9_106=l9_103;
...
if (any(notEqual(l9_104,vec4(0.0)))||any(notEqual(l9_105,vec4(0.0))))
{
int l9_107[8]=l9_96;
unpackValues(l9_104.w,l9_100,l9_107);
unpackValues(l9_104.z,l9_100,l9_107);
unpackValues(l9_104.y,l9_100,l9_107);
unpackValues(l9_104.x,l9_100,l9_107);
unpackValues(l9_105.w,l9_100,l9_107);
unpackValues(l9_105.z,l9_100,l9_107);
unpackValues(l9_105.y,l9_100,l9_107);
unpackValues(l9_105.x,l9_100,l9_107);
int l9_116[8]=l9_97;
unpackValues(l9_106.w,l9_100,l9_116);
unpackValues(l9_106.z,l9_100,l9_116);
unpackValues(l9_106.y,l9_100,l9_116);
unpackValues(l9_106.x,l9_100,l9_116);
}
l9_100++;
continue;
}
...
vec4 l9_121=texture(sc_OITFilteredDepthBoundsTexture,l9_95);
vec2 l9_122=l9_121.xy;
int l9_123;
#if (sc_SkinBonesCount>0)
{
l9_123=encodeDepth(((1.0-l9_121.x)*1000.0)+getDepthOrderingEpsilon(),l9_122);
}
#else
{
l9_123=0;
...
#endif
int l9_124=encodeDepth(viewSpaceDepth(),l9_122);
vec4 l9_125;
l9_125=l9_80*l9_80.w;
vec4 l9_126;
int l9_127=0;
for (int snapLoopIndex=0; snapLoopIndex==0; snapLoopIndex+=0)
{
if (l9_127<8)
{
int l9_128=l9_96[l9_127];
int l9_129=l9_124-l9_123;
bool l9_130=l9_128<l9_129;
bool l9_131;
if (l9_130)
{
l9_131=l9_96[l9_127]>0;
}
else
{
l9_131=l9_130;
...
if (l9_131)
{
vec3 l9_132=l9_125.xyz*(1.0-(float(l9_97[l9_127])/255.0));
l9_126=vec4(l9_132.x,l9_132.y,l9_132.z,l9_125.w);
}
else
{
l9_126=l9_125;
...
sc_writeFragData0Internal(l9_125,sc_UniformConstants.x,sc_ShaderCacheConstant);
#if (sc_OITMaxLayersVisualizeLayerCount)
{
discard;
}
...
#else
{
sc_writeFragData0Internal(l9_79,sc_UniformConstants.x,sc_ShaderCacheConstant);
}
#endif
}
#endif

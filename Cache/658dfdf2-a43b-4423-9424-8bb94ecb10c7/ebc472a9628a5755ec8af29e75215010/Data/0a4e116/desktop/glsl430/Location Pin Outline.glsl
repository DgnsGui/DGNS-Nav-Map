...
//spec_const int intensityTextureLayout 73 0
//spec_const int sc_DepthBufferMode 74 0
//spec_const int sc_RenderingSpace 75 -1
//spec_const int sc_ScreenTextureLayout 76 0
//spec_const int sc_ShaderCacheConstant 77 0
//spec_const int sc_SkinBonesCount 78 0
//spec_const int sc_StereoRenderingMode 79 0
//spec_const int sc_StereoRendering_IsClipDistanceEnabled 80 0
//spec_const int sc_StereoViewID 81 0
//SG_REFLECTION_END
...
vec3 l9_9=l9_6*l9_8;
float l9_10=step(length(vec2(dot(l9_1,l9_5)*Mask_Radius,dot(l9_1,l9_9)*Mask_Radius)/(Port_Input1_N088+vec2(1.234e-06))),Port_Input1_N021);
vec4 l9_11=vec4(lineColor.x,lineColor.y,lineColor.z,vec4(0.0).w);
l9_11.w=l9_10;
#if (sc_BlendMode_AlphaTest)
{
if (l9_10<alphaTestThreshold)
{
discard;
}
}
...
{
if (l9_10<((mod(dot(floor(mod(gl_FragCoord.xy,vec2(4.0))),vec2(4.0,1.0))*9.0,16.0)+1.0)/17.0))
{
discard;
}
}
...
{
l9_15=clamp(dot(l9_11.xyz,vec3(l9_10)),0.0,1.0);
}
#else
{
float l9_16;
...
{
l9_17=(1.0-dot(l9_11.xyz,vec3(0.33333001)))*l9_10;
}
#else
{
float l9_18;
...
{
l9_18=(1.0-clamp(dot(l9_11.xyz,vec3(1.0)),0.0,1.0))*l9_10;
}
#else
{
float l9_19;
...
{
l9_19=clamp(dot(l9_11.xyz,vec3(1.0)),0.0,1.0)*l9_10;
}
#else
{
float l9_20;
#if (sc_BlendMode_Add)
{
l9_20=clamp(dot(l9_11.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_21;
#if (sc_BlendMode_AddWithAlphaFactor)
{
l9_21=clamp(dot(l9_11.xyz,vec3(1.0)),0.0,1.0)*l9_10;
}
#else
{
float l9_22;
...
{
l9_22=dot(l9_11.xyz,vec3(0.33333001))*l9_10;
}
#else
{
float l9_23;
#if (sc_BlendMode_Min)
{
l9_23=1.0-clamp(dot(l9_11.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_24;
#if (sc_BlendMode_Max)
{
l9_24=clamp(dot(l9_11.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
l9_24=1.0;
...
#endif
l9_12=vec4(mix(sc_ShadowColor.xyz,sc_ShadowColor.xyz*l9_11.xyz,vec3(sc_ShadowColor.w)),sc_ShadowDensity*l9_13);
}
#else
{
vec4 l9_25;
...
#if (sc_FramebufferFetch)
{
l9_27=sc_readFragData0_Platform();
}
#else
{
vec2 l9_28=sc_ScreenCoordsGlobalToView(gl_FragCoord.xy*sc_CurrentRenderTargetDims.zw);
vec4 l9_29;
#if (sc_ScreenTextureLayout==2)
{
l9_29=texture(sc_ScreenTextureArrSC,sc_SamplingCoordsViewToGlobal(l9_28,sc_ScreenTextureLayout,sc_ScreenTextureGetStereoViewIndex()),0.0);
}
#else
{
l9_29=texture(sc_ScreenTexture,sc_SamplingCoordsViewToGlobal(l9_28,sc_ScreenTextureLayout,sc_ScreenTextureGetStereoViewIndex()).xy,0.0);
}
#endif
l9_27=l9_29;
}
#endif
vec3 l9_30=mix(l9_27.xyz,definedBlend(l9_27.xyz,l9_11.xyz).xyz,vec3(l9_10));
...
#if (sc_Voxelization)
{
l9_32=vec4(varScreenPos.xyz,1.0);
}
#else
{
vec4 l9_33;
#if (sc_OutputBounds)
{
float l9_34=clamp(abs(gl_FragCoord.z),0.0,1.0);
l9_33=vec4(l9_34,1.0-l9_34,1.0,1.0);
}
#else
{
vec4 l9_35;
#if (sc_BlendMode_MultiplyOriginal)
{
l9_35=vec4(mix(vec3(1.0),l9_11.xyz,vec3(l9_10)),l9_10);
}
#else
{
vec4 l9_36;
...
#endif
l9_36=vec4(l9_11.xyz*l9_37,l9_37);
}
#else
{
l9_36=l9_11;
...
vec4 l9_40=sc_OutputMotionVectorsIfNeeded(varPos,max(l9_38,vec4(0.0)));
vec4 l9_41=clamp(l9_40,vec4(0.0),vec4(1.0));
#if (sc_OITDepthBoundsPass)
{
#if (sc_OITDepthBoundsPass)
{
float l9_42=clamp(viewSpaceDepth()/1000.0,0.0,1.0);
sc_writeFragData0Internal(vec4(max(0.0,1.0-(l9_42-0.0039215689)),min(1.0,l9_42+0.0039215689),0.0,0.0),sc_UniformConstants.x,sc_ShaderCacheConstant);
}
#endif
}
#else
...
#if (sc_OITDepthGatherPass)
{
vec2 l9_43=sc_ScreenCoordsGlobalToView(gl_FragCoord.xy*sc_CurrentRenderTargetDims.zw);
#if (sc_OITMaxLayers4Plus1)
{
if ((gl_FragCoord.z-texture(sc_OITFrontDepthTexture,l9_43).x)<=getFrontLayerZTestEpsilon())
{
discard;
}
}
#endif
int l9_44=encodeDepth(viewSpaceDepth(),texture(sc_OITFilteredDepthBoundsTexture,l9_43).xy);
float l9_45=packValue(l9_44);
int l9_52=int(l9_41.w*255.0);
float l9_53=packValue(l9_52);
sc_writeFragData0Internal(vec4(packValue(l9_44),packValue(l9_44),packValue(l9_44),packValue(l9_44)),sc_UniformConstants.x,sc_ShaderCacheConstant);
sc_writeFragData1(vec4(l9_45,packValue(l9_44),packValue(l9_44),packValue(l9_44)));
sc_writeFragData2(vec4(l9_53,packValue(l9_52),packValue(l9_52),packValue(l9_52)));
...
if (l9_61==0)
{
l9_64=texture(sc_OITAlpha0,l9_56);
l9_63=texture(sc_OITDepthLow0,l9_56);
l9_62=texture(sc_OITDepthHigh0,l9_56);
}
else
{
l9_64=vec4(0.0);
...
if (l9_61==1)
{
l9_67=texture(sc_OITAlpha1,l9_56);
l9_66=texture(sc_OITDepthLow1,l9_56);
l9_65=texture(sc_OITDepthHigh1,l9_56);
}
else
{
l9_67=l9_64;
...
if (any(notEqual(l9_65,vec4(0.0)))||any(notEqual(l9_66,vec4(0.0))))
{
int l9_68[8]=l9_57;
unpackValues(l9_65.w,l9_61,l9_68);
unpackValues(l9_65.z,l9_61,l9_68);
unpackValues(l9_65.y,l9_61,l9_68);
unpackValues(l9_65.x,l9_61,l9_68);
unpackValues(l9_66.w,l9_61,l9_68);
unpackValues(l9_66.z,l9_61,l9_68);
unpackValues(l9_66.y,l9_61,l9_68);
unpackValues(l9_66.x,l9_61,l9_68);
int l9_77[8]=l9_58;
unpackValues(l9_67.w,l9_61,l9_77);
unpackValues(l9_67.z,l9_61,l9_77);
unpackValues(l9_67.y,l9_61,l9_77);
unpackValues(l9_67.x,l9_61,l9_77);
}
l9_61++;
continue;
}
...
vec4 l9_82=texture(sc_OITFilteredDepthBoundsTexture,l9_56);
vec2 l9_83=l9_82.xy;
int l9_84;
#if (sc_SkinBonesCount>0)
{
...
if (l9_92)
{
vec3 l9_93=l9_86.xyz*(1.0-(float(l9_58[l9_88])/255.0));
...
sc_writeFragData0Internal(l9_41,sc_UniformConstants.x,sc_ShaderCacheConstant);
}
#endif
}
#else
{
sc_writeFragData0Internal(l9_40,sc_UniformConstants.x,sc_ShaderCacheConstant);
}
#endif
}
#endif

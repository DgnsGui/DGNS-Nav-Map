...
//sampler sampler baseTexSmpSC 0:16
...
//texture texture2D baseTex 0:0:0:16
...
//texture texture2DArray baseTexArrSC 0:25:0:16
...
//spec_const int SC_SOFTWARE_WRAP_MODE_V_baseTex 77 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_V_intensityTexture 78 -1
//spec_const int baseTexLayout 79 0
...
l9_8=varTangent.xyz;
l9_7=l9_5;
l9_6=(sc_ModelMatrix*vec4(((sc_ModelMatrixInverse*vec4(varPos,1.0)).xyz*vec3(lineWeight+1.0))+vec3(Port_Input2_N008),1.0)).xyz;
}
varPos=l9_6;
varNormal=normalize(l9_7);
vec3 l9_9=normalize(l9_8);
...
#if (sc_RenderingSpace==3)
{
l9_10=sc_ProjectionMatrixInverseArray[sc_GetStereoViewIndex()]*l9_0.position;
}
#else
{
vec4 l9_11;
#if (sc_RenderingSpace==2)
{
l9_11=sc_ViewMatrixArray[sc_GetStereoViewIndex()]*l9_0.position;
}
#else
{
vec4 l9_12;
#if (sc_RenderingSpace==1)
{
l9_12=sc_ModelViewMatrixArray[sc_GetStereoViewIndex()]*l9_0.position;
}
#else
{
l9_12=l9_0.position;
...
#if (sc_RenderingSpace==4)
{
l9_14=(sc_ModelViewMatrixArray[sc_GetStereoViewIndex()]*l9_0.position)*vec4(1.0/sc_Camera.aspect,1.0,1.0,1.0);
}
#else
{
vec4 l9_15;
#if (sc_RenderingSpace==2)
{
l9_15=sc_ViewProjectionMatrixArray[sc_GetStereoViewIndex()]*vec4(varPos,1.0);
}
#else
{
vec4 l9_16;
...
#if (sc_RenderingSpace==1)
{
l9_17=sc_ModelMatrix*l9_0.position;
}
#else
{
l9_17=l9_0.position;
...
#endif
vec4 l9_18=sc_ProjectorMatrix*l9_17;
varShadowTex=((l9_18.xy/vec2(l9_18.w))*0.5)+vec2(0.5);
}
#endif
vec4 l9_19;
...
{
vec4 l9_21=l9_13;
l9_21.z=((log2(max(sc_Camera.clipPlanes.x,1.0+l9_13.w))*(2.0/log2(sc_Camera.clipPlanes.y+1.0)))-1.0)*l9_13.w;
l9_20=l9_21;
}
else
{
...
#if (sc_TAAEnabled)
{
vec2 l9_23=l9_19.xy+(sc_TAAJitterOffset*l9_19.w);
l9_22=vec4(l9_23.x,l9_23.y,l9_19.z,l9_19.w);
}
#else
{
l9_22=l9_19;
...
#endif
sc_SetClipPosition(l9_22);
#if (sc_Voxelization)
{
sc_Vertex_t l9_24=sc_Vertex_t(l9_0.position,l9_0.normal,l9_0.tangent,l9_3,l9_0.texture1);
sc_BlendVertex(l9_24);
sc_SkinVertex(l9_24);
int l9_25=sc_GetLocalInstanceIDInternal(sc_FallbackInstanceID);
int l9_26=int(voxelization_params_0.w);
vec4 l9_27=createVoxelOrthoMatrix(voxelization_params_frustum_lrbt.x,voxelization_params_frustum_lrbt.y,voxelization_params_frustum_lrbt.z,voxelization_params_frustum_lrbt.w,voxelization_params_frustum_nf.x,voxelization_params_frustum_nf.y)*vec4(((sc_ModelMatrixVoxelization*l9_24.position).xyz+vec3(float(l9_25%l9_26)*voxelization_params_0.y,float(l9_25/l9_26)*voxelization_params_0.y,(float(l9_25)*(voxelization_params_0.y/voxelization_params_0.z))+voxelization_params_frustum_nf.x))-voxelization_params_camera_pos,1.0);
l9_27.w=1.0;
varScreenPos=l9_27;
sc_SetClipPosition(l9_27*1.0);
}
#else
{
#if (sc_OutputBounds)
{
sc_Vertex_t l9_28=sc_Vertex_t(l9_0.position,l9_0.normal,l9_0.tangent,l9_3,l9_0.texture1);
sc_BlendVertex(l9_28);
sc_SkinVertex(l9_28);
vec2 l9_29=((l9_28.position.xy/vec2(l9_28.position.w))*0.5)+vec2(0.5);
varPackedTex=vec4(l9_29.x,l9_29.y,varPackedTex.z,varPackedTex.w);
vec4 l9_30=sc_ModelMatrixVoxelization*l9_28.position;
vec3 l9_31=l9_30.xyz-voxelization_params_camera_pos;
varPos=l9_31.xyz;
varNormal=normalize(l9_28.normal);
vec4 l9_32=createVoxelOrthoMatrix(voxelization_params_frustum_lrbt.x,voxelization_params_frustum_lrbt.y,voxelization_params_frustum_lrbt.z,voxelization_params_frustum_lrbt.w,voxelization_params_frustum_nf.x,voxelization_params_frustum_nf.y)*vec4(l9_31.x,l9_31.y,l9_31.z,l9_30.w);
vec4 l9_33=vec4(l9_32.x,l9_32.y,l9_32.z,vec4(0.0).w);
l9_33.w=1.0;
varScreenPos=l9_33;
sc_SetClipPosition(l9_33*1.0);
}
#endif
}
#endif
...
uniform vec3 Tweak_N10;
uniform float Mask_Radius;
uniform float Port_Value1_N082;
uniform float Port_Value2_N082;
uniform float Port_Value3_N082;
uniform vec2 Port_Input1_N088;
...
vec3 l9_1=varPos-Tweak_N10;
vec3 l9_2=cross(l9_0,vec3(Port_Value1_N082,Port_Value2_N082,Port_Value3_N082));
...
#if (baseTexLayout==2)
{
bool l9_11=(int(SC_USE_CLAMP_TO_BORDER_baseTex)!=0)&&(!(int(SC_USE_UV_MIN_MAX_baseTex)!=0));
float l9_12=varPackedTex.x;
sc_SoftwareWrapEarly(l9_12,ivec2(SC_SOFTWARE_WRAP_MODE_U_baseTex,SC_SOFTWARE_WRAP_MODE_V_baseTex).x);
float l9_13=l9_12;
float l9_14=varPackedTex.y;
...
float l9_27=l9_26.x;
float l9_28=l9_17;
sc_SoftwareWrapLate(l9_27,ivec2(SC_SOFTWARE_WRAP_MODE_U_baseTex,SC_SOFTWARE_WRAP_MODE_V_baseTex).x,l9_11,l9_28);
float l9_29=l9_26.y;
float l9_30=l9_28;
sc_SoftwareWrapLate(l9_29,ivec2(SC_SOFTWARE_WRAP_MODE_U_baseTex,SC_SOFTWARE_WRAP_MODE_V_baseTex).y,l9_11,l9_30);
float l9_31=l9_30;
...
#else
{
bool l9_35=(int(SC_USE_CLAMP_TO_BORDER_baseTex)!=0)&&(!(int(SC_USE_UV_MIN_MAX_baseTex)!=0));
float l9_36=varPackedTex.x;
sc_SoftwareWrapEarly(l9_36,ivec2(SC_SOFTWARE_WRAP_MODE_U_baseTex,SC_SOFTWARE_WRAP_MODE_V_baseTex).x);
float l9_37=l9_36;
float l9_38=varPackedTex.y;
sc_SoftwareWrapEarly(l9_38,ivec2(SC_SOFTWARE_WRAP_MODE_U_baseTex,SC_SOFTWARE_WRAP_MODE_V_baseTex).y);
float l9_39=l9_38;
vec2 l9_40;
float l9_41;
#if (SC_USE_UV_MIN_MAX_baseTex)
...
#if (SC_USE_CLAMP_TO_BORDER_baseTex)
{
l9_42=ivec2(SC_SOFTWARE_WRAP_MODE_U_baseTex,SC_SOFTWARE_WRAP_MODE_V_baseTex).x==3;
}
#else
{
...
float l9_43=l9_37;
float l9_44=1.0;
sc_ClampUV(l9_43,baseTexUvMinMax.x,baseTexUvMinMax.z,l9_42,l9_44);
float l9_45=l9_43;
float l9_46=l9_44;
bool l9_47;
#if (SC_USE_CLAMP_TO_BORDER_baseTex)
{
l9_47=ivec2(SC_SOFTWARE_WRAP_MODE_U_baseTex,SC_SOFTWARE_WRAP_MODE_V_baseTex).y==3;
}
#else
{
...
float l9_48=l9_39;
float l9_49=l9_46;
sc_ClampUV(l9_48,baseTexUvMinMax.y,baseTexUvMinMax.w,l9_47,l9_49);
l9_41=l9_49;
...
#endif
vec2 l9_50=sc_TransformUV(l9_40,(int(SC_USE_UV_TRANSFORM_baseTex)!=0),baseTexTransform);
float l9_51=l9_50.x;
float l9_52=l9_41;
sc_SoftwareWrapLate(l9_51,ivec2(SC_SOFTWARE_WRAP_MODE_U_baseTex,SC_SOFTWARE_WRAP_MODE_V_baseTex).x,l9_35,l9_52);
float l9_53=l9_50.y;
float l9_54=l9_52;
sc_SoftwareWrapLate(l9_53,ivec2(SC_SOFTWARE_WRAP_MODE_U_baseTex,SC_SOFTWARE_WRAP_MODE_V_baseTex).y,l9_35,l9_54);
float l9_55=l9_54;
vec3 l9_56=sc_SamplingCoordsViewToGlobal(vec2(l9_51,l9_53),baseTexLayout,baseTexGetStereoViewIndex());
vec4 l9_57=texture(baseTex,l9_56.xy,0.0);
vec4 l9_58;
#if (SC_USE_CLAMP_TO_BORDER_baseTex)
{
l9_58=mix(baseTexBorderColor,l9_57,vec4(l9_55));
}
#else
{
l9_58=l9_57;
...
#endif
float l9_59=min(step(length(vec2(dot(l9_1,l9_5)*Mask_Radius,dot(l9_1,l9_9)*Mask_Radius)/(Port_Input1_N088+vec2(1.234e-06))),Port_Input1_N021),l9_10.w);
vec4 l9_60=vec4(lineColor.x,lineColor.y,lineColor.z,vec4(0.0).w);
l9_60.w=l9_59;
#if (sc_BlendMode_AlphaTest)
{
if (l9_59<alphaTestThreshold)
{
discard;
}
}
...
{
if (l9_59<((mod(dot(floor(mod(gl_FragCoord.xy,vec2(4.0))),vec2(4.0,1.0))*9.0,16.0)+1.0)/17.0))
{
discard;
}
}
...
{
l9_64=clamp(dot(l9_60.xyz,vec3(l9_59)),0.0,1.0);
}
#else
{
float l9_65;
...
{
l9_66=(1.0-dot(l9_60.xyz,vec3(0.33333001)))*l9_59;
}
#else
{
float l9_67;
...
{
l9_67=(1.0-clamp(dot(l9_60.xyz,vec3(1.0)),0.0,1.0))*l9_59;
}
#else
{
float l9_68;
...
{
l9_68=clamp(dot(l9_60.xyz,vec3(1.0)),0.0,1.0)*l9_59;
}
#else
{
float l9_69;
#if (sc_BlendMode_Add)
{
l9_69=clamp(dot(l9_60.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_70;
#if (sc_BlendMode_AddWithAlphaFactor)
{
l9_70=clamp(dot(l9_60.xyz,vec3(1.0)),0.0,1.0)*l9_59;
}
#else
{
float l9_71;
...
{
l9_71=dot(l9_60.xyz,vec3(0.33333001))*l9_59;
}
#else
{
float l9_72;
#if (sc_BlendMode_Min)
{
l9_72=1.0-clamp(dot(l9_60.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_73;
#if (sc_BlendMode_Max)
{
l9_73=clamp(dot(l9_60.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
l9_73=1.0;
...
#endif
l9_61=vec4(mix(sc_ShadowColor.xyz,sc_ShadowColor.xyz*l9_60.xyz,vec3(sc_ShadowColor.w)),sc_ShadowDensity*l9_62);
}
#else
{
vec4 l9_74;
...
#if (sc_FramebufferFetch)
{
l9_76=sc_readFragData0_Platform();
}
#else
{
vec2 l9_77=sc_ScreenCoordsGlobalToView(gl_FragCoord.xy*sc_CurrentRenderTargetDims.zw);
vec4 l9_78;
#if (sc_ScreenTextureLayout==2)
{
l9_78=texture(sc_ScreenTextureArrSC,sc_SamplingCoordsViewToGlobal(l9_77,sc_ScreenTextureLayout,sc_ScreenTextureGetStereoViewIndex()),0.0);
}
#else
{
l9_78=texture(sc_ScreenTexture,sc_SamplingCoordsViewToGlobal(l9_77,sc_ScreenTextureLayout,sc_ScreenTextureGetStereoViewIndex()).xy,0.0);
}
#endif
l9_76=l9_78;
}
#endif
vec3 l9_79=mix(l9_76.xyz,definedBlend(l9_76.xyz,l9_60.xyz).xyz,vec3(l9_59));
...
#if (sc_BlendMode_MultiplyOriginal)
{
l9_84=vec4(mix(vec3(1.0),l9_60.xyz,vec3(l9_59)),l9_59);
}
#else
{
vec4 l9_85;
...
#endif
l9_85=vec4(l9_60.xyz*l9_86,l9_86);
}
#else
{
l9_85=l9_60;
...
vec4 l9_89=sc_OutputMotionVectorsIfNeeded(varPos,max(l9_87,vec4(0.0)));
vec4 l9_90=clamp(l9_89,vec4(0.0),vec4(1.0));
#if (sc_OITDepthBoundsPass)
{
#if (sc_OITDepthBoundsPass)
{
float l9_91=clamp(viewSpaceDepth()/1000.0,0.0,1.0);
sc_writeFragData0Internal(vec4(max(0.0,1.0-(l9_91-0.0039215689)),min(1.0,l9_91+0.0039215689),0.0,0.0),sc_UniformConstants.x,sc_ShaderCacheConstant);
}
#endif
}
#else
...
{
if ((gl_FragCoord.z-texture(sc_OITFrontDepthTexture,l9_92).x)<=getFrontLayerZTestEpsilon())
{
discard;
}
}
#endif
int l9_93=encodeDepth(viewSpaceDepth(),texture(sc_OITFilteredDepthBoundsTexture,l9_92).xy);
float l9_94=packValue(l9_93);
int l9_101=int(l9_90.w*255.0);
float l9_102=packValue(l9_101);
sc_writeFragData0Internal(vec4(packValue(l9_93),packValue(l9_93),packValue(l9_93),packValue(l9_93)),sc_UniformConstants.x,sc_ShaderCacheConstant);
sc_writeFragData1(vec4(l9_94,packValue(l9_93),packValue(l9_93),packValue(l9_93)));
sc_writeFragData2(vec4(l9_102,packValue(l9_101),packValue(l9_101),packValue(l9_101)));
...
#if (sc_OITCompositingPass)
{
vec2 l9_105=sc_ScreenCoordsGlobalToView(gl_FragCoord.xy*sc_CurrentRenderTargetDims.zw);
#if (sc_OITMaxLayers4Plus1)
{
if ((gl_FragCoord.z-texture(sc_OITFrontDepthTexture,l9_105).x)<=getFrontLayerZTestEpsilon())
{
discard;
}
}
...
if (l9_110==0)
{
l9_113=texture(sc_OITAlpha0,l9_105);
l9_112=texture(sc_OITDepthLow0,l9_105);
l9_111=texture(sc_OITDepthHigh0,l9_105);
}
else
{
l9_113=vec4(0.0);
...
if (l9_110==1)
{
l9_116=texture(sc_OITAlpha1,l9_105);
l9_115=texture(sc_OITDepthLow1,l9_105);
l9_114=texture(sc_OITDepthHigh1,l9_105);
}
else
{
l9_116=l9_113;
...
if (any(notEqual(l9_114,vec4(0.0)))||any(notEqual(l9_115,vec4(0.0))))
{
int l9_117[8]=l9_106;
unpackValues(l9_114.w,l9_110,l9_117);
unpackValues(l9_114.z,l9_110,l9_117);
unpackValues(l9_114.y,l9_110,l9_117);
unpackValues(l9_114.x,l9_110,l9_117);
unpackValues(l9_115.w,l9_110,l9_117);
unpackValues(l9_115.z,l9_110,l9_117);
unpackValues(l9_115.y,l9_110,l9_117);
unpackValues(l9_115.x,l9_110,l9_117);
int l9_126[8]=l9_107;
unpackValues(l9_116.w,l9_110,l9_126);
unpackValues(l9_116.z,l9_110,l9_126);
unpackValues(l9_116.y,l9_110,l9_126);
unpackValues(l9_116.x,l9_110,l9_126);
}
l9_110++;
continue;
}
...
vec4 l9_131=texture(sc_OITFilteredDepthBoundsTexture,l9_105);
vec2 l9_132=l9_131.xy;
int l9_133;
#if (sc_SkinBonesCount>0)
{
l9_133=encodeDepth(((1.0-l9_131.x)*1000.0)+getDepthOrderingEpsilon(),l9_132);
}
#else
{
l9_133=0;
...
#endif
int l9_134=encodeDepth(viewSpaceDepth(),l9_132);
vec4 l9_135;
l9_135=l9_90*l9_90.w;
vec4 l9_136;
int l9_137=0;
for (int snapLoopIndex=0; snapLoopIndex==0; snapLoopIndex+=0)
{
if (l9_137<8)
{
int l9_138=l9_106[l9_137];
int l9_139=l9_134-l9_133;
bool l9_140=l9_138<l9_139;
bool l9_141;
if (l9_140)
{
l9_141=l9_106[l9_137]>0;
}
else
{
l9_141=l9_140;
...
if (l9_141)
{
vec3 l9_142=l9_135.xyz*(1.0-(float(l9_107[l9_137])/255.0));
l9_136=vec4(l9_142.x,l9_142.y,l9_142.z,l9_135.w);
}
else
{
l9_136=l9_135;
...
sc_writeFragData0Internal(l9_135,sc_UniformConstants.x,sc_ShaderCacheConstant);
#if (sc_OITMaxLayersVisualizeLayerCount)
{
discard;
}
...
sc_writeFragData0Internal(l9_90,sc_UniformConstants.x,sc_ShaderCacheConstant);
}
#endif
}
#else
{
sc_writeFragData0Internal(l9_89,sc_UniformConstants.x,sc_ShaderCacheConstant);
}
#endif
}
#endif

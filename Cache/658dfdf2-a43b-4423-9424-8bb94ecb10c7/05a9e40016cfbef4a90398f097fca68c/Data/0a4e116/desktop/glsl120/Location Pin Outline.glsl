...
float l9_25=l9_24;
vec3 l9_26=sc_SamplingCoordsViewToGlobal(vec2(l9_21,l9_23),baseTexLayout,l9_4);
vec4 l9_27=texture2D(baseTex,l9_26.xy,0.0);
vec4 l9_28;
#if (SC_USE_CLAMP_TO_BORDER_baseTex)
{
...
#endif
float l9_29=min(l9_0,l9_28.w);
vec4 l9_30=vec4(lineColor.x,lineColor.y,lineColor.z,vec4(0.0).w);
l9_30.w=l9_29;
#if (sc_BlendMode_AlphaTest)
{
if (l9_29<alphaTestThreshold)
{
discard;
}
}
...
{
if (l9_29<((mod(dot(floor(mod(gl_FragCoord.xy,vec2(4.0))),vec2(4.0,1.0))*9.0,16.0)+1.0)/17.0))
{
discard;
}
}
...
{
l9_34=clamp(dot(l9_30.xyz,vec3(l9_29)),0.0,1.0);
}
#else
{
float l9_35;
...
{
l9_36=(1.0-dot(l9_30.xyz,vec3(0.33333001)))*l9_29;
}
#else
{
float l9_37;
...
{
l9_37=(1.0-clamp(dot(l9_30.xyz,vec3(1.0)),0.0,1.0))*l9_29;
}
#else
{
float l9_38;
...
{
l9_38=clamp(dot(l9_30.xyz,vec3(1.0)),0.0,1.0)*l9_29;
}
#else
{
float l9_39;
#if (sc_BlendMode_Add)
{
l9_39=clamp(dot(l9_30.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_40;
#if (sc_BlendMode_AddWithAlphaFactor)
{
l9_40=clamp(dot(l9_30.xyz,vec3(1.0)),0.0,1.0)*l9_29;
}
#else
{
float l9_41;
...
{
l9_41=dot(l9_30.xyz,vec3(0.33333001))*l9_29;
}
#else
{
float l9_42;
#if (sc_BlendMode_Min)
{
l9_42=1.0-clamp(dot(l9_30.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_43;
#if (sc_BlendMode_Max)
{
l9_43=clamp(dot(l9_30.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
l9_43=1.0;
...
#endif
l9_31=vec4(mix(sc_ShadowColor.xyz,sc_ShadowColor.xyz*l9_30.xyz,vec3(sc_ShadowColor.w)),sc_ShadowDensity*l9_32);
}
#else
{
vec4 l9_44;
...
#endif
l9_46=texture2D(sc_ScreenTexture,sc_SamplingCoordsViewToGlobal(l9_47,sc_ScreenTextureLayout,l9_48).xy,0.0);
}
#endif
vec3 l9_49=mix(l9_46.xyz,definedBlend(l9_46.xyz,l9_30.xyz).xyz,vec3(l9_29));
...
#if (sc_BlendMode_MultiplyOriginal)
{
l9_54=vec4(mix(vec3(1.0),l9_30.xyz,vec3(l9_29)),l9_29);
}
#else
{
vec4 l9_55;
...
#endif
l9_55=vec4(l9_30.xyz*l9_56,l9_56);
}
#else
{
l9_55=l9_30;
...
#endif
int l9_63=encodeDepth(viewSpaceDepth(),texture2D(sc_OITFilteredDepthBoundsTexture,l9_62).xy);
...
#if (sc_OITMaxLayers4Plus1)
{
if ((gl_FragCoord.z-texture2D(sc_OITFrontDepthTexture,l9_75).x)<=getFrontLayerZTestEpsilon())
{
discard;
}
}
...
if (l9_80==0)
{
l9_83=texture2D(sc_OITAlpha0,l9_75);
l9_82=texture2D(sc_OITDepthLow0,l9_75);
l9_81=texture2D(sc_OITDepthHigh0,l9_75);
}
else
{
l9_83=vec4(0.0);
...
if (l9_80==1)
{
l9_86=texture2D(sc_OITAlpha1,l9_75);
l9_85=texture2D(sc_OITDepthLow1,l9_75);
l9_84=texture2D(sc_OITDepthHigh1,l9_75);
}
else
{
l9_86=l9_83;
...
vec4 l9_101=texture2D(sc_OITFilteredDepthBoundsTexture,l9_75);

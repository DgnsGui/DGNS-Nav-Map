...
l9_9=varTangent.xyz;
l9_8=varNormalAndMotion.xyz;
l9_7=(sc_ModelMatrix*vec4(((sc_ModelMatrixInverse*vec4(varPosAndMotion.xyz,1.0)).xyz*vec3(lineWeight+1.0))+vec3(Port_Input2_N008),1.0)).xyz;
}
...
vec3 l9_1=varPosAndMotion.xyz-circleBoundCentre;
vec3 l9_2=cross(l9_0,vec3(Port_Value1_N089,Port_Value2_N089,Port_Value3_N089));
...
#endif
float l9_59=min(step(length(vec2(dot(l9_1,l9_5),dot(l9_1,l9_9))/(Port_Input1_N097+vec2(1.234e-06))),Port_Input1_N099),l9_10.w);
...
vec4 l9_89=sc_OutputMotionVectorIfNeeded(max(l9_87,vec4(0.0)));
...
sc_writeFragData0(vec4(max(0.0,1.0-(l9_91-0.0039215689)),min(1.0,l9_91+0.0039215689),0.0,0.0));
}
#endif
}
#else
...
sc_writeFragData0(vec4(packValue(l9_93),packValue(l9_93),packValue(l9_93),packValue(l9_93)));
}
#endif
}
#else

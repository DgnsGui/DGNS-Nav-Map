...
{
l9_0=step(distance(varPos,circleBoundCentre),circleBoundRadius);
}
else
{
vec3 l9_1=varPos-cornerPosition;
float l9_2=dot(verticalVector,l9_1);
float l9_3=dot(l9_1,horizontalVector);
l9_0=min(min(min(step(Port_Input0_N047,l9_2),step(l9_2,dot(verticalVector,verticalVector))),step(Port_Input0_N072,l9_3)),step(l9_3,dot(horizontalVector,horizontalVector)));
}
vec4 l9_4;
#if (baseTexLayout==2)
{
...
#endif
float l9_53=min(l9_0,l9_4.w);
vec4 l9_54=vec4(lineColor.x,lineColor.y,lineColor.z,vec4(0.0).w);
l9_54.w=l9_53;
#if (sc_BlendMode_AlphaTest)
{
if (l9_53<alphaTestThreshold)
{
discard;
}
}
...
{
if (l9_53<((mod(dot(floor(mod(gl_FragCoord.xy,vec2(4.0))),vec2(4.0,1.0))*9.0,16.0)+1.0)/17.0))
{
discard;
}
}
...
{
l9_58=clamp(dot(l9_54.xyz,vec3(l9_53)),0.0,1.0);
}
#else
{
float l9_59;
...
{
l9_60=(1.0-dot(l9_54.xyz,vec3(0.33333001)))*l9_53;
}
#else
{
float l9_61;
...
{
l9_61=(1.0-clamp(dot(l9_54.xyz,vec3(1.0)),0.0,1.0))*l9_53;
}
#else
{
float l9_62;
...
{
l9_62=clamp(dot(l9_54.xyz,vec3(1.0)),0.0,1.0)*l9_53;
}
#else
{
float l9_63;
#if (sc_BlendMode_Add)
{
l9_63=clamp(dot(l9_54.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_64;
#if (sc_BlendMode_AddWithAlphaFactor)
{
l9_64=clamp(dot(l9_54.xyz,vec3(1.0)),0.0,1.0)*l9_53;
}
#else
{
float l9_65;
...
{
l9_65=dot(l9_54.xyz,vec3(0.33333001))*l9_53;
}
#else
{
float l9_66;
#if (sc_BlendMode_Min)
{
l9_66=1.0-clamp(dot(l9_54.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_67;
#if (sc_BlendMode_Max)
{
l9_67=clamp(dot(l9_54.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
l9_67=1.0;
...
#endif
l9_55=vec4(mix(sc_ShadowColor.xyz,sc_ShadowColor.xyz*l9_54.xyz,vec3(sc_ShadowColor.w)),sc_ShadowDensity*l9_56);
}
#else
{
vec4 l9_68;
...
#if (sc_FramebufferFetch)
{
l9_70=sc_readFragData0_Platform();
}
#else
{
vec2 l9_71=sc_ScreenCoordsGlobalToView(gl_FragCoord.xy*sc_CurrentRenderTargetDims.zw);
vec4 l9_72;
#if (sc_ScreenTextureLayout==2)
{
l9_72=texture(sc_ScreenTextureArrSC,sc_SamplingCoordsViewToGlobal(l9_71,sc_ScreenTextureLayout,sc_ScreenTextureGetStereoViewIndex()),0.0);
}
#else
{
l9_72=texture(sc_ScreenTexture,sc_SamplingCoordsViewToGlobal(l9_71,sc_ScreenTextureLayout,sc_ScreenTextureGetStereoViewIndex()).xy,0.0);
}
#endif
l9_70=l9_72;
}
#endif
vec3 l9_73=mix(l9_70.xyz,definedBlend(l9_70.xyz,l9_54.xyz).xyz,vec3(l9_53));
...
#if (sc_Voxelization)
{
l9_75=vec4(varScreenPos.xyz,1.0);
}
#else
{
vec4 l9_76;
#if (sc_OutputBounds)
{
float l9_77=clamp(abs(gl_FragCoord.z),0.0,1.0);
l9_76=vec4(l9_77,1.0-l9_77,1.0,1.0);
}
#else
{
vec4 l9_78;
#if (sc_BlendMode_MultiplyOriginal)
{
l9_78=vec4(mix(vec3(1.0),l9_54.xyz,vec3(l9_53)),l9_53);
}
#else
{
vec4 l9_79;
...
#endif
l9_79=vec4(l9_54.xyz*l9_80,l9_80);
}
#else
{
l9_79=l9_54;
...
vec4 l9_83=sc_OutputMotionVectorsIfNeeded(varPos,max(l9_81,vec4(0.0)));
vec4 l9_84=clamp(l9_83,vec4(0.0),vec4(1.0));
#if (sc_OITDepthBoundsPass)
{
#if (sc_OITDepthBoundsPass)
{
float l9_85=clamp(viewSpaceDepth()/1000.0,0.0,1.0);
sc_writeFragData0Internal(vec4(max(0.0,1.0-(l9_85-0.0039215689)),min(1.0,l9_85+0.0039215689),0.0,0.0),sc_UniformConstants.x,sc_ShaderCacheConstant);
}
#endif
}
#else
...
{
if ((gl_FragCoord.z-texture(sc_OITFrontDepthTexture,l9_86).x)<=getFrontLayerZTestEpsilon())
{
discard;
}
}
#endif
int l9_87=encodeDepth(viewSpaceDepth(),texture(sc_OITFilteredDepthBoundsTexture,l9_86).xy);
float l9_88=packValue(l9_87);
int l9_95=int(l9_84.w*255.0);
float l9_96=packValue(l9_95);
sc_writeFragData0Internal(vec4(packValue(l9_87),packValue(l9_87),packValue(l9_87),packValue(l9_87)),sc_UniformConstants.x,sc_ShaderCacheConstant);
sc_writeFragData1(vec4(l9_88,packValue(l9_87),packValue(l9_87),packValue(l9_87)));
sc_writeFragData2(vec4(l9_96,packValue(l9_95),packValue(l9_95),packValue(l9_95)));
...
if (l9_104==0)
{
l9_107=texture(sc_OITAlpha0,l9_99);
l9_106=texture(sc_OITDepthLow0,l9_99);
l9_105=texture(sc_OITDepthHigh0,l9_99);
}
else
{
l9_107=vec4(0.0);
...
if (l9_104==1)
{
l9_110=texture(sc_OITAlpha1,l9_99);
l9_109=texture(sc_OITDepthLow1,l9_99);
l9_108=texture(sc_OITDepthHigh1,l9_99);
}
else
{
l9_110=l9_107;
...
if (any(notEqual(l9_108,vec4(0.0)))||any(notEqual(l9_109,vec4(0.0))))
{
int l9_111[8]=l9_100;
unpackValues(l9_108.w,l9_104,l9_111);
unpackValues(l9_108.z,l9_104,l9_111);
unpackValues(l9_108.y,l9_104,l9_111);
unpackValues(l9_108.x,l9_104,l9_111);
unpackValues(l9_109.w,l9_104,l9_111);
unpackValues(l9_109.z,l9_104,l9_111);
unpackValues(l9_109.y,l9_104,l9_111);
unpackValues(l9_109.x,l9_104,l9_111);
int l9_120[8]=l9_101;
unpackValues(l9_110.w,l9_104,l9_120);
unpackValues(l9_110.z,l9_104,l9_120);
unpackValues(l9_110.y,l9_104,l9_120);
unpackValues(l9_110.x,l9_104,l9_120);
}
l9_104++;
continue;
}
...
vec4 l9_125=texture(sc_OITFilteredDepthBoundsTexture,l9_99);
vec2 l9_126=l9_125.xy;
int l9_127;
#if (sc_SkinBonesCount>0)
{
l9_127=encodeDepth(((1.0-l9_125.x)*1000.0)+getDepthOrderingEpsilon(),l9_126);
}
#else
{
l9_127=0;
...
#endif
int l9_128=encodeDepth(viewSpaceDepth(),l9_126);
vec4 l9_129;
l9_129=l9_84*l9_84.w;
vec4 l9_130;
int l9_131=0;
for (int snapLoopIndex=0; snapLoopIndex==0; snapLoopIndex+=0)
{
if (l9_131<8)
{
int l9_132=l9_100[l9_131];
int l9_133=l9_128-l9_127;
bool l9_134=l9_132<l9_133;
bool l9_135;
if (l9_134)
{
l9_135=l9_100[l9_131]>0;
}
else
{
l9_135=l9_134;
...
if (l9_135)
{
vec3 l9_136=l9_129.xyz*(1.0-(float(l9_101[l9_131])/255.0));
l9_130=vec4(l9_136.x,l9_136.y,l9_136.z,l9_129.w);
}
else
{
l9_130=l9_129;
...
sc_writeFragData0Internal(l9_129,sc_UniformConstants.x,sc_ShaderCacheConstant);
#if (sc_OITMaxLayersVisualizeLayerCount)
{
discard;
}
...
sc_writeFragData0Internal(l9_84,sc_UniformConstants.x,sc_ShaderCacheConstant);
}
#endif
}
#else

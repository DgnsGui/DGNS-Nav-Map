...
//spec_const bool sc_RayTracingReflectionsHasSwappedViews 122 0
//spec_const bool sc_RayTracingShadowsHasSwappedViews 123 0
//spec_const bool sc_RenderAlphaToColor 124 0
//spec_const bool sc_SSAOEnabled 125 0
//spec_const bool sc_ScreenTextureHasSwappedViews 126 0
//spec_const bool sc_TAAEnabled 127 0
//spec_const bool sc_VertexBlending 128 0
//spec_const bool sc_VertexBlendingUseNormals 129 0
//spec_const bool sc_Voxelization 130 0
//spec_const bool uv2EnableAnimation 131 0
//spec_const bool uv3EnableAnimation 132 0
//spec_const int NODE_13_DROPLIST_ITEM 133 0
//spec_const int NODE_181_DROPLIST_ITEM 134 0
//spec_const int NODE_184_DROPLIST_ITEM 135 0
//spec_const int NODE_221_DROPLIST_ITEM 136 0
//spec_const int NODE_228_DROPLIST_ITEM 137 0
//spec_const int NODE_27_DROPLIST_ITEM 138 0
//spec_const int NODE_315_DROPLIST_ITEM 139 0
//spec_const int NODE_38_DROPLIST_ITEM 140 0
//spec_const int NODE_49_DROPLIST_ITEM 141 0
//spec_const int NODE_69_DROPLIST_ITEM 142 0
//spec_const int NODE_76_DROPLIST_ITEM 143 0
//spec_const int SC_DEVICE_CLASS 144 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_U_baseTex 145 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_U_detailNormalTex 146 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_U_emissiveTex 147 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_U_intensityTexture 148 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_U_materialParamsTex 149 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_U_normalTex 150 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_U_opacityTex 151 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_U_reflectionModulationTex 152 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_U_reflectionTex 153 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_U_rimColorTex 154 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_V_baseTex 155 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_V_detailNormalTex 156 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_V_emissiveTex 157 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_V_intensityTexture 158 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_V_materialParamsTex 159 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_V_normalTex 160 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_V_opacityTex 161 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_V_reflectionModulationTex 162 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_V_reflectionTex 163 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_V_rimColorTex 164 -1
//spec_const int baseTexLayout 165 0
//spec_const int detailNormalTexLayout 166 0
//spec_const int emissiveTexLayout 167 0
//spec_const int intensityTextureLayout 168 0
//spec_const int materialParamsTexLayout 169 0
//spec_const int normalTexLayout 170 0
//spec_const int opacityTexLayout 171 0
//spec_const int reflectionModulationTexLayout 172 0
//spec_const int reflectionTexLayout 173 0
//spec_const int rimColorTexLayout 174 0
//spec_const int sc_AmbientLightMode0 175 0
//spec_const int sc_AmbientLightMode1 176 0
//spec_const int sc_AmbientLightMode2 177 0
//spec_const int sc_AmbientLightMode_Constant 178 0
//spec_const int sc_AmbientLightMode_EnvironmentMap 179 0
//spec_const int sc_AmbientLightMode_FromCamera 180 0
//spec_const int sc_AmbientLightMode_SphericalHarmonics 181 0
//spec_const int sc_AmbientLightsCount 182 0
//spec_const int sc_DepthBufferMode 183 0
//spec_const int sc_DirectionalLightsCount 184 0
//spec_const int sc_EnvLightMode 185 0
//spec_const int sc_EnvmapDiffuseLayout 186 0
//spec_const int sc_EnvmapSpecularLayout 187 0
//spec_const int sc_LightEstimationSGCount 188 0
//spec_const int sc_PointLightsCount 189 0
//spec_const int sc_RayTracingGlobalIlluminationLayout 190 0
//spec_const int sc_RayTracingReflectionsLayout 191 0
//spec_const int sc_RayTracingShadowsLayout 192 0
//spec_const int sc_RenderingSpace 193 -1
//spec_const int sc_ScreenTextureLayout 194 0
//spec_const int sc_ShaderCacheConstant 195 0
//spec_const int sc_SkinBonesCount 196 0
//spec_const int sc_StereoRenderingMode 197 0
//spec_const int sc_StereoRendering_IsClipDistanceEnabled 198 0
//spec_const int sc_StereoViewID 199 0
//SG_REFLECTION_END
...
{
vec2 l9_296;
Node176_Switch(0.0,vec2(0.0),vec2(0.0),vec2(0.0),vec2(0.0),vec2(0.0),l9_296,l9_6);
vec2 l9_297=l9_296;
#if (materialParamsTexLayout==2)
{
bool l9_298=(int(SC_USE_CLAMP_TO_BORDER_materialParamsTex)!=0)&&(!(int(SC_USE_UV_MIN_MAX_materialParamsTex)!=0));
float l9_299=l9_297.x;
sc_SoftwareWrapEarly(l9_299,ivec2(SC_SOFTWARE_WRAP_MODE_U_materialParamsTex,SC_SOFTWARE_WRAP_MODE_V_materialParamsTex).x);
float l9_300=l9_299;
float l9_301=l9_297.y;
sc_SoftwareWrapEarly(l9_301,ivec2(SC_SOFTWARE_WRAP_MODE_U_materialParamsTex,SC_SOFTWARE_WRAP_MODE_V_materialParamsTex).y);
float l9_302=l9_301;
vec2 l9_303;
float l9_304;
#if (SC_USE_UV_MIN_MAX_materialParamsTex)
...
#if (SC_USE_CLAMP_TO_BORDER_materialParamsTex)
{
l9_305=ivec2(SC_SOFTWARE_WRAP_MODE_U_materialParamsTex,SC_SOFTWARE_WRAP_MODE_V_materialParamsTex).x==3;
}
#else
{
l9_305=(int(SC_USE_CLAMP_TO_BORDER_materialParamsTex)!=0);
}
#endif
float l9_306=l9_300;
float l9_307=1.0;
sc_ClampUV(l9_306,materialParamsTexUvMinMax.x,materialParamsTexUvMinMax.z,l9_305,l9_307);
float l9_308=l9_306;
float l9_309=l9_307;
bool l9_310;
#if (SC_USE_CLAMP_TO_BORDER_materialParamsTex)
{
l9_310=ivec2(SC_SOFTWARE_WRAP_MODE_U_materialParamsTex,SC_SOFTWARE_WRAP_MODE_V_materialParamsTex).y==3;
}
#else
{
l9_310=(int(SC_USE_CLAMP_TO_BORDER_materialParamsTex)!=0);
}
#endif
float l9_311=l9_302;
float l9_312=l9_309;
sc_ClampUV(l9_311,materialParamsTexUvMinMax.y,materialParamsTexUvMinMax.w,l9_310,l9_312);
l9_304=l9_312;
...
#endif
vec2 l9_313=sc_TransformUV(l9_303,(int(SC_USE_UV_TRANSFORM_materialParamsTex)!=0),materialParamsTexTransform);
float l9_314=l9_313.x;
float l9_315=l9_304;
sc_SoftwareWrapLate(l9_314,ivec2(SC_SOFTWARE_WRAP_MODE_U_materialParamsTex,SC_SOFTWARE_WRAP_MODE_V_materialParamsTex).x,l9_298,l9_315);
float l9_316=l9_313.y;
float l9_317=l9_315;
sc_SoftwareWrapLate(l9_316,ivec2(SC_SOFTWARE_WRAP_MODE_U_materialParamsTex,SC_SOFTWARE_WRAP_MODE_V_materialParamsTex).y,l9_298,l9_317);
}
#else
{
bool l9_318=(int(SC_USE_CLAMP_TO_BORDER_materialParamsTex)!=0)&&(!(int(SC_USE_UV_MIN_MAX_materialParamsTex)!=0));
float l9_319=l9_297.x;
sc_SoftwareWrapEarly(l9_319,ivec2(SC_SOFTWARE_WRAP_MODE_U_materialParamsTex,SC_SOFTWARE_WRAP_MODE_V_materialParamsTex).x);
float l9_320=l9_319;
float l9_321=l9_297.y;
sc_SoftwareWrapEarly(l9_321,ivec2(SC_SOFTWARE_WRAP_MODE_U_materialParamsTex,SC_SOFTWARE_WRAP_MODE_V_materialParamsTex).y);
float l9_322=l9_321;
vec2 l9_323;
float l9_324;
#if (SC_USE_UV_MIN_MAX_materialParamsTex)
...
#if (SC_USE_CLAMP_TO_BORDER_materialParamsTex)
{
l9_325=ivec2(SC_SOFTWARE_WRAP_MODE_U_materialParamsTex,SC_SOFTWARE_WRAP_MODE_V_materialParamsTex).x==3;
}
#else
{
l9_325=(int(SC_USE_CLAMP_TO_BORDER_materialParamsTex)!=0);
}
#endif
float l9_326=l9_320;
float l9_327=1.0;
sc_ClampUV(l9_326,materialParamsTexUvMinMax.x,materialParamsTexUvMinMax.z,l9_325,l9_327);
float l9_328=l9_326;
float l9_329=l9_327;
bool l9_330;
#if (SC_USE_CLAMP_TO_BORDER_materialParamsTex)
{
l9_330=ivec2(SC_SOFTWARE_WRAP_MODE_U_materialParamsTex,SC_SOFTWARE_WRAP_MODE_V_materialParamsTex).y==3;
}
#else
{
...
float l9_331=l9_322;
float l9_332=l9_329;
sc_ClampUV(l9_331,materialParamsTexUvMinMax.y,materialParamsTexUvMinMax.w,l9_330,l9_332);
l9_324=l9_332;
...
#endif
vec2 l9_333=sc_TransformUV(l9_323,(int(SC_USE_UV_TRANSFORM_materialParamsTex)!=0),materialParamsTexTransform);
float l9_334=l9_333.x;
float l9_335=l9_324;
sc_SoftwareWrapLate(l9_334,ivec2(SC_SOFTWARE_WRAP_MODE_U_materialParamsTex,SC_SOFTWARE_WRAP_MODE_V_materialParamsTex).x,l9_318,l9_335);
float l9_336=l9_333.y;
float l9_337=l9_335;
sc_SoftwareWrapLate(l9_336,ivec2(SC_SOFTWARE_WRAP_MODE_U_materialParamsTex,SC_SOFTWARE_WRAP_MODE_V_materialParamsTex).y,l9_318,l9_337);
}
#endif
vec3 l9_338;
Node188_If_else(0.0,vec3(0.0),vec3(0.0),l9_338,l9_6);
}
#else
{
}
...
#endif
float l9_340=clamp(l9_68,0.0,1.0);
#if (sc_BlendMode_AlphaTest)
{
if (l9_340<alphaTestThreshold)
{
discard;
}
}
...
{
if (l9_340<((mod(dot(floor(mod(gl_FragCoord.xy,vec2(4.0))),vec2(4.0,1.0))*9.0,16.0)+1.0)/17.0))
{
discard;
}
}
#endif
uvec3 l9_341=uvec3(round((varPos-sc_RayTracingOriginOffset)*sc_RayTracingOriginScale));
sc_RayTracingPositionAndMask=uvec4(l9_341.x,l9_341.y,l9_341.z,sc_RayTracingPositionAndMask.w);
sc_RayTracingPositionAndMask.w=sc_RayTracingReceiverMask;
vec3 l9_342=l9_339/vec3(dot(abs(l9_339),vec3(1.0)));
vec2 l9_343=vec2(clamp(-l9_342.z,0.0,1.0));
vec2 l9_344=l9_342.xy;
uint l9_345=packHalf2x16(l9_344+mix(-l9_343,l9_343,step(vec2(0.0),l9_344)));
uvec2 l9_346=uvec2(l9_345&65535u,l9_345>>16u);
sc_RayTracingNormalAndMore=uvec4(l9_346.x,l9_346.y,sc_RayTracingNormalAndMore.z,sc_RayTracingNormalAndMore.w);
sc_RayTracingNormalAndMore.z=0u;
sc_RayTracingNormalAndMore.w=uint(clamp(roughness*l9_247.y,0.0,1.0)*1000.0)|((sc_RayTracingReceiverId%32u)<<10u);
}
...
vec3 l9_17=normalize(varNormal);
...
ssGlobals l9_18=ssGlobals(sc_Time.x,sc_Time.y,0.0,vec3(0.0),l9_9,l9_8,l9_7,l9_6,l9_5,l9_4,l9_3,l9_2,l9_1,l9_8);
vec4 l9_19;
#if (NODE_38_DROPLIST_ITEM==1)
{
vec3 l9_20;
...
{
vec2 l9_29;
Node35_If_else(0.0,vec2(0.0),vec2(0.0),l9_29,l9_18);
l9_28=l9_29;
}
#else
{
...
#endif
float l9_80=(baseColor*l9_22).w*l9_23;
float l9_81=l9_80*l9_79;
vec3 param_9;
Node337_If_else(0.0,vec3(0.0),vec3(0.0),param_9,l9_18);
vec3 l9_82=param_9;
vec3 l9_83;
#if ((NODE_38_DROPLIST_ITEM==2)||Tweak_N223)
{
...
{
vec3 l9_85;
Node132_If_else(0.0,vec3(0.0),Port_Default_N132,l9_85,l9_18);
l9_84=l9_7.xyz+l9_85;
}
#else
{
vec3 l9_86;
Node132_If_else(0.0,vec3(0.0),Port_Default_N132,l9_86,l9_18);
l9_84=l9_86;
}
#endif
...
{
vec3 l9_88;
Node337_If_else(0.0,vec3(0.0),vec3(0.0),l9_88,l9_18);
vec3 l9_89=l9_88;
vec3 l9_90=reflect(l9_9,l9_89);
...
#if (reflectionTexLayout==2)
{
bool l9_100=(int(SC_USE_CLAMP_TO_BORDER_reflectionTex)!=0)&&(!(int(SC_USE_UV_MIN_MAX_reflectionTex)!=0));
float l9_101=l9_98.x;
sc_SoftwareWrapEarly(l9_101,ivec2(SC_SOFTWARE_WRAP_MODE_U_reflectionTex,SC_SOFTWARE_WRAP_MODE_V_reflectionTex).x);
float l9_102=l9_101;
float l9_103=l9_98.y;
sc_SoftwareWrapEarly(l9_103,ivec2(SC_SOFTWARE_WRAP_MODE_U_reflectionTex,SC_SOFTWARE_WRAP_MODE_V_reflectionTex).y);
float l9_104=l9_103;
vec2 l9_105;
float l9_106;
#if (SC_USE_UV_MIN_MAX_reflectionTex)
...
#if (SC_USE_CLAMP_TO_BORDER_reflectionTex)
{
l9_107=ivec2(SC_SOFTWARE_WRAP_MODE_U_reflectionTex,SC_SOFTWARE_WRAP_MODE_V_reflectionTex).x==3;
}
#else
{
l9_107=(int(SC_USE_CLAMP_TO_BORDER_reflectionTex)!=0);
}
#endif
float l9_108=l9_102;
float l9_109=1.0;
sc_ClampUV(l9_108,reflectionTexUvMinMax.x,reflectionTexUvMinMax.z,l9_107,l9_109);
float l9_110=l9_108;
float l9_111=l9_109;
bool l9_112;
#if (SC_USE_CLAMP_TO_BORDER_reflectionTex)
{
l9_112=ivec2(SC_SOFTWARE_WRAP_MODE_U_reflectionTex,SC_SOFTWARE_WRAP_MODE_V_reflectionTex).y==3;
}
#else
{
l9_112=(int(SC_USE_CLAMP_TO_BORDER_reflectionTex)!=0);
}
#endif
float l9_113=l9_104;
float l9_114=l9_111;
sc_ClampUV(l9_113,reflectionTexUvMinMax.y,reflectionTexUvMinMax.w,l9_112,l9_114);
l9_106=l9_114;
...
#endif
vec2 l9_115=sc_TransformUV(l9_105,(int(SC_USE_UV_TRANSFORM_reflectionTex)!=0),reflectionTexTransform);
float l9_116=l9_115.x;
float l9_117=l9_106;
sc_SoftwareWrapLate(l9_116,ivec2(SC_SOFTWARE_WRAP_MODE_U_reflectionTex,SC_SOFTWARE_WRAP_MODE_V_reflectionTex).x,l9_100,l9_117);
float l9_118=l9_115.y;
float l9_119=l9_117;
sc_SoftwareWrapLate(l9_118,ivec2(SC_SOFTWARE_WRAP_MODE_U_reflectionTex,SC_SOFTWARE_WRAP_MODE_V_reflectionTex).y,l9_100,l9_119);
float l9_120=l9_119;
vec3 l9_121=sc_SamplingCoordsViewToGlobal(vec2(l9_116,l9_118),reflectionTexLayout,reflectionTexGetStereoViewIndex());
vec4 l9_122=texture(reflectionTexArrSC,l9_121,0.0);
vec4 l9_123;
#if (SC_USE_CLAMP_TO_BORDER_reflectionTex)
{
l9_123=mix(reflectionTexBorderColor,l9_122,vec4(l9_120));
}
#else
{
l9_123=l9_122;
...
#else
{
bool l9_124=(int(SC_USE_CLAMP_TO_BORDER_reflectionTex)!=0)&&(!(int(SC_USE_UV_MIN_MAX_reflectionTex)!=0));
float l9_125=l9_98.x;
sc_SoftwareWrapEarly(l9_125,ivec2(SC_SOFTWARE_WRAP_MODE_U_reflectionTex,SC_SOFTWARE_WRAP_MODE_V_reflectionTex).x);
float l9_126=l9_125;
float l9_127=l9_98.y;
sc_SoftwareWrapEarly(l9_127,ivec2(SC_SOFTWARE_WRAP_MODE_U_reflectionTex,SC_SOFTWARE_WRAP_MODE_V_reflectionTex).y);
float l9_128=l9_127;
vec2 l9_129;
float l9_130;
#if (SC_USE_UV_MIN_MAX_reflectionTex)
...
#if (SC_USE_CLAMP_TO_BORDER_reflectionTex)
{
l9_131=ivec2(SC_SOFTWARE_WRAP_MODE_U_reflectionTex,SC_SOFTWARE_WRAP_MODE_V_reflectionTex).x==3;
}
#else
{
l9_131=(int(SC_USE_CLAMP_TO_BORDER_reflectionTex)!=0);
}
#endif
float l9_132=l9_126;
float l9_133=1.0;
sc_ClampUV(l9_132,reflectionTexUvMinMax.x,reflectionTexUvMinMax.z,l9_131,l9_133);
float l9_134=l9_132;
float l9_135=l9_133;
bool l9_136;
#if (SC_USE_CLAMP_TO_BORDER_reflectionTex)
{
l9_136=ivec2(SC_SOFTWARE_WRAP_MODE_U_reflectionTex,SC_SOFTWARE_WRAP_MODE_V_reflectionTex).y==3;
}
#else
{
l9_136=(int(SC_USE_CLAMP_TO_BORDER_reflectionTex)!=0);
}
#endif
float l9_137=l9_128;
float l9_138=l9_135;
sc_ClampUV(l9_137,reflectionTexUvMinMax.y,reflectionTexUvMinMax.w,l9_136,l9_138);
l9_130=l9_138;
...
#endif
vec2 l9_139=sc_TransformUV(l9_129,(int(SC_USE_UV_TRANSFORM_reflectionTex)!=0),reflectionTexTransform);
float l9_140=l9_139.x;
float l9_141=l9_130;
sc_SoftwareWrapLate(l9_140,ivec2(SC_SOFTWARE_WRAP_MODE_U_reflectionTex,SC_SOFTWARE_WRAP_MODE_V_reflectionTex).x,l9_124,l9_141);
float l9_142=l9_139.y;
float l9_143=l9_141;
sc_SoftwareWrapLate(l9_142,ivec2(SC_SOFTWARE_WRAP_MODE_U_reflectionTex,SC_SOFTWARE_WRAP_MODE_V_reflectionTex).y,l9_124,l9_143);
float l9_144=l9_143;
vec3 l9_145=sc_SamplingCoordsViewToGlobal(vec2(l9_140,l9_142),reflectionTexLayout,reflectionTexGetStereoViewIndex());
vec4 l9_146=texture(reflectionTex,l9_145.xy,0.0);
vec4 l9_147;
#if (SC_USE_CLAMP_TO_BORDER_reflectionTex)
{
l9_147=mix(reflectionTexBorderColor,l9_146,vec4(l9_144));
}
#else
{
l9_147=l9_146;
...
{
vec2 l9_152;
Node1_If_else(0.0,vec2(0.0),vec2(0.0),l9_152,l9_18);
l9_151=l9_152;
}
#else
{
...
{
vec2 l9_154;
Node35_If_else(0.0,vec2(0.0),vec2(0.0),l9_154,l9_18);
l9_153=l9_154;
}
#else
{
...
#if (reflectionModulationTexLayout==2)
{
bool l9_156=(int(SC_USE_CLAMP_TO_BORDER_reflectionModulationTex)!=0)&&(!(int(SC_USE_UV_MIN_MAX_reflectionModulationTex)!=0));
float l9_157=l9_149.x;
sc_SoftwareWrapEarly(l9_157,ivec2(SC_SOFTWARE_WRAP_MODE_U_reflectionModulationTex,SC_SOFTWARE_WRAP_MODE_V_reflectionModulationTex).x);
float l9_158=l9_157;
float l9_159=l9_149.y;
sc_SoftwareWrapEarly(l9_159,ivec2(SC_SOFTWARE_WRAP_MODE_U_reflectionModulationTex,SC_SOFTWARE_WRAP_MODE_V_reflectionModulationTex).y);
float l9_160=l9_159;
vec2 l9_161;
float l9_162;
#if (SC_USE_UV_MIN_MAX_reflectionModulationTex)
...
#if (SC_USE_CLAMP_TO_BORDER_reflectionModulationTex)
{
l9_163=ivec2(SC_SOFTWARE_WRAP_MODE_U_reflectionModulationTex,SC_SOFTWARE_WRAP_MODE_V_reflectionModulationTex).x==3;
}
#else
{
l9_163=(int(SC_USE_CLAMP_TO_BORDER_reflectionModulationTex)!=0);
}
#endif
float l9_164=l9_158;
float l9_165=1.0;
sc_ClampUV(l9_164,reflectionModulationTexUvMinMax.x,reflectionModulationTexUvMinMax.z,l9_163,l9_165);
float l9_166=l9_164;
float l9_167=l9_165;
bool l9_168;
#if (SC_USE_CLAMP_TO_BORDER_reflectionModulationTex)
{
l9_168=ivec2(SC_SOFTWARE_WRAP_MODE_U_reflectionModulationTex,SC_SOFTWARE_WRAP_MODE_V_reflectionModulationTex).y==3;
}
#else
{
...
float l9_169=l9_160;
float l9_170=l9_167;
sc_ClampUV(l9_169,reflectionModulationTexUvMinMax.y,reflectionModulationTexUvMinMax.w,l9_168,l9_170);
l9_162=l9_170;
...
#endif
vec2 l9_171=sc_TransformUV(l9_161,(int(SC_USE_UV_TRANSFORM_reflectionModulationTex)!=0),reflectionModulationTexTransform);
float l9_172=l9_171.x;
float l9_173=l9_162;
sc_SoftwareWrapLate(l9_172,ivec2(SC_SOFTWARE_WRAP_MODE_U_reflectionModulationTex,SC_SOFTWARE_WRAP_MODE_V_reflectionModulationTex).x,l9_156,l9_173);
float l9_174=l9_171.y;
float l9_175=l9_173;
sc_SoftwareWrapLate(l9_174,ivec2(SC_SOFTWARE_WRAP_MODE_U_reflectionModulationTex,SC_SOFTWARE_WRAP_MODE_V_reflectionModulationTex).y,l9_156,l9_175);
float l9_176=l9_175;
vec3 l9_177=sc_SamplingCoordsViewToGlobal(vec2(l9_172,l9_174),reflectionModulationTexLayout,reflectionModulationTexGetStereoViewIndex());
vec4 l9_178=texture(reflectionModulationTexArrSC,l9_177,0.0);
vec4 l9_179;
#if (SC_USE_CLAMP_TO_BORDER_reflectionModulationTex)
{
l9_179=mix(reflectionModulationTexBorderColor,l9_178,vec4(l9_176));
}
#else
{
l9_179=l9_178;
...
#else
{
bool l9_180=(int(SC_USE_CLAMP_TO_BORDER_reflectionModulationTex)!=0)&&(!(int(SC_USE_UV_MIN_MAX_reflectionModulationTex)!=0));
float l9_181=l9_149.x;
sc_SoftwareWrapEarly(l9_181,ivec2(SC_SOFTWARE_WRAP_MODE_U_reflectionModulationTex,SC_SOFTWARE_WRAP_MODE_V_reflectionModulationTex).x);
float l9_182=l9_181;
float l9_183=l9_149.y;
sc_SoftwareWrapEarly(l9_183,ivec2(SC_SOFTWARE_WRAP_MODE_U_reflectionModulationTex,SC_SOFTWARE_WRAP_MODE_V_reflectionModulationTex).y);
float l9_184=l9_183;
vec2 l9_185;
float l9_186;
#if (SC_USE_UV_MIN_MAX_reflectionModulationTex)
...
#if (SC_USE_CLAMP_TO_BORDER_reflectionModulationTex)
{
l9_187=ivec2(SC_SOFTWARE_WRAP_MODE_U_reflectionModulationTex,SC_SOFTWARE_WRAP_MODE_V_reflectionModulationTex).x==3;
}
#else
{
l9_187=(int(SC_USE_CLAMP_TO_BORDER_reflectionModulationTex)!=0);
}
#endif
float l9_188=l9_182;
float l9_189=1.0;
sc_ClampUV(l9_188,reflectionModulationTexUvMinMax.x,reflectionModulationTexUvMinMax.z,l9_187,l9_189);
float l9_190=l9_188;
float l9_191=l9_189;
bool l9_192;
#if (SC_USE_CLAMP_TO_BORDER_reflectionModulationTex)
{
l9_192=ivec2(SC_SOFTWARE_WRAP_MODE_U_reflectionModulationTex,SC_SOFTWARE_WRAP_MODE_V_reflectionModulationTex).y==3;
}
#else
{
l9_192=(int(SC_USE_CLAMP_TO_BORDER_reflectionModulationTex)!=0);
}
#endif
float l9_193=l9_184;
float l9_194=l9_191;
sc_ClampUV(l9_193,reflectionModulationTexUvMinMax.y,reflectionModulationTexUvMinMax.w,l9_192,l9_194);
l9_186=l9_194;
...
#endif
vec2 l9_195=sc_TransformUV(l9_185,(int(SC_USE_UV_TRANSFORM_reflectionModulationTex)!=0),reflectionModulationTexTransform);
float l9_196=l9_195.x;
float l9_197=l9_186;
sc_SoftwareWrapLate(l9_196,ivec2(SC_SOFTWARE_WRAP_MODE_U_reflectionModulationTex,SC_SOFTWARE_WRAP_MODE_V_reflectionModulationTex).x,l9_180,l9_197);
float l9_198=l9_195.y;
float l9_199=l9_197;
sc_SoftwareWrapLate(l9_198,ivec2(SC_SOFTWARE_WRAP_MODE_U_reflectionModulationTex,SC_SOFTWARE_WRAP_MODE_V_reflectionModulationTex).y,l9_180,l9_199);
float l9_200=l9_199;
vec3 l9_201=sc_SamplingCoordsViewToGlobal(vec2(l9_196,l9_198),reflectionModulationTexLayout,reflectionModulationTexGetStereoViewIndex());
vec4 l9_202=texture(reflectionModulationTex,l9_201.xy,0.0);
vec4 l9_203;
#if (SC_USE_CLAMP_TO_BORDER_reflectionModulationTex)
{
l9_203=mix(reflectionModulationTexBorderColor,l9_202,vec4(l9_200));
}
#else
{
l9_203=l9_202;
...
#else
{
l9_148=Port_Default_N041;
}
#endif
l9_87=vec3(reflectionIntensity)*ssSRGB_to_Linear(l9_99.xyz*l9_148);
}
#else
{
...
{
vec2 l9_209;
Node1_If_else(0.0,vec2(0.0),vec2(0.0),l9_209,l9_18);
l9_208=l9_209;
}
#else
{
...
{
vec2 l9_211;
Node35_If_else(0.0,vec2(0.0),vec2(0.0),l9_211,l9_18);
l9_210=l9_211;
}
#else
{
...
#if (rimColorTexLayout==2)
{
bool l9_213=(int(SC_USE_CLAMP_TO_BORDER_rimColorTex)!=0)&&(!(int(SC_USE_UV_MIN_MAX_rimColorTex)!=0));
float l9_214=l9_206.x;
sc_SoftwareWrapEarly(l9_214,ivec2(SC_SOFTWARE_WRAP_MODE_U_rimColorTex,SC_SOFTWARE_WRAP_MODE_V_rimColorTex).x);
float l9_215=l9_214;
float l9_216=l9_206.y;
sc_SoftwareWrapEarly(l9_216,ivec2(SC_SOFTWARE_WRAP_MODE_U_rimColorTex,SC_SOFTWARE_WRAP_MODE_V_rimColorTex).y);
float l9_217=l9_216;
vec2 l9_218;
float l9_219;
#if (SC_USE_UV_MIN_MAX_rimColorTex)
...
#if (SC_USE_CLAMP_TO_BORDER_rimColorTex)
{
l9_220=ivec2(SC_SOFTWARE_WRAP_MODE_U_rimColorTex,SC_SOFTWARE_WRAP_MODE_V_rimColorTex).x==3;
}
#else
{
...
float l9_221=l9_215;
float l9_222=1.0;
sc_ClampUV(l9_221,rimColorTexUvMinMax.x,rimColorTexUvMinMax.z,l9_220,l9_222);
float l9_223=l9_221;
float l9_224=l9_222;
bool l9_225;
#if (SC_USE_CLAMP_TO_BORDER_rimColorTex)
{
l9_225=ivec2(SC_SOFTWARE_WRAP_MODE_U_rimColorTex,SC_SOFTWARE_WRAP_MODE_V_rimColorTex).y==3;
}
#else
{
...
float l9_226=l9_217;
float l9_227=l9_224;
sc_ClampUV(l9_226,rimColorTexUvMinMax.y,rimColorTexUvMinMax.w,l9_225,l9_227);
l9_219=l9_227;
...
#endif
vec2 l9_228=sc_TransformUV(l9_218,(int(SC_USE_UV_TRANSFORM_rimColorTex)!=0),rimColorTexTransform);
float l9_229=l9_228.x;
float l9_230=l9_219;
sc_SoftwareWrapLate(l9_229,ivec2(SC_SOFTWARE_WRAP_MODE_U_rimColorTex,SC_SOFTWARE_WRAP_MODE_V_rimColorTex).x,l9_213,l9_230);
float l9_231=l9_228.y;
float l9_232=l9_230;
sc_SoftwareWrapLate(l9_231,ivec2(SC_SOFTWARE_WRAP_MODE_U_rimColorTex,SC_SOFTWARE_WRAP_MODE_V_rimColorTex).y,l9_213,l9_232);
float l9_233=l9_232;
vec3 l9_234=sc_SamplingCoordsViewToGlobal(vec2(l9_229,l9_231),rimColorTexLayout,rimColorTexGetStereoViewIndex());
vec4 l9_235=texture(rimColorTexArrSC,l9_234,0.0);
vec4 l9_236;
#if (SC_USE_CLAMP_TO_BORDER_rimColorTex)
{
l9_236=mix(rimColorTexBorderColor,l9_235,vec4(l9_233));
}
#else
{
l9_236=l9_235;
...
#else
{
bool l9_237=(int(SC_USE_CLAMP_TO_BORDER_rimColorTex)!=0)&&(!(int(SC_USE_UV_MIN_MAX_rimColorTex)!=0));
float l9_238=l9_206.x;
sc_SoftwareWrapEarly(l9_238,ivec2(SC_SOFTWARE_WRAP_MODE_U_rimColorTex,SC_SOFTWARE_WRAP_MODE_V_rimColorTex).x);
float l9_239=l9_238;
float l9_240=l9_206.y;
sc_SoftwareWrapEarly(l9_240,ivec2(SC_SOFTWARE_WRAP_MODE_U_rimColorTex,SC_SOFTWARE_WRAP_MODE_V_rimColorTex).y);
float l9_241=l9_240;
vec2 l9_242;
float l9_243;
#if (SC_USE_UV_MIN_MAX_rimColorTex)
...
#if (SC_USE_CLAMP_TO_BORDER_rimColorTex)
{
l9_244=ivec2(SC_SOFTWARE_WRAP_MODE_U_rimColorTex,SC_SOFTWARE_WRAP_MODE_V_rimColorTex).x==3;
}
#else
{
l9_244=(int(SC_USE_CLAMP_TO_BORDER_rimColorTex)!=0);
}
#endif
float l9_245=l9_239;
float l9_246=1.0;
sc_ClampUV(l9_245,rimColorTexUvMinMax.x,rimColorTexUvMinMax.z,l9_244,l9_246);
float l9_247=l9_245;
float l9_248=l9_246;
bool l9_249;
#if (SC_USE_CLAMP_TO_BORDER_rimColorTex)
{
l9_249=ivec2(SC_SOFTWARE_WRAP_MODE_U_rimColorTex,SC_SOFTWARE_WRAP_MODE_V_rimColorTex).y==3;
}
#else
{
l9_249=(int(SC_USE_CLAMP_TO_BORDER_rimColorTex)!=0);
}
#endif
float l9_250=l9_241;
float l9_251=l9_248;
sc_ClampUV(l9_250,rimColorTexUvMinMax.y,rimColorTexUvMinMax.w,l9_249,l9_251);
l9_243=l9_251;
...
#endif
vec2 l9_252=sc_TransformUV(l9_242,(int(SC_USE_UV_TRANSFORM_rimColorTex)!=0),rimColorTexTransform);
float l9_253=l9_252.x;
float l9_254=l9_243;
sc_SoftwareWrapLate(l9_253,ivec2(SC_SOFTWARE_WRAP_MODE_U_rimColorTex,SC_SOFTWARE_WRAP_MODE_V_rimColorTex).x,l9_237,l9_254);
float l9_255=l9_252.y;
float l9_256=l9_254;
sc_SoftwareWrapLate(l9_255,ivec2(SC_SOFTWARE_WRAP_MODE_U_rimColorTex,SC_SOFTWARE_WRAP_MODE_V_rimColorTex).y,l9_237,l9_256);
float l9_257=l9_256;
vec3 l9_258=sc_SamplingCoordsViewToGlobal(vec2(l9_253,l9_255),rimColorTexLayout,rimColorTexGetStereoViewIndex());
vec4 l9_259=texture(rimColorTex,l9_258.xy,0.0);
vec4 l9_260;
#if (SC_USE_CLAMP_TO_BORDER_rimColorTex)
{
l9_260=mix(rimColorTexBorderColor,l9_259,vec4(l9_257));
}
#else
{
l9_260=l9_259;
...
#else
{
l9_205=Port_Default_N170;
}
#endif
vec3 l9_261=ssSRGB_to_Linear((rimColor*vec3(rimIntensity))*l9_205);
float l9_262;
#if (rimInvert)
{
vec3 l9_263;
Node337_If_else(0.0,vec3(0.0),vec3(0.0),l9_263,l9_18);
l9_262=abs(dot(l9_263,-l9_9));
}
#else
{
vec3 l9_264;
Node337_If_else(0.0,vec3(0.0),vec3(0.0),l9_264,l9_18);
l9_262=1.0-abs(dot(l9_264,-l9_9));
}
#endif
float l9_265;
if (l9_262<=0.0)
...
{
l9_265=pow(l9_262,rimExponent);
}
l9_204=l9_261*vec3(l9_265);
}
#else
{
l9_204=Port_Default_N173;
}
#endif
vec3 l9_266=l9_83+l9_87;
vec3 l9_267=l9_266+l9_204;
vec3 l9_268;
#if (SC_DEVICE_CLASS>=2)
{
l9_268=vec3(pow(l9_267.x,0.45454544),pow(l9_267.y,0.45454544),pow(l9_267.z,0.45454544));
}
#else
{
l9_268=sqrt(l9_267);
...
#endif
vec2 param_17;
Node176_Switch(0.0,vec2(0.0),vec2(0.0),vec2(0.0),vec2(0.0),vec2(0.0),param_17,l9_18);
vec2 l9_269=param_17;
vec4 l9_270;
#if (materialParamsTexLayout==2)
{
bool l9_271=(int(SC_USE_CLAMP_TO_BORDER_materialParamsTex)!=0)&&(!(int(SC_USE_UV_MIN_MAX_materialParamsTex)!=0));
float l9_272=l9_269.x;
sc_SoftwareWrapEarly(l9_272,ivec2(SC_SOFTWARE_WRAP_MODE_U_materialParamsTex,SC_SOFTWARE_WRAP_MODE_V_materialParamsTex).x);
float l9_273=l9_272;
float l9_274=l9_269.y;
sc_SoftwareWrapEarly(l9_274,ivec2(SC_SOFTWARE_WRAP_MODE_U_materialParamsTex,SC_SOFTWARE_WRAP_MODE_V_materialParamsTex).y);
float l9_275=l9_274;
vec2 l9_276;
float l9_277;
#if (SC_USE_UV_MIN_MAX_materialParamsTex)
...
#if (SC_USE_CLAMP_TO_BORDER_materialParamsTex)
{
l9_278=ivec2(SC_SOFTWARE_WRAP_MODE_U_materialParamsTex,SC_SOFTWARE_WRAP_MODE_V_materialParamsTex).x==3;
}
#else
{
l9_278=(int(SC_USE_CLAMP_TO_BORDER_materialParamsTex)!=0);
}
#endif
float l9_279=l9_273;
float l9_280=1.0;
sc_ClampUV(l9_279,materialParamsTexUvMinMax.x,materialParamsTexUvMinMax.z,l9_278,l9_280);
float l9_281=l9_279;
float l9_282=l9_280;
bool l9_283;
#if (SC_USE_CLAMP_TO_BORDER_materialParamsTex)
{
l9_283=ivec2(SC_SOFTWARE_WRAP_MODE_U_materialParamsTex,SC_SOFTWARE_WRAP_MODE_V_materialParamsTex).y==3;
}
#else
{
l9_283=(int(SC_USE_CLAMP_TO_BORDER_materialParamsTex)!=0);
}
#endif
float l9_284=l9_275;
float l9_285=l9_282;
sc_ClampUV(l9_284,materialParamsTexUvMinMax.y,materialParamsTexUvMinMax.w,l9_283,l9_285);
l9_277=l9_285;
...
#endif
vec2 l9_286=sc_TransformUV(l9_276,(int(SC_USE_UV_TRANSFORM_materialParamsTex)!=0),materialParamsTexTransform);
float l9_287=l9_286.x;
float l9_288=l9_277;
sc_SoftwareWrapLate(l9_287,ivec2(SC_SOFTWARE_WRAP_MODE_U_materialParamsTex,SC_SOFTWARE_WRAP_MODE_V_materialParamsTex).x,l9_271,l9_288);
float l9_289=l9_286.y;
float l9_290=l9_288;
sc_SoftwareWrapLate(l9_289,ivec2(SC_SOFTWARE_WRAP_MODE_U_materialParamsTex,SC_SOFTWARE_WRAP_MODE_V_materialParamsTex).y,l9_271,l9_290);
float l9_291=l9_290;
vec3 l9_292=sc_SamplingCoordsViewToGlobal(vec2(l9_287,l9_289),materialParamsTexLayout,materialParamsTexGetStereoViewIndex());
vec4 l9_293=texture(materialParamsTexArrSC,l9_292,0.0);
vec4 l9_294;
#if (SC_USE_CLAMP_TO_BORDER_materialParamsTex)
{
l9_294=mix(materialParamsTexBorderColor,l9_293,vec4(l9_291));
}
#else
{
l9_294=l9_293;
...
#else
{
bool l9_295=(int(SC_USE_CLAMP_TO_BORDER_materialParamsTex)!=0)&&(!(int(SC_USE_UV_MIN_MAX_materialParamsTex)!=0));
float l9_296=l9_269.x;
sc_SoftwareWrapEarly(l9_296,ivec2(SC_SOFTWARE_WRAP_MODE_U_materialParamsTex,SC_SOFTWARE_WRAP_MODE_V_materialParamsTex).x);
float l9_297=l9_296;
float l9_298=l9_269.y;
sc_SoftwareWrapEarly(l9_298,ivec2(SC_SOFTWARE_WRAP_MODE_U_materialParamsTex,SC_SOFTWARE_WRAP_MODE_V_materialParamsTex).y);
float l9_299=l9_298;
vec2 l9_300;
float l9_301;
#if (SC_USE_UV_MIN_MAX_materialParamsTex)
...
#if (SC_USE_CLAMP_TO_BORDER_materialParamsTex)
{
l9_302=ivec2(SC_SOFTWARE_WRAP_MODE_U_materialParamsTex,SC_SOFTWARE_WRAP_MODE_V_materialParamsTex).x==3;
}
#else
{
l9_302=(int(SC_USE_CLAMP_TO_BORDER_materialParamsTex)!=0);
}
#endif
float l9_303=l9_297;
float l9_304=1.0;
sc_ClampUV(l9_303,materialParamsTexUvMinMax.x,materialParamsTexUvMinMax.z,l9_302,l9_304);
float l9_305=l9_303;
float l9_306=l9_304;
bool l9_307;
#if (SC_USE_CLAMP_TO_BORDER_materialParamsTex)
{
l9_307=ivec2(SC_SOFTWARE_WRAP_MODE_U_materialParamsTex,SC_SOFTWARE_WRAP_MODE_V_materialParamsTex).y==3;
}
#else
{
l9_307=(int(SC_USE_CLAMP_TO_BORDER_materialParamsTex)!=0);
}
#endif
float l9_308=l9_299;
float l9_309=l9_306;
sc_ClampUV(l9_308,materialParamsTexUvMinMax.y,materialParamsTexUvMinMax.w,l9_307,l9_309);
l9_301=l9_309;
l9_300=vec2(l9_305,l9_308);
}
#else
{
l9_301=1.0;
l9_300=vec2(l9_297,l9_299);
}
#endif
vec2 l9_310=sc_TransformUV(l9_300,(int(SC_USE_UV_TRANSFORM_materialParamsTex)!=0),materialParamsTexTransform);
float l9_311=l9_310.x;
float l9_312=l9_301;
sc_SoftwareWrapLate(l9_311,ivec2(SC_SOFTWARE_WRAP_MODE_U_materialParamsTex,SC_SOFTWARE_WRAP_MODE_V_materialParamsTex).x,l9_295,l9_312);
float l9_313=l9_310.y;
float l9_314=l9_312;
sc_SoftwareWrapLate(l9_313,ivec2(SC_SOFTWARE_WRAP_MODE_U_materialParamsTex,SC_SOFTWARE_WRAP_MODE_V_materialParamsTex).y,l9_295,l9_314);
float l9_315=l9_314;
vec3 l9_316=sc_SamplingCoordsViewToGlobal(vec2(l9_311,l9_313),materialParamsTexLayout,materialParamsTexGetStereoViewIndex());
vec4 l9_317=texture(materialParamsTex,l9_316.xy,0.0);
vec4 l9_318;
#if (SC_USE_CLAMP_TO_BORDER_materialParamsTex)
{
l9_318=mix(materialParamsTexBorderColor,l9_317,vec4(l9_315));
}
#else
{
l9_318=l9_317;
...
#endif
vec3 param_22;
Node188_If_else(0.0,vec3(0.0),vec3(0.0),param_22,l9_18);
vec3 l9_319=param_22;
vec3 l9_320;
#if (Tweak_N179)
{
l9_320=Port_Value1_N079;
}
#else
{
vec3 l9_321;
...
{
vec2 l9_322;
Node176_Switch(0.0,vec2(0.0),vec2(0.0),vec2(0.0),vec2(0.0),vec2(0.0),l9_322,l9_18);
vec2 l9_323=l9_322;
vec4 l9_324;
#if (materialParamsTexLayout==2)
{
bool l9_325=(int(SC_USE_CLAMP_TO_BORDER_materialParamsTex)!=0)&&(!(int(SC_USE_UV_MIN_MAX_materialParamsTex)!=0));
float l9_326=l9_323.x;
sc_SoftwareWrapEarly(l9_326,ivec2(SC_SOFTWARE_WRAP_MODE_U_materialParamsTex,SC_SOFTWARE_WRAP_MODE_V_materialParamsTex).x);
float l9_327=l9_326;
float l9_328=l9_323.y;
sc_SoftwareWrapEarly(l9_328,ivec2(SC_SOFTWARE_WRAP_MODE_U_materialParamsTex,SC_SOFTWARE_WRAP_MODE_V_materialParamsTex).y);
float l9_329=l9_328;
vec2 l9_330;
float l9_331;
#if (SC_USE_UV_MIN_MAX_materialParamsTex)
...
#if (SC_USE_CLAMP_TO_BORDER_materialParamsTex)
{
l9_332=ivec2(SC_SOFTWARE_WRAP_MODE_U_materialParamsTex,SC_SOFTWARE_WRAP_MODE_V_materialParamsTex).x==3;
}
#else
{
l9_332=(int(SC_USE_CLAMP_TO_BORDER_materialParamsTex)!=0);
}
#endif
float l9_333=l9_327;
float l9_334=1.0;
sc_ClampUV(l9_333,materialParamsTexUvMinMax.x,materialParamsTexUvMinMax.z,l9_332,l9_334);
float l9_335=l9_333;
float l9_336=l9_334;
bool l9_337;
#if (SC_USE_CLAMP_TO_BORDER_materialParamsTex)
{
l9_337=ivec2(SC_SOFTWARE_WRAP_MODE_U_materialParamsTex,SC_SOFTWARE_WRAP_MODE_V_materialParamsTex).y==3;
}
#else
{
l9_337=(int(SC_USE_CLAMP_TO_BORDER_materialParamsTex)!=0);
}
#endif
float l9_338=l9_329;
float l9_339=l9_336;
sc_ClampUV(l9_338,materialParamsTexUvMinMax.y,materialParamsTexUvMinMax.w,l9_337,l9_339);
l9_331=l9_339;
l9_330=vec2(l9_335,l9_338);
}
#else
{
l9_331=1.0;
l9_330=vec2(l9_327,l9_329);
}
#endif
vec2 l9_340=sc_TransformUV(l9_330,(int(SC_USE_UV_TRANSFORM_materialParamsTex)!=0),materialParamsTexTransform);
float l9_341=l9_340.x;
float l9_342=l9_331;
sc_SoftwareWrapLate(l9_341,ivec2(SC_SOFTWARE_WRAP_MODE_U_materialParamsTex,SC_SOFTWARE_WRAP_MODE_V_materialParamsTex).x,l9_325,l9_342);
float l9_343=l9_340.y;
float l9_344=l9_342;
sc_SoftwareWrapLate(l9_343,ivec2(SC_SOFTWARE_WRAP_MODE_U_materialParamsTex,SC_SOFTWARE_WRAP_MODE_V_materialParamsTex).y,l9_325,l9_344);
float l9_345=l9_344;
vec3 l9_346=sc_SamplingCoordsViewToGlobal(vec2(l9_341,l9_343),materialParamsTexLayout,materialParamsTexGetStereoViewIndex());
vec4 l9_347=texture(materialParamsTexArrSC,l9_346,0.0);
vec4 l9_348;
#if (SC_USE_CLAMP_TO_BORDER_materialParamsTex)
{
l9_348=mix(materialParamsTexBorderColor,l9_347,vec4(l9_345));
}
#else
{
l9_348=l9_347;
...
#else
{
bool l9_349=(int(SC_USE_CLAMP_TO_BORDER_materialParamsTex)!=0)&&(!(int(SC_USE_UV_MIN_MAX_materialParamsTex)!=0));
float l9_350=l9_323.x;
sc_SoftwareWrapEarly(l9_350,ivec2(SC_SOFTWARE_WRAP_MODE_U_materialParamsTex,SC_SOFTWARE_WRAP_MODE_V_materialParamsTex).x);
float l9_351=l9_350;
float l9_352=l9_323.y;
sc_SoftwareWrapEarly(l9_352,ivec2(SC_SOFTWARE_WRAP_MODE_U_materialParamsTex,SC_SOFTWARE_WRAP_MODE_V_materialParamsTex).y);
float l9_353=l9_352;
vec2 l9_354;
float l9_355;
#if (SC_USE_UV_MIN_MAX_materialParamsTex)
...
#if (SC_USE_CLAMP_TO_BORDER_materialParamsTex)
{
l9_356=ivec2(SC_SOFTWARE_WRAP_MODE_U_materialParamsTex,SC_SOFTWARE_WRAP_MODE_V_materialParamsTex).x==3;
}
#else
{
l9_356=(int(SC_USE_CLAMP_TO_BORDER_materialParamsTex)!=0);
}
#endif
float l9_357=l9_351;
float l9_358=1.0;
sc_ClampUV(l9_357,materialParamsTexUvMinMax.x,materialParamsTexUvMinMax.z,l9_356,l9_358);
float l9_359=l9_357;
float l9_360=l9_358;
bool l9_361;
#if (SC_USE_CLAMP_TO_BORDER_materialParamsTex)
{
l9_361=ivec2(SC_SOFTWARE_WRAP_MODE_U_materialParamsTex,SC_SOFTWARE_WRAP_MODE_V_materialParamsTex).y==3;
}
#else
{
l9_361=(int(SC_USE_CLAMP_TO_BORDER_materialParamsTex)!=0);
}
#endif
float l9_362=l9_353;
float l9_363=l9_360;
sc_ClampUV(l9_362,materialParamsTexUvMinMax.y,materialParamsTexUvMinMax.w,l9_361,l9_363);
l9_355=l9_363;
l9_354=vec2(l9_359,l9_362);
}
#else
{
l9_355=1.0;
l9_354=vec2(l9_351,l9_353);
}
#endif
vec2 l9_364=sc_TransformUV(l9_354,(int(SC_USE_UV_TRANSFORM_materialParamsTex)!=0),materialParamsTexTransform);
float l9_365=l9_364.x;
float l9_366=l9_355;
sc_SoftwareWrapLate(l9_365,ivec2(SC_SOFTWARE_WRAP_MODE_U_materialParamsTex,SC_SOFTWARE_WRAP_MODE_V_materialParamsTex).x,l9_349,l9_366);
float l9_367=l9_364.y;
float l9_368=l9_366;
sc_SoftwareWrapLate(l9_367,ivec2(SC_SOFTWARE_WRAP_MODE_U_materialParamsTex,SC_SOFTWARE_WRAP_MODE_V_materialParamsTex).y,l9_349,l9_368);
float l9_369=l9_368;
vec3 l9_370=sc_SamplingCoordsViewToGlobal(vec2(l9_365,l9_367),materialParamsTexLayout,materialParamsTexGetStereoViewIndex());
vec4 l9_371=texture(materialParamsTex,l9_370.xy,0.0);
vec4 l9_372;
#if (SC_USE_CLAMP_TO_BORDER_materialParamsTex)
{
l9_372=mix(materialParamsTexBorderColor,l9_371,vec4(l9_369));
}
#else
{
l9_372=l9_371;
...
#endif
vec3 l9_373=vec3(metallic*l9_324.x);
vec3 l9_374=mix(Port_Input0_N239,Port_Import_N235*l9_373,l9_373);
vec3 l9_375;
Node188_If_else(0.0,vec3(0.0),vec3(0.0),l9_375,l9_18);
l9_321=mix(Port_Input0_N325,mix((vec3(1.0-specularAoDarkening)*l9_374)*l9_374,Port_Input1_N322,l9_375),vec3(specularAoIntensity));
}
#else
{
l9_321=Port_Default_N326;
}
#endif
l9_320=l9_321;
}
...
#endif
float l9_377=clamp(l9_81,0.0,1.0);
#if (sc_BlendMode_AlphaTest)
{
if (l9_377<alphaTestThreshold)
{
discard;
}
}
...
#if (ENABLE_STIPPLE_PATTERN_TEST)
{
if (l9_377<((mod(dot(floor(mod(gl_FragCoord.xy,vec2(4.0))),vec2(4.0,1.0))*9.0,16.0)+1.0)/17.0))
{
discard;
}
}
#endif
vec3 l9_378=max(l9_19.xyz,vec3(0.0));
vec4 l9_379;
#if (sc_ProjectiveShadowsCaster)
{
l9_379=vec4(l9_378,l9_377);
}
#else
{
l9_379=ngsCalculateLighting(l9_378,l9_377,l9_376,l9_8,l9_9,max(l9_268,vec3(0.0)),clamp(metallic*l9_270.x,0.0,1.0),clamp(roughness*l9_270.y,0.0,1.0),clamp(l9_319,vec3(0.0),vec3(1.0)),clamp(l9_320,vec3(0.0),vec3(1.0)));
}
#endif
vec4 l9_380=max(l9_379,vec4(0.0));
if (l9_0)
{
vec4 l9_381;
...
#endif
sc_writeFragData0Internal(max(l9_381,vec4(0.0)),sc_UniformConstants.x,sc_ShaderCacheConstant);
return;
}
vec4 l9_383;
#if (sc_ProjectiveShadowsCaster)
...
#if (sc_BlendMode_PremultipliedAlpha)
{
l9_385=clamp(l9_380.w*2.0,0.0,1.0);
}
#else
{
float l9_386;
...
{
l9_386=clamp(dot(l9_380.xyz,vec3(l9_380.w)),0.0,1.0);
}
#else
{
float l9_387;
...
#if (sc_BlendMode_Multiply)
{
l9_388=(1.0-dot(l9_380.xyz,vec3(0.33333001)))*l9_380.w;
}
#else
{
float l9_389;
...
{
l9_389=(1.0-clamp(dot(l9_380.xyz,vec3(1.0)),0.0,1.0))*l9_380.w;
}
#else
{
float l9_390;
#if (sc_BlendMode_ColoredGlass)
{
l9_390=clamp(dot(l9_380.xyz,vec3(1.0)),0.0,1.0)*l9_380.w;
}
#else
{
float l9_391;
#if (sc_BlendMode_Add)
{
l9_391=clamp(dot(l9_380.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_392;
#if (sc_BlendMode_AddWithAlphaFactor)
{
l9_392=clamp(dot(l9_380.xyz,vec3(1.0)),0.0,1.0)*l9_380.w;
}
#else
{
float l9_393;
...
{
l9_393=dot(l9_380.xyz,vec3(0.33333001))*l9_380.w;
}
#else
{
float l9_394;
#if (sc_BlendMode_Min)
{
l9_394=1.0-clamp(dot(l9_380.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_395;
#if (sc_BlendMode_Max)
{
l9_395=clamp(dot(l9_380.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
l9_395=1.0;
...
#endif
l9_383=vec4(mix(sc_ShadowColor.xyz,sc_ShadowColor.xyz*l9_380.xyz,vec3(sc_ShadowColor.w)),sc_ShadowDensity*l9_384);
}
#else
{
vec4 l9_396;
...
{
vec3 l9_398=sc_GetFramebufferColor().xyz;
vec3 l9_399=mix(l9_398,definedBlend(l9_398,l9_380.xyz).xyz,vec3(l9_380.w));
vec4 l9_400=vec4(l9_399.x,l9_399.y,l9_399.z,vec4(0.0).w);
l9_400.w=1.0;
l9_397=l9_400;
}
#else
...
#if (sc_Voxelization)
{
l9_401=vec4(varScreenPos.xyz,1.0);
}
#else
{
vec4 l9_402;
#if (sc_OutputBounds)
{
float l9_403=clamp(abs(gl_FragCoord.z),0.0,1.0);
l9_402=vec4(l9_403,1.0-l9_403,1.0,1.0);
}
#else
{
vec4 l9_404;
#if (sc_BlendMode_MultiplyOriginal)
{
float l9_405=l9_380.w;
l9_404=vec4(mix(vec3(1.0),l9_380.xyz,vec3(l9_405)),l9_405);
}
#else
{
vec4 l9_406;
...
{
float l9_407=l9_380.w;
float l9_408;
#if (sc_BlendMode_PremultipliedAlphaAuto)
{
l9_408=clamp(l9_407,0.0,1.0);
}
#else
{
l9_408=l9_407;
...
#endif
l9_406=vec4(l9_380.xyz*l9_408,l9_408);
}
#else
{
l9_406=l9_380;
...
vec4 l9_411=sc_OutputMotionVectorsIfNeeded(varPos,max(l9_409,vec4(0.0)));
vec4 l9_412=clamp(l9_411,vec4(0.0),vec4(1.0));
#if (sc_OITDepthBoundsPass)
{
#if (sc_OITDepthBoundsPass)
{
float l9_413=clamp(viewSpaceDepth()/1000.0,0.0,1.0);
sc_writeFragData0Internal(vec4(max(0.0,1.0-(l9_413-0.0039215689)),min(1.0,l9_413+0.0039215689),0.0,0.0),sc_UniformConstants.x,sc_ShaderCacheConstant);
}
#endif
}
#else
...
#if (sc_OITDepthGatherPass)
{
vec2 l9_414=sc_ScreenCoordsGlobalToView(gl_FragCoord.xy*sc_CurrentRenderTargetDims.zw);
#if (sc_OITMaxLayers4Plus1)
{
if ((gl_FragCoord.z-texture(sc_OITFrontDepthTexture,l9_414).x)<=getFrontLayerZTestEpsilon())
{
discard;
}
}
#endif
int l9_415=encodeDepth(viewSpaceDepth(),texture(sc_OITFilteredDepthBoundsTexture,l9_414).xy);
float l9_416=packValue(l9_415);
int l9_423=int(l9_412.w*255.0);
float l9_424=packValue(l9_423);
sc_writeFragData0Internal(vec4(packValue(l9_415),packValue(l9_415),packValue(l9_415),packValue(l9_415)),sc_UniformConstants.x,sc_ShaderCacheConstant);
sc_writeFragData1(vec4(l9_416,packValue(l9_415),packValue(l9_415),packValue(l9_415)));
sc_writeFragData2(vec4(l9_424,packValue(l9_423),packValue(l9_423),packValue(l9_423)));
...
#if (sc_OITCompositingPass)
{
vec2 l9_427=sc_ScreenCoordsGlobalToView(gl_FragCoord.xy*sc_CurrentRenderTargetDims.zw);
#if (sc_OITMaxLayers4Plus1)
{
if ((gl_FragCoord.z-texture(sc_OITFrontDepthTexture,l9_427).x)<=getFrontLayerZTestEpsilon())
{
discard;
}
}
...
if (l9_432==0)
{
l9_435=texture(sc_OITAlpha0,l9_427);
l9_434=texture(sc_OITDepthLow0,l9_427);
l9_433=texture(sc_OITDepthHigh0,l9_427);
}
else
{
l9_435=vec4(0.0);
...
if (l9_432==1)
{
l9_438=texture(sc_OITAlpha1,l9_427);
l9_437=texture(sc_OITDepthLow1,l9_427);
l9_436=texture(sc_OITDepthHigh1,l9_427);
}
else
{
l9_438=l9_435;
...
if (any(notEqual(l9_436,vec4(0.0)))||any(notEqual(l9_437,vec4(0.0))))
{
int l9_439[8]=l9_428;
unpackValues(l9_436.w,l9_432,l9_439);
unpackValues(l9_436.z,l9_432,l9_439);
unpackValues(l9_436.y,l9_432,l9_439);
unpackValues(l9_436.x,l9_432,l9_439);
unpackValues(l9_437.w,l9_432,l9_439);
unpackValues(l9_437.z,l9_432,l9_439);
unpackValues(l9_437.y,l9_432,l9_439);
unpackValues(l9_437.x,l9_432,l9_439);
int l9_448[8]=l9_429;
unpackValues(l9_438.w,l9_432,l9_448);
unpackValues(l9_438.z,l9_432,l9_448);
unpackValues(l9_438.y,l9_432,l9_448);
unpackValues(l9_438.x,l9_432,l9_448);
}
l9_432++;
continue;
}
...
vec4 l9_453=texture(sc_OITFilteredDepthBoundsTexture,l9_427);
vec2 l9_454=l9_453.xy;
int l9_455;
#if (sc_SkinBonesCount>0)
{
l9_455=encodeDepth(((1.0-l9_453.x)*1000.0)+getDepthOrderingEpsilon(),l9_454);
}
#else
{
l9_455=0;
...
#endif
int l9_456=encodeDepth(viewSpaceDepth(),l9_454);
vec4 l9_457;
l9_457=l9_412*l9_412.w;
vec4 l9_458;
int l9_459=0;
for (int snapLoopIndex=0; snapLoopIndex==0; snapLoopIndex+=0)
{
if (l9_459<8)
{
int l9_460=l9_428[l9_459];
int l9_461=l9_456-l9_455;
bool l9_462=l9_460<l9_461;
bool l9_463;
if (l9_462)
{
l9_463=l9_428[l9_459]>0;
}
else
{
l9_463=l9_462;
...
if (l9_463)
{
vec3 l9_464=l9_457.xyz*(1.0-(float(l9_429[l9_459])/255.0));
l9_458=vec4(l9_464.x,l9_464.y,l9_464.z,l9_457.w);
}
else
{
l9_458=l9_457;
...
sc_writeFragData0Internal(l9_457,sc_UniformConstants.x,sc_ShaderCacheConstant);
#if (sc_OITMaxLayersVisualizeLayerCount)
{
discard;
}
...
sc_writeFragData0Internal(l9_412,sc_UniformConstants.x,sc_ShaderCacheConstant);
}
#endif
}
#else
{
sc_writeFragData0Internal(l9_411,sc_UniformConstants.x,sc_ShaderCacheConstant);
}
#endif
}
#endif

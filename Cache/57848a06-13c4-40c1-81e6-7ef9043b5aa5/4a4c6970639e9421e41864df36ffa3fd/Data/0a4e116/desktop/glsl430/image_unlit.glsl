...
vec3 l9_66=((Port_Red_N029*l9_65.x)+(Port_Green_N029*l9_65.y))+(Port_Blue_N029*l9_65.z);
float l9_67;
...
vec4 l9_126=vec4(l9_66.x,l9_66.y,l9_66.z,vec4(0.0).w);
l9_126.w=l9_125;
...
#endif
sc_writeFragData0Internal(max(l9_127,vec4(0.0)),sc_UniformConstants.x,sc_ShaderCacheConstant);
return;
}
vec4 l9_129;
...
{
l9_131=clamp(l9_125*2.0,0.0,1.0);
}
#else
{
float l9_132;
...
{
l9_132=clamp(dot(l9_126.xyz,vec3(l9_125)),0.0,1.0);
}
#else
{
float l9_133;
...
{
l9_134=(1.0-dot(l9_126.xyz,vec3(0.33333001)))*l9_125;
}
#else
{
float l9_135;
...
{
l9_135=(1.0-clamp(dot(l9_126.xyz,vec3(1.0)),0.0,1.0))*l9_125;
}
#else
{
float l9_136;
...
{
l9_136=clamp(dot(l9_126.xyz,vec3(1.0)),0.0,1.0)*l9_125;
}
#else
{
float l9_137;
#if (sc_BlendMode_Add)
{
l9_137=clamp(dot(l9_126.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_138;
#if (sc_BlendMode_AddWithAlphaFactor)
{
l9_138=clamp(dot(l9_126.xyz,vec3(1.0)),0.0,1.0)*l9_125;
}
#else
{
float l9_139;
...
{
l9_139=dot(l9_126.xyz,vec3(0.33333001))*l9_125;
}
#else
{
float l9_140;
#if (sc_BlendMode_Min)
{
l9_140=1.0-clamp(dot(l9_126.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_141;
#if (sc_BlendMode_Max)
{
l9_141=clamp(dot(l9_126.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
l9_141=1.0;
...
#endif
l9_129=vec4(mix(sc_ShadowColor.xyz,sc_ShadowColor.xyz*l9_126.xyz,vec3(sc_ShadowColor.w)),sc_ShadowDensity*l9_130);
}
#else
{
vec4 l9_142;
...
#if (sc_FramebufferFetch)
{
l9_144=sc_readFragData0_Platform();
}
#else
{
vec2 l9_145=sc_ScreenCoordsGlobalToView(gl_FragCoord.xy*sc_CurrentRenderTargetDims.zw);
vec4 l9_146;
#if (sc_ScreenTextureLayout==2)
{
l9_146=texture(sc_ScreenTextureArrSC,sc_SamplingCoordsViewToGlobal(l9_145,sc_ScreenTextureLayout,sc_ScreenTextureGetStereoViewIndex()),0.0);
}
#else
{
l9_146=texture(sc_ScreenTexture,sc_SamplingCoordsViewToGlobal(l9_145,sc_ScreenTextureLayout,sc_ScreenTextureGetStereoViewIndex()).xy,0.0);
}
#endif
l9_144=l9_146;
}
#endif
vec3 l9_147=mix(l9_144.xyz,definedBlend(l9_144.xyz,l9_126.xyz).xyz,vec3(l9_125));
...
#if (sc_Voxelization)
{
l9_149=vec4(varScreenPos.xyz,1.0);
}
#else
{
vec4 l9_150;
#if (sc_OutputBounds)
{
float l9_151=clamp(abs(gl_FragCoord.z),0.0,1.0);
l9_150=vec4(l9_151,1.0-l9_151,1.0,1.0);
}
#else
{
vec4 l9_152;
#if (sc_BlendMode_MultiplyOriginal)
{
l9_152=vec4(mix(vec3(1.0),l9_126.xyz,vec3(l9_125)),l9_125);
}
#else
{
vec4 l9_153;
...
#endif
l9_153=vec4(l9_126.xyz*l9_154,l9_154);
}
#else
{
l9_153=l9_126;
...
vec4 l9_157=sc_OutputMotionVectorsIfNeeded(varPos,max(l9_155,vec4(0.0)));
vec4 l9_158=clamp(l9_157,vec4(0.0),vec4(1.0));
#if (sc_OITDepthBoundsPass)
{
#if (sc_OITDepthBoundsPass)
{
float l9_159=clamp(viewSpaceDepth()/1000.0,0.0,1.0);
sc_writeFragData0Internal(vec4(max(0.0,1.0-(l9_159-0.0039215689)),min(1.0,l9_159+0.0039215689),0.0,0.0),sc_UniformConstants.x,sc_ShaderCacheConstant);
}
#endif
}
#else
...
#if (sc_OITDepthGatherPass)
{
vec2 l9_160=sc_ScreenCoordsGlobalToView(gl_FragCoord.xy*sc_CurrentRenderTargetDims.zw);
#if (sc_OITMaxLayers4Plus1)
{
if ((gl_FragCoord.z-texture(sc_OITFrontDepthTexture,l9_160).x)<=getFrontLayerZTestEpsilon())
{
discard;
}
}
#endif
int l9_161=encodeDepth(viewSpaceDepth(),texture(sc_OITFilteredDepthBoundsTexture,l9_160).xy);
float l9_162=packValue(l9_161);
int l9_169=int(l9_158.w*255.0);
float l9_170=packValue(l9_169);
sc_writeFragData0Internal(vec4(packValue(l9_161),packValue(l9_161),packValue(l9_161),packValue(l9_161)),sc_UniformConstants.x,sc_ShaderCacheConstant);
sc_writeFragData1(vec4(l9_162,packValue(l9_161),packValue(l9_161),packValue(l9_161)));
sc_writeFragData2(vec4(l9_170,packValue(l9_169),packValue(l9_169),packValue(l9_169)));
...
#if (sc_OITCompositingPass)
{
vec2 l9_173=sc_ScreenCoordsGlobalToView(gl_FragCoord.xy*sc_CurrentRenderTargetDims.zw);
#if (sc_OITMaxLayers4Plus1)
{
if ((gl_FragCoord.z-texture(sc_OITFrontDepthTexture,l9_173).x)<=getFrontLayerZTestEpsilon())
{
discard;
}
}
...
if (l9_178==0)
{
l9_181=texture(sc_OITAlpha0,l9_173);
l9_180=texture(sc_OITDepthLow0,l9_173);
l9_179=texture(sc_OITDepthHigh0,l9_173);
}
else
{
l9_181=vec4(0.0);
...
if (l9_178==1)
{
l9_184=texture(sc_OITAlpha1,l9_173);
l9_183=texture(sc_OITDepthLow1,l9_173);
l9_182=texture(sc_OITDepthHigh1,l9_173);
}
else
{
l9_184=l9_181;
...
if (any(notEqual(l9_182,vec4(0.0)))||any(notEqual(l9_183,vec4(0.0))))
{
int l9_185[8]=l9_174;
unpackValues(l9_182.w,l9_178,l9_185);
unpackValues(l9_182.z,l9_178,l9_185);
unpackValues(l9_182.y,l9_178,l9_185);
unpackValues(l9_182.x,l9_178,l9_185);
unpackValues(l9_183.w,l9_178,l9_185);
unpackValues(l9_183.z,l9_178,l9_185);
unpackValues(l9_183.y,l9_178,l9_185);
unpackValues(l9_183.x,l9_178,l9_185);
int l9_194[8]=l9_175;
unpackValues(l9_184.w,l9_178,l9_194);
unpackValues(l9_184.z,l9_178,l9_194);
unpackValues(l9_184.y,l9_178,l9_194);
unpackValues(l9_184.x,l9_178,l9_194);
}
l9_178++;
continue;
}
...
vec4 l9_199=texture(sc_OITFilteredDepthBoundsTexture,l9_173);
vec2 l9_200=l9_199.xy;
int l9_201;
#if (sc_SkinBonesCount>0)
{
l9_201=encodeDepth(((1.0-l9_199.x)*1000.0)+getDepthOrderingEpsilon(),l9_200);
}
#else
{
l9_201=0;
...
#endif
int l9_202=encodeDepth(viewSpaceDepth(),l9_200);
vec4 l9_203;
l9_203=l9_158*l9_158.w;
vec4 l9_204;
int l9_205=0;
for (int snapLoopIndex=0; snapLoopIndex==0; snapLoopIndex+=0)
{
if (l9_205<8)
{
int l9_206=l9_174[l9_205];
int l9_207=l9_202-l9_201;
bool l9_208=l9_206<l9_207;
bool l9_209;
if (l9_208)
{
l9_209=l9_174[l9_205]>0;
}
else
{
l9_209=l9_208;
...
if (l9_209)
{
vec3 l9_210=l9_203.xyz*(1.0-(float(l9_175[l9_205])/255.0));
l9_204=vec4(l9_210.x,l9_210.y,l9_210.z,l9_203.w);
}
else
{
l9_204=l9_203;
...
sc_writeFragData0Internal(l9_203,sc_UniformConstants.x,sc_ShaderCacheConstant);
#if (sc_OITMaxLayersVisualizeLayerCount)
{
discard;
}
...
#else
{
sc_writeFragData0Internal(l9_157,sc_UniformConstants.x,sc_ShaderCacheConstant);
}
#endif
}
#endif

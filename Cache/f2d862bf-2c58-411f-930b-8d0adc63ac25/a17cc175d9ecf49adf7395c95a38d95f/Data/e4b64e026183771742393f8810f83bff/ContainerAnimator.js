...
var __selfType = requireType("./ContainerAnimator");
    ...
    var ZToggleMover = _classThis = class extends _classSuper {
        ...
        moveToInitial(logIt = false) {
            ...
            if (logIt && this.enableDebugLogs)
                log.i(`Position rentrée : Z = ${this.initialZ}`);
        }
...
//# sourceMappingURL=ContainerAnimator.js.map
...
// @input float handIndex {"hint":"Main : 0 = Droite, 1 = Gauche"}
// @input Component.ScriptComponent sikScript {"hint":"Spectacles Interaction Kit (glisse ici)"}
...
awakeEvent.bind(() => {
    ...
    checkUndefined("handIndex", []);
    checkUndefined("sikScript", []);
    if (script.onAwake) {
       script.onAwake();
    }
});

...
export class ZTweenToggleMover extends BaseScriptComponent {
  @input
  @hint("PinchButton qui déclenche le déplacement")
  ...
  private initialize(): void {
    if (this.enableDebugLogs) log.i("ZTweenToggleMover: Démarrage")
    ...
    if (this.enableDebugLogs) log.i("Initialisation réussie")
  }

  private toggleWithAnimation(): void {
    if (this.currentAnimation) this.currentAnimation()

    const destinationZ = this.isForward ? this.initialZ : this.targetZ
    this.animateTo(destinationZ)

...
//sampler sampler iridescenceMapSmpSC 0:26
//sampler sampler opacityTextureSmpSC 0:27
//sampler sampler sc_EnvmapDiffuseSmpSC 0:28
//sampler sampler sc_EnvmapSpecularSmpSC 0:29
//sampler sampler sc_OITCommonSampler 0:30
...
//sampler sampler sc_RayTracingReflectionsSmpSC 0:34
//sampler sampler sc_RayTracingShadowsSmpSC 0:35
...
//texture texture2D iridescenceMap 0:4:0:26
//texture texture2D opacityTexture 0:5:0:27
//texture texture2D sc_EnvmapDiffuse 0:6:0:28
//texture texture2D sc_EnvmapSpecular 0:7:0:29
//texture texture2D sc_OITAlpha0 0:8:0:30
//texture texture2D sc_OITAlpha1 0:9:0:30
//texture texture2D sc_OITDepthHigh0 0:10:0:30
//texture texture2D sc_OITDepthHigh1 0:11:0:30
//texture texture2D sc_OITDepthLow0 0:12:0:30
//texture texture2D sc_OITDepthLow1 0:13:0:30
//texture texture2D sc_OITFilteredDepthBoundsTexture 0:14:0:30
//texture texture2D sc_OITFrontDepthTexture 0:15:0:30
//texture texture2D sc_RayTracingGlobalIllumination 0:16:0:31
//texture utexture2D sc_RayTracingHitCasterIdAndBarycentric 0:17:0:32
//texture texture2D sc_RayTracingRayDirection 0:18:0:33
//texture texture2D sc_RayTracingReflections 0:19:0:34
//texture texture2D sc_RayTracingShadows 0:20:0:35
//texture texture2D sc_SSAOTexture 0:21:0:36
//texture texture2D sc_ScreenTexture 0:22:0:37
//texture texture2D sc_ShadowTexture 0:23:0:38
//texture texture2DArray intensityTextureArrSC 0:40:0:25
//texture texture2DArray iridescenceMapArrSC 0:41:0:26
//texture texture2DArray opacityTextureArrSC 0:42:0:27
//texture texture2DArray sc_EnvmapDiffuseArrSC 0:43:0:28
//texture texture2DArray sc_EnvmapSpecularArrSC 0:44:0:29
//texture texture2DArray sc_RayTracingGlobalIlluminationArrSC 0:45:0:31
//texture texture2DArray sc_RayTracingReflectionsArrSC 0:47:0:34
//texture texture2DArray sc_RayTracingShadowsArrSC 0:48:0:35
//texture texture2DArray sc_ScreenTextureArrSC 0:49:0:37
...
//spec_const bool sc_OITDepthPrepass 71 0
//spec_const bool sc_OITFrontLayerPass 72 0
//spec_const bool sc_OITMaxLayers4Plus1 73 0
//spec_const bool sc_OITMaxLayers8 74 0
//spec_const bool sc_OITMaxLayersVisualizeLayerCount 75 0
...
//spec_const bool sc_RayTracingCasterForceOpaque 79 0
//spec_const bool sc_RayTracingGlobalIlluminationHasSwappedViews 80 0
//spec_const bool sc_RayTracingReflectionsHasSwappedViews 81 0
//spec_const bool sc_RayTracingShadowsHasSwappedViews 82 0
...
//spec_const int SC_DEVICE_CLASS 90 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_U_intensityTexture 91 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_U_iridescenceMap 92 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_U_opacityTexture 93 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_V_intensityTexture 94 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_V_iridescenceMap 95 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_V_opacityTexture 96 -1
//spec_const int intensityTextureLayout 97 0
//spec_const int iridescenceMapLayout 98 0
//spec_const int opacityTextureLayout 99 0
//spec_const int sc_AmbientLightMode0 100 0
//spec_const int sc_AmbientLightMode1 101 0
//spec_const int sc_AmbientLightMode2 102 0
//spec_const int sc_AmbientLightMode_Constant 103 0
//spec_const int sc_AmbientLightMode_EnvironmentMap 104 0
//spec_const int sc_AmbientLightMode_FromCamera 105 0
//spec_const int sc_AmbientLightMode_SphericalHarmonics 106 0
//spec_const int sc_AmbientLightsCount 107 0
//spec_const int sc_DepthBufferMode 108 0
//spec_const int sc_DirectionalLightsCount 109 0
//spec_const int sc_EnvLightMode 110 0
//spec_const int sc_EnvmapDiffuseLayout 111 0
//spec_const int sc_EnvmapSpecularLayout 112 0
//spec_const int sc_LightEstimationSGCount 113 0
//spec_const int sc_PointLightsCount 114 0
//spec_const int sc_RayTracingGlobalIlluminationLayout 115 0
//spec_const int sc_RayTracingReflectionsLayout 116 0
//spec_const int sc_RayTracingShadowsLayout 117 0
//spec_const int sc_RenderingSpace 118 -1
//spec_const int sc_ScreenTextureLayout 119 0
//spec_const int sc_ShaderCacheConstant 120 0
//spec_const int sc_SkinBonesCount 121 0
//spec_const int sc_StereoRenderingMode 122 0
//spec_const int sc_StereoRendering_IsClipDistanceEnabled 123 0
//spec_const int sc_StereoViewID 124 0
//SG_REFLECTION_END
...
#endif
#ifndef iridescenceMapHasSwappedViews
#define iridescenceMapHasSwappedViews 0
#elif iridescenceMapHasSwappedViews==1
#undef iridescenceMapHasSwappedViews
#define iridescenceMapHasSwappedViews 1
#endif
#ifndef iridescenceMapLayout
#define iridescenceMapLayout 0
#endif
...
#endif
#ifndef SC_USE_UV_TRANSFORM_iridescenceMap
#define SC_USE_UV_TRANSFORM_iridescenceMap 0
#elif SC_USE_UV_TRANSFORM_iridescenceMap==1
#undef SC_USE_UV_TRANSFORM_iridescenceMap
#define SC_USE_UV_TRANSFORM_iridescenceMap 1
#endif
#ifndef SC_SOFTWARE_WRAP_MODE_U_iridescenceMap
#define SC_SOFTWARE_WRAP_MODE_U_iridescenceMap -1
#endif
#ifndef SC_SOFTWARE_WRAP_MODE_V_iridescenceMap
#define SC_SOFTWARE_WRAP_MODE_V_iridescenceMap -1
#endif
#ifndef SC_USE_UV_MIN_MAX_iridescenceMap
#define SC_USE_UV_MIN_MAX_iridescenceMap 0
#elif SC_USE_UV_MIN_MAX_iridescenceMap==1
#undef SC_USE_UV_MIN_MAX_iridescenceMap
#define SC_USE_UV_MIN_MAX_iridescenceMap 1
#endif
#ifndef SC_USE_CLAMP_TO_BORDER_iridescenceMap
#define SC_USE_CLAMP_TO_BORDER_iridescenceMap 0
#elif SC_USE_CLAMP_TO_BORDER_iridescenceMap==1
#undef SC_USE_CLAMP_TO_BORDER_iridescenceMap
#define SC_USE_CLAMP_TO_BORDER_iridescenceMap 1
#endif
layout(binding=0,std430) readonly buffer sc_RayTracingCasterIndexBuffer
{
uint sc_RayTracingCasterTriangles[1];
...
uniform float Port_Input2_N021;
uniform float Port_RangeMinA_N049;
uniform float Port_RangeMaxA_N049;
uniform float Port_RangeMinB_N049;
uniform float Port_RangeMaxB_N049;
uniform mat3 iridescenceMapTransform;
uniform vec4 iridescenceMapUvMinMax;
...
int iridescenceMapGetStereoViewIndex()
{
int l9_0;
#if (iridescenceMapHasSwappedViews)
{
...
vec4 l9_1=sc_ModelMatrixInverse*vec4(varPos,1.0);
float l9_2=1.0-clamp(dot(normalize(sc_Camera.position-varPos),l9_0),0.0,1.0);
float l9_3;
if (l9_2<=0.0)
{
l9_3=0.0;
...
{
l9_3=pow(l9_2,exponent);
}
float l9_4=snoise(vec2(floor((((floor(((snoise(vec2(floor(l9_1.x*10000.0)*9.9999997e-05,floor(l9_1.y*10000.0)*9.9999997e-05)*(noiseScale*0.5))*0.5)+0.5)*10000.0)*9.9999997e-05)*Port_Input1_N011)-Port_Input1_N012)*10000.0)*9.9999997e-05,floor(l9_1.z*10000.0)*9.9999997e-05)*(Port_Scale_N041*0.5));
float l9_5=l9_3+((((floor(((l9_4*0.5)+0.5)*10000.0)*9.9999997e-05)-Port_Input1_N025)*noiseIntensity)*Port_Input2_N021);
float l9_6=(((clamp(thinFilmWeight,0.0,1.0)-Port_RangeMinA_N049)/((Port_RangeMaxA_N049-Port_RangeMinA_N049)+1e-06))*(Port_RangeMaxB_N049-Port_RangeMinB_N049))+Port_RangeMinB_N049;
float l9_7;
if (Port_RangeMaxB_N049>Port_RangeMinB_N049)
{
l9_7=clamp(l9_6,Port_RangeMinB_N049,Port_RangeMaxB_N049);
}
else
{
l9_7=clamp(l9_6,Port_RangeMaxB_N049,Port_RangeMinB_N049);
}
#if (iridescenceMapLayout==2)
{
bool l9_8=(int(SC_USE_CLAMP_TO_BORDER_iridescenceMap)!=0)&&(!(int(SC_USE_UV_MIN_MAX_iridescenceMap)!=0));
float l9_9=l9_5;
sc_SoftwareWrapEarly(l9_9,ivec2(SC_SOFTWARE_WRAP_MODE_U_iridescenceMap,SC_SOFTWARE_WRAP_MODE_V_iridescenceMap).x);
float l9_10=l9_9;
float l9_11=l9_7;
sc_SoftwareWrapEarly(l9_11,ivec2(SC_SOFTWARE_WRAP_MODE_U_iridescenceMap,SC_SOFTWARE_WRAP_MODE_V_iridescenceMap).y);
float l9_12=l9_11;
vec2 l9_13;
float l9_14;
#if (SC_USE_UV_MIN_MAX_iridescenceMap)
{
bool l9_15;
#if (SC_USE_CLAMP_TO_BORDER_iridescenceMap)
{
l9_15=ivec2(SC_SOFTWARE_WRAP_MODE_U_iridescenceMap,SC_SOFTWARE_WRAP_MODE_V_iridescenceMap).x==3;
}
#else
{
l9_15=(int(SC_USE_CLAMP_TO_BORDER_iridescenceMap)!=0);
}
#endif
float l9_16=l9_10;
float l9_17=1.0;
sc_ClampUV(l9_16,iridescenceMapUvMinMax.x,iridescenceMapUvMinMax.z,l9_15,l9_17);
float l9_18=l9_16;
float l9_19=l9_17;
bool l9_20;
#if (SC_USE_CLAMP_TO_BORDER_iridescenceMap)
{
l9_20=ivec2(SC_SOFTWARE_WRAP_MODE_U_iridescenceMap,SC_SOFTWARE_WRAP_MODE_V_iridescenceMap).y==3;
}
#else
{
l9_20=(int(SC_USE_CLAMP_TO_BORDER_iridescenceMap)!=0);
}
#endif
float l9_21=l9_12;
float l9_22=l9_19;
sc_ClampUV(l9_21,iridescenceMapUvMinMax.y,iridescenceMapUvMinMax.w,l9_20,l9_22);
l9_14=l9_22;
...
#endif
vec2 l9_23=sc_TransformUV(l9_13,(int(SC_USE_UV_TRANSFORM_iridescenceMap)!=0),iridescenceMapTransform);
float l9_24=l9_23.x;
float l9_25=l9_14;
sc_SoftwareWrapLate(l9_24,ivec2(SC_SOFTWARE_WRAP_MODE_U_iridescenceMap,SC_SOFTWARE_WRAP_MODE_V_iridescenceMap).x,l9_8,l9_25);
float l9_26=l9_23.y;
float l9_27=l9_25;
sc_SoftwareWrapLate(l9_26,ivec2(SC_SOFTWARE_WRAP_MODE_U_iridescenceMap,SC_SOFTWARE_WRAP_MODE_V_iridescenceMap).y,l9_8,l9_27);
}
#else
{
bool l9_28=(int(SC_USE_CLAMP_TO_BORDER_iridescenceMap)!=0)&&(!(int(SC_USE_UV_MIN_MAX_iridescenceMap)!=0));
float l9_29=l9_5;
sc_SoftwareWrapEarly(l9_29,ivec2(SC_SOFTWARE_WRAP_MODE_U_iridescenceMap,SC_SOFTWARE_WRAP_MODE_V_iridescenceMap).x);
float l9_30=l9_29;
float l9_31=l9_7;
sc_SoftwareWrapEarly(l9_31,ivec2(SC_SOFTWARE_WRAP_MODE_U_iridescenceMap,SC_SOFTWARE_WRAP_MODE_V_iridescenceMap).y);
float l9_32=l9_31;
vec2 l9_33;
float l9_34;
#if (SC_USE_UV_MIN_MAX_iridescenceMap)
...
#if (SC_USE_CLAMP_TO_BORDER_iridescenceMap)
{
l9_35=ivec2(SC_SOFTWARE_WRAP_MODE_U_iridescenceMap,SC_SOFTWARE_WRAP_MODE_V_iridescenceMap).x==3;
}
#else
{
l9_35=(int(SC_USE_CLAMP_TO_BORDER_iridescenceMap)!=0);
}
#endif
float l9_36=l9_30;
float l9_37=1.0;
sc_ClampUV(l9_36,iridescenceMapUvMinMax.x,iridescenceMapUvMinMax.z,l9_35,l9_37);
float l9_38=l9_36;
float l9_39=l9_37;
bool l9_40;
#if (SC_USE_CLAMP_TO_BORDER_iridescenceMap)
{
l9_40=ivec2(SC_SOFTWARE_WRAP_MODE_U_iridescenceMap,SC_SOFTWARE_WRAP_MODE_V_iridescenceMap).y==3;
}
#else
{
l9_40=(int(SC_USE_CLAMP_TO_BORDER_iridescenceMap)!=0);
}
#endif
float l9_41=l9_32;
float l9_42=l9_39;
sc_ClampUV(l9_41,iridescenceMapUvMinMax.y,iridescenceMapUvMinMax.w,l9_40,l9_42);
l9_34=l9_42;
...
#endif
vec2 l9_43=sc_TransformUV(l9_33,(int(SC_USE_UV_TRANSFORM_iridescenceMap)!=0),iridescenceMapTransform);
float l9_44=l9_43.x;
float l9_45=l9_34;
sc_SoftwareWrapLate(l9_44,ivec2(SC_SOFTWARE_WRAP_MODE_U_iridescenceMap,SC_SOFTWARE_WRAP_MODE_V_iridescenceMap).x,l9_28,l9_45);
float l9_46=l9_43.y;
float l9_47=l9_45;
sc_SoftwareWrapLate(l9_46,ivec2(SC_SOFTWARE_WRAP_MODE_U_iridescenceMap,SC_SOFTWARE_WRAP_MODE_V_iridescenceMap).y,l9_28,l9_47);
}
#endif
vec3 l9_48;
...
#endif
uvec3 l9_49=uvec3(round((varPos-sc_RayTracingOriginOffset)*sc_RayTracingOriginScale));
sc_RayTracingPositionAndMask=uvec4(l9_49.x,l9_49.y,l9_49.z,sc_RayTracingPositionAndMask.w);
sc_RayTracingPositionAndMask.w=sc_RayTracingReceiverMask;
vec3 l9_50=l9_48/vec3(dot(abs(l9_48),vec3(1.0)));
vec2 l9_51=vec2(clamp(-l9_50.z,0.0,1.0));
vec2 l9_52=l9_50.xy;
uint l9_53=packHalf2x16(l9_52+mix(-l9_51,l9_51,step(vec2(0.0),l9_52)));
uvec2 l9_54=uvec2(l9_53&65535u,l9_53>>16u);
sc_RayTracingNormalAndMore=uvec4(l9_54.x,l9_54.y,sc_RayTracingNormalAndMore.z,sc_RayTracingNormalAndMore.w);
...
{
bool l9_55=(int(SC_USE_CLAMP_TO_BORDER_opacityTexture)!=0)&&(!(int(SC_USE_UV_MIN_MAX_opacityTexture)!=0));
float l9_56=varPackedTex.x;
sc_SoftwareWrapEarly(l9_56,ivec2(SC_SOFTWARE_WRAP_MODE_U_opacityTexture,SC_SOFTWARE_WRAP_MODE_V_opacityTexture).x);
float l9_57=l9_56;
float l9_58=varPackedTex.y;
sc_SoftwareWrapEarly(l9_58,ivec2(SC_SOFTWARE_WRAP_MODE_U_opacityTexture,SC_SOFTWARE_WRAP_MODE_V_opacityTexture).y);
float l9_59=l9_58;
vec2 l9_60;
float l9_61;
...
{
l9_62=ivec2(SC_SOFTWARE_WRAP_MODE_U_opacityTexture,SC_SOFTWARE_WRAP_MODE_V_opacityTexture).x==3;
}
#else
{
l9_62=(int(SC_USE_CLAMP_TO_BORDER_opacityTexture)!=0);
}
#endif
float l9_63=l9_57;
float l9_64=1.0;
sc_ClampUV(l9_63,opacityTextureUvMinMax.x,opacityTextureUvMinMax.z,l9_62,l9_64);
float l9_65=l9_63;
float l9_66=l9_64;
bool l9_67;
#if (SC_USE_CLAMP_TO_BORDER_opacityTexture)
{
l9_67=ivec2(SC_SOFTWARE_WRAP_MODE_U_opacityTexture,SC_SOFTWARE_WRAP_MODE_V_opacityTexture).y==3;
}
#else
{
l9_67=(int(SC_USE_CLAMP_TO_BORDER_opacityTexture)!=0);
}
#endif
float l9_68=l9_59;
float l9_69=l9_66;
sc_ClampUV(l9_68,opacityTextureUvMinMax.y,opacityTextureUvMinMax.w,l9_67,l9_69);
l9_61=l9_69;
...
#endif
vec2 l9_70=sc_TransformUV(l9_60,(int(SC_USE_UV_TRANSFORM_opacityTexture)!=0),opacityTextureTransform);
float l9_71=l9_70.x;
float l9_72=l9_61;
sc_SoftwareWrapLate(l9_71,ivec2(SC_SOFTWARE_WRAP_MODE_U_opacityTexture,SC_SOFTWARE_WRAP_MODE_V_opacityTexture).x,l9_55,l9_72);
float l9_73=l9_70.y;
float l9_74=l9_72;
sc_SoftwareWrapLate(l9_73,ivec2(SC_SOFTWARE_WRAP_MODE_U_opacityTexture,SC_SOFTWARE_WRAP_MODE_V_opacityTexture).y,l9_55,l9_74);
}
#else
{
bool l9_75=(int(SC_USE_CLAMP_TO_BORDER_opacityTexture)!=0)&&(!(int(SC_USE_UV_MIN_MAX_opacityTexture)!=0));
float l9_76=varPackedTex.x;
sc_SoftwareWrapEarly(l9_76,ivec2(SC_SOFTWARE_WRAP_MODE_U_opacityTexture,SC_SOFTWARE_WRAP_MODE_V_opacityTexture).x);
float l9_77=l9_76;
float l9_78=varPackedTex.y;
sc_SoftwareWrapEarly(l9_78,ivec2(SC_SOFTWARE_WRAP_MODE_U_opacityTexture,SC_SOFTWARE_WRAP_MODE_V_opacityTexture).y);
float l9_79=l9_78;
vec2 l9_80;
float l9_81;
#if (SC_USE_UV_MIN_MAX_opacityTexture)
...
#if (SC_USE_CLAMP_TO_BORDER_opacityTexture)
{
l9_82=ivec2(SC_SOFTWARE_WRAP_MODE_U_opacityTexture,SC_SOFTWARE_WRAP_MODE_V_opacityTexture).x==3;
}
#else
{
l9_82=(int(SC_USE_CLAMP_TO_BORDER_opacityTexture)!=0);
}
#endif
float l9_83=l9_77;
float l9_84=1.0;
sc_ClampUV(l9_83,opacityTextureUvMinMax.x,opacityTextureUvMinMax.z,l9_82,l9_84);
float l9_85=l9_83;
float l9_86=l9_84;
bool l9_87;
#if (SC_USE_CLAMP_TO_BORDER_opacityTexture)
{
l9_87=ivec2(SC_SOFTWARE_WRAP_MODE_U_opacityTexture,SC_SOFTWARE_WRAP_MODE_V_opacityTexture).y==3;
}
#else
{
l9_87=(int(SC_USE_CLAMP_TO_BORDER_opacityTexture)!=0);
}
#endif
float l9_88=l9_79;
float l9_89=l9_86;
sc_ClampUV(l9_88,opacityTextureUvMinMax.y,opacityTextureUvMinMax.w,l9_87,l9_89);
l9_81=l9_89;
...
#endif
vec2 l9_90=sc_TransformUV(l9_80,(int(SC_USE_UV_TRANSFORM_opacityTexture)!=0),opacityTextureTransform);
float l9_91=l9_90.x;
float l9_92=l9_81;
sc_SoftwareWrapLate(l9_91,ivec2(SC_SOFTWARE_WRAP_MODE_U_opacityTexture,SC_SOFTWARE_WRAP_MODE_V_opacityTexture).x,l9_75,l9_92);
float l9_93=l9_90.y;
float l9_94=l9_92;
sc_SoftwareWrapLate(l9_93,ivec2(SC_SOFTWARE_WRAP_MODE_U_opacityTexture,SC_SOFTWARE_WRAP_MODE_V_opacityTexture).y,l9_75,l9_94);
}
#endif
}
#else
...
uniform sampler2DArray iridescenceMapArrSC;
...
l9_5=l9_7;
l9_4=l9_6.uv0;
l9_3=(sc_ModelMatrixInverse*vec4(l9_7,1.0)).xyz;
l9_2=l9_6.normalWS;
l9_1=l9_6.viewDirWS;
}
else
...
l9_3=(sc_ModelMatrixInverse*vec4(varPos,1.0)).xyz;
l9_2=normalize(varNormal);
l9_1=normalize(sc_Camera.position-varPos);
}
float l9_8=dot(l9_1,l9_2);
float l9_9=1.0-clamp(l9_8,0.0,1.0);
float l9_10;
if (l9_9<=0.0)
{
l9_10=0.0;
...
{
l9_10=pow(l9_9,exponent);
}
float l9_11=snoise(vec2(floor((((floor(((snoise(vec2(floor(l9_3.x*10000.0)*9.9999997e-05,floor(l9_3.y*10000.0)*9.9999997e-05)*(noiseScale*0.5))*0.5)+0.5)*10000.0)*9.9999997e-05)*Port_Input1_N011)-Port_Input1_N012)*10000.0)*9.9999997e-05,floor(l9_3.z*10000.0)*9.9999997e-05)*(Port_Scale_N041*0.5));
float l9_12=l9_10+((((floor(((l9_11*0.5)+0.5)*10000.0)*9.9999997e-05)-Port_Input1_N025)*noiseIntensity)*Port_Input2_N021);
float l9_13=(((clamp(thinFilmWeight,0.0,1.0)-Port_RangeMinA_N049)/((Port_RangeMaxA_N049-Port_RangeMinA_N049)+1e-06))*(Port_RangeMaxB_N049-Port_RangeMinB_N049))+Port_RangeMinB_N049;
float l9_14;
if (Port_RangeMaxB_N049>Port_RangeMinB_N049)
{
l9_14=clamp(l9_13,Port_RangeMinB_N049,Port_RangeMaxB_N049);
}
else
{
l9_14=clamp(l9_13,Port_RangeMaxB_N049,Port_RangeMinB_N049);
}
vec4 l9_15;
#if (iridescenceMapLayout==2)
{
bool l9_16=(int(SC_USE_CLAMP_TO_BORDER_iridescenceMap)!=0)&&(!(int(SC_USE_UV_MIN_MAX_iridescenceMap)!=0));
float l9_17=l9_12;
sc_SoftwareWrapEarly(l9_17,ivec2(SC_SOFTWARE_WRAP_MODE_U_iridescenceMap,SC_SOFTWARE_WRAP_MODE_V_iridescenceMap).x);
float l9_18=l9_17;
float l9_19=l9_14;
sc_SoftwareWrapEarly(l9_19,ivec2(SC_SOFTWARE_WRAP_MODE_U_iridescenceMap,SC_SOFTWARE_WRAP_MODE_V_iridescenceMap).y);
float l9_20=l9_19;
vec2 l9_21;
float l9_22;
#if (SC_USE_UV_MIN_MAX_iridescenceMap)
...
#if (SC_USE_CLAMP_TO_BORDER_iridescenceMap)
{
l9_23=ivec2(SC_SOFTWARE_WRAP_MODE_U_iridescenceMap,SC_SOFTWARE_WRAP_MODE_V_iridescenceMap).x==3;
}
#else
{
l9_23=(int(SC_USE_CLAMP_TO_BORDER_iridescenceMap)!=0);
}
#endif
float l9_24=l9_18;
float l9_25=1.0;
sc_ClampUV(l9_24,iridescenceMapUvMinMax.x,iridescenceMapUvMinMax.z,l9_23,l9_25);
float l9_26=l9_24;
float l9_27=l9_25;
bool l9_28;
#if (SC_USE_CLAMP_TO_BORDER_iridescenceMap)
{
l9_28=ivec2(SC_SOFTWARE_WRAP_MODE_U_iridescenceMap,SC_SOFTWARE_WRAP_MODE_V_iridescenceMap).y==3;
}
#else
{
l9_28=(int(SC_USE_CLAMP_TO_BORDER_iridescenceMap)!=0);
}
#endif
float l9_29=l9_20;
float l9_30=l9_27;
sc_ClampUV(l9_29,iridescenceMapUvMinMax.y,iridescenceMapUvMinMax.w,l9_28,l9_30);
l9_22=l9_30;
...
#endif
vec2 l9_31=sc_TransformUV(l9_21,(int(SC_USE_UV_TRANSFORM_iridescenceMap)!=0),iridescenceMapTransform);
float l9_32=l9_31.x;
float l9_33=l9_22;
sc_SoftwareWrapLate(l9_32,ivec2(SC_SOFTWARE_WRAP_MODE_U_iridescenceMap,SC_SOFTWARE_WRAP_MODE_V_iridescenceMap).x,l9_16,l9_33);
float l9_34=l9_31.y;
float l9_35=l9_33;
sc_SoftwareWrapLate(l9_34,ivec2(SC_SOFTWARE_WRAP_MODE_U_iridescenceMap,SC_SOFTWARE_WRAP_MODE_V_iridescenceMap).y,l9_16,l9_35);
float l9_36=l9_35;
vec3 l9_37=sc_SamplingCoordsViewToGlobal(vec2(l9_32,l9_34),iridescenceMapLayout,iridescenceMapGetStereoViewIndex());
vec4 l9_38=texture(iridescenceMapArrSC,l9_37,0.0);
vec4 l9_39;
#if (SC_USE_CLAMP_TO_BORDER_iridescenceMap)
{
l9_39=mix(iridescenceMapBorderColor,l9_38,vec4(l9_36));
}
#else
{
l9_39=l9_38;
...
#else
{
bool l9_40=(int(SC_USE_CLAMP_TO_BORDER_iridescenceMap)!=0)&&(!(int(SC_USE_UV_MIN_MAX_iridescenceMap)!=0));
float l9_41=l9_12;
sc_SoftwareWrapEarly(l9_41,ivec2(SC_SOFTWARE_WRAP_MODE_U_iridescenceMap,SC_SOFTWARE_WRAP_MODE_V_iridescenceMap).x);
float l9_42=l9_41;
float l9_43=l9_14;
sc_SoftwareWrapEarly(l9_43,ivec2(SC_SOFTWARE_WRAP_MODE_U_iridescenceMap,SC_SOFTWARE_WRAP_MODE_V_iridescenceMap).y);
float l9_44=l9_43;
vec2 l9_45;
float l9_46;
#if (SC_USE_UV_MIN_MAX_iridescenceMap)
...
#if (SC_USE_CLAMP_TO_BORDER_iridescenceMap)
{
l9_47=ivec2(SC_SOFTWARE_WRAP_MODE_U_iridescenceMap,SC_SOFTWARE_WRAP_MODE_V_iridescenceMap).x==3;
}
#else
{
l9_47=(int(SC_USE_CLAMP_TO_BORDER_iridescenceMap)!=0);
}
#endif
float l9_48=l9_42;
float l9_49=1.0;
sc_ClampUV(l9_48,iridescenceMapUvMinMax.x,iridescenceMapUvMinMax.z,l9_47,l9_49);
float l9_50=l9_48;
float l9_51=l9_49;
bool l9_52;
#if (SC_USE_CLAMP_TO_BORDER_iridescenceMap)
{
l9_52=ivec2(SC_SOFTWARE_WRAP_MODE_U_iridescenceMap,SC_SOFTWARE_WRAP_MODE_V_iridescenceMap).y==3;
}
#else
{
l9_52=(int(SC_USE_CLAMP_TO_BORDER_iridescenceMap)!=0);
}
#endif
float l9_53=l9_44;
float l9_54=l9_51;
sc_ClampUV(l9_53,iridescenceMapUvMinMax.y,iridescenceMapUvMinMax.w,l9_52,l9_54);
l9_46=l9_54;
...
#endif
vec2 l9_55=sc_TransformUV(l9_45,(int(SC_USE_UV_TRANSFORM_iridescenceMap)!=0),iridescenceMapTransform);
float l9_56=l9_55.x;
float l9_57=l9_46;
sc_SoftwareWrapLate(l9_56,ivec2(SC_SOFTWARE_WRAP_MODE_U_iridescenceMap,SC_SOFTWARE_WRAP_MODE_V_iridescenceMap).x,l9_40,l9_57);
float l9_58=l9_55.y;
float l9_59=l9_57;
sc_SoftwareWrapLate(l9_58,ivec2(SC_SOFTWARE_WRAP_MODE_U_iridescenceMap,SC_SOFTWARE_WRAP_MODE_V_iridescenceMap).y,l9_40,l9_59);
float l9_60=l9_59;
vec3 l9_61=sc_SamplingCoordsViewToGlobal(vec2(l9_56,l9_58),iridescenceMapLayout,iridescenceMapGetStereoViewIndex());
vec4 l9_62=texture(iridescenceMap,l9_61.xy,0.0);
vec4 l9_63;
#if (SC_USE_CLAMP_TO_BORDER_iridescenceMap)
{
l9_63=mix(iridescenceMapBorderColor,l9_62,vec4(l9_60));
}
#else
{
l9_63=l9_62;
...
#endif
vec4 l9_64=baseColor*l9_15;
vec4 l9_65=mix(baseColor,l9_64*vec4(intensity),vec4(mixAmount));
vec3 l9_66;
#if (!sc_ProjectiveShadowsCaster)
{
l9_66=l9_2;
...
#endif
vec3 l9_67=max(l9_65.xyz,vec3(0.0));
vec4 l9_68;
#if (sc_ProjectiveShadowsCaster)
{
l9_68=vec4(l9_67,Port_Opacity_N006);
}
#else
{
l9_68=ngsCalculateLighting(l9_67,Port_Opacity_N006,l9_66,l9_5,l9_1,Port_Emissive_N006,clamp(metallic,0.0,1.0),clamp(roughness,0.0,1.0),Port_AO_N006,Port_SpecularAO_N006);
}
#endif
vec4 l9_69=max(l9_68,vec4(0.0));
vec4 l9_70;
#if (Tweak_N38)
{
vec4 l9_71;
#if (opacityTextureLayout==2)
{
bool l9_72=(int(SC_USE_CLAMP_TO_BORDER_opacityTexture)!=0)&&(!(int(SC_USE_UV_MIN_MAX_opacityTexture)!=0));
float l9_73=l9_4.x;
sc_SoftwareWrapEarly(l9_73,ivec2(SC_SOFTWARE_WRAP_MODE_U_opacityTexture,SC_SOFTWARE_WRAP_MODE_V_opacityTexture).x);
float l9_74=l9_73;
float l9_75=l9_4.y;
sc_SoftwareWrapEarly(l9_75,ivec2(SC_SOFTWARE_WRAP_MODE_U_opacityTexture,SC_SOFTWARE_WRAP_MODE_V_opacityTexture).y);
float l9_76=l9_75;
vec2 l9_77;
float l9_78;
#if (SC_USE_UV_MIN_MAX_opacityTexture)
...
#if (SC_USE_CLAMP_TO_BORDER_opacityTexture)
{
l9_79=ivec2(SC_SOFTWARE_WRAP_MODE_U_opacityTexture,SC_SOFTWARE_WRAP_MODE_V_opacityTexture).x==3;
}
#else
{
l9_79=(int(SC_USE_CLAMP_TO_BORDER_opacityTexture)!=0);
}
#endif
float l9_80=l9_74;
float l9_81=1.0;
sc_ClampUV(l9_80,opacityTextureUvMinMax.x,opacityTextureUvMinMax.z,l9_79,l9_81);
float l9_82=l9_80;
float l9_83=l9_81;
bool l9_84;
#if (SC_USE_CLAMP_TO_BORDER_opacityTexture)
{
l9_84=ivec2(SC_SOFTWARE_WRAP_MODE_U_opacityTexture,SC_SOFTWARE_WRAP_MODE_V_opacityTexture).y==3;
}
#else
{
l9_84=(int(SC_USE_CLAMP_TO_BORDER_opacityTexture)!=0);
}
#endif
float l9_85=l9_76;
float l9_86=l9_83;
sc_ClampUV(l9_85,opacityTextureUvMinMax.y,opacityTextureUvMinMax.w,l9_84,l9_86);
l9_78=l9_86;
...
#endif
vec2 l9_87=sc_TransformUV(l9_77,(int(SC_USE_UV_TRANSFORM_opacityTexture)!=0),opacityTextureTransform);
float l9_88=l9_87.x;
float l9_89=l9_78;
sc_SoftwareWrapLate(l9_88,ivec2(SC_SOFTWARE_WRAP_MODE_U_opacityTexture,SC_SOFTWARE_WRAP_MODE_V_opacityTexture).x,l9_72,l9_89);
float l9_90=l9_87.y;
float l9_91=l9_89;
sc_SoftwareWrapLate(l9_90,ivec2(SC_SOFTWARE_WRAP_MODE_U_opacityTexture,SC_SOFTWARE_WRAP_MODE_V_opacityTexture).y,l9_72,l9_91);
float l9_92=l9_91;
vec3 l9_93=sc_SamplingCoordsViewToGlobal(vec2(l9_88,l9_90),opacityTextureLayout,opacityTextureGetStereoViewIndex());
vec4 l9_94=texture(opacityTextureArrSC,l9_93,0.0);
vec4 l9_95;
#if (SC_USE_CLAMP_TO_BORDER_opacityTexture)
{
l9_95=mix(opacityTextureBorderColor,l9_94,vec4(l9_92));
}
#else
{
l9_95=l9_94;
...
#else
{
bool l9_96=(int(SC_USE_CLAMP_TO_BORDER_opacityTexture)!=0)&&(!(int(SC_USE_UV_MIN_MAX_opacityTexture)!=0));
float l9_97=l9_4.x;
sc_SoftwareWrapEarly(l9_97,ivec2(SC_SOFTWARE_WRAP_MODE_U_opacityTexture,SC_SOFTWARE_WRAP_MODE_V_opacityTexture).x);
float l9_98=l9_97;
float l9_99=l9_4.y;
sc_SoftwareWrapEarly(l9_99,ivec2(SC_SOFTWARE_WRAP_MODE_U_opacityTexture,SC_SOFTWARE_WRAP_MODE_V_opacityTexture).y);
float l9_100=l9_99;
vec2 l9_101;
float l9_102;
#if (SC_USE_UV_MIN_MAX_opacityTexture)
...
#if (SC_USE_CLAMP_TO_BORDER_opacityTexture)
{
l9_103=ivec2(SC_SOFTWARE_WRAP_MODE_U_opacityTexture,SC_SOFTWARE_WRAP_MODE_V_opacityTexture).x==3;
}
#else
{
l9_103=(int(SC_USE_CLAMP_TO_BORDER_opacityTexture)!=0);
}
#endif
float l9_104=l9_98;
float l9_105=1.0;
sc_ClampUV(l9_104,opacityTextureUvMinMax.x,opacityTextureUvMinMax.z,l9_103,l9_105);
float l9_106=l9_104;
float l9_107=l9_105;
bool l9_108;
#if (SC_USE_CLAMP_TO_BORDER_opacityTexture)
{
l9_108=ivec2(SC_SOFTWARE_WRAP_MODE_U_opacityTexture,SC_SOFTWARE_WRAP_MODE_V_opacityTexture).y==3;
}
#else
{
l9_108=(int(SC_USE_CLAMP_TO_BORDER_opacityTexture)!=0);
}
#endif
float l9_109=l9_100;
float l9_110=l9_107;
sc_ClampUV(l9_109,opacityTextureUvMinMax.y,opacityTextureUvMinMax.w,l9_108,l9_110);
l9_102=l9_110;
...
#endif
vec2 l9_111=sc_TransformUV(l9_101,(int(SC_USE_UV_TRANSFORM_opacityTexture)!=0),opacityTextureTransform);
float l9_112=l9_111.x;
float l9_113=l9_102;
sc_SoftwareWrapLate(l9_112,ivec2(SC_SOFTWARE_WRAP_MODE_U_opacityTexture,SC_SOFTWARE_WRAP_MODE_V_opacityTexture).x,l9_96,l9_113);
float l9_114=l9_111.y;
float l9_115=l9_113;
sc_SoftwareWrapLate(l9_114,ivec2(SC_SOFTWARE_WRAP_MODE_U_opacityTexture,SC_SOFTWARE_WRAP_MODE_V_opacityTexture).y,l9_96,l9_115);
float l9_116=l9_115;
vec3 l9_117=sc_SamplingCoordsViewToGlobal(vec2(l9_112,l9_114),opacityTextureLayout,opacityTextureGetStereoViewIndex());
vec4 l9_118=texture(opacityTexture,l9_117.xy,0.0);
vec4 l9_119;
#if (SC_USE_CLAMP_TO_BORDER_opacityTexture)
{
l9_119=mix(opacityTextureBorderColor,l9_118,vec4(l9_116));
}
#else
{
l9_119=l9_118;
...
#else
{
l9_70=vec4(Port_Input2_N040);
}
#endif
float l9_120=clamp((l9_65.w*l9_70.x)+0.001,Port_Input1_N058+0.001,Port_Input2_N058+0.001)-0.001;
vec4 l9_121=vec4(l9_69.x,l9_69.y,l9_69.z,vec4(0.0).w);
l9_121.w=l9_120;
if (l9_0)
{
vec4 l9_122;
...
#endif
sc_writeFragData0Internal(max(l9_122,vec4(0.0)),sc_UniformConstants.x,sc_ShaderCacheConstant);
return;
}
vec4 l9_124;
#if (sc_ProjectiveShadowsCaster)
...
#if (sc_BlendMode_PremultipliedAlpha)
{
l9_126=clamp(l9_120*2.0,0.0,1.0);
}
#else
{
float l9_127;
...
{
l9_127=clamp(dot(l9_121.xyz,vec3(l9_120)),0.0,1.0);
}
#else
{
float l9_128;
...
#if (sc_BlendMode_Multiply)
{
l9_129=(1.0-dot(l9_121.xyz,vec3(0.33333001)))*l9_120;
}
#else
{
float l9_130;
...
{
l9_130=(1.0-clamp(dot(l9_121.xyz,vec3(1.0)),0.0,1.0))*l9_120;
}
#else
{
float l9_131;
#if (sc_BlendMode_ColoredGlass)
{
l9_131=clamp(dot(l9_121.xyz,vec3(1.0)),0.0,1.0)*l9_120;
}
#else
{
float l9_132;
#if (sc_BlendMode_Add)
{
l9_132=clamp(dot(l9_121.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_133;
#if (sc_BlendMode_AddWithAlphaFactor)
{
l9_133=clamp(dot(l9_121.xyz,vec3(1.0)),0.0,1.0)*l9_120;
}
#else
{
float l9_134;
...
{
l9_134=dot(l9_121.xyz,vec3(0.33333001))*l9_120;
}
#else
{
float l9_135;
#if (sc_BlendMode_Min)
{
l9_135=1.0-clamp(dot(l9_121.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_136;
#if (sc_BlendMode_Max)
{
l9_136=clamp(dot(l9_121.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
l9_136=1.0;
...
#endif
l9_124=vec4(mix(sc_ShadowColor.xyz,sc_ShadowColor.xyz*l9_121.xyz,vec3(sc_ShadowColor.w)),sc_ShadowDensity*l9_125);
}
#else
{
vec4 l9_137;
...
{
vec3 l9_139=sc_GetFramebufferColor().xyz;
vec3 l9_140=mix(l9_139,definedBlend(l9_139,l9_121.xyz).xyz,vec3(l9_120));
...
#if (sc_Voxelization)
{
l9_142=vec4(varScreenPos.xyz,1.0);
}
#else
{
vec4 l9_143;
#if (sc_OutputBounds)
{
float l9_144=clamp(abs(gl_FragCoord.z),0.0,1.0);
l9_143=vec4(l9_144,1.0-l9_144,1.0,1.0);
}
#else
{
vec4 l9_145;
#if (sc_BlendMode_MultiplyOriginal)
{
l9_145=vec4(mix(vec3(1.0),l9_121.xyz,vec3(l9_120)),l9_120);
}
#else
{
vec4 l9_146;
...
#endif
l9_146=vec4(l9_121.xyz*l9_147,l9_147);
}
#else
{
l9_146=l9_121;
...
vec4 l9_150=sc_OutputMotionVectorsIfNeeded(varPos,max(l9_148,vec4(0.0)));
vec4 l9_151=clamp(l9_150,vec4(0.0),vec4(1.0));
#if (sc_OITDepthBoundsPass)
{
#if (sc_OITDepthBoundsPass)
{
float l9_152=clamp(viewSpaceDepth()/1000.0,0.0,1.0);
sc_writeFragData0Internal(vec4(max(0.0,1.0-(l9_152-0.0039215689)),min(1.0,l9_152+0.0039215689),0.0,0.0),sc_UniformConstants.x,sc_ShaderCacheConstant);
}
#endif
}
#else
...
#if (sc_OITDepthGatherPass)
{
vec2 l9_153=sc_ScreenCoordsGlobalToView(gl_FragCoord.xy*sc_CurrentRenderTargetDims.zw);
#if (sc_OITMaxLayers4Plus1)
{
if ((gl_FragCoord.z-texture(sc_OITFrontDepthTexture,l9_153).x)<=getFrontLayerZTestEpsilon())
{
discard;
}
}
#endif
int l9_154=encodeDepth(viewSpaceDepth(),texture(sc_OITFilteredDepthBoundsTexture,l9_153).xy);
float l9_155=packValue(l9_154);
int l9_162=int(l9_151.w*255.0);
float l9_163=packValue(l9_162);
sc_writeFragData0Internal(vec4(packValue(l9_154),packValue(l9_154),packValue(l9_154),packValue(l9_154)),sc_UniformConstants.x,sc_ShaderCacheConstant);
sc_writeFragData1(vec4(l9_155,packValue(l9_154),packValue(l9_154),packValue(l9_154)));
sc_writeFragData2(vec4(l9_163,packValue(l9_162),packValue(l9_162),packValue(l9_162)));
...
#if (sc_OITCompositingPass)
{
vec2 l9_166=sc_ScreenCoordsGlobalToView(gl_FragCoord.xy*sc_CurrentRenderTargetDims.zw);
#if (sc_OITMaxLayers4Plus1)
{
if ((gl_FragCoord.z-texture(sc_OITFrontDepthTexture,l9_166).x)<=getFrontLayerZTestEpsilon())
{
discard;
}
}
...
if (l9_171==0)
{
l9_174=texture(sc_OITAlpha0,l9_166);
l9_173=texture(sc_OITDepthLow0,l9_166);
l9_172=texture(sc_OITDepthHigh0,l9_166);
}
else
{
l9_174=vec4(0.0);
...
if (l9_171==1)
{
l9_177=texture(sc_OITAlpha1,l9_166);
l9_176=texture(sc_OITDepthLow1,l9_166);
l9_175=texture(sc_OITDepthHigh1,l9_166);
}
else
{
l9_177=l9_174;
...
if (any(notEqual(l9_175,vec4(0.0)))||any(notEqual(l9_176,vec4(0.0))))
{
int l9_178[8]=l9_167;
unpackValues(l9_175.w,l9_171,l9_178);
unpackValues(l9_175.z,l9_171,l9_178);
unpackValues(l9_175.y,l9_171,l9_178);
unpackValues(l9_175.x,l9_171,l9_178);
unpackValues(l9_176.w,l9_171,l9_178);
unpackValues(l9_176.z,l9_171,l9_178);
unpackValues(l9_176.y,l9_171,l9_178);
unpackValues(l9_176.x,l9_171,l9_178);
int l9_187[8]=l9_168;
unpackValues(l9_177.w,l9_171,l9_187);
unpackValues(l9_177.z,l9_171,l9_187);
unpackValues(l9_177.y,l9_171,l9_187);
unpackValues(l9_177.x,l9_171,l9_187);
}
l9_171++;
continue;
}
...
vec4 l9_192=texture(sc_OITFilteredDepthBoundsTexture,l9_166);
vec2 l9_193=l9_192.xy;
int l9_194;
#if (sc_SkinBonesCount>0)
{
l9_194=encodeDepth(((1.0-l9_192.x)*1000.0)+getDepthOrderingEpsilon(),l9_193);
}
#else
{
l9_194=0;
...
#endif
int l9_195=encodeDepth(viewSpaceDepth(),l9_193);
vec4 l9_196;
l9_196=l9_151*l9_151.w;
vec4 l9_197;
int l9_198=0;
for (int snapLoopIndex=0; snapLoopIndex==0; snapLoopIndex+=0)
{
if (l9_198<8)
{
int l9_199=l9_167[l9_198];
int l9_200=l9_195-l9_194;
bool l9_201=l9_199<l9_200;
bool l9_202;
if (l9_201)
{
l9_202=l9_167[l9_198]>0;
}
else
{
l9_202=l9_201;
...
if (l9_202)
{
vec3 l9_203=l9_196.xyz*(1.0-(float(l9_168[l9_198])/255.0));
l9_197=vec4(l9_203.x,l9_203.y,l9_203.z,l9_196.w);
}
else
{
l9_197=l9_196;
...
sc_writeFragData0Internal(l9_151,sc_UniformConstants.x,sc_ShaderCacheConstant);
}
#endif
}
#else

...
import { SwitchToggleGroup } from "SpectaclesInteractionKit.lspkg/Components/UI/SwitchToggleGroup/SwitchToggleGroup";
...
class PlaceSlot {
  ...
  public switchToggle: SwitchToggleGroup;
  ...
  constructor(
    ...
    switchToggle: SwitchToggleGroup,
...
export class PlacesListController extends BaseScriptComponent {
  ...
  @input private place0Toggle: SwitchToggleGroup;
  ...
  @input private place1Toggle: SwitchToggleGroup;
  ...
  @input private place2Toggle: SwitchToggleGroup;
  ...
  @input private place3Toggle: SwitchToggleGroup;
  ...
  @input private place4Toggle: SwitchToggleGroup;
  ...
  @input private place5Toggle: SwitchToggleGroup;
  ...
  @input private place6Toggle: SwitchToggleGroup;
  ...
  @input private place7Toggle: SwitchToggleGroup;
  ...
  @input private place8Toggle: SwitchToggleGroup;
  ...
  @input private place9Toggle: SwitchToggleGroup;

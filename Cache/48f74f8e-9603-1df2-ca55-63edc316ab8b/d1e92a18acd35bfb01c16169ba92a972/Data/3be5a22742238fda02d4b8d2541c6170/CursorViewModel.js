...
class CursorViewModel {
     ...
     */
    shouldCursorHold() {
        return (this.enableCursorHolding &&
            ((this.interactor &&
                (this.interactor.inputType & (Interactor_1.InteractorInputType.BothHands | Interactor_1.InteractorInputType.Mouse)) !== 0) ??
                false));
    }
    shouldFilter() {

...
//spec_const bool uv2EnableAnimation 83 0
//spec_const bool uv3EnableAnimation 84 0
//spec_const int NODE_13_DROPLIST_ITEM 85 0
//spec_const int NODE_27_DROPLIST_ITEM 86 0
//spec_const int NODE_49_DROPLIST_ITEM 87 0
//spec_const int NODE_69_DROPLIST_ITEM 88 0
//spec_const int SC_SOFTWARE_WRAP_MODE_U_baseTex 89 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_U_intensityTexture 90 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_U_opacityTex 91 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_V_baseTex 92 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_V_intensityTexture 93 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_V_opacityTex 94 -1
//spec_const int baseTexLayout 95 0
//spec_const int intensityTextureLayout 96 0
//spec_const int opacityTexLayout 97 0
...
//spec_const int sc_StereoViewID 105 0
//SG_REFLECTION_END
...
ssGlobals l9_3=ssGlobals(sc_Time.x,sc_Time.y,0.0,varPackedTex.xy,varPackedTex.zw,l9_1,varPos,l9_2);
vec4 l9_4;
#if (Tweak_N121)
{
vec2 l9_5;
...
{
vec2 l9_8;
Node122_If_else(0.0,vec2(0.0),vec2(0.0),l9_8,l9_3);
float l9_9;
Node67_Bool_Parameter(l9_9,l9_3);
l9_7=mix(varPackedTex.xy,l9_8,vec2(l9_9));
}
#else
{
vec2 l9_10;
...
{
vec2 l9_11;
Node64_If_else(0.0,vec2(0.0),vec2(0.0),l9_11,l9_3);
float l9_12;
Node11_Bool_Parameter(l9_12,l9_3);
l9_10=mix(varPackedTex.xy,l9_11,vec2(l9_12));
}
#else
{
l9_10=varPackedTex.xy;
}
#endif
l9_7=l9_10;
}
...
float l9_34=l9_33;
vec3 l9_35=sc_SamplingCoordsViewToGlobal(vec2(l9_30,l9_32),baseTexLayout,l9_13);
vec4 l9_36=texture2D(baseTex,l9_35.xy,0.0);
vec4 l9_37;
#if (SC_USE_CLAMP_TO_BORDER_baseTex)
{
...
#else
{
l9_4=Port_Default_N369;
}
#endif
vec4 l9_38=baseColor*l9_4;
vec3 l9_39=varPos-circleBoundCentre;
vec3 l9_40=cross(l9_2,vec3(Port_Value1_N089,Port_Value2_N089,Port_Value3_N089));
float l9_41=dot(l9_40,l9_40);
float l9_42;
if (l9_41>0.0)
{
l9_42=1.0/sqrt(l9_41);
}
else
{
l9_42=0.0;
}
vec3 l9_43=l9_40*l9_42;
vec3 l9_44=cross(l9_2,l9_43);
float l9_45=dot(l9_44,l9_44);
float l9_46;
if (l9_45>0.0)
{
l9_46=1.0/sqrt(l9_45);
}
else
{
l9_46=0.0;
}
vec3 l9_47=l9_44*l9_46;
float l9_48;
#if (Tweak_N308)
{
vec2 l9_49;
...
{
vec2 l9_52;
Node122_If_else(0.0,vec2(0.0),vec2(0.0),l9_52,l9_3);
float l9_53;
Node67_Bool_Parameter(l9_53,l9_3);
l9_51=mix(varPackedTex.xy,l9_52,vec2(l9_53));
}
#else
{
vec2 l9_54;
...
{
vec2 l9_55;
Node64_If_else(0.0,vec2(0.0),vec2(0.0),l9_55,l9_3);
float l9_56;
Node11_Bool_Parameter(l9_56,l9_3);
l9_54=mix(varPackedTex.xy,l9_55,vec2(l9_56));
}
#else
{
...
#endif
bool l9_58=(int(SC_USE_CLAMP_TO_BORDER_opacityTex)!=0)&&(!(int(SC_USE_UV_MIN_MAX_opacityTex)!=0));
float l9_59=l9_49.x;
sc_SoftwareWrapEarly(l9_59,ivec2(SC_SOFTWARE_WRAP_MODE_U_opacityTex,SC_SOFTWARE_WRAP_MODE_V_opacityTex).x);
float l9_60=l9_59;
float l9_61=l9_49.y;
sc_SoftwareWrapEarly(l9_61,ivec2(SC_SOFTWARE_WRAP_MODE_U_opacityTex,SC_SOFTWARE_WRAP_MODE_V_opacityTex).y);
float l9_62=l9_61;
vec2 l9_63;
float l9_64;
...
{
l9_65=ivec2(SC_SOFTWARE_WRAP_MODE_U_opacityTex,SC_SOFTWARE_WRAP_MODE_V_opacityTex).x==3;
}
#else
{
l9_65=(int(SC_USE_CLAMP_TO_BORDER_opacityTex)!=0);
}
#endif
float l9_66=l9_60;
float l9_67=1.0;
sc_ClampUV(l9_66,opacityTexUvMinMax.x,opacityTexUvMinMax.z,l9_65,l9_67);
float l9_68=l9_66;
float l9_69=l9_67;
bool l9_70;
#if (SC_USE_CLAMP_TO_BORDER_opacityTex)
{
l9_70=ivec2(SC_SOFTWARE_WRAP_MODE_U_opacityTex,SC_SOFTWARE_WRAP_MODE_V_opacityTex).y==3;
}
#else
{
...
float l9_71=l9_62;
float l9_72=l9_69;
sc_ClampUV(l9_71,opacityTexUvMinMax.y,opacityTexUvMinMax.w,l9_70,l9_72);
l9_64=l9_72;
...
#endif
vec2 l9_73=sc_TransformUV(l9_63,(int(SC_USE_UV_TRANSFORM_opacityTex)!=0),opacityTexTransform);
float l9_74=l9_73.x;
float l9_75=l9_64;
sc_SoftwareWrapLate(l9_74,ivec2(SC_SOFTWARE_WRAP_MODE_U_opacityTex,SC_SOFTWARE_WRAP_MODE_V_opacityTex).x,l9_58,l9_75);
float l9_76=l9_73.y;
float l9_77=l9_75;
sc_SoftwareWrapLate(l9_76,ivec2(SC_SOFTWARE_WRAP_MODE_U_opacityTex,SC_SOFTWARE_WRAP_MODE_V_opacityTex).y,l9_58,l9_77);
float l9_78=l9_77;
vec3 l9_79=sc_SamplingCoordsViewToGlobal(vec2(l9_74,l9_76),opacityTexLayout,l9_57);
vec4 l9_80=texture2D(opacityTex,l9_79.xy,0.0);
vec4 l9_81;
#if (SC_USE_CLAMP_TO_BORDER_opacityTex)
{
l9_81=mix(opacityTexBorderColor,l9_80,vec4(l9_78));
}
#else
{
l9_81=l9_80;
...
#else
{
l9_48=Port_Default_N204;
}
#endif
float l9_82=l9_38.w*l9_48;
float l9_83=min(step(length(vec2(dot(l9_39,l9_43),dot(l9_39,l9_47))/(Port_Input1_N097+vec2(1.234e-06))),Port_Input1_N099),l9_82);
vec4 l9_84=vec4(l9_38.x,l9_38.y,l9_38.z,vec4(0.0).w);
l9_84.w=l9_83;
...
{
l9_88=clamp(dot(l9_84.xyz,vec3(l9_83)),0.0,1.0);
}
#else
{
float l9_89;
...
{
l9_90=(1.0-dot(l9_84.xyz,vec3(0.33333001)))*l9_83;
}
#else
{
float l9_91;
...
{
l9_91=(1.0-clamp(dot(l9_84.xyz,vec3(1.0)),0.0,1.0))*l9_83;
}
#else
{
float l9_92;
...
{
l9_92=clamp(dot(l9_84.xyz,vec3(1.0)),0.0,1.0)*l9_83;
}
#else
{
float l9_93;
#if (sc_BlendMode_Add)
{
l9_93=clamp(dot(l9_84.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_94;
#if (sc_BlendMode_AddWithAlphaFactor)
{
l9_94=clamp(dot(l9_84.xyz,vec3(1.0)),0.0,1.0)*l9_83;
}
#else
{
float l9_95;
...
{
l9_95=dot(l9_84.xyz,vec3(0.33333001))*l9_83;
}
#else
{
float l9_96;
#if (sc_BlendMode_Min)
{
l9_96=1.0-clamp(dot(l9_84.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_97;
#if (sc_BlendMode_Max)
{
l9_97=clamp(dot(l9_84.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
l9_97=1.0;
...
#endif
l9_85=vec4(mix(sc_ShadowColor.xyz,sc_ShadowColor.xyz*l9_84.xyz,vec3(sc_ShadowColor.w)),sc_ShadowDensity*l9_86);
}
#else
{
vec4 l9_98;
...
#else
{
vec2 l9_101=sc_ScreenCoordsGlobalToView(l9_0);
int l9_102;
...
#endif
l9_100=texture2D(sc_ScreenTexture,sc_SamplingCoordsViewToGlobal(l9_101,sc_ScreenTextureLayout,l9_102).xy,0.0);
}
#endif
vec3 l9_103=mix(l9_100.xyz,definedBlend(l9_100.xyz,l9_84.xyz).xyz,vec3(l9_83));
...
#if (sc_BlendMode_MultiplyOriginal)
{
l9_108=vec4(mix(vec3(1.0),l9_84.xyz,vec3(l9_83)),l9_83);
}
#else
{
vec4 l9_109;
...
#endif
l9_109=vec4(l9_84.xyz*l9_110,l9_110);
}
#else
{
l9_109=l9_84;
...
#if (sc_OITDepthGatherPass)
{
vec2 l9_116=sc_ScreenCoordsGlobalToView(l9_0);
#if (sc_OITMaxLayers4Plus1)
{
if ((gl_FragCoord.z-texture2D(sc_OITFrontDepthTexture,l9_116).x)<=getFrontLayerZTestEpsilon())
{
discard;
}
}
#endif
int l9_117=encodeDepth(viewSpaceDepth(),texture2D(sc_OITFilteredDepthBoundsTexture,l9_116).xy);
...
#if (sc_OITCompositingPass)
{
vec2 l9_129=sc_ScreenCoordsGlobalToView(l9_0);
#if (sc_OITMaxLayers4Plus1)
{
if ((gl_FragCoord.z-texture2D(sc_OITFrontDepthTexture,l9_129).x)<=getFrontLayerZTestEpsilon())
{
discard;
}
}
...
if (l9_134==0)
{
l9_137=texture2D(sc_OITAlpha0,l9_129);
l9_136=texture2D(sc_OITDepthLow0,l9_129);
l9_135=texture2D(sc_OITDepthHigh0,l9_129);
}
else
{
l9_137=vec4(0.0);
...
if (l9_134==1)
{
l9_140=texture2D(sc_OITAlpha1,l9_129);
l9_139=texture2D(sc_OITDepthLow1,l9_129);
l9_138=texture2D(sc_OITDepthHigh1,l9_129);
}
else
{
l9_140=l9_137;
...
vec4 l9_155=texture2D(sc_OITFilteredDepthBoundsTexture,l9_129);

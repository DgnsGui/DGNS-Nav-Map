...
uniform bool isMini;
uniform vec3 Tweak_N77;
uniform vec3 verticalVector;
uniform vec3 cornerPosition;
uniform vec3 horizontalVector;
uniform float Port_Value1_N101;
uniform float Port_Value2_N101;
uniform float Port_Value3_N101;
uniform vec2 Port_Input1_N109;
...
{
vec3 l9_70=l9_2-Tweak_N77;
vec3 l9_71=cross(l9_1,vec3(Port_Value1_N101,Port_Value2_N101,Port_Value3_N101));
...
l9_69=step(length(vec2(dot(l9_70,l9_74),dot(l9_70,l9_75*l9_77))/(Port_Input1_N109+vec2(1.234e-06))),Port_Input1_N111);
}
else
{
vec3 l9_78=Port_Input0_N045-cornerPosition;

...
uniform vec3 Tweak_N86;
uniform vec3 verticalVector;
uniform vec3 cornerPosition;
uniform vec3 horizontalVector;
uniform float Port_Value1_N089;
uniform float Port_Value2_N089;
uniform float Port_Value3_N089;
uniform vec2 Port_Input1_N097;
uniform float Port_Input1_N099;
...
{
vec2 l9_14;
Node122_If_else(0.0,vec2(0.0),vec2(0.0),l9_14,l9_9);
float l9_15;
Node67_Bool_Parameter(l9_15,l9_9);
...
{
vec2 l9_17;
Node64_If_else(0.0,vec2(0.0),vec2(0.0),l9_17,l9_9);
float l9_18;
Node11_Bool_Parameter(l9_18,l9_9);
l9_16=mix(l9_5,l9_17,vec2(l9_18));
}
#else
{
l9_16=l9_5;
...
#else
{
l9_10=Port_Default_N369;
}
#endif
vec4 l9_68=baseColor*l9_10;
float l9_69;
if ((float(isMini)*1.0)!=0.0)
{
float l9_70=distance(l9_2,circleBoundCentre);
vec3 l9_71=l9_2-Tweak_N86;
vec3 l9_72=cross(l9_1,vec3(Port_Value1_N089,Port_Value2_N089,Port_Value3_N089));
...
l9_69=step(l9_70,step(length(vec2(dot(l9_71,l9_75),dot(l9_71,l9_76*l9_78))/(Port_Input1_N097+vec2(1.234e-06))),Port_Input1_N099));
}
else
{
vec3 l9_79=l9_2-cornerPosition;
float l9_80=dot(verticalVector,l9_79);
float l9_81=dot(l9_79,horizontalVector);
l9_69=min(min(min(step(Port_Input0_N047,l9_80),step(l9_80,dot(verticalVector,verticalVector))),step(Port_Input0_N072,l9_81)),step(l9_81,dot(horizontalVector,horizontalVector)));
}
float l9_82;
#if (Tweak_N308)
{
...
{
vec2 l9_86;
Node122_If_else(0.0,vec2(0.0),vec2(0.0),l9_86,l9_9);
float l9_87;
Node67_Bool_Parameter(l9_87,l9_9);
l9_85=mix(l9_5,l9_86,vec2(l9_87));
}
#else
{
vec2 l9_88;
...
{
vec2 l9_89;
Node64_If_else(0.0,vec2(0.0),vec2(0.0),l9_89,l9_9);
float l9_90;
Node11_Bool_Parameter(l9_90,l9_9);
l9_88=mix(l9_5,l9_89,vec2(l9_90));
}
#else
{
l9_88=l9_5;
...
{
bool l9_92=(int(SC_USE_CLAMP_TO_BORDER_opacityTex)!=0)&&(!(int(SC_USE_UV_MIN_MAX_opacityTex)!=0));
float l9_93=l9_83.x;
sc_SoftwareWrapEarly(l9_93,ivec2(SC_SOFTWARE_WRAP_MODE_U_opacityTex,SC_SOFTWARE_WRAP_MODE_V_opacityTex).x);
float l9_94=l9_93;
float l9_95=l9_83.y;
sc_SoftwareWrapEarly(l9_95,ivec2(SC_SOFTWARE_WRAP_MODE_U_opacityTex,SC_SOFTWARE_WRAP_MODE_V_opacityTex).y);
float l9_96=l9_95;
vec2 l9_97;
float l9_98;
...
{
l9_99=ivec2(SC_SOFTWARE_WRAP_MODE_U_opacityTex,SC_SOFTWARE_WRAP_MODE_V_opacityTex).x==3;
}
#else
{
...
float l9_100=l9_94;
float l9_101=1.0;
sc_ClampUV(l9_100,opacityTexUvMinMax.x,opacityTexUvMinMax.z,l9_99,l9_101);
float l9_102=l9_100;
float l9_103=l9_101;
bool l9_104;
#if (SC_USE_CLAMP_TO_BORDER_opacityTex)
{
l9_104=ivec2(SC_SOFTWARE_WRAP_MODE_U_opacityTex,SC_SOFTWARE_WRAP_MODE_V_opacityTex).y==3;
}
#else
{
...
float l9_105=l9_96;
float l9_106=l9_103;
sc_ClampUV(l9_105,opacityTexUvMinMax.y,opacityTexUvMinMax.w,l9_104,l9_106);
l9_98=l9_106;
...
#endif
vec2 l9_107=sc_TransformUV(l9_97,(int(SC_USE_UV_TRANSFORM_opacityTex)!=0),opacityTexTransform);
float l9_108=l9_107.x;
float l9_109=l9_98;
sc_SoftwareWrapLate(l9_108,ivec2(SC_SOFTWARE_WRAP_MODE_U_opacityTex,SC_SOFTWARE_WRAP_MODE_V_opacityTex).x,l9_92,l9_109);
float l9_110=l9_107.y;
float l9_111=l9_109;
sc_SoftwareWrapLate(l9_110,ivec2(SC_SOFTWARE_WRAP_MODE_U_opacityTex,SC_SOFTWARE_WRAP_MODE_V_opacityTex).y,l9_92,l9_111);
float l9_112=l9_111;
vec3 l9_113=sc_SamplingCoordsViewToGlobal(vec2(l9_108,l9_110),opacityTexLayout,opacityTexGetStereoViewIndex());
vec4 l9_114=texture(opacityTexArrSC,l9_113,0.0);
vec4 l9_115;
#if (SC_USE_CLAMP_TO_BORDER_opacityTex)
{
l9_115=mix(opacityTexBorderColor,l9_114,vec4(l9_112));
}
#else
{
l9_115=l9_114;
...
#else
{
bool l9_116=(int(SC_USE_CLAMP_TO_BORDER_opacityTex)!=0)&&(!(int(SC_USE_UV_MIN_MAX_opacityTex)!=0));
float l9_117=l9_83.x;
sc_SoftwareWrapEarly(l9_117,ivec2(SC_SOFTWARE_WRAP_MODE_U_opacityTex,SC_SOFTWARE_WRAP_MODE_V_opacityTex).x);
float l9_118=l9_117;
float l9_119=l9_83.y;
sc_SoftwareWrapEarly(l9_119,ivec2(SC_SOFTWARE_WRAP_MODE_U_opacityTex,SC_SOFTWARE_WRAP_MODE_V_opacityTex).y);
float l9_120=l9_119;
vec2 l9_121;
float l9_122;
#if (SC_USE_UV_MIN_MAX_opacityTex)
...
#if (SC_USE_CLAMP_TO_BORDER_opacityTex)
{
l9_123=ivec2(SC_SOFTWARE_WRAP_MODE_U_opacityTex,SC_SOFTWARE_WRAP_MODE_V_opacityTex).x==3;
}
#else
{
l9_123=(int(SC_USE_CLAMP_TO_BORDER_opacityTex)!=0);
}
#endif
float l9_124=l9_118;
float l9_125=1.0;
sc_ClampUV(l9_124,opacityTexUvMinMax.x,opacityTexUvMinMax.z,l9_123,l9_125);
float l9_126=l9_124;
float l9_127=l9_125;
bool l9_128;
#if (SC_USE_CLAMP_TO_BORDER_opacityTex)
{
l9_128=ivec2(SC_SOFTWARE_WRAP_MODE_U_opacityTex,SC_SOFTWARE_WRAP_MODE_V_opacityTex).y==3;
}
#else
{
l9_128=(int(SC_USE_CLAMP_TO_BORDER_opacityTex)!=0);
}
#endif
float l9_129=l9_120;
float l9_130=l9_127;
sc_ClampUV(l9_129,opacityTexUvMinMax.y,opacityTexUvMinMax.w,l9_128,l9_130);
l9_122=l9_130;
...
#endif
vec2 l9_131=sc_TransformUV(l9_121,(int(SC_USE_UV_TRANSFORM_opacityTex)!=0),opacityTexTransform);
float l9_132=l9_131.x;
float l9_133=l9_122;
sc_SoftwareWrapLate(l9_132,ivec2(SC_SOFTWARE_WRAP_MODE_U_opacityTex,SC_SOFTWARE_WRAP_MODE_V_opacityTex).x,l9_116,l9_133);
float l9_134=l9_131.y;
float l9_135=l9_133;
sc_SoftwareWrapLate(l9_134,ivec2(SC_SOFTWARE_WRAP_MODE_U_opacityTex,SC_SOFTWARE_WRAP_MODE_V_opacityTex).y,l9_116,l9_135);
float l9_136=l9_135;
vec3 l9_137=sc_SamplingCoordsViewToGlobal(vec2(l9_132,l9_134),opacityTexLayout,opacityTexGetStereoViewIndex());
vec4 l9_138=texture(opacityTex,l9_137.xy,0.0);
vec4 l9_139;
#if (SC_USE_CLAMP_TO_BORDER_opacityTex)
{
l9_139=mix(opacityTexBorderColor,l9_138,vec4(l9_136));
}
#else
{
l9_139=l9_138;
...
#else
{
l9_82=Port_Default_N204;
}
#endif
float l9_140=l9_68.w*l9_82;
float l9_141=min(l9_69,l9_140);
vec4 l9_142=vec4(l9_68.x,l9_68.y,l9_68.z,vec4(0.0).w);
l9_142.w=l9_141;
#if (sc_BlendMode_AlphaTest)
{
if (l9_141<alphaTestThreshold)
{
discard;
}
}
...
{
if (l9_141<((mod(dot(floor(mod(gl_FragCoord.xy,vec2(4.0))),vec2(4.0,1.0))*9.0,16.0)+1.0)/17.0))
{
discard;
}
}
...
#endif
sc_writeFragData0Internal(max(l9_143,vec4(0.0)),sc_UniformConstants.x,sc_ShaderCacheConstant);
return;
}
vec4 l9_145;
...
{
l9_147=clamp(l9_141*2.0,0.0,1.0);
}
#else
{
float l9_148;
...
{
l9_148=clamp(dot(l9_142.xyz,vec3(l9_141)),0.0,1.0);
}
#else
{
float l9_149;
...
{
l9_150=(1.0-dot(l9_142.xyz,vec3(0.33333001)))*l9_141;
}
#else
{
float l9_151;
...
{
l9_151=(1.0-clamp(dot(l9_142.xyz,vec3(1.0)),0.0,1.0))*l9_141;
}
#else
{
float l9_152;
...
{
l9_152=clamp(dot(l9_142.xyz,vec3(1.0)),0.0,1.0)*l9_141;
}
#else
{
float l9_153;
#if (sc_BlendMode_Add)
{
l9_153=clamp(dot(l9_142.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_154;
#if (sc_BlendMode_AddWithAlphaFactor)
{
l9_154=clamp(dot(l9_142.xyz,vec3(1.0)),0.0,1.0)*l9_141;
}
#else
{
float l9_155;
...
{
l9_155=dot(l9_142.xyz,vec3(0.33333001))*l9_141;
}
#else
{
float l9_156;
#if (sc_BlendMode_Min)
{
l9_156=1.0-clamp(dot(l9_142.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_157;
#if (sc_BlendMode_Max)
{
l9_157=clamp(dot(l9_142.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
l9_157=1.0;
...
#endif
l9_145=vec4(mix(sc_ShadowColor.xyz,sc_ShadowColor.xyz*l9_142.xyz,vec3(sc_ShadowColor.w)),sc_ShadowDensity*l9_146);
}
#else
{
vec4 l9_158;
...
#if (sc_FramebufferFetch)
{
l9_160=sc_readFragData0_Platform();
}
#else
{
vec2 l9_161=sc_ScreenCoordsGlobalToView(gl_FragCoord.xy*sc_CurrentRenderTargetDims.zw);
vec4 l9_162;
#if (sc_ScreenTextureLayout==2)
{
l9_162=texture(sc_ScreenTextureArrSC,sc_SamplingCoordsViewToGlobal(l9_161,sc_ScreenTextureLayout,sc_ScreenTextureGetStereoViewIndex()),0.0);
}
#else
{
l9_162=texture(sc_ScreenTexture,sc_SamplingCoordsViewToGlobal(l9_161,sc_ScreenTextureLayout,sc_ScreenTextureGetStereoViewIndex()).xy,0.0);
}
#endif
l9_160=l9_162;
}
#endif
vec3 l9_163=mix(l9_160.xyz,definedBlend(l9_160.xyz,l9_142.xyz).xyz,vec3(l9_141));
vec4 l9_164=vec4(l9_163.x,l9_163.y,l9_163.z,vec4(0.0).w);
l9_164.w=1.0;
l9_159=l9_164;
}
#else
...
#if (sc_Voxelization)
{
l9_165=vec4(varScreenPos.xyz,1.0);
}
#else
{
vec4 l9_166;
#if (sc_OutputBounds)
{
float l9_167=clamp(abs(gl_FragCoord.z),0.0,1.0);
l9_166=vec4(l9_167,1.0-l9_167,1.0,1.0);
}
#else
{
vec4 l9_168;
#if (sc_BlendMode_MultiplyOriginal)
{
l9_168=vec4(mix(vec3(1.0),l9_142.xyz,vec3(l9_141)),l9_141);
}
#else
{
vec4 l9_169;
...
#endif
l9_169=vec4(l9_142.xyz*l9_170,l9_170);
}
#else
{
l9_169=l9_142;
...
vec4 l9_173=sc_OutputMotionVectorsIfNeeded(varPos,max(l9_171,vec4(0.0)));
vec4 l9_174=clamp(l9_173,vec4(0.0),vec4(1.0));
#if (sc_OITDepthBoundsPass)
{
#if (sc_OITDepthBoundsPass)
{
float l9_175=clamp(viewSpaceDepth()/1000.0,0.0,1.0);
sc_writeFragData0Internal(vec4(max(0.0,1.0-(l9_175-0.0039215689)),min(1.0,l9_175+0.0039215689),0.0,0.0),sc_UniformConstants.x,sc_ShaderCacheConstant);
}
#endif
}
#else
...
#endif
int l9_177=encodeDepth(viewSpaceDepth(),texture(sc_OITFilteredDepthBoundsTexture,l9_176).xy);
float l9_178=packValue(l9_177);
int l9_185=int(l9_174.w*255.0);
float l9_186=packValue(l9_185);
sc_writeFragData0Internal(vec4(packValue(l9_177),packValue(l9_177),packValue(l9_177),packValue(l9_177)),sc_UniformConstants.x,sc_ShaderCacheConstant);
sc_writeFragData1(vec4(l9_178,packValue(l9_177),packValue(l9_177),packValue(l9_177)));
sc_writeFragData2(vec4(l9_186,packValue(l9_185),packValue(l9_185),packValue(l9_185)));
...
#if (sc_OITCompositingPass)
{
vec2 l9_189=sc_ScreenCoordsGlobalToView(gl_FragCoord.xy*sc_CurrentRenderTargetDims.zw);
#if (sc_OITMaxLayers4Plus1)
{
if ((gl_FragCoord.z-texture(sc_OITFrontDepthTexture,l9_189).x)<=getFrontLayerZTestEpsilon())
{
discard;
}
}
...
if (l9_194==0)
{
l9_197=texture(sc_OITAlpha0,l9_189);
l9_196=texture(sc_OITDepthLow0,l9_189);
l9_195=texture(sc_OITDepthHigh0,l9_189);
}
else
{
l9_197=vec4(0.0);
...
if (l9_194==1)
{
l9_200=texture(sc_OITAlpha1,l9_189);
l9_199=texture(sc_OITDepthLow1,l9_189);
l9_198=texture(sc_OITDepthHigh1,l9_189);
}
else
{
l9_200=l9_197;
...
if (any(notEqual(l9_198,vec4(0.0)))||any(notEqual(l9_199,vec4(0.0))))
{
int l9_201[8]=l9_190;
unpackValues(l9_198.w,l9_194,l9_201);
unpackValues(l9_198.z,l9_194,l9_201);
unpackValues(l9_198.y,l9_194,l9_201);
unpackValues(l9_198.x,l9_194,l9_201);
unpackValues(l9_199.w,l9_194,l9_201);
unpackValues(l9_199.z,l9_194,l9_201);
unpackValues(l9_199.y,l9_194,l9_201);
unpackValues(l9_199.x,l9_194,l9_201);
int l9_210[8]=l9_191;
unpackValues(l9_200.w,l9_194,l9_210);
unpackValues(l9_200.z,l9_194,l9_210);
unpackValues(l9_200.y,l9_194,l9_210);
unpackValues(l9_200.x,l9_194,l9_210);
}
l9_194++;
continue;
}
...
vec4 l9_215=texture(sc_OITFilteredDepthBoundsTexture,l9_189);
vec2 l9_216=l9_215.xy;
int l9_217;
#if (sc_SkinBonesCount>0)
{
l9_217=encodeDepth(((1.0-l9_215.x)*1000.0)+getDepthOrderingEpsilon(),l9_216);
}
#else
{
l9_217=0;
...
#endif
int l9_218=encodeDepth(viewSpaceDepth(),l9_216);
vec4 l9_219;
l9_219=l9_174*l9_174.w;
vec4 l9_220;
int l9_221=0;
for (int snapLoopIndex=0; snapLoopIndex==0; snapLoopIndex+=0)
{
if (l9_221<8)
{
int l9_222=l9_190[l9_221];
int l9_223=l9_218-l9_217;
bool l9_224=l9_222<l9_223;
bool l9_225;
if (l9_224)
{
l9_225=l9_190[l9_221]>0;
}
else
{
l9_225=l9_224;
...
if (l9_225)
{
vec3 l9_226=l9_219.xyz*(1.0-(float(l9_191[l9_221])/255.0));
l9_220=vec4(l9_226.x,l9_226.y,l9_226.z,l9_219.w);
}
else
{
l9_220=l9_219;
...
sc_writeFragData0Internal(l9_219,sc_UniformConstants.x,sc_ShaderCacheConstant);
#if (sc_OITMaxLayersVisualizeLayerCount)
{
discard;
}
...
sc_writeFragData0Internal(l9_174,sc_UniformConstants.x,sc_ShaderCacheConstant);
}
#endif
}
#else

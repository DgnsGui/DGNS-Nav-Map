...
//sampler sampler Tweak_N45SmpSC 0:21
...
//texture texture2D Tweak_N45 0:3:0:21
...
//texture texture2DArray Tweak_N45ArrSC 0:32:0:21
...
//spec_const bool SC_USE_CLAMP_TO_BORDER_Tweak_N45 32 0
//spec_const bool SC_USE_CLAMP_TO_BORDER_intensityTexture 33 0
//spec_const bool SC_USE_UV_MIN_MAX_Tweak_N45 34 0
//spec_const bool SC_USE_UV_MIN_MAX_intensityTexture 35 0
//spec_const bool SC_USE_UV_TRANSFORM_Tweak_N45 36 0
//spec_const bool SC_USE_UV_TRANSFORM_intensityTexture 37 0
//spec_const bool Tweak_N102 38 0
//spec_const bool Tweak_N106 39 0
//spec_const bool Tweak_N45HasSwappedViews 40 0
//spec_const bool Tweak_N47 41 0
//spec_const bool Tweak_N70 42 0
...
//spec_const int SC_SOFTWARE_WRAP_MODE_U_Tweak_N45 81 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_U_intensityTexture 82 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_V_Tweak_N45 83 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_V_intensityTexture 84 -1
//spec_const int Tweak_N103 85 0
//spec_const int Tweak_N45Layout 86 0
//spec_const int Tweak_N46 87 0
//spec_const int Tweak_N48 88 0
...
#define sc_OutputBounds 1
#endif
#ifndef Tweak_N45HasSwappedViews
#define Tweak_N45HasSwappedViews 0
#elif Tweak_N45HasSwappedViews==1
#undef Tweak_N45HasSwappedViews
#define Tweak_N45HasSwappedViews 1
#endif
#ifndef Tweak_N45Layout
#define Tweak_N45Layout 0
#endif
...
#define Tweak_N46 0
#endif
#ifndef SC_USE_UV_TRANSFORM_Tweak_N45
#define SC_USE_UV_TRANSFORM_Tweak_N45 0
#elif SC_USE_UV_TRANSFORM_Tweak_N45==1
#undef SC_USE_UV_TRANSFORM_Tweak_N45
#define SC_USE_UV_TRANSFORM_Tweak_N45 1
#endif
#ifndef SC_SOFTWARE_WRAP_MODE_U_Tweak_N45
#define SC_SOFTWARE_WRAP_MODE_U_Tweak_N45 -1
#endif
#ifndef SC_SOFTWARE_WRAP_MODE_V_Tweak_N45
#define SC_SOFTWARE_WRAP_MODE_V_Tweak_N45 -1
#endif
#ifndef SC_USE_UV_MIN_MAX_Tweak_N45
#define SC_USE_UV_MIN_MAX_Tweak_N45 0
#elif SC_USE_UV_MIN_MAX_Tweak_N45==1
#undef SC_USE_UV_MIN_MAX_Tweak_N45
#define SC_USE_UV_MIN_MAX_Tweak_N45 1
#endif
#ifndef SC_USE_CLAMP_TO_BORDER_Tweak_N45
#define SC_USE_CLAMP_TO_BORDER_Tweak_N45 0
#elif SC_USE_CLAMP_TO_BORDER_Tweak_N45==1
#undef SC_USE_CLAMP_TO_BORDER_Tweak_N45
#define SC_USE_CLAMP_TO_BORDER_Tweak_N45 1
#endif
#ifndef sc_DepthOnly
...
uniform vec4 Tweak_N42;
uniform vec2 Tweak_N54;
uniform vec2 Tweak_N57;
uniform float Port_Speed_N084;
uniform vec2 Tweak_N104;
uniform vec2 Tweak_N105;
uniform float Port_Speed_N119;
uniform mat3 Tweak_N45Transform;
uniform vec4 Tweak_N45UvMinMax;
uniform vec4 Tweak_N45BorderColor;
uniform vec3 Tweak_N141;
uniform float Mask_Radius;
uniform vec4 sc_Time;
uniform vec4 Port_Default_N137;
uniform float Port_Value1_N144;
uniform float Port_Value2_N144;
uniform float Port_Value3_N144;
uniform vec2 Port_Input1_N162;
uniform float Port_Input1_N164;
uniform vec3 Port_Red_N167;
uniform vec3 Port_Green_N167;
uniform vec3 Port_Blue_N167;
uniform int PreviewEnabled;
uniform usampler2D sc_RayTracingHitCasterIdAndBarycentric;
uniform sampler2D sc_RayTracingRayDirection;
uniform sampler2D Tweak_N45;
uniform sampler2DArray Tweak_N45ArrSC;
...
void Node79_Switch(float Switch,vec2 Value0,vec2 Value1,vec2 Value2,vec2 Default,out vec2 Result,ssGlobals Globals)
{
#if (Tweak_N48==0)
{
...
void Node85_If_else(float Bool1,vec2 Value1,vec2 Default,out vec2 Result,ssGlobals Globals)
{
#if (Tweak_N70)
{
vec2 param_5;
Node79_Switch(0.0,vec2(0.0),vec2(0.0),vec2(0.0),vec2(0.0),param_5,Globals);
Value1=((param_5*Tweak_N54)+Tweak_N57)+(Tweak_N57*(Globals.gTimeElapsed*Port_Speed_N084));
Result=Value1;
}
#else
{
vec2 param_12;
Node79_Switch(0.0,vec2(0.0),vec2(0.0),vec2(0.0),vec2(0.0),param_12,Globals);
Default=(param_12*Tweak_N54)+Tweak_N57;
Result=Default;
}
#endif
}
...
void Node114_Switch(float Switch,vec2 Value0,vec2 Value1,vec2 Value2,vec2 Value3,vec2 Default,out vec2 Result,ssGlobals Globals)
{
#if (Tweak_N103==0)
{
Value0=Globals.Surface_UVCoord0;
...
{
vec2 param_3;
Node85_If_else(0.0,vec2(0.0),vec2(0.0),param_3,Globals);
float param_5;
Node47_Bool_Parameter(param_5,Globals);
...
int Tweak_N45GetStereoViewIndex()
{
int l9_0;
#if (Tweak_N45HasSwappedViews)
{
...
vec4 l9_8=sc_ViewProjectionMatrixArray[sc_GetStereoViewIndex()]*vec4(l9_7,1.0);
l9_5=l9_6.uv0;
l9_4=l9_6.uv1;
l9_3=((l9_8.xy/vec2(l9_8.w))*0.5)+vec2(0.5);
l9_2=l9_7;
l9_1=l9_6.normalWS;
}
else
...
ssGlobals l9_9=ssGlobals(sc_Time.x,sc_Time.y,0.0,l9_5,l9_4,l9_3,l9_2,l9_1);
vec4 l9_10;
#if (ENABLE_BASE_TEX)
{
vec2 l9_11;
...
{
vec2 l9_14;
Node85_If_else(0.0,vec2(0.0),vec2(0.0),l9_14,l9_9);
float l9_15;
Node47_Bool_Parameter(l9_15,l9_9);
l9_13=mix(l9_5,l9_14,vec2(l9_15));
}
#else
{
vec2 l9_16;
...
{
vec2 l9_18;
Node114_Switch(0.0,vec2(0.0),vec2(0.0),vec2(0.0),vec2(0.0),vec2(0.0),l9_18,l9_9);
l9_17=((l9_18*Tweak_N104)+Tweak_N105)+(Tweak_N105*(sc_Time.x*Port_Speed_N119));
}
#else
{
vec2 l9_19;
Node114_Switch(0.0,vec2(0.0),vec2(0.0),vec2(0.0),vec2(0.0),vec2(0.0),l9_19,l9_9);
l9_17=(l9_19*Tweak_N104)+Tweak_N105;
}
#endif
float l9_20;
#if (Tweak_N102)
...
#endif
l9_16=mix(l9_5,l9_17,vec2(l9_20-0.001));
}
#else
{
l9_16=l9_5;
...
#endif
vec4 l9_21;
#if (Tweak_N45Layout==2)
{
bool l9_22=(int(SC_USE_CLAMP_TO_BORDER_Tweak_N45)!=0)&&(!(int(SC_USE_UV_MIN_MAX_Tweak_N45)!=0));
float l9_23=l9_11.x;
sc_SoftwareWrapEarly(l9_23,ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N45,SC_SOFTWARE_WRAP_MODE_V_Tweak_N45).x);
float l9_24=l9_23;
float l9_25=l9_11.y;
sc_SoftwareWrapEarly(l9_25,ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N45,SC_SOFTWARE_WRAP_MODE_V_Tweak_N45).y);
float l9_26=l9_25;
vec2 l9_27;
float l9_28;
#if (SC_USE_UV_MIN_MAX_Tweak_N45)
{
bool l9_29;
#if (SC_USE_CLAMP_TO_BORDER_Tweak_N45)
{
l9_29=ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N45,SC_SOFTWARE_WRAP_MODE_V_Tweak_N45).x==3;
}
#else
{
l9_29=(int(SC_USE_CLAMP_TO_BORDER_Tweak_N45)!=0);
}
#endif
float l9_30=l9_24;
float l9_31=1.0;
sc_ClampUV(l9_30,Tweak_N45UvMinMax.x,Tweak_N45UvMinMax.z,l9_29,l9_31);
float l9_32=l9_30;
float l9_33=l9_31;
bool l9_34;
#if (SC_USE_CLAMP_TO_BORDER_Tweak_N45)
{
l9_34=ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N45,SC_SOFTWARE_WRAP_MODE_V_Tweak_N45).y==3;
}
#else
{
l9_34=(int(SC_USE_CLAMP_TO_BORDER_Tweak_N45)!=0);
}
#endif
float l9_35=l9_26;
float l9_36=l9_33;
sc_ClampUV(l9_35,Tweak_N45UvMinMax.y,Tweak_N45UvMinMax.w,l9_34,l9_36);
l9_28=l9_36;
...
#endif
vec2 l9_37=sc_TransformUV(l9_27,(int(SC_USE_UV_TRANSFORM_Tweak_N45)!=0),Tweak_N45Transform);
float l9_38=l9_37.x;
float l9_39=l9_28;
sc_SoftwareWrapLate(l9_38,ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N45,SC_SOFTWARE_WRAP_MODE_V_Tweak_N45).x,l9_22,l9_39);
float l9_40=l9_37.y;
float l9_41=l9_39;
sc_SoftwareWrapLate(l9_40,ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N45,SC_SOFTWARE_WRAP_MODE_V_Tweak_N45).y,l9_22,l9_41);
float l9_42=l9_41;
vec3 l9_43=sc_SamplingCoordsViewToGlobal(vec2(l9_38,l9_40),Tweak_N45Layout,Tweak_N45GetStereoViewIndex());
vec4 l9_44=texture(Tweak_N45ArrSC,l9_43,0.0);
vec4 l9_45;
#if (SC_USE_CLAMP_TO_BORDER_Tweak_N45)
{
l9_45=mix(Tweak_N45BorderColor,l9_44,vec4(l9_42));
}
#else
{
l9_45=l9_44;
...
#else
{
bool l9_46=(int(SC_USE_CLAMP_TO_BORDER_Tweak_N45)!=0)&&(!(int(SC_USE_UV_MIN_MAX_Tweak_N45)!=0));
float l9_47=l9_11.x;
sc_SoftwareWrapEarly(l9_47,ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N45,SC_SOFTWARE_WRAP_MODE_V_Tweak_N45).x);
float l9_48=l9_47;
float l9_49=l9_11.y;
sc_SoftwareWrapEarly(l9_49,ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N45,SC_SOFTWARE_WRAP_MODE_V_Tweak_N45).y);
float l9_50=l9_49;
vec2 l9_51;
float l9_52;
#if (SC_USE_UV_MIN_MAX_Tweak_N45)
...
#if (SC_USE_CLAMP_TO_BORDER_Tweak_N45)
{
l9_53=ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N45,SC_SOFTWARE_WRAP_MODE_V_Tweak_N45).x==3;
}
#else
{
l9_53=(int(SC_USE_CLAMP_TO_BORDER_Tweak_N45)!=0);
}
#endif
float l9_54=l9_48;
float l9_55=1.0;
sc_ClampUV(l9_54,Tweak_N45UvMinMax.x,Tweak_N45UvMinMax.z,l9_53,l9_55);
float l9_56=l9_54;
float l9_57=l9_55;
bool l9_58;
#if (SC_USE_CLAMP_TO_BORDER_Tweak_N45)
{
l9_58=ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N45,SC_SOFTWARE_WRAP_MODE_V_Tweak_N45).y==3;
}
#else
{
l9_58=(int(SC_USE_CLAMP_TO_BORDER_Tweak_N45)!=0);
}
#endif
float l9_59=l9_50;
float l9_60=l9_57;
sc_ClampUV(l9_59,Tweak_N45UvMinMax.y,Tweak_N45UvMinMax.w,l9_58,l9_60);
l9_52=l9_60;
...
#endif
vec2 l9_61=sc_TransformUV(l9_51,(int(SC_USE_UV_TRANSFORM_Tweak_N45)!=0),Tweak_N45Transform);
float l9_62=l9_61.x;
float l9_63=l9_52;
sc_SoftwareWrapLate(l9_62,ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N45,SC_SOFTWARE_WRAP_MODE_V_Tweak_N45).x,l9_46,l9_63);
float l9_64=l9_61.y;
float l9_65=l9_63;
sc_SoftwareWrapLate(l9_64,ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N45,SC_SOFTWARE_WRAP_MODE_V_Tweak_N45).y,l9_46,l9_65);
float l9_66=l9_65;
vec3 l9_67=sc_SamplingCoordsViewToGlobal(vec2(l9_62,l9_64),Tweak_N45Layout,Tweak_N45GetStereoViewIndex());
vec4 l9_68=texture(Tweak_N45,l9_67.xy,0.0);
vec4 l9_69;
#if (SC_USE_CLAMP_TO_BORDER_Tweak_N45)
{
l9_69=mix(Tweak_N45BorderColor,l9_68,vec4(l9_66));
}
#else
{
l9_69=l9_68;
...
#else
{
l9_10=Port_Default_N137;
}
#endif
vec4 l9_70=Tweak_N42*l9_10;
vec3 l9_71=l9_2-Tweak_N141;
vec3 l9_72=cross(l9_1,vec3(Port_Value1_N144,Port_Value2_N144,Port_Value3_N144));
float l9_73=dot(l9_72,l9_72);
float l9_74;
if (l9_73>0.0)
{
...
vec3 l9_75=l9_72*l9_74;
vec3 l9_76=cross(l9_1,l9_75);
float l9_77=dot(l9_76,l9_76);
float l9_78;
if (l9_77>0.0)
{
...
vec3 l9_79=l9_76*l9_78;
float l9_80=step(length(vec2(dot(l9_71,l9_75)*Mask_Radius,dot(l9_71,l9_79)*Mask_Radius)/(Port_Input1_N162+vec2(1.234e-06))),Port_Input1_N164);
vec3 l9_81=((Port_Red_N167*l9_70.x)+(Port_Green_N167*l9_70.y))+(Port_Blue_N167*l9_70.z);
vec4 l9_82=vec4(l9_81.x,l9_81.y,l9_81.z,vec4(0.0).w);
l9_82.w=l9_80;
#if (sc_BlendMode_AlphaTest)
{
if (l9_80<alphaTestThreshold)
{
discard;
}
}
...
{
if (l9_80<((mod(dot(floor(mod(gl_FragCoord.xy,vec2(4.0))),vec2(4.0,1.0))*9.0,16.0)+1.0)/17.0))
{
discard;
}
}
...
#endif
sc_writeFragData0Internal(max(l9_83,vec4(0.0)),sc_UniformConstants.x,sc_ShaderCacheConstant);
return;
}
vec4 l9_85;
...
{
l9_88=clamp(dot(l9_82.xyz,vec3(l9_80)),0.0,1.0);
}
#else
{
float l9_89;
...
{
l9_90=(1.0-dot(l9_82.xyz,vec3(0.33333001)))*l9_80;
}
#else
{
float l9_91;
...
{
l9_91=(1.0-clamp(dot(l9_82.xyz,vec3(1.0)),0.0,1.0))*l9_80;
}
#else
{
float l9_92;
...
{
l9_92=clamp(dot(l9_82.xyz,vec3(1.0)),0.0,1.0)*l9_80;
}
#else
{
float l9_93;
#if (sc_BlendMode_Add)
{
l9_93=clamp(dot(l9_82.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_94;
#if (sc_BlendMode_AddWithAlphaFactor)
{
l9_94=clamp(dot(l9_82.xyz,vec3(1.0)),0.0,1.0)*l9_80;
}
#else
{
float l9_95;
...
{
l9_95=dot(l9_82.xyz,vec3(0.33333001))*l9_80;
}
#else
{
float l9_96;
#if (sc_BlendMode_Min)
{
l9_96=1.0-clamp(dot(l9_82.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_97;
#if (sc_BlendMode_Max)
{
l9_97=clamp(dot(l9_82.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
l9_97=1.0;
...
#endif
l9_85=vec4(mix(sc_ShadowColor.xyz,sc_ShadowColor.xyz*l9_82.xyz,vec3(sc_ShadowColor.w)),sc_ShadowDensity*l9_86);
}
#else
{
vec4 l9_98;
...
#if (sc_FramebufferFetch)
{
l9_100=sc_readFragData0_Platform();
}
#else
{
...
{
l9_102=texture(sc_ScreenTextureArrSC,sc_SamplingCoordsViewToGlobal(l9_101,sc_ScreenTextureLayout,sc_ScreenTextureGetStereoViewIndex()),0.0);
}
#else
{
l9_102=texture(sc_ScreenTexture,sc_SamplingCoordsViewToGlobal(l9_101,sc_ScreenTextureLayout,sc_ScreenTextureGetStereoViewIndex()).xy,0.0);
}
#endif
l9_100=l9_102;
}
#endif
vec3 l9_103=mix(l9_100.xyz,definedBlend(l9_100.xyz,l9_82.xyz).xyz,vec3(l9_80));
vec4 l9_104=vec4(l9_103.x,l9_103.y,l9_103.z,vec4(0.0).w);
l9_104.w=1.0;
l9_99=l9_104;
}
#else
...
#if (sc_Voxelization)
{
l9_105=vec4(varScreenPos.xyz,1.0);
}
#else
{
vec4 l9_106;
#if (sc_OutputBounds)
{
float l9_107=clamp(abs(gl_FragCoord.z),0.0,1.0);
l9_106=vec4(l9_107,1.0-l9_107,1.0,1.0);
}
#else
{
vec4 l9_108;
#if (sc_BlendMode_MultiplyOriginal)
{
l9_108=vec4(mix(vec3(1.0),l9_82.xyz,vec3(l9_80)),l9_80);
}
#else
{
vec4 l9_109;
...
#endif
l9_109=vec4(l9_82.xyz*l9_110,l9_110);
}
#else
{
l9_109=l9_82;
...
vec4 l9_113=sc_OutputMotionVectorsIfNeeded(varPos,max(l9_111,vec4(0.0)));
vec4 l9_114=clamp(l9_113,vec4(0.0),vec4(1.0));
#if (sc_OITDepthBoundsPass)
{
#if (sc_OITDepthBoundsPass)
{
float l9_115=clamp(viewSpaceDepth()/1000.0,0.0,1.0);
sc_writeFragData0Internal(vec4(max(0.0,1.0-(l9_115-0.0039215689)),min(1.0,l9_115+0.0039215689),0.0,0.0),sc_UniformConstants.x,sc_ShaderCacheConstant);
}
#endif
}
#else
...
#if (sc_OITDepthGatherPass)
{
vec2 l9_116=sc_ScreenCoordsGlobalToView(gl_FragCoord.xy*sc_CurrentRenderTargetDims.zw);
#if (sc_OITMaxLayers4Plus1)
{
if ((gl_FragCoord.z-texture(sc_OITFrontDepthTexture,l9_116).x)<=getFrontLayerZTestEpsilon())
{
discard;
}
}
#endif
int l9_117=encodeDepth(viewSpaceDepth(),texture(sc_OITFilteredDepthBoundsTexture,l9_116).xy);
float l9_118=packValue(l9_117);
int l9_125=int(l9_114.w*255.0);
float l9_126=packValue(l9_125);
sc_writeFragData0Internal(vec4(packValue(l9_117),packValue(l9_117),packValue(l9_117),packValue(l9_117)),sc_UniformConstants.x,sc_ShaderCacheConstant);
sc_writeFragData1(vec4(l9_118,packValue(l9_117),packValue(l9_117),packValue(l9_117)));
sc_writeFragData2(vec4(l9_126,packValue(l9_125),packValue(l9_125),packValue(l9_125)));
...
#if (sc_OITCompositingPass)
{
vec2 l9_129=sc_ScreenCoordsGlobalToView(gl_FragCoord.xy*sc_CurrentRenderTargetDims.zw);
#if (sc_OITMaxLayers4Plus1)
{
if ((gl_FragCoord.z-texture(sc_OITFrontDepthTexture,l9_129).x)<=getFrontLayerZTestEpsilon())
{
discard;
}
}
...
if (l9_134==0)
{
l9_137=texture(sc_OITAlpha0,l9_129);
l9_136=texture(sc_OITDepthLow0,l9_129);
l9_135=texture(sc_OITDepthHigh0,l9_129);
}
else
{
l9_137=vec4(0.0);
...
if (l9_134==1)
{
l9_140=texture(sc_OITAlpha1,l9_129);
l9_139=texture(sc_OITDepthLow1,l9_129);
l9_138=texture(sc_OITDepthHigh1,l9_129);
}
else
{
l9_140=l9_137;
...
if (any(notEqual(l9_138,vec4(0.0)))||any(notEqual(l9_139,vec4(0.0))))
{
int l9_141[8]=l9_130;
unpackValues(l9_138.w,l9_134,l9_141);
unpackValues(l9_138.z,l9_134,l9_141);
unpackValues(l9_138.y,l9_134,l9_141);
unpackValues(l9_138.x,l9_134,l9_141);
unpackValues(l9_139.w,l9_134,l9_141);
unpackValues(l9_139.z,l9_134,l9_141);
unpackValues(l9_139.y,l9_134,l9_141);
unpackValues(l9_139.x,l9_134,l9_141);
int l9_150[8]=l9_131;
unpackValues(l9_140.w,l9_134,l9_150);
unpackValues(l9_140.z,l9_134,l9_150);
unpackValues(l9_140.y,l9_134,l9_150);
unpackValues(l9_140.x,l9_134,l9_150);
}
l9_134++;
continue;
}
...
vec4 l9_155=texture(sc_OITFilteredDepthBoundsTexture,l9_129);
vec2 l9_156=l9_155.xy;
int l9_157;
#if (sc_SkinBonesCount>0)
{
l9_157=encodeDepth(((1.0-l9_155.x)*1000.0)+getDepthOrderingEpsilon(),l9_156);
}
#else
{
l9_157=0;
...
#endif
int l9_158=encodeDepth(viewSpaceDepth(),l9_156);
vec4 l9_159;
l9_159=l9_114*l9_114.w;
vec4 l9_160;
int l9_161=0;
for (int snapLoopIndex=0; snapLoopIndex==0; snapLoopIndex+=0)
{
if (l9_161<8)
{
int l9_162=l9_130[l9_161];
int l9_163=l9_158-l9_157;
bool l9_164=l9_162<l9_163;
bool l9_165;
if (l9_164)
{
l9_165=l9_130[l9_161]>0;
}
else
{
l9_165=l9_164;
...
if (l9_165)
{
vec3 l9_166=l9_159.xyz*(1.0-(float(l9_131[l9_161])/255.0));
l9_160=vec4(l9_166.x,l9_166.y,l9_166.z,l9_159.w);
}
else
{
l9_160=l9_159;
...
sc_writeFragData0Internal(l9_159,sc_UniformConstants.x,sc_ShaderCacheConstant);
#if (sc_OITMaxLayersVisualizeLayerCount)
{
discard;
}
...
sc_writeFragData0Internal(l9_114,sc_UniformConstants.x,sc_ShaderCacheConstant);
}
#endif
}
#else
{
sc_writeFragData0Internal(l9_113,sc_UniformConstants.x,sc_ShaderCacheConstant);
}
#endif
}
#endif

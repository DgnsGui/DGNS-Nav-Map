...
vec3 l9_69=l9_2-circleBoundCentre;
vec3 l9_70=cross(l9_1,vec3(Port_Value1_N089,Port_Value2_N089,Port_Value3_N089));
...
float l9_137=min(step(length(vec2(dot(l9_69,l9_73),dot(l9_69,l9_77))/(Port_Input1_N097+vec2(1.234e-06))),Port_Input1_N099),l9_136);

...
uniform float Port_Default_N081;
...
{
l9_66=step(distance(Port_Input0_N076,circleBoundCentre),circleBoundRadius);
}
else
{
l9_66=Port_Default_N081;
}
float l9_67;
#if (Tweak_N308)
{
...
{
vec2 l9_71;
Node122_If_else(0.0,vec2(0.0),vec2(0.0),l9_71,l9_6);
float l9_72;
Node67_Bool_Parameter(l9_72,l9_6);
l9_70=mix(l9_3,l9_71,vec2(l9_72));
}
#else
{
vec2 l9_73;
...
{
vec2 l9_74;
Node64_If_else(0.0,vec2(0.0),vec2(0.0),l9_74,l9_6);
float l9_75;
Node11_Bool_Parameter(l9_75,l9_6);
...
{
bool l9_77=(int(SC_USE_CLAMP_TO_BORDER_opacityTex)!=0)&&(!(int(SC_USE_UV_MIN_MAX_opacityTex)!=0));
float l9_78=l9_68.x;
sc_SoftwareWrapEarly(l9_78,ivec2(SC_SOFTWARE_WRAP_MODE_U_opacityTex,SC_SOFTWARE_WRAP_MODE_V_opacityTex).x);
float l9_79=l9_78;
float l9_80=l9_68.y;
sc_SoftwareWrapEarly(l9_80,ivec2(SC_SOFTWARE_WRAP_MODE_U_opacityTex,SC_SOFTWARE_WRAP_MODE_V_opacityTex).y);
float l9_81=l9_80;
vec2 l9_82;
float l9_83;
...
{
l9_84=ivec2(SC_SOFTWARE_WRAP_MODE_U_opacityTex,SC_SOFTWARE_WRAP_MODE_V_opacityTex).x==3;
}
#else
{
l9_84=(int(SC_USE_CLAMP_TO_BORDER_opacityTex)!=0);
}
#endif
float l9_85=l9_79;
float l9_86=1.0;
sc_ClampUV(l9_85,opacityTexUvMinMax.x,opacityTexUvMinMax.z,l9_84,l9_86);
float l9_87=l9_85;
float l9_88=l9_86;
bool l9_89;
#if (SC_USE_CLAMP_TO_BORDER_opacityTex)
{
l9_89=ivec2(SC_SOFTWARE_WRAP_MODE_U_opacityTex,SC_SOFTWARE_WRAP_MODE_V_opacityTex).y==3;
}
#else
{
...
float l9_90=l9_81;
float l9_91=l9_88;
sc_ClampUV(l9_90,opacityTexUvMinMax.y,opacityTexUvMinMax.w,l9_89,l9_91);
l9_83=l9_91;
...
#endif
vec2 l9_92=sc_TransformUV(l9_82,(int(SC_USE_UV_TRANSFORM_opacityTex)!=0),opacityTexTransform);
float l9_93=l9_92.x;
float l9_94=l9_83;
sc_SoftwareWrapLate(l9_93,ivec2(SC_SOFTWARE_WRAP_MODE_U_opacityTex,SC_SOFTWARE_WRAP_MODE_V_opacityTex).x,l9_77,l9_94);
float l9_95=l9_92.y;
float l9_96=l9_94;
sc_SoftwareWrapLate(l9_95,ivec2(SC_SOFTWARE_WRAP_MODE_U_opacityTex,SC_SOFTWARE_WRAP_MODE_V_opacityTex).y,l9_77,l9_96);
float l9_97=l9_96;
vec3 l9_98=sc_SamplingCoordsViewToGlobal(vec2(l9_93,l9_95),opacityTexLayout,opacityTexGetStereoViewIndex());
vec4 l9_99=texture(opacityTexArrSC,l9_98,0.0);
vec4 l9_100;
#if (SC_USE_CLAMP_TO_BORDER_opacityTex)
{
l9_100=mix(opacityTexBorderColor,l9_99,vec4(l9_97));
}
#else
{
l9_100=l9_99;
...
#else
{
bool l9_101=(int(SC_USE_CLAMP_TO_BORDER_opacityTex)!=0)&&(!(int(SC_USE_UV_MIN_MAX_opacityTex)!=0));
float l9_102=l9_68.x;
sc_SoftwareWrapEarly(l9_102,ivec2(SC_SOFTWARE_WRAP_MODE_U_opacityTex,SC_SOFTWARE_WRAP_MODE_V_opacityTex).x);
float l9_103=l9_102;
float l9_104=l9_68.y;
sc_SoftwareWrapEarly(l9_104,ivec2(SC_SOFTWARE_WRAP_MODE_U_opacityTex,SC_SOFTWARE_WRAP_MODE_V_opacityTex).y);
float l9_105=l9_104;
vec2 l9_106;
float l9_107;
#if (SC_USE_UV_MIN_MAX_opacityTex)
...
#if (SC_USE_CLAMP_TO_BORDER_opacityTex)
{
l9_108=ivec2(SC_SOFTWARE_WRAP_MODE_U_opacityTex,SC_SOFTWARE_WRAP_MODE_V_opacityTex).x==3;
}
#else
{
...
float l9_109=l9_103;
float l9_110=1.0;
sc_ClampUV(l9_109,opacityTexUvMinMax.x,opacityTexUvMinMax.z,l9_108,l9_110);
float l9_111=l9_109;
float l9_112=l9_110;
bool l9_113;
#if (SC_USE_CLAMP_TO_BORDER_opacityTex)
{
l9_113=ivec2(SC_SOFTWARE_WRAP_MODE_U_opacityTex,SC_SOFTWARE_WRAP_MODE_V_opacityTex).y==3;
}
#else
{
...
float l9_114=l9_105;
float l9_115=l9_112;
sc_ClampUV(l9_114,opacityTexUvMinMax.y,opacityTexUvMinMax.w,l9_113,l9_115);
l9_107=l9_115;
...
#endif
vec2 l9_116=sc_TransformUV(l9_106,(int(SC_USE_UV_TRANSFORM_opacityTex)!=0),opacityTexTransform);
float l9_117=l9_116.x;
float l9_118=l9_107;
sc_SoftwareWrapLate(l9_117,ivec2(SC_SOFTWARE_WRAP_MODE_U_opacityTex,SC_SOFTWARE_WRAP_MODE_V_opacityTex).x,l9_101,l9_118);
float l9_119=l9_116.y;
float l9_120=l9_118;
sc_SoftwareWrapLate(l9_119,ivec2(SC_SOFTWARE_WRAP_MODE_U_opacityTex,SC_SOFTWARE_WRAP_MODE_V_opacityTex).y,l9_101,l9_120);
float l9_121=l9_120;
vec3 l9_122=sc_SamplingCoordsViewToGlobal(vec2(l9_117,l9_119),opacityTexLayout,opacityTexGetStereoViewIndex());
vec4 l9_123=texture(opacityTex,l9_122.xy,0.0);
vec4 l9_124;
#if (SC_USE_CLAMP_TO_BORDER_opacityTex)
{
l9_124=mix(opacityTexBorderColor,l9_123,vec4(l9_121));
}
#else
{
l9_124=l9_123;
...
#else
{
l9_67=Port_Default_N204;
}
#endif
float l9_125=l9_65.w*l9_67;
float l9_126=min(l9_66,l9_125);
vec4 l9_127=vec4(l9_65.x,l9_65.y,l9_65.z,vec4(0.0).w);
l9_127.w=l9_126;
#if (sc_BlendMode_AlphaTest)
{
if (l9_126<alphaTestThreshold)
{
discard;
}
}
...
{
if (l9_126<((mod(dot(floor(mod(gl_FragCoord.xy,vec2(4.0))),vec2(4.0,1.0))*9.0,16.0)+1.0)/17.0))
{
discard;
}
}
...
#endif
sc_writeFragData0Internal(max(l9_128,vec4(0.0)),sc_UniformConstants.x,sc_ShaderCacheConstant);
return;
}
vec4 l9_130;
...
{
l9_132=clamp(l9_126*2.0,0.0,1.0);
}
#else
{
float l9_133;
...
{
l9_133=clamp(dot(l9_127.xyz,vec3(l9_126)),0.0,1.0);
}
#else
{
float l9_134;
...
{
l9_135=(1.0-dot(l9_127.xyz,vec3(0.33333001)))*l9_126;
}
#else
{
float l9_136;
...
{
l9_136=(1.0-clamp(dot(l9_127.xyz,vec3(1.0)),0.0,1.0))*l9_126;
}
#else
{
float l9_137;
...
{
l9_137=clamp(dot(l9_127.xyz,vec3(1.0)),0.0,1.0)*l9_126;
}
#else
{
float l9_138;
#if (sc_BlendMode_Add)
{
l9_138=clamp(dot(l9_127.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_139;
#if (sc_BlendMode_AddWithAlphaFactor)
{
l9_139=clamp(dot(l9_127.xyz,vec3(1.0)),0.0,1.0)*l9_126;
}
#else
{
float l9_140;
...
{
l9_140=dot(l9_127.xyz,vec3(0.33333001))*l9_126;
}
#else
{
float l9_141;
#if (sc_BlendMode_Min)
{
l9_141=1.0-clamp(dot(l9_127.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_142;
#if (sc_BlendMode_Max)
{
l9_142=clamp(dot(l9_127.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
l9_142=1.0;
...
#endif
l9_130=vec4(mix(sc_ShadowColor.xyz,sc_ShadowColor.xyz*l9_127.xyz,vec3(sc_ShadowColor.w)),sc_ShadowDensity*l9_131);
}
#else
{
vec4 l9_143;
...
#if (sc_FramebufferFetch)
{
l9_145=sc_readFragData0_Platform();
}
#else
{
...
{
l9_147=texture(sc_ScreenTextureArrSC,sc_SamplingCoordsViewToGlobal(l9_146,sc_ScreenTextureLayout,sc_ScreenTextureGetStereoViewIndex()),0.0);
}
#else
{
l9_147=texture(sc_ScreenTexture,sc_SamplingCoordsViewToGlobal(l9_146,sc_ScreenTextureLayout,sc_ScreenTextureGetStereoViewIndex()).xy,0.0);
}
#endif
l9_145=l9_147;
}
#endif
vec3 l9_148=mix(l9_145.xyz,definedBlend(l9_145.xyz,l9_127.xyz).xyz,vec3(l9_126));
vec4 l9_149=vec4(l9_148.x,l9_148.y,l9_148.z,vec4(0.0).w);
l9_149.w=1.0;
l9_144=l9_149;
}
#else
...
#if (sc_Voxelization)
{
l9_150=vec4(varScreenPos.xyz,1.0);
}
#else
{
vec4 l9_151;
#if (sc_OutputBounds)
{
float l9_152=clamp(abs(gl_FragCoord.z),0.0,1.0);
l9_151=vec4(l9_152,1.0-l9_152,1.0,1.0);
}
#else
{
vec4 l9_153;
#if (sc_BlendMode_MultiplyOriginal)
{
l9_153=vec4(mix(vec3(1.0),l9_127.xyz,vec3(l9_126)),l9_126);
}
#else
{
vec4 l9_154;
...
#endif
l9_154=vec4(l9_127.xyz*l9_155,l9_155);
}
#else
{
l9_154=l9_127;
...
vec4 l9_158=sc_OutputMotionVectorsIfNeeded(varPos,max(l9_156,vec4(0.0)));
vec4 l9_159=clamp(l9_158,vec4(0.0),vec4(1.0));
#if (sc_OITDepthBoundsPass)
{
#if (sc_OITDepthBoundsPass)
{
float l9_160=clamp(viewSpaceDepth()/1000.0,0.0,1.0);
sc_writeFragData0Internal(vec4(max(0.0,1.0-(l9_160-0.0039215689)),min(1.0,l9_160+0.0039215689),0.0,0.0),sc_UniformConstants.x,sc_ShaderCacheConstant);
}
#endif
}
#else
...
{
if ((gl_FragCoord.z-texture(sc_OITFrontDepthTexture,l9_161).x)<=getFrontLayerZTestEpsilon())
{
discard;
}
}
#endif
int l9_162=encodeDepth(viewSpaceDepth(),texture(sc_OITFilteredDepthBoundsTexture,l9_161).xy);
float l9_163=packValue(l9_162);
int l9_170=int(l9_159.w*255.0);
float l9_171=packValue(l9_170);
sc_writeFragData0Internal(vec4(packValue(l9_162),packValue(l9_162),packValue(l9_162),packValue(l9_162)),sc_UniformConstants.x,sc_ShaderCacheConstant);
sc_writeFragData1(vec4(l9_163,packValue(l9_162),packValue(l9_162),packValue(l9_162)));
sc_writeFragData2(vec4(l9_171,packValue(l9_170),packValue(l9_170),packValue(l9_170)));
...
#if (sc_OITMaxLayers4Plus1)
{
if ((gl_FragCoord.z-texture(sc_OITFrontDepthTexture,l9_174).x)<=getFrontLayerZTestEpsilon())
{
discard;
}
}
...
if (l9_179==0)
{
l9_182=texture(sc_OITAlpha0,l9_174);
l9_181=texture(sc_OITDepthLow0,l9_174);
l9_180=texture(sc_OITDepthHigh0,l9_174);
}
else
{
l9_182=vec4(0.0);
...
if (l9_179==1)
{
l9_185=texture(sc_OITAlpha1,l9_174);
l9_184=texture(sc_OITDepthLow1,l9_174);
l9_183=texture(sc_OITDepthHigh1,l9_174);
}
else
{
l9_185=l9_182;
...
if (any(notEqual(l9_183,vec4(0.0)))||any(notEqual(l9_184,vec4(0.0))))
{
int l9_186[8]=l9_175;
unpackValues(l9_183.w,l9_179,l9_186);
unpackValues(l9_183.z,l9_179,l9_186);
unpackValues(l9_183.y,l9_179,l9_186);
unpackValues(l9_183.x,l9_179,l9_186);
unpackValues(l9_184.w,l9_179,l9_186);
unpackValues(l9_184.z,l9_179,l9_186);
unpackValues(l9_184.y,l9_179,l9_186);
unpackValues(l9_184.x,l9_179,l9_186);
int l9_195[8]=l9_176;
unpackValues(l9_185.w,l9_179,l9_195);
unpackValues(l9_185.z,l9_179,l9_195);
unpackValues(l9_185.y,l9_179,l9_195);
unpackValues(l9_185.x,l9_179,l9_195);
}
l9_179++;
continue;
}
...
vec4 l9_200=texture(sc_OITFilteredDepthBoundsTexture,l9_174);
vec2 l9_201=l9_200.xy;
int l9_202;
#if (sc_SkinBonesCount>0)
{
l9_202=encodeDepth(((1.0-l9_200.x)*1000.0)+getDepthOrderingEpsilon(),l9_201);
}
#else
{
l9_202=0;
...
#endif
int l9_203=encodeDepth(viewSpaceDepth(),l9_201);
vec4 l9_204;
l9_204=l9_159*l9_159.w;
vec4 l9_205;
int l9_206=0;
for (int snapLoopIndex=0; snapLoopIndex==0; snapLoopIndex+=0)
{
if (l9_206<8)
{
int l9_207=l9_175[l9_206];
int l9_208=l9_203-l9_202;
bool l9_209=l9_207<l9_208;
bool l9_210;
if (l9_209)
{
l9_210=l9_175[l9_206]>0;
}
else
{
l9_210=l9_209;
...
if (l9_210)
{
vec3 l9_211=l9_204.xyz*(1.0-(float(l9_176[l9_206])/255.0));
l9_205=vec4(l9_211.x,l9_211.y,l9_211.z,l9_204.w);
}
else
{
l9_205=l9_204;
...
sc_writeFragData0Internal(l9_204,sc_UniformConstants.x,sc_ShaderCacheConstant);
#if (sc_OITMaxLayersVisualizeLayerCount)
{
discard;
}
...
#else
{
sc_writeFragData0Internal(l9_158,sc_UniformConstants.x,sc_ShaderCacheConstant);
}
#endif
}
#endif

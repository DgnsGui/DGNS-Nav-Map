...
vec3 l9_71=l9_2-Tweak_N85;
vec3 l9_72=cross(l9_1,vec3(Port_Value1_N088,Port_Value2_N088,Port_Value3_N088));
...
float l9_80=step(length((vec2(dot(l9_71,l9_75),dot(l9_71,l9_79))/(Port_Input1_N096+vec2(1.234e-06)))+Port_Offset_N099),Port_Input1_N098);

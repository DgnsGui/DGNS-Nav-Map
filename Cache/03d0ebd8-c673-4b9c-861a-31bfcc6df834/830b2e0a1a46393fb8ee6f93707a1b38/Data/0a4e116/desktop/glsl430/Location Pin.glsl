...
uniform float Port_Value1_N045;
uniform float Port_Value2_N045;
uniform float Port_Value3_N045;
...
vec3 l9_9=l9_1-Tweak_N44;
vec3 l9_10=cross(l9_2,vec3(Port_Value1_N045,Port_Value2_N045,Port_Value3_N045));
float l9_11=dot(l9_10,l9_10);
float l9_12;
if (l9_11>0.0)
{
l9_12=1.0/sqrt(l9_11);
}
else
{
l9_12=0.0;
}
vec3 l9_13=l9_10*l9_12;
vec3 l9_14=cross(l9_2,l9_13);
...
vec3 l9_18=l9_1-circleBoundCentre;
vec3 l9_19=cross(l9_2,vec3(Port_Value1_N089,Port_Value2_N089,Port_Value3_N089));
...
vec3 l9_26=l9_23*l9_25;
ssGlobals l9_27=ssGlobals(sc_Time.x,sc_Time.y,0.0,l9_1,l9_2,l9_5,l9_4,l9_3);
vec4 l9_28;
#if (Tweak_N121)
{
vec2 l9_29;
...
{
vec2 l9_32;
Node122_If_else(0.0,vec2(0.0),vec2(0.0),l9_32,l9_27);
float l9_33;
Node67_Bool_Parameter(l9_33,l9_27);
l9_31=mix(l9_5,l9_32,vec2(l9_33));
}
#else
{
vec2 l9_34;
...
{
vec2 l9_35;
Node64_If_else(0.0,vec2(0.0),vec2(0.0),l9_35,l9_27);
float l9_36;
Node11_Bool_Parameter(l9_36,l9_27);
l9_34=mix(l9_5,l9_35,vec2(l9_36));
}
#else
{
l9_34=l9_5;
...
vec4 l9_60=texture(baseTexArrSC,l9_59,0.0);
vec4 l9_61;
#if (SC_USE_CLAMP_TO_BORDER_baseTex)
{
...
#else
{
bool l9_62=(int(SC_USE_CLAMP_TO_BORDER_baseTex)!=0)&&(!(int(SC_USE_UV_MIN_MAX_baseTex)!=0));
float l9_63=l9_29.x;
sc_SoftwareWrapEarly(l9_63,ivec2(SC_SOFTWARE_WRAP_MODE_U_baseTex,SC_SOFTWARE_WRAP_MODE_V_baseTex).x);
float l9_64=l9_63;
float l9_65=l9_29.y;
...
float l9_78=l9_77.x;
float l9_79=l9_68;
sc_SoftwareWrapLate(l9_78,ivec2(SC_SOFTWARE_WRAP_MODE_U_baseTex,SC_SOFTWARE_WRAP_MODE_V_baseTex).x,l9_62,l9_79);
float l9_80=l9_77.y;
float l9_81=l9_79;
sc_SoftwareWrapLate(l9_80,ivec2(SC_SOFTWARE_WRAP_MODE_U_baseTex,SC_SOFTWARE_WRAP_MODE_V_baseTex).y,l9_62,l9_81);
float l9_82=l9_81;
vec3 l9_83=sc_SamplingCoordsViewToGlobal(vec2(l9_78,l9_80),baseTexLayout,baseTexGetStereoViewIndex());
vec4 l9_84=texture(baseTex,l9_83.xy,0.0);
vec4 l9_85;
#if (SC_USE_CLAMP_TO_BORDER_baseTex)
{
...
#else
{
l9_28=Port_Default_N369;
}
#endif
vec4 l9_86=baseColor*l9_28;
float l9_87;
#if (Tweak_N308)
{
vec2 l9_88;
...
{
vec2 l9_91;
Node122_If_else(0.0,vec2(0.0),vec2(0.0),l9_91,l9_27);
float l9_92;
Node67_Bool_Parameter(l9_92,l9_27);
l9_90=mix(l9_5,l9_91,vec2(l9_92));
}
#else
{
vec2 l9_93;
...
{
vec2 l9_94;
Node64_If_else(0.0,vec2(0.0),vec2(0.0),l9_94,l9_27);
float l9_95;
Node11_Bool_Parameter(l9_95,l9_27);
l9_93=mix(l9_5,l9_94,vec2(l9_95));
}
#else
{
l9_93=l9_5;
...
vec4 l9_119=texture(opacityTexArrSC,l9_118,0.0);
vec4 l9_120;
#if (SC_USE_CLAMP_TO_BORDER_opacityTex)
{
...
#else
{
bool l9_121=(int(SC_USE_CLAMP_TO_BORDER_opacityTex)!=0)&&(!(int(SC_USE_UV_MIN_MAX_opacityTex)!=0));
float l9_122=l9_88.x;
sc_SoftwareWrapEarly(l9_122,ivec2(SC_SOFTWARE_WRAP_MODE_U_opacityTex,SC_SOFTWARE_WRAP_MODE_V_opacityTex).x);
float l9_123=l9_122;
float l9_124=l9_88.y;
sc_SoftwareWrapEarly(l9_124,ivec2(SC_SOFTWARE_WRAP_MODE_U_opacityTex,SC_SOFTWARE_WRAP_MODE_V_opacityTex).y);
float l9_125=l9_124;
vec2 l9_126;
float l9_127;
#if (SC_USE_UV_MIN_MAX_opacityTex)
...
#if (SC_USE_CLAMP_TO_BORDER_opacityTex)
{
l9_128=ivec2(SC_SOFTWARE_WRAP_MODE_U_opacityTex,SC_SOFTWARE_WRAP_MODE_V_opacityTex).x==3;
}
#else
{
...
float l9_129=l9_123;
float l9_130=1.0;
sc_ClampUV(l9_129,opacityTexUvMinMax.x,opacityTexUvMinMax.z,l9_128,l9_130);
float l9_131=l9_129;
float l9_132=l9_130;
bool l9_133;
#if (SC_USE_CLAMP_TO_BORDER_opacityTex)
{
l9_133=ivec2(SC_SOFTWARE_WRAP_MODE_U_opacityTex,SC_SOFTWARE_WRAP_MODE_V_opacityTex).y==3;
}
#else
{
l9_133=(int(SC_USE_CLAMP_TO_BORDER_opacityTex)!=0);
}
#endif
float l9_134=l9_125;
float l9_135=l9_132;
sc_ClampUV(l9_134,opacityTexUvMinMax.y,opacityTexUvMinMax.w,l9_133,l9_135);
l9_127=l9_135;
l9_126=vec2(l9_131,l9_134);
}
#else
{
l9_127=1.0;
l9_126=vec2(l9_123,l9_125);
}
#endif
vec2 l9_136=sc_TransformUV(l9_126,(int(SC_USE_UV_TRANSFORM_opacityTex)!=0),opacityTexTransform);
float l9_137=l9_136.x;
float l9_138=l9_127;
sc_SoftwareWrapLate(l9_137,ivec2(SC_SOFTWARE_WRAP_MODE_U_opacityTex,SC_SOFTWARE_WRAP_MODE_V_opacityTex).x,l9_121,l9_138);
float l9_139=l9_136.y;
float l9_140=l9_138;
sc_SoftwareWrapLate(l9_139,ivec2(SC_SOFTWARE_WRAP_MODE_U_opacityTex,SC_SOFTWARE_WRAP_MODE_V_opacityTex).y,l9_121,l9_140);
float l9_141=l9_140;
vec3 l9_142=sc_SamplingCoordsViewToGlobal(vec2(l9_137,l9_139),opacityTexLayout,opacityTexGetStereoViewIndex());
vec4 l9_143=texture(opacityTex,l9_142.xy,0.0);
vec4 l9_144;
#if (SC_USE_CLAMP_TO_BORDER_opacityTex)
{
l9_144=mix(opacityTexBorderColor,l9_143,vec4(l9_141));
}
#else
{
l9_144=l9_143;
...
#else
{
l9_87=Port_Default_N204;
}
#endif
float l9_145=l9_86.w*l9_87;
float l9_146=min(step(length(vec2(dot(l9_18,l9_22),dot(l9_18,l9_26))/(Port_Input1_N097+vec2(1.234e-06))),Port_Input1_N099),l9_145);
vec3 l9_147=vec3(step(length(vec2(dot(l9_9,l9_13)*Mask_Radius,dot(l9_9,l9_17)*Mask_Radius)/(Port_Input1_N057+vec2(1.234e-06))),Port_Input1_N077));
vec4 l9_148=vec4(l9_147.x,l9_147.y,l9_147.z,vec4(0.0).w);
l9_148.w=l9_146;
#if (sc_BlendMode_AlphaTest)
{
if (l9_146<alphaTestThreshold)
{
discard;
}
}
...
{
if (l9_146<((mod(dot(floor(mod(gl_FragCoord.xy,vec2(4.0))),vec2(4.0,1.0))*9.0,16.0)+1.0)/17.0))
{
discard;
}
}
...
#endif
sc_writeFragData0Internal(max(l9_149,vec4(0.0)),sc_UniformConstants.x,sc_ShaderCacheConstant);
return;
}
vec4 l9_151;
...
{
l9_153=clamp(l9_146*2.0,0.0,1.0);
}
#else
{
float l9_154;
...
{
l9_154=clamp(dot(l9_148.xyz,vec3(l9_146)),0.0,1.0);
}
#else
{
float l9_155;
...
{
l9_156=(1.0-dot(l9_148.xyz,vec3(0.33333001)))*l9_146;
}
#else
{
float l9_157;
...
{
l9_157=(1.0-clamp(dot(l9_148.xyz,vec3(1.0)),0.0,1.0))*l9_146;
}
#else
{
float l9_158;
...
{
l9_158=clamp(dot(l9_148.xyz,vec3(1.0)),0.0,1.0)*l9_146;
}
#else
{
float l9_159;
#if (sc_BlendMode_Add)
{
l9_159=clamp(dot(l9_148.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_160;
#if (sc_BlendMode_AddWithAlphaFactor)
{
l9_160=clamp(dot(l9_148.xyz,vec3(1.0)),0.0,1.0)*l9_146;
}
#else
{
float l9_161;
...
{
l9_161=dot(l9_148.xyz,vec3(0.33333001))*l9_146;
}
#else
{
float l9_162;
#if (sc_BlendMode_Min)
{
l9_162=1.0-clamp(dot(l9_148.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_163;
#if (sc_BlendMode_Max)
{
l9_163=clamp(dot(l9_148.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
l9_163=1.0;
...
#endif
l9_151=vec4(mix(sc_ShadowColor.xyz,sc_ShadowColor.xyz*l9_148.xyz,vec3(sc_ShadowColor.w)),sc_ShadowDensity*l9_152);
}
#else
{
vec4 l9_164;
...
#if (sc_FramebufferFetch)
{
l9_166=sc_readFragData0_Platform();
}
#else
{
...
{
l9_168=texture(sc_ScreenTextureArrSC,sc_SamplingCoordsViewToGlobal(l9_167,sc_ScreenTextureLayout,sc_ScreenTextureGetStereoViewIndex()),0.0);
}
#else
{
l9_168=texture(sc_ScreenTexture,sc_SamplingCoordsViewToGlobal(l9_167,sc_ScreenTextureLayout,sc_ScreenTextureGetStereoViewIndex()).xy,0.0);
}
#endif
l9_166=l9_168;
}
#endif
vec3 l9_169=mix(l9_166.xyz,definedBlend(l9_166.xyz,l9_148.xyz).xyz,vec3(l9_146));
vec4 l9_170=vec4(l9_169.x,l9_169.y,l9_169.z,vec4(0.0).w);
l9_170.w=1.0;
l9_165=l9_170;
}
#else
...
#if (sc_Voxelization)
{
l9_171=vec4(varScreenPos.xyz,1.0);
}
#else
{
vec4 l9_172;
#if (sc_OutputBounds)
{
float l9_173=clamp(abs(gl_FragCoord.z),0.0,1.0);
l9_172=vec4(l9_173,1.0-l9_173,1.0,1.0);
}
#else
{
vec4 l9_174;
#if (sc_BlendMode_MultiplyOriginal)
{
l9_174=vec4(mix(vec3(1.0),l9_148.xyz,vec3(l9_146)),l9_146);
}
#else
{
vec4 l9_175;
...
#endif
l9_175=vec4(l9_148.xyz*l9_176,l9_176);
}
#else
{
l9_175=l9_148;
...
vec4 l9_179=sc_OutputMotionVectorsIfNeeded(varPos,max(l9_177,vec4(0.0)));
vec4 l9_180=clamp(l9_179,vec4(0.0),vec4(1.0));
#if (sc_OITDepthBoundsPass)
{
#if (sc_OITDepthBoundsPass)
{
float l9_181=clamp(viewSpaceDepth()/1000.0,0.0,1.0);
sc_writeFragData0Internal(vec4(max(0.0,1.0-(l9_181-0.0039215689)),min(1.0,l9_181+0.0039215689),0.0,0.0),sc_UniformConstants.x,sc_ShaderCacheConstant);
}
#endif
}
#else
...
{
if ((gl_FragCoord.z-texture(sc_OITFrontDepthTexture,l9_182).x)<=getFrontLayerZTestEpsilon())
{
discard;
}
}
#endif
int l9_183=encodeDepth(viewSpaceDepth(),texture(sc_OITFilteredDepthBoundsTexture,l9_182).xy);
float l9_184=packValue(l9_183);
int l9_191=int(l9_180.w*255.0);
float l9_192=packValue(l9_191);
sc_writeFragData0Internal(vec4(packValue(l9_183),packValue(l9_183),packValue(l9_183),packValue(l9_183)),sc_UniformConstants.x,sc_ShaderCacheConstant);
sc_writeFragData1(vec4(l9_184,packValue(l9_183),packValue(l9_183),packValue(l9_183)));
sc_writeFragData2(vec4(l9_192,packValue(l9_191),packValue(l9_191),packValue(l9_191)));
...
#if (sc_OITCompositingPass)
{
vec2 l9_195=sc_ScreenCoordsGlobalToView(gl_FragCoord.xy*sc_CurrentRenderTargetDims.zw);
#if (sc_OITMaxLayers4Plus1)
{
if ((gl_FragCoord.z-texture(sc_OITFrontDepthTexture,l9_195).x)<=getFrontLayerZTestEpsilon())
{
discard;
}
}
...
if (l9_200==0)
{
l9_203=texture(sc_OITAlpha0,l9_195);
l9_202=texture(sc_OITDepthLow0,l9_195);
l9_201=texture(sc_OITDepthHigh0,l9_195);
}
else
{
l9_203=vec4(0.0);
...
if (l9_200==1)
{
l9_206=texture(sc_OITAlpha1,l9_195);
l9_205=texture(sc_OITDepthLow1,l9_195);
l9_204=texture(sc_OITDepthHigh1,l9_195);
}
else
{
l9_206=l9_203;
...
if (any(notEqual(l9_204,vec4(0.0)))||any(notEqual(l9_205,vec4(0.0))))
{
int l9_207[8]=l9_196;
unpackValues(l9_204.w,l9_200,l9_207);
unpackValues(l9_204.z,l9_200,l9_207);
unpackValues(l9_204.y,l9_200,l9_207);
unpackValues(l9_204.x,l9_200,l9_207);
unpackValues(l9_205.w,l9_200,l9_207);
unpackValues(l9_205.z,l9_200,l9_207);
unpackValues(l9_205.y,l9_200,l9_207);
unpackValues(l9_205.x,l9_200,l9_207);
int l9_216[8]=l9_197;
unpackValues(l9_206.w,l9_200,l9_216);
unpackValues(l9_206.z,l9_200,l9_216);
unpackValues(l9_206.y,l9_200,l9_216);
unpackValues(l9_206.x,l9_200,l9_216);
}
l9_200++;
continue;
}
...
vec4 l9_221=texture(sc_OITFilteredDepthBoundsTexture,l9_195);
vec2 l9_222=l9_221.xy;
int l9_223;
#if (sc_SkinBonesCount>0)
{
l9_223=encodeDepth(((1.0-l9_221.x)*1000.0)+getDepthOrderingEpsilon(),l9_222);
}
#else
{
l9_223=0;
...
#endif
int l9_224=encodeDepth(viewSpaceDepth(),l9_222);
vec4 l9_225;
l9_225=l9_180*l9_180.w;
vec4 l9_226;
int l9_227=0;
for (int snapLoopIndex=0; snapLoopIndex==0; snapLoopIndex+=0)
{
if (l9_227<8)
{
int l9_228=l9_196[l9_227];
int l9_229=l9_224-l9_223;
bool l9_230=l9_228<l9_229;
bool l9_231;
if (l9_230)
{
l9_231=l9_196[l9_227]>0;
}
else
{
l9_231=l9_230;
...
if (l9_231)
{
vec3 l9_232=l9_225.xyz*(1.0-(float(l9_197[l9_227])/255.0));
l9_226=vec4(l9_232.x,l9_232.y,l9_232.z,l9_225.w);
}
else
{
l9_226=l9_225;
...
sc_writeFragData0Internal(l9_225,sc_UniformConstants.x,sc_ShaderCacheConstant);
#if (sc_OITMaxLayersVisualizeLayerCount)
{
discard;
}
...
sc_writeFragData0Internal(l9_180,sc_UniformConstants.x,sc_ShaderCacheConstant);
}
#endif
}
#else
{
sc_writeFragData0Internal(l9_179,sc_UniformConstants.x,sc_ShaderCacheConstant);
}
#endif
}
#endif

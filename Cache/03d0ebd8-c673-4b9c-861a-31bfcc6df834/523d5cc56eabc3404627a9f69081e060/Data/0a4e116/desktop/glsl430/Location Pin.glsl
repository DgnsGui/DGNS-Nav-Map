...
{
l9_66=Port_Value1_N081;
}
else
{
vec3 l9_67=Port_Input0_N045-cornerPosition;
float l9_68=dot(verticalVector,l9_67);
float l9_69=dot(l9_67,horizontalVector);
l9_66=min(min(min(step(Port_Input0_N047,l9_68),step(l9_68,dot(verticalVector,verticalVector))),step(Port_Input0_N072,l9_69)),step(l9_69,dot(horizontalVector,horizontalVector)));
}
float l9_70;
#if (Tweak_N308)
{
...
{
vec2 l9_74;
Node122_If_else(0.0,vec2(0.0),vec2(0.0),l9_74,l9_6);
float l9_75;
Node67_Bool_Parameter(l9_75,l9_6);
l9_73=mix(l9_3,l9_74,vec2(l9_75));
}
#else
{
vec2 l9_76;
...
{
vec2 l9_77;
Node64_If_else(0.0,vec2(0.0),vec2(0.0),l9_77,l9_6);
float l9_78;
Node11_Bool_Parameter(l9_78,l9_6);
l9_76=mix(l9_3,l9_77,vec2(l9_78));
}
#else
{
l9_76=l9_3;
...
{
bool l9_80=(int(SC_USE_CLAMP_TO_BORDER_opacityTex)!=0)&&(!(int(SC_USE_UV_MIN_MAX_opacityTex)!=0));
float l9_81=l9_71.x;
sc_SoftwareWrapEarly(l9_81,ivec2(SC_SOFTWARE_WRAP_MODE_U_opacityTex,SC_SOFTWARE_WRAP_MODE_V_opacityTex).x);
float l9_82=l9_81;
float l9_83=l9_71.y;
sc_SoftwareWrapEarly(l9_83,ivec2(SC_SOFTWARE_WRAP_MODE_U_opacityTex,SC_SOFTWARE_WRAP_MODE_V_opacityTex).y);
float l9_84=l9_83;
vec2 l9_85;
float l9_86;
...
{
l9_87=ivec2(SC_SOFTWARE_WRAP_MODE_U_opacityTex,SC_SOFTWARE_WRAP_MODE_V_opacityTex).x==3;
}
#else
{
...
float l9_88=l9_82;
float l9_89=1.0;
sc_ClampUV(l9_88,opacityTexUvMinMax.x,opacityTexUvMinMax.z,l9_87,l9_89);
float l9_90=l9_88;
float l9_91=l9_89;
bool l9_92;
#if (SC_USE_CLAMP_TO_BORDER_opacityTex)
{
l9_92=ivec2(SC_SOFTWARE_WRAP_MODE_U_opacityTex,SC_SOFTWARE_WRAP_MODE_V_opacityTex).y==3;
}
#else
{
...
float l9_93=l9_84;
float l9_94=l9_91;
sc_ClampUV(l9_93,opacityTexUvMinMax.y,opacityTexUvMinMax.w,l9_92,l9_94);
l9_86=l9_94;
...
#endif
vec2 l9_95=sc_TransformUV(l9_85,(int(SC_USE_UV_TRANSFORM_opacityTex)!=0),opacityTexTransform);
float l9_96=l9_95.x;
float l9_97=l9_86;
sc_SoftwareWrapLate(l9_96,ivec2(SC_SOFTWARE_WRAP_MODE_U_opacityTex,SC_SOFTWARE_WRAP_MODE_V_opacityTex).x,l9_80,l9_97);
float l9_98=l9_95.y;
float l9_99=l9_97;
sc_SoftwareWrapLate(l9_98,ivec2(SC_SOFTWARE_WRAP_MODE_U_opacityTex,SC_SOFTWARE_WRAP_MODE_V_opacityTex).y,l9_80,l9_99);
float l9_100=l9_99;
vec3 l9_101=sc_SamplingCoordsViewToGlobal(vec2(l9_96,l9_98),opacityTexLayout,opacityTexGetStereoViewIndex());
vec4 l9_102=texture(opacityTexArrSC,l9_101,0.0);
vec4 l9_103;
#if (SC_USE_CLAMP_TO_BORDER_opacityTex)
{
l9_103=mix(opacityTexBorderColor,l9_102,vec4(l9_100));
}
#else
{
l9_103=l9_102;
...
#else
{
bool l9_104=(int(SC_USE_CLAMP_TO_BORDER_opacityTex)!=0)&&(!(int(SC_USE_UV_MIN_MAX_opacityTex)!=0));
float l9_105=l9_71.x;
sc_SoftwareWrapEarly(l9_105,ivec2(SC_SOFTWARE_WRAP_MODE_U_opacityTex,SC_SOFTWARE_WRAP_MODE_V_opacityTex).x);
float l9_106=l9_105;
float l9_107=l9_71.y;
sc_SoftwareWrapEarly(l9_107,ivec2(SC_SOFTWARE_WRAP_MODE_U_opacityTex,SC_SOFTWARE_WRAP_MODE_V_opacityTex).y);
float l9_108=l9_107;
vec2 l9_109;
float l9_110;
#if (SC_USE_UV_MIN_MAX_opacityTex)
...
#if (SC_USE_CLAMP_TO_BORDER_opacityTex)
{
l9_111=ivec2(SC_SOFTWARE_WRAP_MODE_U_opacityTex,SC_SOFTWARE_WRAP_MODE_V_opacityTex).x==3;
}
#else
{
...
float l9_112=l9_106;
float l9_113=1.0;
sc_ClampUV(l9_112,opacityTexUvMinMax.x,opacityTexUvMinMax.z,l9_111,l9_113);
float l9_114=l9_112;
float l9_115=l9_113;
bool l9_116;
#if (SC_USE_CLAMP_TO_BORDER_opacityTex)
{
l9_116=ivec2(SC_SOFTWARE_WRAP_MODE_U_opacityTex,SC_SOFTWARE_WRAP_MODE_V_opacityTex).y==3;
}
#else
{
l9_116=(int(SC_USE_CLAMP_TO_BORDER_opacityTex)!=0);
}
#endif
float l9_117=l9_108;
float l9_118=l9_115;
sc_ClampUV(l9_117,opacityTexUvMinMax.y,opacityTexUvMinMax.w,l9_116,l9_118);
l9_110=l9_118;
...
#endif
vec2 l9_119=sc_TransformUV(l9_109,(int(SC_USE_UV_TRANSFORM_opacityTex)!=0),opacityTexTransform);
float l9_120=l9_119.x;
float l9_121=l9_110;
sc_SoftwareWrapLate(l9_120,ivec2(SC_SOFTWARE_WRAP_MODE_U_opacityTex,SC_SOFTWARE_WRAP_MODE_V_opacityTex).x,l9_104,l9_121);
float l9_122=l9_119.y;
float l9_123=l9_121;
sc_SoftwareWrapLate(l9_122,ivec2(SC_SOFTWARE_WRAP_MODE_U_opacityTex,SC_SOFTWARE_WRAP_MODE_V_opacityTex).y,l9_104,l9_123);
float l9_124=l9_123;
vec3 l9_125=sc_SamplingCoordsViewToGlobal(vec2(l9_120,l9_122),opacityTexLayout,opacityTexGetStereoViewIndex());
vec4 l9_126=texture(opacityTex,l9_125.xy,0.0);
vec4 l9_127;
#if (SC_USE_CLAMP_TO_BORDER_opacityTex)
{
l9_127=mix(opacityTexBorderColor,l9_126,vec4(l9_124));
}
#else
{
l9_127=l9_126;
...
#else
{
l9_70=Port_Default_N204;
}
#endif
float l9_128=l9_65.w*l9_70;
float l9_129=min(l9_66,l9_128);
vec4 l9_130=vec4(l9_65.x,l9_65.y,l9_65.z,vec4(0.0).w);
l9_130.w=l9_129;
#if (sc_BlendMode_AlphaTest)
{
if (l9_129<alphaTestThreshold)
{
discard;
}
}
...
{
if (l9_129<((mod(dot(floor(mod(gl_FragCoord.xy,vec2(4.0))),vec2(4.0,1.0))*9.0,16.0)+1.0)/17.0))
{
discard;
}
}
...
#endif
sc_writeFragData0Internal(max(l9_131,vec4(0.0)),sc_UniformConstants.x,sc_ShaderCacheConstant);
return;
}
vec4 l9_133;
...
{
l9_135=clamp(l9_129*2.0,0.0,1.0);
}
#else
{
float l9_136;
...
{
l9_136=clamp(dot(l9_130.xyz,vec3(l9_129)),0.0,1.0);
}
#else
{
float l9_137;
...
{
l9_138=(1.0-dot(l9_130.xyz,vec3(0.33333001)))*l9_129;
}
#else
{
float l9_139;
...
{
l9_139=(1.0-clamp(dot(l9_130.xyz,vec3(1.0)),0.0,1.0))*l9_129;
}
#else
{
float l9_140;
...
{
l9_140=clamp(dot(l9_130.xyz,vec3(1.0)),0.0,1.0)*l9_129;
}
#else
{
float l9_141;
#if (sc_BlendMode_Add)
{
l9_141=clamp(dot(l9_130.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_142;
#if (sc_BlendMode_AddWithAlphaFactor)
{
l9_142=clamp(dot(l9_130.xyz,vec3(1.0)),0.0,1.0)*l9_129;
}
#else
{
float l9_143;
...
{
l9_143=dot(l9_130.xyz,vec3(0.33333001))*l9_129;
}
#else
{
float l9_144;
#if (sc_BlendMode_Min)
{
l9_144=1.0-clamp(dot(l9_130.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_145;
#if (sc_BlendMode_Max)
{
l9_145=clamp(dot(l9_130.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
l9_145=1.0;
...
#endif
l9_133=vec4(mix(sc_ShadowColor.xyz,sc_ShadowColor.xyz*l9_130.xyz,vec3(sc_ShadowColor.w)),sc_ShadowDensity*l9_134);
}
#else
{
vec4 l9_146;
...
#if (sc_FramebufferFetch)
{
l9_148=sc_readFragData0_Platform();
}
#else
{
...
{
l9_150=texture(sc_ScreenTextureArrSC,sc_SamplingCoordsViewToGlobal(l9_149,sc_ScreenTextureLayout,sc_ScreenTextureGetStereoViewIndex()),0.0);
}
#else
{
l9_150=texture(sc_ScreenTexture,sc_SamplingCoordsViewToGlobal(l9_149,sc_ScreenTextureLayout,sc_ScreenTextureGetStereoViewIndex()).xy,0.0);
}
#endif
l9_148=l9_150;
}
#endif
vec3 l9_151=mix(l9_148.xyz,definedBlend(l9_148.xyz,l9_130.xyz).xyz,vec3(l9_129));
...
#if (sc_Voxelization)
{
l9_153=vec4(varScreenPos.xyz,1.0);
}
#else
{
vec4 l9_154;
#if (sc_OutputBounds)
{
float l9_155=clamp(abs(gl_FragCoord.z),0.0,1.0);
l9_154=vec4(l9_155,1.0-l9_155,1.0,1.0);
}
#else
{
vec4 l9_156;
#if (sc_BlendMode_MultiplyOriginal)
{
l9_156=vec4(mix(vec3(1.0),l9_130.xyz,vec3(l9_129)),l9_129);
}
#else
{
vec4 l9_157;
...
#endif
l9_157=vec4(l9_130.xyz*l9_158,l9_158);
}
#else
{
l9_157=l9_130;
...
vec4 l9_161=sc_OutputMotionVectorsIfNeeded(varPos,max(l9_159,vec4(0.0)));
vec4 l9_162=clamp(l9_161,vec4(0.0),vec4(1.0));
#if (sc_OITDepthBoundsPass)
{
#if (sc_OITDepthBoundsPass)
{
float l9_163=clamp(viewSpaceDepth()/1000.0,0.0,1.0);
sc_writeFragData0Internal(vec4(max(0.0,1.0-(l9_163-0.0039215689)),min(1.0,l9_163+0.0039215689),0.0,0.0),sc_UniformConstants.x,sc_ShaderCacheConstant);
}
#endif
}
#else
...
#if (sc_OITDepthGatherPass)
{
vec2 l9_164=sc_ScreenCoordsGlobalToView(gl_FragCoord.xy*sc_CurrentRenderTargetDims.zw);
#if (sc_OITMaxLayers4Plus1)
{
if ((gl_FragCoord.z-texture(sc_OITFrontDepthTexture,l9_164).x)<=getFrontLayerZTestEpsilon())
{
discard;
}
}
#endif
int l9_165=encodeDepth(viewSpaceDepth(),texture(sc_OITFilteredDepthBoundsTexture,l9_164).xy);
float l9_166=packValue(l9_165);
int l9_173=int(l9_162.w*255.0);
float l9_174=packValue(l9_173);
sc_writeFragData0Internal(vec4(packValue(l9_165),packValue(l9_165),packValue(l9_165),packValue(l9_165)),sc_UniformConstants.x,sc_ShaderCacheConstant);
sc_writeFragData1(vec4(l9_166,packValue(l9_165),packValue(l9_165),packValue(l9_165)));
sc_writeFragData2(vec4(l9_174,packValue(l9_173),packValue(l9_173),packValue(l9_173)));
...
#if (sc_OITMaxLayers4Plus1)
{
if ((gl_FragCoord.z-texture(sc_OITFrontDepthTexture,l9_177).x)<=getFrontLayerZTestEpsilon())
{
discard;
}
}
...
if (l9_182==0)
{
l9_185=texture(sc_OITAlpha0,l9_177);
l9_184=texture(sc_OITDepthLow0,l9_177);
l9_183=texture(sc_OITDepthHigh0,l9_177);
}
else
{
l9_185=vec4(0.0);
...
if (l9_182==1)
{
l9_188=texture(sc_OITAlpha1,l9_177);
l9_187=texture(sc_OITDepthLow1,l9_177);
l9_186=texture(sc_OITDepthHigh1,l9_177);
}
else
{
l9_188=l9_185;
...
if (any(notEqual(l9_186,vec4(0.0)))||any(notEqual(l9_187,vec4(0.0))))
{
int l9_189[8]=l9_178;
unpackValues(l9_186.w,l9_182,l9_189);
unpackValues(l9_186.z,l9_182,l9_189);
unpackValues(l9_186.y,l9_182,l9_189);
unpackValues(l9_186.x,l9_182,l9_189);
unpackValues(l9_187.w,l9_182,l9_189);
unpackValues(l9_187.z,l9_182,l9_189);
unpackValues(l9_187.y,l9_182,l9_189);
unpackValues(l9_187.x,l9_182,l9_189);
int l9_198[8]=l9_179;
unpackValues(l9_188.w,l9_182,l9_198);
unpackValues(l9_188.z,l9_182,l9_198);
unpackValues(l9_188.y,l9_182,l9_198);
unpackValues(l9_188.x,l9_182,l9_198);
}
l9_182++;
continue;
}
...
vec4 l9_203=texture(sc_OITFilteredDepthBoundsTexture,l9_177);
vec2 l9_204=l9_203.xy;
int l9_205;
#if (sc_SkinBonesCount>0)
{
l9_205=encodeDepth(((1.0-l9_203.x)*1000.0)+getDepthOrderingEpsilon(),l9_204);
}
#else
{
l9_205=0;
...
#endif
int l9_206=encodeDepth(viewSpaceDepth(),l9_204);
vec4 l9_207;
l9_207=l9_162*l9_162.w;
vec4 l9_208;
int l9_209=0;
for (int snapLoopIndex=0; snapLoopIndex==0; snapLoopIndex+=0)
{
if (l9_209<8)
{
int l9_210=l9_178[l9_209];
int l9_211=l9_206-l9_205;
bool l9_212=l9_210<l9_211;
bool l9_213;
if (l9_212)
{
l9_213=l9_178[l9_209]>0;
}
else
{
l9_213=l9_212;
...
if (l9_213)
{
vec3 l9_214=l9_207.xyz*(1.0-(float(l9_179[l9_209])/255.0));
l9_208=vec4(l9_214.x,l9_214.y,l9_214.z,l9_207.w);
}
else
{
l9_208=l9_207;
...
sc_writeFragData0Internal(l9_207,sc_UniformConstants.x,sc_ShaderCacheConstant);
#if (sc_OITMaxLayersVisualizeLayerCount)
{
discard;
}
...
sc_writeFragData0Internal(l9_162,sc_UniformConstants.x,sc_ShaderCacheConstant);
}
#endif
}
#else

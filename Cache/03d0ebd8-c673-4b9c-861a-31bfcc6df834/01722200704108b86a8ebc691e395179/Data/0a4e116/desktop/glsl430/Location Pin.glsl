...
vec3 l9_71=cross(l9_1,vec3(Port_Value1_N089,Port_Value2_N089,Port_Value3_N089));
...
l9_69=step(length(vec2(dot(l9_70,l9_74),dot(l9_70,l9_75*l9_77))/(Port_Input1_N097+vec2(1.234e-06))),Port_Input1_N099);
}
else
{
vec3 l9_78=l9_2-cornerPosition;
float l9_79=dot(verticalVector,l9_78);
float l9_80=dot(l9_78,horizontalVector);
l9_69=min(min(min(step(Port_Input0_N047,l9_79),step(l9_79,dot(verticalVector,verticalVector))),step(Port_Input0_N072,l9_80)),step(l9_80,dot(horizontalVector,horizontalVector)));
}
float l9_81;
#if (Tweak_N308)
{
...
{
vec2 l9_85;
Node122_If_else(0.0,vec2(0.0),vec2(0.0),l9_85,l9_9);
float l9_86;
Node67_Bool_Parameter(l9_86,l9_9);
...
{
vec2 l9_88;
Node64_If_else(0.0,vec2(0.0),vec2(0.0),l9_88,l9_9);
float l9_89;
Node11_Bool_Parameter(l9_89,l9_9);
l9_87=mix(l9_5,l9_88,vec2(l9_89));
}
#else
{
l9_87=l9_5;
...
{
bool l9_91=(int(SC_USE_CLAMP_TO_BORDER_opacityTex)!=0)&&(!(int(SC_USE_UV_MIN_MAX_opacityTex)!=0));
float l9_92=l9_82.x;
sc_SoftwareWrapEarly(l9_92,ivec2(SC_SOFTWARE_WRAP_MODE_U_opacityTex,SC_SOFTWARE_WRAP_MODE_V_opacityTex).x);
float l9_93=l9_92;
float l9_94=l9_82.y;
sc_SoftwareWrapEarly(l9_94,ivec2(SC_SOFTWARE_WRAP_MODE_U_opacityTex,SC_SOFTWARE_WRAP_MODE_V_opacityTex).y);
float l9_95=l9_94;
vec2 l9_96;
float l9_97;
...
{
l9_98=ivec2(SC_SOFTWARE_WRAP_MODE_U_opacityTex,SC_SOFTWARE_WRAP_MODE_V_opacityTex).x==3;
}
#else
{
l9_98=(int(SC_USE_CLAMP_TO_BORDER_opacityTex)!=0);
}
#endif
float l9_99=l9_93;
float l9_100=1.0;
sc_ClampUV(l9_99,opacityTexUvMinMax.x,opacityTexUvMinMax.z,l9_98,l9_100);
float l9_101=l9_99;
float l9_102=l9_100;
bool l9_103;
#if (SC_USE_CLAMP_TO_BORDER_opacityTex)
{
l9_103=ivec2(SC_SOFTWARE_WRAP_MODE_U_opacityTex,SC_SOFTWARE_WRAP_MODE_V_opacityTex).y==3;
}
#else
{
...
float l9_104=l9_95;
float l9_105=l9_102;
sc_ClampUV(l9_104,opacityTexUvMinMax.y,opacityTexUvMinMax.w,l9_103,l9_105);
l9_97=l9_105;
...
#endif
vec2 l9_106=sc_TransformUV(l9_96,(int(SC_USE_UV_TRANSFORM_opacityTex)!=0),opacityTexTransform);
float l9_107=l9_106.x;
float l9_108=l9_97;
sc_SoftwareWrapLate(l9_107,ivec2(SC_SOFTWARE_WRAP_MODE_U_opacityTex,SC_SOFTWARE_WRAP_MODE_V_opacityTex).x,l9_91,l9_108);
float l9_109=l9_106.y;
float l9_110=l9_108;
sc_SoftwareWrapLate(l9_109,ivec2(SC_SOFTWARE_WRAP_MODE_U_opacityTex,SC_SOFTWARE_WRAP_MODE_V_opacityTex).y,l9_91,l9_110);
float l9_111=l9_110;
vec3 l9_112=sc_SamplingCoordsViewToGlobal(vec2(l9_107,l9_109),opacityTexLayout,opacityTexGetStereoViewIndex());
vec4 l9_113=texture(opacityTexArrSC,l9_112,0.0);
vec4 l9_114;
#if (SC_USE_CLAMP_TO_BORDER_opacityTex)
{
l9_114=mix(opacityTexBorderColor,l9_113,vec4(l9_111));
}
#else
{
l9_114=l9_113;
...
#else
{
bool l9_115=(int(SC_USE_CLAMP_TO_BORDER_opacityTex)!=0)&&(!(int(SC_USE_UV_MIN_MAX_opacityTex)!=0));
float l9_116=l9_82.x;
sc_SoftwareWrapEarly(l9_116,ivec2(SC_SOFTWARE_WRAP_MODE_U_opacityTex,SC_SOFTWARE_WRAP_MODE_V_opacityTex).x);
float l9_117=l9_116;
float l9_118=l9_82.y;
sc_SoftwareWrapEarly(l9_118,ivec2(SC_SOFTWARE_WRAP_MODE_U_opacityTex,SC_SOFTWARE_WRAP_MODE_V_opacityTex).y);
float l9_119=l9_118;
vec2 l9_120;
float l9_121;
#if (SC_USE_UV_MIN_MAX_opacityTex)
...
#if (SC_USE_CLAMP_TO_BORDER_opacityTex)
{
l9_122=ivec2(SC_SOFTWARE_WRAP_MODE_U_opacityTex,SC_SOFTWARE_WRAP_MODE_V_opacityTex).x==3;
}
#else
{
l9_122=(int(SC_USE_CLAMP_TO_BORDER_opacityTex)!=0);
}
#endif
float l9_123=l9_117;
float l9_124=1.0;
sc_ClampUV(l9_123,opacityTexUvMinMax.x,opacityTexUvMinMax.z,l9_122,l9_124);
float l9_125=l9_123;
float l9_126=l9_124;
bool l9_127;
#if (SC_USE_CLAMP_TO_BORDER_opacityTex)
{
l9_127=ivec2(SC_SOFTWARE_WRAP_MODE_U_opacityTex,SC_SOFTWARE_WRAP_MODE_V_opacityTex).y==3;
}
#else
{
...
float l9_128=l9_119;
float l9_129=l9_126;
sc_ClampUV(l9_128,opacityTexUvMinMax.y,opacityTexUvMinMax.w,l9_127,l9_129);
l9_121=l9_129;
...
#endif
vec2 l9_130=sc_TransformUV(l9_120,(int(SC_USE_UV_TRANSFORM_opacityTex)!=0),opacityTexTransform);
float l9_131=l9_130.x;
float l9_132=l9_121;
sc_SoftwareWrapLate(l9_131,ivec2(SC_SOFTWARE_WRAP_MODE_U_opacityTex,SC_SOFTWARE_WRAP_MODE_V_opacityTex).x,l9_115,l9_132);
float l9_133=l9_130.y;
float l9_134=l9_132;
sc_SoftwareWrapLate(l9_133,ivec2(SC_SOFTWARE_WRAP_MODE_U_opacityTex,SC_SOFTWARE_WRAP_MODE_V_opacityTex).y,l9_115,l9_134);
float l9_135=l9_134;
vec3 l9_136=sc_SamplingCoordsViewToGlobal(vec2(l9_131,l9_133),opacityTexLayout,opacityTexGetStereoViewIndex());
vec4 l9_137=texture(opacityTex,l9_136.xy,0.0);
vec4 l9_138;
#if (SC_USE_CLAMP_TO_BORDER_opacityTex)
{
l9_138=mix(opacityTexBorderColor,l9_137,vec4(l9_135));
}
#else
{
l9_138=l9_137;
...
#else
{
l9_81=Port_Default_N204;
}
#endif
float l9_139=l9_68.w*l9_81;
float l9_140=min(l9_69,l9_139);
vec4 l9_141=vec4(l9_68.x,l9_68.y,l9_68.z,vec4(0.0).w);
l9_141.w=l9_140;
#if (sc_BlendMode_AlphaTest)
{
if (l9_140<alphaTestThreshold)
{
discard;
}
}
...
{
if (l9_140<((mod(dot(floor(mod(gl_FragCoord.xy,vec2(4.0))),vec2(4.0,1.0))*9.0,16.0)+1.0)/17.0))
{
discard;
}
}
...
#endif
sc_writeFragData0Internal(max(l9_142,vec4(0.0)),sc_UniformConstants.x,sc_ShaderCacheConstant);
return;
}
vec4 l9_144;
...
{
l9_146=clamp(l9_140*2.0,0.0,1.0);
}
#else
{
float l9_147;
...
{
l9_147=clamp(dot(l9_141.xyz,vec3(l9_140)),0.0,1.0);
}
#else
{
float l9_148;
...
{
l9_149=(1.0-dot(l9_141.xyz,vec3(0.33333001)))*l9_140;
}
#else
{
float l9_150;
...
{
l9_150=(1.0-clamp(dot(l9_141.xyz,vec3(1.0)),0.0,1.0))*l9_140;
}
#else
{
float l9_151;
...
{
l9_151=clamp(dot(l9_141.xyz,vec3(1.0)),0.0,1.0)*l9_140;
}
#else
{
float l9_152;
#if (sc_BlendMode_Add)
{
l9_152=clamp(dot(l9_141.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_153;
#if (sc_BlendMode_AddWithAlphaFactor)
{
l9_153=clamp(dot(l9_141.xyz,vec3(1.0)),0.0,1.0)*l9_140;
}
#else
{
float l9_154;
...
{
l9_154=dot(l9_141.xyz,vec3(0.33333001))*l9_140;
}
#else
{
float l9_155;
#if (sc_BlendMode_Min)
{
l9_155=1.0-clamp(dot(l9_141.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_156;
#if (sc_BlendMode_Max)
{
l9_156=clamp(dot(l9_141.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
l9_156=1.0;
...
#endif
l9_144=vec4(mix(sc_ShadowColor.xyz,sc_ShadowColor.xyz*l9_141.xyz,vec3(sc_ShadowColor.w)),sc_ShadowDensity*l9_145);
}
#else
{
vec4 l9_157;
...
#if (sc_FramebufferFetch)
{
l9_159=sc_readFragData0_Platform();
}
#else
{
...
{
l9_161=texture(sc_ScreenTextureArrSC,sc_SamplingCoordsViewToGlobal(l9_160,sc_ScreenTextureLayout,sc_ScreenTextureGetStereoViewIndex()),0.0);
}
#else
{
l9_161=texture(sc_ScreenTexture,sc_SamplingCoordsViewToGlobal(l9_160,sc_ScreenTextureLayout,sc_ScreenTextureGetStereoViewIndex()).xy,0.0);
}
#endif
l9_159=l9_161;
}
#endif
vec3 l9_162=mix(l9_159.xyz,definedBlend(l9_159.xyz,l9_141.xyz).xyz,vec3(l9_140));
vec4 l9_163=vec4(l9_162.x,l9_162.y,l9_162.z,vec4(0.0).w);
l9_163.w=1.0;
l9_158=l9_163;
}
#else
...
#if (sc_Voxelization)
{
l9_164=vec4(varScreenPos.xyz,1.0);
}
#else
{
vec4 l9_165;
#if (sc_OutputBounds)
{
float l9_166=clamp(abs(gl_FragCoord.z),0.0,1.0);
l9_165=vec4(l9_166,1.0-l9_166,1.0,1.0);
}
#else
{
vec4 l9_167;
#if (sc_BlendMode_MultiplyOriginal)
{
l9_167=vec4(mix(vec3(1.0),l9_141.xyz,vec3(l9_140)),l9_140);
}
#else
{
vec4 l9_168;
...
#endif
l9_168=vec4(l9_141.xyz*l9_169,l9_169);
}
#else
{
l9_168=l9_141;
...
vec4 l9_172=sc_OutputMotionVectorsIfNeeded(varPos,max(l9_170,vec4(0.0)));
...
{
if ((gl_FragCoord.z-texture(sc_OITFrontDepthTexture,l9_175).x)<=getFrontLayerZTestEpsilon())
{
discard;
}
}
#endif
int l9_176=encodeDepth(viewSpaceDepth(),texture(sc_OITFilteredDepthBoundsTexture,l9_175).xy);
...
#if (sc_OITMaxLayers4Plus1)
{
if ((gl_FragCoord.z-texture(sc_OITFrontDepthTexture,l9_188).x)<=getFrontLayerZTestEpsilon())
{
discard;
}
}
...
if (l9_193==0)
{
l9_196=texture(sc_OITAlpha0,l9_188);
l9_195=texture(sc_OITDepthLow0,l9_188);
l9_194=texture(sc_OITDepthHigh0,l9_188);
}
else
{
l9_196=vec4(0.0);
...
if (l9_193==1)
{
l9_199=texture(sc_OITAlpha1,l9_188);
l9_198=texture(sc_OITDepthLow1,l9_188);
l9_197=texture(sc_OITDepthHigh1,l9_188);
}
else
{
l9_199=l9_196;
...
vec4 l9_214=texture(sc_OITFilteredDepthBoundsTexture,l9_188);

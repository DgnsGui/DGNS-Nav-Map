...
vec3 l9_69=l9_2-Tweak_N44;
vec3 l9_70=cross(l9_1,vec3(Port_Value1_N045,Port_Value2_N045,Port_Value3_N045));
...
float l9_137=min(step(length(vec2(dot(l9_69,l9_73)*Mask_Radius,dot(l9_69,l9_77)*Mask_Radius)/(Port_Input1_N057+vec2(1.234e-06))),Port_Input1_N077),l9_136);

...
uniform vec2 Tweak_N100;
uniform vec3 verticalVector;
uniform vec3 cornerPosition;
uniform vec3 horizontalVector;
uniform float Port_Value1_N088;
uniform float Port_Value2_N088;
uniform float Port_Value3_N088;
...
vec3 l9_71=cross(l9_1,vec3(Port_Value1_N088,Port_Value2_N088,Port_Value3_N088));
...
l9_69=step(length((vec2(dot(l9_70,l9_74),dot(l9_70,l9_75*l9_77))/(Port_Input1_N096+vec2(1.234e-06)))+Tweak_N100),Port_Input1_N098);
}
else
{

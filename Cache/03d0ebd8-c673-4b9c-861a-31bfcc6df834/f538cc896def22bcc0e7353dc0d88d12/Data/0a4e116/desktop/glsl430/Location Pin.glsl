...
//spec_const bool Tweak_N11 37 0
//spec_const bool Tweak_N121 38 0
...
float l9_80=step(length(vec2(dot(l9_71,l9_75),dot(l9_71,l9_79))/(Port_Input1_N097+vec2(1.234e-06))),Port_Input1_N099);

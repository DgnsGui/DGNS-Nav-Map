...
#endif
sc_writeFragData0(max(l9_139,vec4(0.0)));
return;
}
vec4 l9_141;
...
vec4 l9_169=sc_OutputMotionVectorIfNeeded(max(l9_167,vec4(0.0)));
...
sc_writeFragData0(vec4(max(0.0,1.0-(l9_171-0.0039215689)),min(1.0,l9_171+0.0039215689),0.0,0.0));
}
#endif
}
#else
...
sc_writeFragData0(vec4(packValue(l9_173),packValue(l9_173),packValue(l9_173),packValue(l9_173)));
}
#endif
}
#else
...
sc_writeFragData0(l9_170);
}
#endif
}
#else
{
sc_writeFragData0(l9_169);
}
#endif
}
#endif

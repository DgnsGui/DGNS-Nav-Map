...
#define Node88_Surface_Normal( Normal, Globals ) Normal = Globals.VertexNormal_WorldSpace
...
#define Node82_Min( Input0, Input1, Output, Globals ) Output = min( Input0, Input1 )
...
void main() 
{
	...
	
	{
		...
		float3 Output_N87 = float3(0.0); Node87_Subtract( Position_N41, Output_N74, Output_N87, Globals );
		float3 Normal_N88 = float3(0.0); Node88_Surface_Normal( Normal_N88, Globals );
		...
		float3 Result_N90 = float3(0.0); Node90_Cross( Normal_N88, Value_N89, Result_N90, Globals );
		float3 Output_N91 = float3(0.0); Node91_Normalize( Result_N90, Output_N91, Globals );
		float Output_N92 = 0.0; Node92_Dot_Product( Output_N87, Output_N91, Output_N92, Globals );
		float3 Result_N93 = float3(0.0); Node93_Cross( Normal_N88, Output_N91, Result_N93, Globals );
		float3 Output_N94 = float3(0.0); Node94_Normalize( Result_N93, Output_N94, Globals );
		float Output_N95 = 0.0; Node95_Dot_Product( Output_N87, Output_N94, Output_N95, Globals );
		...
		float Output_N82 = 0.0; Node82_Min( Output_N99, Export_N158, Output_N82, Globals );
		float4 Value_N1 = float4(0.0); Node1_Construct_Vector( Export_N385.xyz, Output_N82, Value_N1, Globals );

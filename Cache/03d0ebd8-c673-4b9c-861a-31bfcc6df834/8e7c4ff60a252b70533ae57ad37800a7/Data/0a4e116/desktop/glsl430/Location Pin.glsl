...
uniform float Port_Input0_N072;
...
{
l9_68=step(distance(l9_1,circleBoundCentre),circleBoundRadius);
}
else
{
...
l9_68=min(min(min(step(Port_Input0_N047,l9_70),step(l9_70,dot(verticalVector,verticalVector))),step(Port_Input0_N072,l9_71)),step(l9_71,dot(horizontalVector,horizontalVector)));
}
float l9_72;
#if (Tweak_N308)
{

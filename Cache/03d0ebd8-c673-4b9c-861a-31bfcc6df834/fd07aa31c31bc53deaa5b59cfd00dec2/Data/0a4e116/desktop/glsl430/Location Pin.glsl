...
{
vec3 l9_70=cross(l9_2,vec3(Port_Value1_N088,Port_Value2_N088,Port_Value3_N088));
...
vec3 l9_74=l9_1-circleBoundCentre;
vec3 l9_75=cross(l9_2,l9_73);
...
l9_69=step(length((vec2(dot(circleBoundCentre,l9_73),dot(l9_74,l9_75*l9_77))/(Port_Input1_N096+vec2(1.234e-06)))+Tweak_N100),Port_Input1_N098);
}
else
{
vec3 l9_78=l9_1-cornerPosition;

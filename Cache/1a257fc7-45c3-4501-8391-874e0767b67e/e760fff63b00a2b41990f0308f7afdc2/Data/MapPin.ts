...
// Remplacement du padding circulaire par deux paddings pour ellipse
...
export class MapPin {
  ...
  updateCircularRenderBound(center: vec3): void {
    ...
    if (this.label !== undefined) {
      // Remplacement du test circulaire par un test elliptique
...
const HIGHLIGHT_TWEEN_DURATION = 1;
const LABEL_BOUNDARY_PADDING = 4;
const LABEL_CIRCLE_BOUNDARY_PADDING = 14;

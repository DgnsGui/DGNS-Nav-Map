// --- START OF FILE MapManipulation.ts (with Scroll Sensitivity) ---
...
export class InteractableManipulation extends BaseScriptComponent {
  ...
  // NOUVEAU : Le paramètre de sensibilité visible dans l'Inspector
  @input
  ...
  private getLocalPosition(worldPosition: vec3): vec2 {
    ...
    // NOUVEAU : On applique le multiplicateur de sensibilité

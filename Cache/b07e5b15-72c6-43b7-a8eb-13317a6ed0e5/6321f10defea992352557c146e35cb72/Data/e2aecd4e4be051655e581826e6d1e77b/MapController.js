...
let MapController = (() => {
    ...
    var MapController = _classThis = class extends _classSuper {
         ...
         * Approche par ratio d'échelle avec calcul correct de l'ancien offsetForLocation.
         */
        handleZoomIn() {
            if (!this.isInitialized) {
            ...
            // 5. Le ratio d'échelle entre les niveaux de zoom est 2 (chaque niveau double la résolution)
            const zoomScale = 2;

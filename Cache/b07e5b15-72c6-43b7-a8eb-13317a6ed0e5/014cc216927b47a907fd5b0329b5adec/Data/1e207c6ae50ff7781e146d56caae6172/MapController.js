...
let MapController = (() => {
    ...
    var MapController = _classThis = class extends _classSuper {
         ...
         */
        getCurrentViewCenterGeoPosition(currentOffset, zoomLevel, currentOffsetForLocation, currentMapLocation, currentNorthwestAsset) {
            ...
            const mapImageOffset = this.mapModule.longLatToImageRatio(currentMapLocation.longitude, currentMapLocation.latitude, currentNorthwestAsset);
        ...
        handleZoomIn() {
            ...
            // IMPORTANT: Créer une VRAIE copie du vec2, pas une référence
            ...
            const centerGeoPosition = this.getCurrentViewCenterGeoPosition(oldOffset, oldZoomLevel, oldOffsetForLocation, oldMapLocation, oldNorthwestAsset);

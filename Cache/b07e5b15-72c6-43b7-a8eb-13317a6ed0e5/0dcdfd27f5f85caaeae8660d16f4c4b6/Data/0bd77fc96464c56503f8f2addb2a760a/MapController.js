...
let MapController = (() => {
    ...
    var MapController = _classThis = class extends _classSuper {
        ...
        handleZoomIn() {
            ...
            // 1. CAPTURER LES VALEURS AVANT MODIFICATION
            ...
            const centerGeoPosition = this.getCurrentViewCenterGeoPosition(oldOffset, oldZoomLevel, oldMapLocation, oldNorthwestAsset);

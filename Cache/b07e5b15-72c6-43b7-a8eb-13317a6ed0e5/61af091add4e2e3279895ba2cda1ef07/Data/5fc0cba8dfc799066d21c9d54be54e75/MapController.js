...
let MapController = (() => {
    ...
    var MapController = _classThis = class extends _classSuper {
        constructor() {
            ...
            // ===== DEBUG CONTROLS =====
            this.enableAutoFollowLocation = this.enableAutoFollowLocation;
            this.enableAutoRecenter = this.enableAutoRecenter;
            this.enableLocationUpdates = this.enableLocationUpdates;
            this.enableMapRotation = this.enableMapRotation;
            this.enableDetailedLogs = this.enableDetailedLogs;
            this.forceResetViewScrolled = this.forceResetViewScrolled;
            this.blockAutoRecenter = this.blockAutoRecenter;

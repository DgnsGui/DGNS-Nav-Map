...
let MapController = (() => {
    ...
    var MapController = _classThis = class extends _classSuper {
        ...
        updateMapPinRotations(pinRotation) {
            if (this.mapParameters.mapPinsRotated) {
                ...
                if (this.mapParameters.enableMapSmoothing) {
                    ...
                    this.pinSet.forEach((pin) => pin.screenTransform.rotation = targetRotation);
                }
            }
        }
        updateMapRotation() {
        ...
        centerMap() { }
        isMapCentered() { /* ... code original ... */ return false; }
        getPositionWithMapRotationOffset(localPosition) { /* ... code original ... */ return vec2.zero(); }

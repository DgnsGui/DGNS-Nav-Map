...
export class MapController extends BaseScriptComponent {
  ...
  private zoomTweenCancelFunction: CancelFunction;
   ...
   */
  private getCurrentViewCenterGeoPosition(
    currentOffset: vec2, 
    zoomLevel: number,
    mapLocation: GeoPosition,
    northwestAsset: LocationAsset
  ): GeoPosition {
  ...
  handleZoomIn(): void {
    ...
    this.zoomTweenCancelFunction = makeTween((t) => {
  ...
  handleZoomOut(): void {
    ...
    this.zoomTweenCancelFunction = makeTween((t) => {
      ...
      const currentScale = lerp(2.0, 1.0, easedT);

...
export class MapController extends BaseScriptComponent {
  ...
  private updateZoomLevel(newZoomLevel: number): void {
    ...
    const centerGeoPosition = this.fromLocalPositionToLongLat(
      relativeOffset,
      currentZoomLevel
    );
    ...
    const newCenterOffsetFromMapLocation = getOffsetForLocation(
      this.mapModule,
      this.referencePositionLocationAsset,

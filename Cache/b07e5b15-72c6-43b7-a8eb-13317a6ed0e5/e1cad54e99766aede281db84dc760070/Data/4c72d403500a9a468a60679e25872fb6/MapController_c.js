...
// @input float scrollSensitivity = 1 {"hint":"Scroll sensitivity multiplier (default: 1.0)", "widget":"slider", "min":0.1, "max":5, "step":0.1}
// @input float zoomSensitivity = 1 {"hint":"Zoom sensitivity multiplier (default: 1.0)", "widget":"slider", "min":0.1, "max":5, "step":0.1}
...
awakeEvent.bind(() => {
    ...
    checkUndefined("zoomSensitivity", []);
    if (script.onAwake) {
       script.onAwake();
    }
});

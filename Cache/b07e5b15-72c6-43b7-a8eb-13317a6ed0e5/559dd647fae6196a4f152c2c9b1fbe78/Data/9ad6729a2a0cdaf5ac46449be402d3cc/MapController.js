...
let MapController = (() => {
    ...
    var MapController = _classThis = class extends _classSuper {
        ...
        animateMapRotationToHeading() {
            ...
            log.i(`Starting rotation animation from ${(0, MapUtils_1.customGetEuler)(startRotation).z} to ${this.getUserHeading()}`);
            this.rotationTweenCancel = (0, MapUtils_1.makeTween)((t) => {
                ...
                if (this.mapParameters.mapPinsRotated) {
                    this.pinSet.forEach((pin) => {
                        pin.screenTransform.rotation = quat.slerp(quat.fromEulerAngles(0, 0, 0), targetPinRotation, t);
                    });
                    this.currentPinRotation = quat.slerp(quat.fromEulerAngles(0, 0, 0), targetPinRotation, t);
                }
                if (t === 1) {
                    this.isRotating = false;
                    this.rotationTweenCancel = null;
        ...
        handleZoomIn() {
            ...
            this.mapParameters.zoomOffet = (0, MapUtils_1.calculateZoomOffset)(newZoomLevel);
            this.referencePositionLocationAsset = LocationAsset.getGeoAnchoredPosition(this.mapLocation.longitude, this.mapLocation.latitude).location.adjacentTile(0, 0, this.mapParameters.zoomOffet);
            this.northwestLocationAsset = LocationAsset.getGeoAnchoredPosition(MAX_LONGITUDE, MAX_LATITUDE).location.adjacentTile(0, 0, this.mapParameters.zoomOffet);
            this.updateLocationOffset();
            ...
            this.zoomTweenCancel = (0, MapUtils_1.makeTween)((t) => {

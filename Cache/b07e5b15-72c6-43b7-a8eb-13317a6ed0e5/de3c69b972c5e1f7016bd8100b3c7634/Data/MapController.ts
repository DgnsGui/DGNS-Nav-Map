// --- START OF FILE MapController.ts (FINAL, BASED ON ORIGINAL, WITH PIN DRAG FIX) ---
...
export class MapController extends BaseScriptComponent {
  ...
  // NOUVEAU : Variables pour la manipulation des pins
  ...
  // RESTAURATION : Déclarations complètes des événements
  ...
  // (Le début du script reste inchangé jusqu'à createMapPin)
  // ...
  ...
  // --- LE RESTE DU SCRIPT EST RESTAURÉ À L'ORIGINAL COMPLET ---
...
Après avoir remplacé ce fichier, ton projet devrait compiler sans erreur et la manipulation des pins devrait fonctionner comme prévu.
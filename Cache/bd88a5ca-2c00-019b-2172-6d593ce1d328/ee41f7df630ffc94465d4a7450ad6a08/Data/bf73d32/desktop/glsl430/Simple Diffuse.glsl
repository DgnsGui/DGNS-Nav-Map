...
//spec_const bool sc_RayTracingGlobalIlluminationHasSwappedViews 71 0
//spec_const bool sc_RayTracingShadowsHasSwappedViews 72 0
//spec_const bool sc_RenderAlphaToColor 73 0
//spec_const bool sc_SSAOEnabled 74 0
...
//spec_const int SC_DEVICE_CLASS 80 -1
...
//spec_const int sc_AmbientLightMode0 84 0
//spec_const int sc_AmbientLightMode1 85 0
//spec_const int sc_AmbientLightMode2 86 0
//spec_const int sc_AmbientLightMode_Constant 87 0
//spec_const int sc_AmbientLightMode_EnvironmentMap 88 0
//spec_const int sc_AmbientLightMode_FromCamera 89 0
//spec_const int sc_AmbientLightMode_SphericalHarmonics 90 0
//spec_const int sc_AmbientLightsCount 91 0
//spec_const int sc_DepthBufferMode 92 0
//spec_const int sc_DirectionalLightsCount 93 0
//spec_const int sc_EnvLightMode 94 0
//spec_const int sc_EnvmapDiffuseLayout 95 0
//spec_const int sc_EnvmapSpecularLayout 96 0
//spec_const int sc_LightEstimationSGCount 97 0
//spec_const int sc_PointLightsCount 98 0
//spec_const int sc_RayTracingGlobalIlluminationLayout 99 0
//spec_const int sc_RayTracingShadowsLayout 100 0
//spec_const int sc_RenderingSpace 101 -1
//spec_const int sc_ScreenTextureLayout 102 0
//spec_const int sc_ShaderCacheConstant 103 0
//spec_const int sc_SkinBonesCount 104 0
//spec_const int sc_StereoRenderingMode 105 0
//spec_const int sc_StereoRendering_IsClipDistanceEnabled 106 0
//spec_const int sc_StereoViewID 107 0
//SG_REFLECTION_END
...
{
l9_0=normalize(varNormalAndMotion.xyz);
}
#else
{
l9_0=vec3(0.0);
...
#endif
float l9_1=clamp(baseColor.w,0.0,1.0);
#if (sc_BlendMode_AlphaTest)
{
if (l9_1<alphaTestThreshold)
{
discard;
}
}
...
{
if (l9_1<((mod(dot(floor(mod(gl_FragCoord.xy,vec2(4.0))),vec2(4.0,1.0))*9.0,16.0)+1.0)/17.0))
{
discard;
}
}
#endif
uvec3 l9_2=uvec3(round((varPosAndMotion.xyz-sc_RayTracingOriginOffset)*sc_RayTracingOriginScale));
sc_RayTracingPositionAndMask=uvec4(l9_2.x,l9_2.y,l9_2.z,sc_RayTracingPositionAndMask.w);
sc_RayTracingPositionAndMask.w=sc_RayTracingReceiverMask;
vec3 l9_3=l9_0/vec3(dot(abs(l9_0),vec3(1.0)));
vec2 l9_4=vec2(clamp(-l9_3.z,0.0,1.0));
vec2 l9_5=l9_3.xy;
uint l9_6=packHalf2x16(l9_5+mix(-l9_4,l9_4,step(vec2(0.0),l9_5)));
uvec2 l9_7=uvec2(l9_6&65535u,l9_6>>16u);
sc_RayTracingNormalAndMore=uvec4(l9_7.x,l9_7.y,sc_RayTracingNormalAndMore.z,sc_RayTracingNormalAndMore.w);
...
{
l9_3=normalize(sc_Camera.position-varPosAndMotion.xyz);
...
#endif
float l9_6=clamp(baseColor.w,0.0,1.0);
#if (sc_BlendMode_AlphaTest)
{
if (l9_6<alphaTestThreshold)
{
discard;
}
}
...
#if (ENABLE_STIPPLE_PATTERN_TEST)
{
if (l9_6<((mod(dot(floor(mod(gl_FragCoord.xy,vec2(4.0))),vec2(4.0,1.0))*9.0,16.0)+1.0)/17.0))
{
discard;
}
}
...
#else
{
l9_8=ngsCalculateLighting(l9_7,l9_6,l9_5,l9_2,l9_3,Port_Emissive_N000,0.0,1.0,Port_AO_N000,vec3(1.0));
}
#endif
vec4 l9_9=max(l9_8,vec4(0.0));
if (l9_0)
{
vec4 l9_10;
...
#endif
sc_writeFragData0(max(l9_10,vec4(0.0)));
return;
}
vec4 l9_12;
#if (sc_ProjectiveShadowsCaster)
...
#if (sc_BlendMode_PremultipliedAlpha)
{
l9_14=clamp(l9_9.w*2.0,0.0,1.0);
}
#else
{
float l9_15;
...
{
l9_15=clamp(dot(l9_9.xyz,vec3(l9_9.w)),0.0,1.0);
}
#else
{
float l9_16;
...
#if (sc_BlendMode_Multiply)
{
l9_17=(1.0-dot(l9_9.xyz,vec3(0.33333001)))*l9_9.w;
}
#else
{
float l9_18;
...
{
l9_18=(1.0-clamp(dot(l9_9.xyz,vec3(1.0)),0.0,1.0))*l9_9.w;
}
#else
{
float l9_19;
#if (sc_BlendMode_ColoredGlass)
{
l9_19=clamp(dot(l9_9.xyz,vec3(1.0)),0.0,1.0)*l9_9.w;
}
#else
{
float l9_20;
#if (sc_BlendMode_Add)
{
l9_20=clamp(dot(l9_9.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_21;
#if (sc_BlendMode_AddWithAlphaFactor)
{
l9_21=clamp(dot(l9_9.xyz,vec3(1.0)),0.0,1.0)*l9_9.w;
}
#else
{
float l9_22;
...
{
l9_22=dot(l9_9.xyz,vec3(0.33333001))*l9_9.w;
}
#else
{
float l9_23;
#if (sc_BlendMode_Min)
{
l9_23=1.0-clamp(dot(l9_9.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_24;
#if (sc_BlendMode_Max)
{
l9_24=clamp(dot(l9_9.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
l9_24=1.0;
...
#endif
l9_12=vec4(mix(sc_ShadowColor.xyz,sc_ShadowColor.xyz*l9_9.xyz,vec3(sc_ShadowColor.w)),sc_ShadowDensity*l9_13);
}
#else
{
vec4 l9_25;
...
{
vec3 l9_27=sc_GetFramebufferColor().xyz;
vec3 l9_28=mix(l9_27,definedBlend(l9_27,l9_9.xyz).xyz,vec3(l9_9.w));
vec4 l9_29=vec4(l9_28.x,l9_28.y,l9_28.z,vec4(0.0).w);
l9_29.w=1.0;
l9_26=l9_29;
}
#else
...
#if (sc_Voxelization)
{
l9_30=vec4(varScreenPos.xyz,1.0);
}
#else
{
vec4 l9_31;
#if (sc_OutputBounds)
{
float l9_32=clamp(abs(gl_FragCoord.z),0.0,1.0);
l9_31=vec4(l9_32,1.0-l9_32,1.0,1.0);
}
#else
{
vec4 l9_33;
...
{
float l9_34=l9_9.w;
l9_33=vec4(mix(vec3(1.0),l9_9.xyz,vec3(l9_34)),l9_34);
}
#else
{
vec4 l9_35;
...
#endif
l9_35=vec4(l9_9.xyz*l9_37,l9_37);
}
#else
{
l9_35=l9_9;
...
vec4 l9_40=sc_OutputMotionVectorIfNeeded(max(l9_38,vec4(0.0)));
...
sc_writeFragData0(vec4(max(0.0,1.0-(l9_42-0.0039215689)),min(1.0,l9_42+0.0039215689),0.0,0.0));
}
#endif
}
#else
...
sc_writeFragData0(vec4(packValue(l9_44),packValue(l9_44),packValue(l9_44),packValue(l9_44)));
}
#endif
}
#else

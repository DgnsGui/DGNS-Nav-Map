...
void N46_main()
{
	if( N46_stops > 0 ) {
		...
		if( N46_useGradient == 1. ) N46_OutColor = mix(N46_OutColor, N46_backgroundColor, 1. - N46_OutColor.a);
	} else {
...
void main() 
{
	...
	
	{
		...
		float4 OutColor_N46 = float4(0.0); Node46_Gradient( Export_N38, outColor_N80, Output_N45, Output_N48, Output_N49, Output_N50, Output_N51, Output_N77, Output_N53, Output_N55, rawDist_N7, Output_N54, OutColor_N46, Globals );
		...
		float4 Output_N41 = float4(0.0); Node41_Mix( OutColor_N46, OutColor_N67, dist_N7, Output_N41, Globals );
		...
		float4 Value_N76 = float4(0.0); Node76_Construct_Vector( Value1_N75, Output_N78, Value_N76, Globals );

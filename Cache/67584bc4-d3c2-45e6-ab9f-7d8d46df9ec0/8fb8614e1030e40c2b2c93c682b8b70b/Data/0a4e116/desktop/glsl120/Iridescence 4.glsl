...
//sampler sampler iridescenceMapSmpSC 0:18
//sampler sampler opacityTextureSmpSC 0:19
...
//sampler sampler sc_SSAOTextureSmpSC 0:23
//sampler sampler sc_ScreenTextureSmpSC 0:24
//sampler sampler sc_ShadowTextureSmpSC 0:25
//texture texture2D intensityTexture 0:0:0:17
//texture texture2D iridescenceMap 0:1:0:18
//texture texture2D opacityTexture 0:2:0:19
//texture texture2D sc_EnvmapDiffuse 0:3:0:20
//texture texture2D sc_EnvmapSpecular 0:4:0:21
...
//texture texture2D sc_SSAOTexture 0:13:0:23
//texture texture2D sc_ScreenTexture 0:14:0:24
//texture texture2D sc_ShadowTexture 0:15:0:25
...
//spec_const int SC_SOFTWARE_WRAP_MODE_U_iridescenceMap 88 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_U_opacityTexture 89 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_V_intensityTexture 90 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_V_iridescenceMap 91 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_V_opacityTexture 92 -1
//spec_const int intensityTextureLayout 93 0
//spec_const int iridescenceMapLayout 94 0
//spec_const int opacityTextureLayout 95 0
//spec_const int sc_AmbientLightMode0 96 0
//spec_const int sc_AmbientLightMode1 97 0
//spec_const int sc_AmbientLightMode2 98 0
//spec_const int sc_AmbientLightMode_Constant 99 0
//spec_const int sc_AmbientLightMode_EnvironmentMap 100 0
//spec_const int sc_AmbientLightMode_FromCamera 101 0
//spec_const int sc_AmbientLightMode_SphericalHarmonics 102 0
//spec_const int sc_AmbientLightsCount 103 0
//spec_const int sc_DepthBufferMode 104 0
//spec_const int sc_DirectionalLightsCount 105 0
//spec_const int sc_EnvLightMode 106 0
//spec_const int sc_EnvmapDiffuseLayout 107 0
//spec_const int sc_EnvmapSpecularLayout 108 0
//spec_const int sc_LightEstimationSGCount 109 0
//spec_const int sc_PointLightsCount 110 0
...
vec3 l9_1=normalize(sc_Camera.position-varPos);
vec4 l9_2=sc_ModelMatrixInverse*vec4(varPos,1.0);
float l9_3=1.0-clamp(dot(l9_1,l9_0),0.0,1.0);
float l9_4;
if (l9_3<=0.0)
{
l9_4=0.0;
...
{
l9_4=pow(l9_3,exponent);
}
float l9_5=snoise(vec2(floor((((floor(((snoise(vec2(floor(l9_2.x*10000.0)*9.9999997e-05,floor(l9_2.y*10000.0)*9.9999997e-05)*(noiseScale*0.5))*0.5)+0.5)*10000.0)*9.9999997e-05)*Port_Input1_N011)-Port_Input1_N012)*10000.0)*9.9999997e-05,floor(l9_2.z*10000.0)*9.9999997e-05)*(Port_Scale_N041*0.5));
float l9_6=l9_4+((((floor(((l9_5*0.5)+0.5)*10000.0)*9.9999997e-05)-Port_Input1_N025)*noiseIntensity)*Port_Input2_N021);
float l9_7=(((clamp(thinFilmWeight,0.0,1.0)-Port_RangeMinA_N049)/((Port_RangeMaxA_N049-Port_RangeMinA_N049)+1e-06))*(Port_RangeMaxB_N049-Port_RangeMinB_N049))+Port_RangeMinB_N049;
float l9_8;
if (Port_RangeMaxB_N049>Port_RangeMinB_N049)
{
l9_8=clamp(l9_7,Port_RangeMinB_N049,Port_RangeMaxB_N049);
}
else
{
l9_8=clamp(l9_7,Port_RangeMaxB_N049,Port_RangeMinB_N049);
}
int l9_9;
...
#endif
bool l9_10=(int(SC_USE_CLAMP_TO_BORDER_iridescenceMap)!=0)&&(!(int(SC_USE_UV_MIN_MAX_iridescenceMap)!=0));
float l9_11=l9_6;
sc_SoftwareWrapEarly(l9_11,ivec2(SC_SOFTWARE_WRAP_MODE_U_iridescenceMap,SC_SOFTWARE_WRAP_MODE_V_iridescenceMap).x);
float l9_12=l9_11;
float l9_13=l9_8;
sc_SoftwareWrapEarly(l9_13,ivec2(SC_SOFTWARE_WRAP_MODE_U_iridescenceMap,SC_SOFTWARE_WRAP_MODE_V_iridescenceMap).y);
float l9_14=l9_13;
vec2 l9_15;
float l9_16;
...
{
l9_17=ivec2(SC_SOFTWARE_WRAP_MODE_U_iridescenceMap,SC_SOFTWARE_WRAP_MODE_V_iridescenceMap).x==3;
}
#else
{
l9_17=(int(SC_USE_CLAMP_TO_BORDER_iridescenceMap)!=0);
}
#endif
float l9_18=l9_12;
float l9_19=1.0;
sc_ClampUV(l9_18,iridescenceMapUvMinMax.x,iridescenceMapUvMinMax.z,l9_17,l9_19);
float l9_20=l9_18;
float l9_21=l9_19;
bool l9_22;
#if (SC_USE_CLAMP_TO_BORDER_iridescenceMap)
{
l9_22=ivec2(SC_SOFTWARE_WRAP_MODE_U_iridescenceMap,SC_SOFTWARE_WRAP_MODE_V_iridescenceMap).y==3;
}
#else
{
l9_22=(int(SC_USE_CLAMP_TO_BORDER_iridescenceMap)!=0);
}
#endif
float l9_23=l9_14;
float l9_24=l9_21;
sc_ClampUV(l9_23,iridescenceMapUvMinMax.y,iridescenceMapUvMinMax.w,l9_22,l9_24);
l9_16=l9_24;
...
#endif
vec2 l9_25=sc_TransformUV(l9_15,(int(SC_USE_UV_TRANSFORM_iridescenceMap)!=0),iridescenceMapTransform);
float l9_26=l9_25.x;
float l9_27=l9_16;
sc_SoftwareWrapLate(l9_26,ivec2(SC_SOFTWARE_WRAP_MODE_U_iridescenceMap,SC_SOFTWARE_WRAP_MODE_V_iridescenceMap).x,l9_10,l9_27);
float l9_28=l9_25.y;
float l9_29=l9_27;
sc_SoftwareWrapLate(l9_28,ivec2(SC_SOFTWARE_WRAP_MODE_U_iridescenceMap,SC_SOFTWARE_WRAP_MODE_V_iridescenceMap).y,l9_10,l9_29);
float l9_30=l9_29;
vec3 l9_31=sc_SamplingCoordsViewToGlobal(vec2(l9_26,l9_28),iridescenceMapLayout,l9_9);
vec4 l9_32=texture2D(iridescenceMap,l9_31.xy,0.0);
vec4 l9_33;
#if (SC_USE_CLAMP_TO_BORDER_iridescenceMap)
{
l9_33=mix(iridescenceMapBorderColor,l9_32,vec4(l9_30));
}
#else
{
l9_33=l9_32;
...
#endif
vec4 l9_34=baseColor*l9_33;
vec4 l9_35=mix(baseColor,l9_34*vec4(intensity),vec4(mixAmount));
vec3 l9_36;
...
#endif
vec3 l9_37=max(l9_35.xyz,vec3(0.0));
vec4 l9_38;
#if (sc_ProjectiveShadowsCaster)
{
l9_38=vec4(l9_37,Port_Opacity_N006);
}
#else
{
float l9_39=clamp(metallic,0.0,1.0);
float l9_40=clamp(roughness,0.0,1.0);
vec3 l9_41=ssSRGB_to_Linear(l9_37);
vec3 l9_42=normalize(l9_36);
vec3 l9_43=ssSRGB_to_Linear(Port_Emissive_N006);
vec3 l9_44;
#if (sc_SSAOEnabled)
{
l9_44=evaluateSSAO(varPos);
}
#else
{
l9_44=Port_AO_N006;
...
#endif
vec3 l9_45=vec3(l9_39);
vec3 l9_46=mix(vec3(0.039999999),l9_41*l9_39,l9_45);
vec3 l9_47=mix(l9_41*(1.0-l9_39),vec3(0.0),l9_45);
SurfaceProperties l9_48=SurfaceProperties(l9_47,Port_Opacity_N006,l9_42,varPos,l9_1,l9_39,l9_40,l9_43,l9_44,Port_SpecularAO_N006,vec3(1.0),l9_46);
vec4 l9_49=vec4(1.0);
vec3 l9_50;
vec3 l9_51;
vec3 l9_52;
...
l9_58=vec3(0.0);
l9_57=vec3(0.0);
LightingComponents l9_64;
LightProperties l9_65;
SurfaceProperties l9_66;
vec3 l9_67;
int l9_68=0;
for (int snapLoopIndex=0; snapLoopIndex==0; snapLoopIndex+=0)
{
if (l9_68<sc_DirectionalLightsCount)
{
LightingComponents l9_69=accumulateLight(LightingComponents(l9_57,l9_58,l9_63,l9_62,l9_60,l9_59),LightProperties(sc_DirectionalLights[l9_68].direction,sc_DirectionalLights[l9_68].color.xyz,sc_DirectionalLights[l9_68].color.w*l9_49[(l9_61<3) ? l9_61 : 3]),l9_48,l9_1);
l9_63=l9_69.indirectDiffuse;
l9_62=l9_69.indirectSpecular;
l9_61++;
l9_60=l9_69.emitted;
l9_59=l9_69.transmitted;
l9_58=l9_69.directSpecular;
l9_57=l9_69.directDiffuse;
l9_68++;
continue;
}
else
...
for (int snapLoopIndex=0; snapLoopIndex==0; snapLoopIndex+=0)
{
if (l9_86<sc_PointLightsCount)
{
vec3 l9_88=sc_PointLights[l9_86].position-varPos;
vec3 l9_89=normalize(l9_88);
float l9_90=l9_49[(l9_87<3) ? l9_87 : 3];
float l9_91=clamp((dot(l9_89,sc_PointLights[l9_86].direction)*sc_PointLights[l9_86].angleScale)+sc_PointLights[l9_86].angleOffset,0.0,1.0);
float l9_92=(sc_PointLights[l9_86].color.w*l9_90)*(l9_91*l9_91);
float l9_93;
if (sc_PointLights[l9_86].falloffEnabled)
{
l9_93=l9_92*computeDistanceAttenuation(length(l9_88),sc_PointLights[l9_86].falloffEndDistance);
}
else
{
l9_93=l9_92;
...
l9_79=l9_87+1;
LightingComponents l9_94=accumulateLight(LightingComponents(l9_73,l9_74,l9_78,l9_77,l9_76,l9_75),LightProperties(l9_89,sc_PointLights[l9_86].color.xyz,l9_93),l9_48,l9_1);
l9_80=l9_94.directDiffuse;
l9_81=l9_94.directSpecular;
l9_82=l9_94.indirectDiffuse;
l9_83=l9_94.indirectSpecular;
l9_84=l9_94.emitted;
l9_85=l9_94.transmitted;
l9_78=l9_82;
l9_77=l9_83;
l9_87=l9_79;
l9_76=l9_84;
...
#if (sc_ProjectiveShadowsReceiver)
{
vec2 l9_98=abs(varShadowTex-vec2(0.5));
vec4 l9_99=texture2D(sc_ShadowTexture,varShadowTex)*step(max(l9_98.x,l9_98.y),0.5);
l9_97=mix(vec3(1.0),mix(sc_ShadowColor.xyz,sc_ShadowColor.xyz*l9_99.xyz,vec3(sc_ShadowColor.w)),vec3(l9_99.w*sc_ShadowDensity));
}
#else
{
l9_97=vec3(1.0);
...
{
vec2 l9_101=calcPanoramicTexCoordsFromDir(l9_42,sc_EnvmapRotation.y);
vec4 l9_102;
...
#if (SC_DEVICE_CLASS>=2)
{
l9_103=calcSeamlessPanoramicUvsForSampling(l9_101,sc_EnvmapSpecularSize.xy,5.0);
}
#else
{
l9_103=l9_101;
...
#endif
l9_102=texture2D(sc_EnvmapSpecular,sc_SamplingCoordsViewToGlobal(l9_103,sc_EnvmapSpecularLayout,sc_EnvmapSpecularGetStereoViewIndex()).xy,13.0);
}
#else
{
vec4 l9_104;
...
{
vec2 l9_105=calcSeamlessPanoramicUvsForSampling(l9_101,sc_EnvmapDiffuseSize.xy,0.0);
int l9_106;
#if (sc_EnvmapDiffuseHasSwappedViews)
{
l9_106=1-sc_GetStereoViewIndex();
}
#else
{
l9_106=sc_GetStereoViewIndex();
}
#endif
l9_104=texture2D(sc_EnvmapDiffuse,sc_SamplingCoordsViewToGlobal(l9_105,sc_EnvmapDiffuseLayout,l9_106).xy,-13.0);
}
#else
{
l9_104=texture2D(sc_EnvmapSpecular,sc_SamplingCoordsViewToGlobal(l9_101,sc_EnvmapSpecularLayout,sc_EnvmapSpecularGetStereoViewIndex()).xy,13.0);
}
#endif
l9_102=l9_104;
}
#endif
l9_100=(l9_102.xyz*(1.0/l9_102.w))*sc_EnvmapExposure;
}
#else
{
vec3 l9_107;
...
float l9_110=l9_108.y;
float l9_111=l9_108.z;
l9_107=(((((((sc_Sh[8]*0.42904299)*((l9_109*l9_109)-(l9_110*l9_110)))+((sc_Sh[6]*0.74312502)*(l9_111*l9_111)))+(sc_Sh[0]*0.88622701))-(sc_Sh[6]*0.24770799))+((((sc_Sh[4]*(l9_109*l9_110))+(sc_Sh[7]*(l9_109*l9_111)))+(sc_Sh[5]*(l9_110*l9_111)))*0.85808599))+((((sc_Sh[3]*l9_109)+(sc_Sh[1]*l9_110))+(sc_Sh[2]*l9_111))*1.0233279))*sc_ShIntensity;
}
#else
{
l9_107=vec3(0.0);
...
{
l9_113=l9_100+(sc_AmbientLights[0].color*sc_AmbientLights[0].intensity);
}
#else
{
vec3 l9_114=l9_100;
l9_114.x=l9_100.x+(1e-06*sc_AmbientLights[0].color.x);
l9_113=l9_114;
}
#endif
l9_112=l9_113;
...
{
l9_116=l9_112+(sc_AmbientLights[1].color*sc_AmbientLights[1].intensity);
}
#else
{
vec3 l9_117=l9_112;
l9_117.x=l9_112.x+(1e-06*sc_AmbientLights[1].color.x);
l9_116=l9_117;
}
#endif
l9_115=l9_116;
...
{
l9_119=l9_115+(sc_AmbientLights[2].color*sc_AmbientLights[2].intensity);
}
#else
{
vec3 l9_120=l9_115;
l9_120.x=l9_115.x+(1e-06*sc_AmbientLights[2].color.x);
l9_119=l9_120;
}
#endif
l9_118=l9_119;
...
{
vec3 l9_122;
l9_122=sc_LightEstimationData.ambientLight;
vec3 l9_123;
int l9_124=0;
for (int snapLoopIndex=0; snapLoopIndex==0; snapLoopIndex+=0)
{
...
{
float l9_125=dot(sc_LightEstimationData.sg[l9_124].axis,l9_42);
float l9_126=exp(-sc_LightEstimationData.sg[l9_124].sharpness);
float l9_127=l9_126*l9_126;
float l9_128=1.0/sc_LightEstimationData.sg[l9_124].sharpness;
float l9_129=(1.0+(2.0*l9_127))-l9_128;
float l9_130=sqrt(1.0-l9_129);
float l9_131=0.36000001*l9_125;
float l9_132=(1.0/(4.0*0.36000001))*l9_130;
float l9_133=l9_131+l9_132;
float l9_134;
if (step(abs(l9_131),l9_132)>0.5)
{
l9_134=(l9_133*l9_133)/l9_130;
}
else
{
l9_134=clamp(l9_125,0.0,1.0);
}
l9_123=l9_122+((((sc_LightEstimationData.sg[l9_124].color/vec3(sc_LightEstimationData.sg[l9_124].sharpness))*6.2831855)*((l9_129*l9_134)+(((l9_126-l9_127)*l9_128)-l9_127)))/vec3(3.1415927));
l9_122=l9_123;
l9_124++;
continue;
}
...
#if ((sc_EnvLightMode==sc_AmbientLightMode_EnvironmentMap)||(sc_EnvLightMode==sc_AmbientLightMode_FromCamera))
{
float l9_136=clamp(pow(l9_40,0.66666669),0.0,1.0)*5.0;
vec2 l9_137=calcPanoramicTexCoordsFromDir(getSpecularDominantDir(l9_42,reflect(-l9_1,l9_42),l9_40),sc_EnvmapRotation.y);
vec4 l9_138;
#if (SC_DEVICE_CLASS>=2)
{
float l9_139=floor(l9_136);
float l9_140=ceil(l9_136);
l9_138=mix(texture2DLod(sc_EnvmapSpecular,sc_SamplingCoordsViewToGlobal(calcSeamlessPanoramicUvsForSampling(l9_137,sc_EnvmapSpecularSize.xy,l9_139),sc_EnvmapSpecularLayout,sc_EnvmapSpecularGetStereoViewIndex()).xy,l9_139),texture2DLod(sc_EnvmapSpecular,sc_SamplingCoordsViewToGlobal(calcSeamlessPanoramicUvsForSampling(l9_137,sc_EnvmapSpecularSize.xy,l9_140),sc_EnvmapSpecularLayout,sc_EnvmapSpecularGetStereoViewIndex()).xy,l9_140),vec4(l9_136-l9_139));
}
#else
{
l9_138=texture2DLod(sc_EnvmapSpecular,sc_SamplingCoordsViewToGlobal(l9_137,sc_EnvmapSpecularLayout,sc_EnvmapSpecularGetStereoViewIndex()).xy,l9_136);
}
#endif
l9_135=vec3(0.0)+((((l9_138.xyz*(1.0/l9_138.w))*sc_EnvmapExposure)+vec3(1e-06))*envBRDFApprox(l9_48,abs(dot(l9_42,l9_1))));
}
#else
{
l9_135=vec3(0.0);
...
#if (sc_LightEstimation)
{
float l9_142=clamp(l9_40*l9_40,0.0099999998,1.0);
vec3 l9_143;
l9_143=sc_LightEstimationData.ambientLight*l9_46;
int l9_144=0;
for (int snapLoopIndex=0; snapLoopIndex==0; snapLoopIndex+=0)
{
if (l9_144<sc_LightEstimationSGCount)
{
float l9_145=l9_142*l9_142;
vec3 l9_146=reflect(-l9_1,l9_42);
float l9_147=dot(l9_42,l9_1);
float l9_148=(2.0/l9_145)/(4.0*max(l9_147,9.9999997e-05));
float l9_149=length((l9_146*l9_148)+(sc_LightEstimationData.sg[l9_144].axis*sc_LightEstimationData.sg[l9_144].sharpness));
float l9_150=clamp(dot(l9_42,l9_146),0.0,1.0);
float l9_151=clamp(l9_147,0.0,1.0);
float l9_152=1.0-l9_145;
l9_143+=((((((((vec3(1.0/(3.1415927*l9_145))*exp((l9_149-l9_148)-sc_LightEstimationData.sg[l9_144].sharpness))*sc_LightEstimationData.sg[l9_144].color)*6.2831855)*(1.0-exp((-2.0)*l9_149)))/vec3(l9_149))*((1.0/(l9_150+sqrt(l9_145+((l9_152*l9_150)*l9_150))))*(1.0/(l9_151+sqrt(l9_145+((l9_152*l9_151)*l9_151))))))*(l9_46+((vec3(1.0)-l9_46)*pow(1.0-clamp(dot(l9_146,normalize(l9_146+l9_1)),0.0,1.0),5.0))))*l9_150);
l9_144++;
continue;
}
else
...
l9_156=vec3(0.0);
l9_155=vec3(0.0);
l9_154=ssSRGB_to_Linear(sc_GetFramebufferColor().xyz)*mix(vec3(1.0),l9_47,vec3(Port_Opacity_N006));
l9_153=1.0;
}
#else
{
...
#endif
vec3 l9_158=l9_155*l9_44;
vec3 l9_159=l9_156+l9_158;
vec3 l9_160=l9_47*l9_159;
vec3 l9_161=l9_141*Port_SpecularAO_N006;
vec3 l9_162=l9_95+l9_161;
vec3 l9_163;
if (l9_157)
{
l9_163=l9_160*srgbToLinear(l9_153);
}
else
{
l9_163=l9_160;
...
vec3 l9_165=(l9_164+l9_43)+l9_154;
float l9_166=l9_165.x;
vec4 l9_167=vec4(l9_166,l9_165.yz,l9_153);
vec4 l9_168;
#if (sc_IsEditor)
{
vec4 l9_169=l9_167;
l9_169.x=l9_166+((l9_44.x*Port_SpecularAO_N006.x)*9.9999997e-06);
l9_168=l9_169;
}
#else
{
...
l9_38=vec4(l9_173.x,l9_173.y,l9_173.z,l9_170.w);
}
#endif
vec4 l9_174=max(l9_38,vec4(0.0));
vec4 l9_175;
#if (Tweak_N38)
{
int l9_176;
...
{
l9_176=1-sc_GetStereoViewIndex();
}
#else
{
l9_176=sc_GetStereoViewIndex();
}
#endif
bool l9_177=(int(SC_USE_CLAMP_TO_BORDER_opacityTexture)!=0)&&(!(int(SC_USE_UV_MIN_MAX_opacityTexture)!=0));
float l9_178=varPackedTex.x;
sc_SoftwareWrapEarly(l9_178,ivec2(SC_SOFTWARE_WRAP_MODE_U_opacityTexture,SC_SOFTWARE_WRAP_MODE_V_opacityTexture).x);
float l9_179=l9_178;
float l9_180=varPackedTex.y;
sc_SoftwareWrapEarly(l9_180,ivec2(SC_SOFTWARE_WRAP_MODE_U_opacityTexture,SC_SOFTWARE_WRAP_MODE_V_opacityTexture).y);
float l9_181=l9_180;
vec2 l9_182;
float l9_183;
...
{
l9_184=ivec2(SC_SOFTWARE_WRAP_MODE_U_opacityTexture,SC_SOFTWARE_WRAP_MODE_V_opacityTexture).x==3;
}
#else
{
l9_184=(int(SC_USE_CLAMP_TO_BORDER_opacityTexture)!=0);
}
#endif
float l9_185=l9_179;
float l9_186=1.0;
sc_ClampUV(l9_185,opacityTextureUvMinMax.x,opacityTextureUvMinMax.z,l9_184,l9_186);
float l9_187=l9_185;
float l9_188=l9_186;
bool l9_189;
#if (SC_USE_CLAMP_TO_BORDER_opacityTexture)
{
l9_189=ivec2(SC_SOFTWARE_WRAP_MODE_U_opacityTexture,SC_SOFTWARE_WRAP_MODE_V_opacityTexture).y==3;
}
#else
{
l9_189=(int(SC_USE_CLAMP_TO_BORDER_opacityTexture)!=0);
}
#endif
float l9_190=l9_181;
float l9_191=l9_188;
sc_ClampUV(l9_190,opacityTextureUvMinMax.y,opacityTextureUvMinMax.w,l9_189,l9_191);
l9_183=l9_191;
l9_182=vec2(l9_187,l9_190);
}
#else
{
l9_183=1.0;
l9_182=vec2(l9_179,l9_181);
}
#endif
vec2 l9_192=sc_TransformUV(l9_182,(int(SC_USE_UV_TRANSFORM_opacityTexture)!=0),opacityTextureTransform);
float l9_193=l9_192.x;
float l9_194=l9_183;
sc_SoftwareWrapLate(l9_193,ivec2(SC_SOFTWARE_WRAP_MODE_U_opacityTexture,SC_SOFTWARE_WRAP_MODE_V_opacityTexture).x,l9_177,l9_194);
float l9_195=l9_192.y;
float l9_196=l9_194;
sc_SoftwareWrapLate(l9_195,ivec2(SC_SOFTWARE_WRAP_MODE_U_opacityTexture,SC_SOFTWARE_WRAP_MODE_V_opacityTexture).y,l9_177,l9_196);
float l9_197=l9_196;
vec3 l9_198=sc_SamplingCoordsViewToGlobal(vec2(l9_193,l9_195),opacityTextureLayout,l9_176);
vec4 l9_199=texture2D(opacityTexture,l9_198.xy,0.0);
vec4 l9_200;
#if (SC_USE_CLAMP_TO_BORDER_opacityTexture)
{
l9_200=mix(opacityTextureBorderColor,l9_199,vec4(l9_197));
}
#else
{
l9_200=l9_199;
...
#else
{
l9_175=vec4(Port_Input2_N040);
}
#endif
float l9_201=clamp((l9_35.w*l9_175.x)+0.001,Port_Input1_N058+0.001,Port_Input2_N058+0.001)-0.001;
vec4 l9_202=vec4(l9_174.x,l9_174.y,l9_174.z,vec4(0.0).w);
l9_202.w=l9_201;
vec4 l9_203;
#if (sc_ProjectiveShadowsCaster)
{
...
#if (sc_BlendMode_PremultipliedAlpha)
{
l9_205=clamp(l9_201*2.0,0.0,1.0);
}
#else
{
float l9_206;
...
{
l9_206=clamp(dot(l9_202.xyz,vec3(l9_201)),0.0,1.0);
}
#else
{
float l9_207;
...
#if (sc_BlendMode_Multiply)
{
l9_208=(1.0-dot(l9_202.xyz,vec3(0.33333001)))*l9_201;
}
#else
{
float l9_209;
...
{
l9_209=(1.0-clamp(dot(l9_202.xyz,vec3(1.0)),0.0,1.0))*l9_201;
}
#else
{
float l9_210;
#if (sc_BlendMode_ColoredGlass)
{
l9_210=clamp(dot(l9_202.xyz,vec3(1.0)),0.0,1.0)*l9_201;
}
#else
{
float l9_211;
#if (sc_BlendMode_Add)
{
l9_211=clamp(dot(l9_202.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_212;
#if (sc_BlendMode_AddWithAlphaFactor)
{
l9_212=clamp(dot(l9_202.xyz,vec3(1.0)),0.0,1.0)*l9_201;
}
#else
{
float l9_213;
...
{
l9_213=dot(l9_202.xyz,vec3(0.33333001))*l9_201;
}
#else
{
float l9_214;
#if (sc_BlendMode_Min)
{
l9_214=1.0-clamp(dot(l9_202.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_215;
#if (sc_BlendMode_Max)
{
l9_215=clamp(dot(l9_202.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
l9_215=1.0;
...
#endif
l9_203=vec4(mix(sc_ShadowColor.xyz,sc_ShadowColor.xyz*l9_202.xyz,vec3(sc_ShadowColor.w)),sc_ShadowDensity*l9_204);
}
#else
{
vec4 l9_216;
...
{
vec3 l9_218=sc_GetFramebufferColor().xyz;
vec3 l9_219=mix(l9_218,definedBlend(l9_218,l9_202.xyz).xyz,vec3(l9_201));
vec4 l9_220=vec4(l9_219.x,l9_219.y,l9_219.z,vec4(0.0).w);
l9_220.w=1.0;
l9_217=l9_220;
}
#else
...
#if (sc_Voxelization)
{
l9_221=vec4(varScreenPos.xyz,1.0);
}
#else
{
vec4 l9_222;
#if (sc_OutputBounds)
{
float l9_223=clamp(abs(gl_FragCoord.z),0.0,1.0);
l9_222=vec4(l9_223,1.0-l9_223,1.0,1.0);
}
#else
{
vec4 l9_224;
#if (sc_BlendMode_MultiplyOriginal)
{
l9_224=vec4(mix(vec3(1.0),l9_202.xyz,vec3(l9_201)),l9_201);
}
#else
{
vec4 l9_225;
...
#endif
l9_225=vec4(l9_202.xyz*l9_226,l9_226);
}
#else
{
l9_225=l9_202;
...
vec4 l9_229=sc_OutputMotionVectorsIfNeeded(varPos,max(l9_227,vec4(0.0)));
vec4 l9_230=clamp(l9_229,vec4(0.0),vec4(1.0));
#if (sc_OITDepthBoundsPass)
{
#if (sc_OITDepthBoundsPass)
{
float l9_231=clamp(viewSpaceDepth()/1000.0,0.0,1.0);
sc_writeFragData0Internal(vec4(max(0.0,1.0-(l9_231-0.0039215689)),min(1.0,l9_231+0.0039215689),0.0,0.0),sc_UniformConstants.x,sc_ShaderCacheConstant);
}
#endif
}
#else
...
#if (sc_OITDepthGatherPass)
{
vec2 l9_232=sc_ScreenCoordsGlobalToView(gl_FragCoord.xy*sc_CurrentRenderTargetDims.zw);
#if (sc_OITMaxLayers4Plus1)
{
if ((gl_FragCoord.z-texture2D(sc_OITFrontDepthTexture,l9_232).x)<=getFrontLayerZTestEpsilon())
{
discard;
}
}
#endif
int l9_233=encodeDepth(viewSpaceDepth(),texture2D(sc_OITFilteredDepthBoundsTexture,l9_232).xy);
float l9_234=packValue(l9_233);
int l9_241=int(l9_230.w*255.0);
float l9_242=packValue(l9_241);
sc_writeFragData0Internal(vec4(packValue(l9_233),packValue(l9_233),packValue(l9_233),packValue(l9_233)),sc_UniformConstants.x,sc_ShaderCacheConstant);
sc_writeFragData1(vec4(l9_234,packValue(l9_233),packValue(l9_233),packValue(l9_233)));
sc_writeFragData2(vec4(l9_242,packValue(l9_241),packValue(l9_241),packValue(l9_241)));
...
#if (sc_OITCompositingPass)
{
vec2 l9_245=sc_ScreenCoordsGlobalToView(gl_FragCoord.xy*sc_CurrentRenderTargetDims.zw);
#if (sc_OITMaxLayers4Plus1)
{
if ((gl_FragCoord.z-texture2D(sc_OITFrontDepthTexture,l9_245).x)<=getFrontLayerZTestEpsilon())
{
discard;
}
}
...
if (l9_250==0)
{
l9_253=texture2D(sc_OITAlpha0,l9_245);
l9_252=texture2D(sc_OITDepthLow0,l9_245);
l9_251=texture2D(sc_OITDepthHigh0,l9_245);
}
else
{
l9_253=vec4(0.0);
...
if (l9_250==1)
{
l9_256=texture2D(sc_OITAlpha1,l9_245);
l9_255=texture2D(sc_OITDepthLow1,l9_245);
l9_254=texture2D(sc_OITDepthHigh1,l9_245);
}
else
{
l9_256=l9_253;
...
if (any(notEqual(l9_254,vec4(0.0)))||any(notEqual(l9_255,vec4(0.0))))
{
int l9_257[8]=l9_246;
unpackValues(l9_254.w,l9_250,l9_257);
unpackValues(l9_254.z,l9_250,l9_257);
unpackValues(l9_254.y,l9_250,l9_257);
unpackValues(l9_254.x,l9_250,l9_257);
unpackValues(l9_255.w,l9_250,l9_257);
unpackValues(l9_255.z,l9_250,l9_257);
unpackValues(l9_255.y,l9_250,l9_257);
unpackValues(l9_255.x,l9_250,l9_257);
int l9_266[8]=l9_247;
unpackValues(l9_256.w,l9_250,l9_266);
unpackValues(l9_256.z,l9_250,l9_266);
unpackValues(l9_256.y,l9_250,l9_266);
unpackValues(l9_256.x,l9_250,l9_266);
}
l9_250++;
continue;
}
...
vec4 l9_271=texture2D(sc_OITFilteredDepthBoundsTexture,l9_245);
vec2 l9_272=l9_271.xy;
int l9_273;
#if (sc_SkinBonesCount>0)
{
l9_273=encodeDepth(((1.0-l9_271.x)*1000.0)+getDepthOrderingEpsilon(),l9_272);
}
#else
{
l9_273=0;
...
#endif
int l9_274=encodeDepth(viewSpaceDepth(),l9_272);
vec4 l9_275;
l9_275=l9_230*l9_230.w;
vec4 l9_276;
int l9_277=0;
for (int snapLoopIndex=0; snapLoopIndex==0; snapLoopIndex+=0)
{
if (l9_277<8)
{
int l9_278=l9_246[l9_277];
int l9_279=l9_274-l9_273;
bool l9_280=l9_278<l9_279;
bool l9_281;
if (l9_280)
{
l9_281=l9_246[l9_277]>0;
}
else
{
l9_281=l9_280;
...
if (l9_281)
{
vec3 l9_282=l9_275.xyz*(1.0-(float(l9_247[l9_277])/255.0));
l9_276=vec4(l9_282.x,l9_282.y,l9_282.z,l9_275.w);
}
else
{
l9_276=l9_275;
...
sc_writeFragData0Internal(l9_275,sc_UniformConstants.x,sc_ShaderCacheConstant);
#if (sc_OITMaxLayersVisualizeLayerCount)
{
discard;
}
...
sc_writeFragData0Internal(l9_230,sc_UniformConstants.x,sc_ShaderCacheConstant);
}
#endif
}
#else
{
sc_writeFragData0Internal(l9_229,sc_UniformConstants.x,sc_ShaderCacheConstant);
}
#endif
}
#endif

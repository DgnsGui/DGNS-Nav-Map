...
float l9_2=1.0-clamp(dot(normalize(sc_Camera.position-varPosAndMotion.xyz),l9_0),0.0,1.0);
float l9_3;
if (l9_2<=0.0)
{
l9_3=0.0;
...
#endif
uvec3 l9_49=uvec3(round((varPosAndMotion.xyz-sc_RayTracingOriginOffset)*sc_RayTracingOriginScale));
...
l9_4=varTex01.xy;
l9_3=(sc_ModelMatrixInverse*vec4(varPosAndMotion.xyz,1.0)).xyz;
l9_2=normalize(varNormalAndMotion.xyz);
l9_1=normalize(sc_Camera.position-varPosAndMotion.xyz);
}
...
#endif
sc_writeFragData0(max(l9_122,vec4(0.0)));
return;
}
vec4 l9_124;
#if (sc_ProjectiveShadowsCaster)
...
vec4 l9_150=sc_OutputMotionVectorIfNeeded(max(l9_148,vec4(0.0)));
...
sc_writeFragData0(vec4(max(0.0,1.0-(l9_152-0.0039215689)),min(1.0,l9_152+0.0039215689),0.0,0.0));
}
#endif
}
#else
...
sc_writeFragData0(vec4(packValue(l9_154),packValue(l9_154),packValue(l9_154),packValue(l9_154)));
}
#endif
}
#else
...
sc_writeFragData0(l9_151);
}
#endif
}
#else
{
sc_writeFragData0(l9_150);
}
#endif
}
#endif

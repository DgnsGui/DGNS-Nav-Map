...
export class ZToggleMover extends BaseScriptComponent {
  ...
  @input
  @hint("Commence en position sortie (visible) au lieu de rentrée (cachée)")
  private startVisible: boolean = false
  ...
  private isOut: boolean = false // false = rentrée, true = sorti
  ...
  private initialize(): void {
    ...
    // Configuration de l'état initial selon startVisible
    if (this.startVisible) {
      // Commence en position sortie (visible)
      this.moveToTarget(true)
      this.targetObject.enabled = true
      this.isOut = true
    } else {
      // Commence en position rentrée (cachée) - comportement par défaut
